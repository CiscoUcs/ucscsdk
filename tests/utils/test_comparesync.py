...
# TODO: Placeholder for the test compare_sync functionality
'''
from ucscentralsdk.utils.comparesyncmo import compare_ucscentral_mo, write_mo_diff
...
def static_setup():
    ...
    from ucscentralsdk.ucscentralcoremeta import UcsCentralVersion

    global ref_handle
    global diff_handle

    ref_handle = UcsCentralHandle("192.168.1.1", "admin", "password")
    diff_handle = UcsCentralHandle("192.168.1.2", "admin", "password")

    ref_handle.__dict__['_UcsCentralSession__version'] = UcsCentralVersion("2.2(5a)")
    diff_handle.__dict__['_UcsCentralSession__version'] = UcsCentralVersion("2.2(2c)")
