...
from .ucscfiltertype import OrFilter, AndFilter, NotFilter
from .ucscbasetype import FilterFilter
...
def handle_filter_max_component_limit(handle, l_filter):
    ...
    from .ucsccore import AbstractFilter
    from .ucscfiltertype import AndFilter, OrFilter
...
def create_basic_filter(filter_name, **kwargs):
    ...
    fq_module_name = ucscmeta.OTHER_TYPE_CLASS_ID[filter_name]
