...
prop_meta = {
    ...
    "in_pool_name": MethodPropertyMeta("InPoolName", "inPoolName", "Xs:string", "Version142b", "Input", False),
    "in_qualifier_name": MethodPropertyMeta("InQualifierName", "inQualifierName", "Xs:string", "Version142b", "Input", False),
...
prop_map = {
    ...
    "inPoolName": "in_pool_name",
    "inQualifierName": "in_qualifier_name",
