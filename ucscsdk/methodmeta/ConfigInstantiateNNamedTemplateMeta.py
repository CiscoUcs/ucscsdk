"""This module contains the meta information of ConfigInstantiateNNamedTemplate ExternalMethod."""

from ..ucsccoremeta import MethodMeta, MethodPropertyMeta

method_meta = MethodMeta("ConfigInstantiateNNamedTemplate", "configInstantiateNNamedTemplate", "Version142b")
