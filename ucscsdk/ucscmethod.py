...
"""
This module contains the ucscsdk Core classes.
"""
...
class ExternalMethod(UcscBase):
    ...
    def __init__(self, method_id):
        # """ __init__ of the UcscBase class """
        UcscBase.__init__(self, method_id)

        meta_module = ucsccoreutils.load_module(method_id)
