...
class TestingServiceProfileFsm(ManagedObject):
    ...
    mo_meta = MoMeta("TestingServiceProfileFsm", "testingServiceProfileFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['testingServiceProfile'], ['testingServiceProfileFsmStage'], [None])
