"""This module contains the general information for TestingSnmpPolicy ManagedObject."""
...
class TestingSnmpPolicy(ManagedObject):
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "TestingSnmpPolicy", parent_mo_or_dn, **kwargs)
