...
class TestingServiceProfile(ManagedObject):
    ...
    mo_meta = MoMeta("TestingServiceProfile", "testingServiceProfile", "service-profile-[name]", VersionMeta.Version101a, "InputOutput", 0x1ff, [], ["admin", "read-only"], ['orgOrg'], ['eventInst', 'faultInst', 'testingServiceProfileFsm', 'testingServiceProfileFsmTask'], [None])
