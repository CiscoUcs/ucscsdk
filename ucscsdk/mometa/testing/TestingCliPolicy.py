"""This module contains the general information for TestingCliPolicy ManagedObject."""
...
class TestingCliPolicy(ManagedObject):
    """This is TestingCliPolicy class."""

    consts = TestingCliPolicyConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("TestingCliPolicy", "testingCliPolicy", "cli-policy-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["admin", "read-only"], [u'orgOrg', u'topSystem'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "TestingCliPolicy", parent_mo_or_dn, **kwargs)
