...
class FaultInst(ManagedObject):
    ...
    prop_meta = {
        ...
        "cause_string": MoPropertyMeta("cause_string", "causeString", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
