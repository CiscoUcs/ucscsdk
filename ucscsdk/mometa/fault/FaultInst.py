...
class FaultInst(ManagedObject):
    ...
    prop_meta = {
        ...
        "src_dme": MoPropertyMeta("src_dme", "srcDme", "string", VersionMeta.Version121a, MoPropertyMeta.READ_WRITE, None, None, None, None, ["central-mgr", "identifier-mgr", "mgmt-controller", "operation-mgr", "policy-mgr", "resource-mgr", "server-mgr", "service-reg", "stats-mgr", "unknown"], []), 
