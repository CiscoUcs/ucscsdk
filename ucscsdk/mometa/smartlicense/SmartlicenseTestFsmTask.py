"""This module contains the general information for SmartlicenseTestFsmTask ManagedObject."""
...
class SmartlicenseTestFsmTaskConsts():
...
class SmartlicenseTestFsmTask(ManagedObject):
    """This is SmartlicenseTestFsmTask class."""

    consts = SmartlicenseTestFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("SmartlicenseTestFsmTask", "smartlicenseTestFsmTask", "task-[item]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'smartlicenseTest'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseTestFsmTask", parent_mo_or_dn, **kwargs)
