...
class SmartlicenseEntitlementEpFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SmartlicenseEntitlementEpFsm", "smartlicenseEntitlementEpFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['smartlicenseEntitlementEp'], ['smartlicenseEntitlementEpFsmStage'], [None])
