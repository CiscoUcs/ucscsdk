"""This module contains the general information for SmartlicenseEntitlementEpFsmStage ManagedObject."""
...
class SmartlicenseEntitlementEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CONFIGURE_BEGIN = "ConfigureBegin"
    NAME_CONFIGURE_FAIL = "ConfigureFail"
    NAME_CONFIGURE_REPORT = "ConfigureReport"
    NAME_CONFIGURE_RETRY_REPORT = "ConfigureRetryReport"
...
class SmartlicenseEntitlementEpFsmStage(ManagedObject):
    """This is SmartlicenseEntitlementEpFsmStage class."""

    consts = SmartlicenseEntitlementEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SmartlicenseEntitlementEpFsmStage", "smartlicenseEntitlementEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'smartlicenseEntitlementEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureReport", "ConfigureRetryReport", "ConfigureSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseEntitlementEpFsmStage", parent_mo_or_dn, **kwargs)
