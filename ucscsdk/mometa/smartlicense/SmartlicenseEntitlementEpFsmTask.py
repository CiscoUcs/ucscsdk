"""This module contains the general information for SmartlicenseEntitlementEpFsmTask ManagedObject."""
...
class SmartlicenseEntitlementEpFsmTaskConsts():
...
class SmartlicenseEntitlementEpFsmTask(ManagedObject):
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseEntitlementEpFsmTask", parent_mo_or_dn, **kwargs)
