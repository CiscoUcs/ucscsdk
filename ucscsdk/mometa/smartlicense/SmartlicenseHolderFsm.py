...
class SmartlicenseHolderFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SmartlicenseHolderFsm", "smartlicenseHolderFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['smartlicenseHolder'], ['smartlicenseHolderFsmStage'], [None])
