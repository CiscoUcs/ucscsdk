"""This module contains the general information for SmartlicenseAgentFsmStage ManagedObject."""
...
class SmartlicenseAgentFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class SmartlicenseAgentFsmStage(ManagedObject):
    """This is SmartlicenseAgentFsmStage class."""

    consts = SmartlicenseAgentFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SmartlicenseAgentFsmStage", "smartlicenseAgentFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'smartlicenseAgentFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureBegin", "ConfigureConfig", "ConfigureFail", "ConfigureSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseAgentFsmStage", parent_mo_or_dn, **kwargs)
