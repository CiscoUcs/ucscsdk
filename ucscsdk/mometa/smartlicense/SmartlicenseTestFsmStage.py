"""This module contains the general information for SmartlicenseTestFsmStage ManagedObject."""
...
class SmartlicenseTestFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CONFIGURE_BEGIN = "ConfigureBegin"
    NAME_CONFIGURE_EXECUTE_TEST_CLI = "ConfigureExecuteTestCli"
...
class SmartlicenseTestFsmStage(ManagedObject):
    """This is SmartlicenseTestFsmStage class."""

    consts = SmartlicenseTestFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("SmartlicenseTestFsmStage", "smartlicenseTestFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'smartlicenseTestFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureBegin", "ConfigureExecuteTestCli", "ConfigureFail", "ConfigureSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseTestFsmStage", parent_mo_or_dn, **kwargs)
