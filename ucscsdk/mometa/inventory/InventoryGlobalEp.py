...
class InventoryGlobalEp(ManagedObject):
    ...
    mo_meta = MoMeta("InventoryGlobalEp", "inventoryGlobalEp", "global-ep", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["admin", "operations"], [u'inventoryHolder'], [u'inventoryInventoryMoMeta'], [None])
