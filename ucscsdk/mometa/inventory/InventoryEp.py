"""This module contains the general information for InventoryEp ManagedObject."""
...
class InventoryEpConsts():
    pass


class InventoryEp(ManagedObject):
    """This is InventoryEp class."""

    consts = InventoryEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("InventoryEp", "inventoryEp", "inventory", VersionMeta.Version201a, "InputOutput", 0xf, [], ["admin", "operations"], [u'topRoot'], [u'inventoryHolder'], ["get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "InventoryEp", **kwargs)
