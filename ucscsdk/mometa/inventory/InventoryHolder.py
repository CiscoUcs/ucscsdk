...
class InventoryHolder(ManagedObject):
    ...
    mo_meta = MoMeta("InventoryHolder", "inventoryHolder", "holder-[type]", VersionMeta.Version201a, "InputOutput", 0x7f, [], ["admin", "operations"], [u'inventoryEp'], [u'inventoryDomainEp', u'inventoryGlobalEp'], [None])
    ...
    prop_meta = {
        ...
        "inventory_trig_state": MoPropertyMeta("inventory_trig_state", "inventoryTrigState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["off", "on"], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x40, None, None, None, ["boot-mgr", "central-mgr", "identifier-mgr", "managed-endpoint", "mgmt-controller", "operation-mgr", "policy-mgr", "resource-aggr", "resource-mgr", "server-mgr", "service-reg", "stats-mgr", "storage-broker", "virtual-switching-mgr", "vm-mgr"], []), 
    }
