...
class LsmaintAck(ManagedObject):
    ...
    prop_meta = {
        ...
        "acked_by": MoPropertyMeta("acked_by", "ackedBy", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, 0, 32, None, [], []), 
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version111a, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["trigger", "trigger-immediate", "triggered", "untriggered", "user-ack"], []), 
        ...
        "disr": MoPropertyMeta("disr", "disr", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|ac-power-cycle|storage-access|storage-uptime|up-time),){0,4}(defaultValue|ac-power-cycle|storage-access|storage-uptime|up-time){0,1}""", [], []), 
        ...
        "modified": MoPropertyMeta("modified", "modified", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
