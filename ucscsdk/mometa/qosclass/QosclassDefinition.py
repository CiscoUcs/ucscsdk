...
class QosclassDefinition(ManagedObject):
    ...
    mo_meta = MoMeta("QosclassDefinition", "qosclassDefinition", "classes", VersionMeta.Version141a, "InputOutput", 0x1f, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], ['fabricLanCloud', 'orgDomainGroup'], ['firmwareAck', 'qosclassEthBE', 'qosclassEthClassified', 'qosclassFc'], ["Get", "Set"])
