...
class QosclassPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("QosclassPolicy", "qosclassPolicy", "qosclass-[name]", VersionMeta.Version201b, "InputOutput", 0x3f, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [u'orgDomainGroup'], [u'qosclassEthBE', u'qosclassEthClassified', u'qosclassFc'], ["add", "get", "remove", "set"])
