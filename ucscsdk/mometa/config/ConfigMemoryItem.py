"""This module contains the general information for ConfigMemoryItem ManagedObject."""
...
class ConfigMemoryItem(ManagedObject):
    """This is ConfigMemoryItem class."""

    consts = ConfigMemoryItemConsts()
    naming_props = set([])

    mo_meta = MoMeta("ConfigMemoryItem", "configMemoryItem", "memory-item", VersionMeta.Version141a, "InputOutput", 0xf, [], ["read-only"], [], [], [None])

    prop_meta = {
        "capacity": MoPropertyMeta("capacity", "capacity", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unspecified"], ["0-4294967295"]), 
        "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version141a, MoPropertyMeta.INTERNAL, None, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "clock": MoPropertyMeta("clock", "clock", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["unspecified"], ["0-4294967295"]), 
        ...
        "locator": MoPropertyMeta("locator", "locator", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigMemoryItem", parent_mo_or_dn, **kwargs)
