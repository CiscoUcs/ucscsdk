"""This module contains the general information for ConfigPSUItem ManagedObject."""
...
class ConfigPSUItem(ManagedObject):
    """This is ConfigPSUItem class."""

    consts = ConfigPSUItemConsts()
    naming_props = set([])

    mo_meta = MoMeta("ConfigPSUItem", "configPSUItem", "psu-item", VersionMeta.Version141a, "InputOutput", 0xf, [], ["read-only"], [], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigPSUItem", parent_mo_or_dn, **kwargs)
