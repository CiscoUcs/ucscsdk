"""This module contains the general information for ConfigCryptoCardItem ManagedObject."""
...
class ConfigCryptoCardItemConsts():
...
class ConfigCryptoCardItem(ManagedObject):
    """This is ConfigCryptoCardItem class."""

    consts = ConfigCryptoCardItemConsts()
    naming_props = set([])

    mo_meta = MoMeta("ConfigCryptoCardItem", "configCryptoCardItem", "crypto-card-item", VersionMeta.Version141a, "InputOutput", 0xf, [], ["read-only"], [], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigCryptoCardItem", parent_mo_or_dn, **kwargs)
