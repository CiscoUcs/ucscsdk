...
class ConfigNetRefItem(ManagedObject):
    ...
    mo_meta = MoMeta("ConfigNetRefItem", "configNetRefItem", "", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [], [], [None])
    ...
    prop_meta = {
        ...
        "inband_policy_dn": MoPropertyMeta("inband_policy_dn", "inbandPolicyDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["aci", "all", "classic"], []), 
    }
