"""This module contains the general information for ConfigIOMItem ManagedObject."""
...
class ConfigIOMItemConsts():
    ...
    IS_SHARED_IOMODULE_FALSE = "false"
    IS_SHARED_IOMODULE_NO = "no"
    IS_SHARED_IOMODULE_TRUE = "true"
    IS_SHARED_IOMODULE_YES = "yes"
...
class ConfigIOMItem(ManagedObject):
    """This is ConfigIOMItem class."""

    consts = ConfigIOMItemConsts()
    naming_props = set([])

    mo_meta = MoMeta("ConfigIOMItem", "configIOMItem", "iom-item", VersionMeta.Version141a, "InputOutput", 0xf, [], ["read-only"], [], [], [None])
    ...
    prop_meta = {
        ...
        "is_shared_io_module": MoPropertyMeta("is_shared_io_module", "isSharedIOModule", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "side": MoPropertyMeta("side", "side", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["left", "right"], []), 
    ...
    prop_map = {
        ...
        "id": "id", 
        "isSharedIOModule": "is_shared_io_module", 
        "location": "location", 
        "model": "model", 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigIOMItem", parent_mo_or_dn, **kwargs)
