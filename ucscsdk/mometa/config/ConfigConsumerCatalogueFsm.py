...
class ConfigConsumerCatalogueFsm(ManagedObject):
    ...
    mo_meta = MoMeta("ConfigConsumerCatalogueFsm", "configConsumerCatalogueFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['configConsumerCatalogue'], ['configConsumerCatalogueFsmStage'], [None])
