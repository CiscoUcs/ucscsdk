"""This module contains the general information for ConfigConsumerCatalogueFsmStage ManagedObject."""
...
class ConfigConsumerCatalogueFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CREATE_BEGIN = "CreateBegin"
    NAME_CREATE_FAIL = "CreateFail"
    NAME_CREATE_MAKE_CFG_DIRS = "CreateMakeCfgDirs"
...
class ConfigConsumerCatalogueFsmStage(ManagedObject):
    """This is ConfigConsumerCatalogueFsmStage class."""

    consts = ConfigConsumerCatalogueFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ConfigConsumerCatalogueFsmStage", "configConsumerCatalogueFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'configConsumerCatalogueFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["CreateBegin", "CreateFail", "CreateMakeCfgDirs", "CreateSuccess", "DeleteBegin", "DeleteFail", "DeleteLocal", "DeleteSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigConsumerCatalogueFsmStage", parent_mo_or_dn, **kwargs)
