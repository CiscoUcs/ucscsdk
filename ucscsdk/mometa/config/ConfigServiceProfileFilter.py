"""This module contains the general information for ConfigServiceProfileFilter ManagedObject."""
...
class ConfigServiceProfileFilterConsts():
...
class ConfigServiceProfileFilter(ManagedObject):
    """This is ConfigServiceProfileFilter class."""

    consts = ConfigServiceProfileFilterConsts()
    naming_props = set([])

    mo_meta = MoMeta("ConfigServiceProfileFilter", "configServiceProfileFilter", "service-profile-filter", VersionMeta.Version141a, "InputOutput", 0x3ff, [], ["read-only"], [], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigServiceProfileFilter", parent_mo_or_dn, **kwargs)
