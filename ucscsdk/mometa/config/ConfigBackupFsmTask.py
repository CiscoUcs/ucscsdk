"""This module contains the general information for ConfigBackupFsmTask ManagedObject."""
...
class ConfigBackupFsmTaskConsts():
...
class ConfigBackupFsmTask(ManagedObject):
    """This is ConfigBackupFsmTask class."""

    consts = ConfigBackupFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ConfigBackupFsmTask", "configBackupFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'configBackup'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["Delete", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigBackupFsmTask", parent_mo_or_dn, **kwargs)
