...
class ConfigServerItem(ManagedObject):
    ...
    prop_meta = {
        ...
        "diag_oper_state": MoPropertyMeta("diag_oper_state", "diagOperState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["cancelled", "completed", "failed", "idle", "in-progress", "unknown"], []), 
        "diag_overall_progress": MoPropertyMeta("diag_overall_progress", "diagOverallProgress", "byte", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-100"]), 
