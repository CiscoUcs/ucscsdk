...
class ConfigCpuItem(ManagedObject):
    ...
    prop_meta = {
        "arch": MoPropertyMeta("arch", "arch", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Dual-Core_Opteron", "Intel_P4_C", "Opteron", "Pentium_4", "Turion_64", "Xeon", "Xeon_MP", "any"], []), 
