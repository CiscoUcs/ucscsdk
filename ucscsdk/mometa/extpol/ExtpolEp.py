...
class ExtpolEp(ManagedObject):
    ...
    mo_meta = MoMeta("ExtpolEp", "extpolEp", "extpol", VersionMeta.Version101a, "InputOutput", 0xf, [], ["admin"], ['topRoot'], ['eventInst', 'extpolEpFsm', 'extpolEpFsmTask', 'extpolRegistry', 'faultInst', 'faultSummary'], ["Get"])
