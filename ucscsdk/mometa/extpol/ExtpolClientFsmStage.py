"""This module contains the general information for ExtpolClientFsmStage ManagedObject."""
...
class ExtpolClientFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_UPDATE_CONTEXT_FSM_BEGIN = "UpdateContextFsmBegin"
    NAME_UPDATE_CONTEXT_FSM_EXECUTE = "UpdateContextFsmExecute"
    NAME_UPDATE_CONTEXT_FSM_FAIL = "UpdateContextFsmFail"
    NAME_UPDATE_CONTEXT_FSM_SUCCESS = "UpdateContextFsmSuccess"
    NAME_NOP = "nop"
...
class ExtpolClientFsmStage(ManagedObject):
    """This is ExtpolClientFsmStage class."""

    consts = ExtpolClientFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ExtpolClientFsmStage", "extpolClientFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'extpolClientFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["UpdateContextFsmBegin", "UpdateContextFsmExecute", "UpdateContextFsmFail", "UpdateContextFsmSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtpolClientFsmStage", parent_mo_or_dn, **kwargs)
