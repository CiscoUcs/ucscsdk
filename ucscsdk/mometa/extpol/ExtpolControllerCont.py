...
class ExtpolControllerCont(ManagedObject):
    ...
    mo_meta = MoMeta("ExtpolControllerCont", "extpolControllerCont", "controllers", VersionMeta.Version101a, "InputOutput", 0xf, [], ["admin"], [u'extpolRegistry'], [u'extpolController'], ["Get"])
