...
class ExtvmmVMNetworkSets(ManagedObject):
    ...
    mo_meta = MoMeta("ExtvmmVMNetworkSets", "extvmmVMNetworkSets", "vm-network-sets", VersionMeta.Version141a, "InputOutput", 0xf, [], ["admin", "ls-network", "ls-network-policy"], ['fabricLanCloud'], [], ["Get"])
