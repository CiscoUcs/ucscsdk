...
class StorageConnectionDef(ManagedObject):
    ...
    mo_meta = MoMeta("StorageConnectionDef", "storageConnectionDef", "storage-conndef", VersionMeta.Version111a, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], ['vnicFcGroupDef'], ['faultInst', 'storageFcTargetEp'], ["Add", "Get", "Remove", "Set"])
