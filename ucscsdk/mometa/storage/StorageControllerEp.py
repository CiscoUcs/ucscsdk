...
class StorageControllerEp(ManagedObject):
    ...
    mo_meta = MoMeta("StorageControllerEp", "storageControllerEp", "controller-ep-[id]", VersionMeta.Version151a, "InputOutput", 0x1f, [], ["read-only"], [u'storageLocalDisk', u'storageVirtualDrive'], [], ["Get"])
