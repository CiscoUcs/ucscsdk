"""This module contains the general information for StorageComputeBladeOperation ManagedObject."""
...
class StorageComputeBladeOperationConsts():
...
class StorageComputeBladeOperation(ManagedObject):
    """This is StorageComputeBladeOperation class."""

    consts = StorageComputeBladeOperationConsts()
    naming_props = set([])

    mo_meta = MoMeta("StorageComputeBladeOperation", "storageComputeBladeOperation", "remote-oper", VersionMeta.Version131a, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], ['storageBlade'], ['faultInst'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "StorageComputeBladeOperation", parent_mo_or_dn, **kwargs)
