...
class StorageVsanRef(ManagedObject):
    ...
    mo_meta = MoMeta("StorageVsanRef", "storageVsanRef", "vsan-ref", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["admin", "ext-san-config", "ext-san-policy", "ls-storage", "ls-storage-policy"], [u'storageFcTargetEp'], [u'faultInst'], ["Add", "Get", "Set"])
