...
class StorageController(ManagedObject):
    ...
    prop_meta = {
        ...
        "sub_type": MoPropertyMeta("sub_type", "subType", "string", VersionMeta.Version210a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["NA", "NVME-FRONT", "NVME-HHHL", "NVME-M2", "NVME-MEZZ", "NVME-REAR", "RDE"], []), 
