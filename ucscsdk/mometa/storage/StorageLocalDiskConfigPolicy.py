...
class StorageLocalDiskConfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("StorageLocalDiskConfigPolicy", "storageLocalDiskConfigPolicy", "local-disk-config-[name]", VersionMeta.Version111a, "InputOutput", 0x3ff, [], ["read-only"], [u'orgOrg'], [u'storageLocalDiskPartition'], ["Add", "Get", "Remove", "Set"])
