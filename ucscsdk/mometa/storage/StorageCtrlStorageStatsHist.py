...
class StorageCtrlStorageStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("StorageCtrlStorageStatsHist", "storageCtrlStorageStatsHist", "[id]", VersionMeta.Version131a, "OutputOnly", 0xf, [], ["read-only"], [u'storageCtrlStorageStats'], [], [None])
