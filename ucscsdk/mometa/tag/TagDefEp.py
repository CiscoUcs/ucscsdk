"""This module contains the general information for TagDefEp ManagedObject."""
...
class TagDefEpConsts():
    pass


class TagDefEp(ManagedObject):
    """This is TagDefEp class."""

    consts = TagDefEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("TagDefEp", "tagDefEp", "tag-def-ep", VersionMeta.Version151a, "InputOutput", 0xf, [], ["read-only"], [u'fabricHolder'], [u'tagDef'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "TagDefEp", parent_mo_or_dn, **kwargs)
