...
class StatsThr32Definition(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThr32Definition", "statsThr32Definition", "[prop_id]", VersionMeta.Version101a, "InputOutput", 0xff, [], ["admin", "operations"], ['statsThresholdClass'], ['statsThr32Value', 'statsThr64Value', 'statsThrFloatValue'], ["Add", "Get", "Remove", "Set"])
