...
class StatsThr64Definition(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThr64Definition", "statsThr64Definition", "[prop_id]", VersionMeta.Version101a, "InputOutput", 0xff, [], ["admin", "operations"], ['statsThresholdClass'], ['statsThr32Value', 'statsThr64Value', 'statsThrFloatValue'], ["Add", "Get", "Remove", "Set"])
