...
class StatsThr64Definition(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThr64Definition", "statsThr64Definition", "[prop_id]", VersionMeta.Version101a, "InputOutput", 0xff, [], ["admin", "operations"], [u'statsThresholdClass'], [u'statsThr32Value', u'statsThr64Value', u'statsThrFloatValue'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "normal_value": MoPropertyMeta("normal_value", "normalValue", "ulong", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, [], []), 
