...
class ComputePowerExtendedPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePowerExtendedPolicy", "computePowerExtendedPolicy", "power-extended-policy", VersionMeta.Version201u, "InputOutput", 0xff, [], ["admin", "domain-group-management", "pn-equipment", "pn-policy"], ['orgDomainGroup'], [], [None])
