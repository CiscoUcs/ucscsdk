...
class ComputeSystemQual(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeSystemQual", "computeSystemQual", "system-qualifier-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], [""], ['orgOrg'], ['computeOwnerQual', 'computeSiteQual', 'computeSystemAddrQual'], ["Add", "Get", "Remove", "Set"])
