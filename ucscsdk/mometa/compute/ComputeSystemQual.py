"""This module contains the general information for ComputeSystemQual ManagedObject."""
...
class ComputeSystemQual(ManagedObject):
    """This is ComputeSystemQual class."""

    consts = ComputeSystemQualConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ComputeSystemQual", "computeSystemQual", "system-qualifier-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], [""], [u'orgOrg'], [u'computeOwnerQual', u'computeSiteQual', u'computeSystemAddrQual'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeSystemQual", parent_mo_or_dn, **kwargs)
