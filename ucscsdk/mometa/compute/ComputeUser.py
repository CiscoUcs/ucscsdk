"""This module contains the general information for ComputeUser ManagedObject."""
...
class ComputeUser(ManagedObject):
    """This is ComputeUser class."""

    consts = ComputeUserConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ComputeUser", "computeUser", "user-[name]", VersionMeta.Version101a, "InputOutput", 0x7f, [], ["aaa", "admin"], [u'computeProfile', u'computeUserEp'], [u'computeSession'], [None])
    ...
    prop_meta = {
        ...
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[!""#%&'\(\)\*\+,\-\./:;<>@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{0,128}""", [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeUser", parent_mo_or_dn, **kwargs)
