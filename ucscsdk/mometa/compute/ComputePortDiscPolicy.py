...
class ComputePortDiscPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePortDiscPolicy", "computePortDiscPolicy", "port-discovery", VersionMeta.Version201a, "InputOutput", 0xff, [], ["admin", "domain-group-management", "pn-policy", "read-only"], [u'orgDomainGroup', u'orgOrg'], [], ["get", "set"])
