...
class ComputePowerSyncPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputePowerSyncPolicy", "computePowerSyncPolicy", "power-sync-[name]", VersionMeta.Version201b, "InputOutput", 0x7f, [], ["admin", "ls-compute", "ls-config-policy", "ls-server", "ls-server-policy"], ['orgOrg'], [], ["add", "get", "remove", "set"])
    ...
    prop_meta = {
        ...
        "sync_option": MoPropertyMeta("sync_option", "syncOption", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["always-sync", "default", "initial-only-sync"], []), 
    }
