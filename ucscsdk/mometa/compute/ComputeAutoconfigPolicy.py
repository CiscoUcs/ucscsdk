...
class ComputeAutoconfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeAutoconfigPolicy", "computeAutoconfigPolicy", "autoconfig-[name]", VersionMeta.Version141a, "InputOutput", 0x1ff, [], ["admin", "pn-policy"], [u'orgDomainGroup', u'orgOrg'], [u'faultInst'], ["Get", "Set"])
