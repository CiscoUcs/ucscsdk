...
class ComputeChassisFeatMask(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeChassisFeatMask", "computeChassisFeatMask", "chassis-feat-mask", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'computeSystem', u'equipmentChassis', u'equipmentChassisProfile', u'extpolDomain'], [], ["get"])
    ...
    prop_meta = {
        ...
        "feat_mask": MoPropertyMeta("feat_mask", "featMask", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|none|compute_conn_policy_feature_mask|light_weight_patching_feature_mask),){0,3}(defaultValue|none|compute_conn_policy_feature_mask|light_weight_patching_feature_mask){0,1}""", [], []), 
