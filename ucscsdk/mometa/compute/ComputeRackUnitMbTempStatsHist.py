...
class ComputeRackUnitMbTempStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeRackUnitMbTempStatsHist", "computeRackUnitMbTempStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], ['computeRackUnitMbTempStats'], [], [None])
