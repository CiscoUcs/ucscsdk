...
class ComputeDomainQual(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeDomainQual", "computeDomainQual", "Domain-qualifier-[name]", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["admin", "pn-policy", "read-only"], ['computeQual'], ['computeChassisQual', 'computeDomainGroupQual', 'computeDomainNameQual', 'computeOwnerQual', 'computeProductFamilyQual', 'computeRackQual', 'computeSiteQual', 'computeSystemAddrQual'], ["Add", "Get", "Remove"])
