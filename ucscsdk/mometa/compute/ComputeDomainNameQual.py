"""This module contains the general information for ComputeDomainNameQual ManagedObject."""
...
class ComputeDomainNameQualConsts():
    pass


class ComputeDomainNameQual(ManagedObject):
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, 0x4, 1, 510, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeDomainNameQual", parent_mo_or_dn, **kwargs)
