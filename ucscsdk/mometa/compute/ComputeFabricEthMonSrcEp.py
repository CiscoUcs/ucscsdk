...
class ComputeFabricEthMonSrcEp(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeFabricEthMonSrcEp", "computeFabricEthMonSrcEp", "src-[id]", VersionMeta.Version201a, "InputOutput", 0xff, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'computeFabricEthMonSrcEpCont'], [], [None])
