"""This module contains the general information for ComputeSystemFsmStage ManagedObject."""
...
class ComputeSystemFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_REGISTER_AUTHENTICATE = "RegisterAuthenticate"
    NAME_REGISTER_BEGIN = "RegisterBegin"
    NAME_REGISTER_FAIL = "RegisterFail"
    NAME_REGISTER_SUCCESS = "RegisterSuccess"
    NAME_NOP = "nop"
...
class ComputeSystemFsmStage(ManagedObject):
    """This is ComputeSystemFsmStage class."""

    consts = ComputeSystemFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ComputeSystemFsmStage", "computeSystemFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'computeSystemFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["RegisterAuthenticate", "RegisterBegin", "RegisterFail", "RegisterSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeSystemFsmStage", parent_mo_or_dn, **kwargs)
