...
class ComputeMbPowerStats(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeMbPowerStats", "computeMbPowerStats", "power-stats", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], ['computeBoard'], ['computeMbPowerStatsHist'], [None])
