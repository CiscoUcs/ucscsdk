"""This module contains the general information for ComputeProfile ManagedObject."""
...
class ComputeProfile(ManagedObject):
    """This is ComputeProfile class."""

    consts = ComputeProfileConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ComputeProfile", "computeProfile", "profile-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["admin"], [u'computeResourceAggrEp'], [u'computeUser'], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeProfile", parent_mo_or_dn, **kwargs)
