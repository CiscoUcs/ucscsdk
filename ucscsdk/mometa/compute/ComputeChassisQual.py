...
class ComputeChassisQual(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeChassisQual", "computeChassisQual", "chassis-from-[min_id]-to-[max_id]", VersionMeta.Version111a, "InputOutput", 0x3f, [], ["admin", "pn-policy", "read-only"], ['computeDomainQual'], ['computeSlotQual'], ["Add", "Get", "Remove", "Set"])
