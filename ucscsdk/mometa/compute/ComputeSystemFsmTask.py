"""This module contains the general information for ComputeSystemFsmTask ManagedObject."""
...
class ComputeSystemFsmTaskConsts():
...
class ComputeSystemFsmTask(ManagedObject):
    """This is ComputeSystemFsmTask class."""

    consts = ComputeSystemFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ComputeSystemFsmTask", "computeSystemFsmTask", "task-[item]", VersionMeta.Version111a, "OutputOnly", 0xf, [], [""], [u'computeSystem'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111a, MoPropertyMeta.NAMING, None, None, None, None, ["Register", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeSystemFsmTask", parent_mo_or_dn, **kwargs)
