...
class ComputeFabricEthMonSrcEpCont(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeFabricEthMonSrcEpCont", "computeFabricEthMonSrcEpCont", "eth-mon", VersionMeta.Version201a, "InputOutput", 0xf, [], ["admin", "operations"], [u'computeSystem'], [u'computeFabricEthMonSrcEp'], [None])
