"""This module contains the general information for ComputeUserEp ManagedObject."""
...
class ComputeUserEp(ManagedObject):
    """This is ComputeUserEp class."""

    consts = ComputeUserEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("ComputeUserEp", "computeUserEp", "user", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["aaa", "admin"], [u'computeSystem'], [u'computeUser'], [None])
    ...
    prop_meta = {
        ...
        "profile_dn": MoPropertyMeta("profile_dn", "profileDn", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeUserEp", parent_mo_or_dn, **kwargs)
