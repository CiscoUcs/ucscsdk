...
class CommSvcEpFsmStageConsts():
    ...
    NAME_RESTART_WEB_SVC_RESTART = "restartWebSvcRestart"
...
class CommSvcEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("CommSvcEpFsmStage", "commSvcEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'commSvcEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "restartWebSvcBegin", "restartWebSvcFail", "restartWebSvcRestart", "restartWebSvcSuccess"], []), 
