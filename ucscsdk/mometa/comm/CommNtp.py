"""This module contains the general information for CommNtp ManagedObject."""
...
class CommNtp(ManagedObject):
    """This is CommNtp class."""

    consts = CommNtpConsts()
    naming_props = set([])

    mo_meta = MoMeta("CommNtp", "commNtp", "ntp-svc", VersionMeta.Version101a, "InputOutput", 0xff, [], ["admin", "ext-lan-config", "ext-lan-security", "operations"], [], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CommNtp", parent_mo_or_dn, **kwargs)
