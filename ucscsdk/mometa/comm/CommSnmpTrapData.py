"""This module contains the general information for CommSnmpTrapData ManagedObject."""
...
class CommSnmpTrapData(ManagedObject):
    ...
    prop_meta = {
        ...
        "prop_oid": MoPropertyMeta("prop_oid", "propOid", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, 0x10, 1, 510, None, [], []), 
        "pwd": MoPropertyMeta("pwd", "pwd", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[!""#%&'\(\)\*\+,\-\./:;<>@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{0,128}""", [], []), 
        "pwd_set": MoPropertyMeta("pwd_set", "pwdSet", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "value": MoPropertyMeta("value", "value", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, [], []), 
        "var_type": MoPropertyMeta("var_type", "varType", "byte", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, prop_oid, **kwargs):
        self._dirty_mask = 0
        self.prop_oid = prop_oid
        ...
        ManagedObject.__init__(self, "CommSnmpTrapData", parent_mo_or_dn, **kwargs)
