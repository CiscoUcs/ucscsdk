...
class CommSvcEp(ManagedObject):
    ...
    mo_meta = MoMeta("CommSvcEp", "commSvcEp", "svc-ext", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["aaa", "admin"], ['computeSystem', 'topSystem'], ['commDateTime', 'commHttps', 'commSvcEpFsm', 'commSvcEpFsmTask', 'eventInst', 'faultInst'], ["Get"])
