...
class CommSvcPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("CommSvcPolicy", "commSvcPolicy", "comm-pol-[name]", VersionMeta.Version131a, "InputOutput", 0x3f, [], ["read-only"], [u'orgOrg'], [u'commDateTime', u'commDns', u'commSyslog'], [None])
