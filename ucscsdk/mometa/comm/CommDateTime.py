...
class CommDateTimeConsts():
    ...
    FSM_PREV_NOP = "nop"
    FSM_PREV_TIMEZONE_BEGIN = "timezoneBegin"
    FSM_PREV_TIMEZONE_CHANGE = "timezoneChange"
    FSM_PREV_TIMEZONE_FAIL = "timezoneFail"
    FSM_PREV_TIMEZONE_SUCCESS = "timezoneSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_TIMEZONE_BEGIN = "timezoneBegin"
    FSM_STATUS_TIMEZONE_CHANGE = "timezoneChange"
    FSM_STATUS_TIMEZONE_FAIL = "timezoneFail"
    FSM_STATUS_TIMEZONE_SUCCESS = "timezoneSuccess"
    INT_ID_NONE = "none"
...
class CommDateTime(ManagedObject):
    ...
    prop_meta = {
        ...
        "date": MoPropertyMeta("date", "date", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version151a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "timezoneBegin", "timezoneChange", "timezoneFail", "timezoneSuccess"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version151a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "timezoneBegin", "timezoneChange", "timezoneFail", "timezoneSuccess"], []), 
        ...
        "port": MoPropertyMeta("port", "port", "uint", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], ["0-65535"]), 
        ...
        "timezone": MoPropertyMeta("timezone", "timezone", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x100, 0, 510, None, [], []), 
    }
