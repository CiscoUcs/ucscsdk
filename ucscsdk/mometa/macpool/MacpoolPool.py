...
class MacpoolPool(ManagedObject):
    ...
    mo_meta = MoMeta("MacpoolPool", "macpoolPool", "mac-pool-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["read-only"], ['orgOrg'], ['faultInst', 'macpoolBlock', 'macpoolPooled'], ["Add", "Get", "Remove", "Set"])
