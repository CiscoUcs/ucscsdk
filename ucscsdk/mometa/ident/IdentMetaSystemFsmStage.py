...
class IdentMetaSystemFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("IdentMetaSystemFsmStage", "identMetaSystemFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'identMetaSystemFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "syncBegin", "syncExecute", "syncFail", "syncPing", "syncSuccess"], []), 
