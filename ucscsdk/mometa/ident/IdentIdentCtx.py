...
class IdentIdentCtx(ManagedObject):
    ...
    prop_meta = {
        ...
        "domain_id": MoPropertyMeta("domain_id", "domainId", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "is_from_global_pool": MoPropertyMeta("is_from_global_pool", "isFromGlobalPool", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "ucsm_id": MoPropertyMeta("ucsm_id", "ucsmId", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "validate_msg": MoPropertyMeta("validate_msg", "validateMsg", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    }
