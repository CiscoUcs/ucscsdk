"""This module contains the general information for MgmtRegistryInfoFsmTask ManagedObject."""
...
class MgmtRegistryInfoFsmTaskConsts():
...
class MgmtRegistryInfoFsmTask(ManagedObject):
    """This is MgmtRegistryInfoFsmTask class."""

    consts = MgmtRegistryInfoFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("MgmtRegistryInfoFsmTask", "mgmtRegistryInfoFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'mgmtRegistryInfo'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["configure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtRegistryInfoFsmTask", parent_mo_or_dn, **kwargs)
