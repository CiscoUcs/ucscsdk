"""This module contains the general information for MgmtDataImporterFsmTask ManagedObject."""
...
class MgmtDataImporterFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_IMPORT_DATA = "importData"
    ITEM_NOP = "nop"


class MgmtDataImporterFsmTask(ManagedObject):
    """This is MgmtDataImporterFsmTask class."""

    consts = MgmtDataImporterFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("MgmtDataImporterFsmTask", "mgmtDataImporterFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'mgmtDataImporter'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["importData", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtDataImporterFsmTask", parent_mo_or_dn, **kwargs)
