...
class MgmtImporterFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtImporterFsmStage", "mgmtImporterFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtImporterFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["importBegin", "importConfig", "importDownloadLocal", "importFail", "importReportResults", "importSuccess", "nop"], []), 
