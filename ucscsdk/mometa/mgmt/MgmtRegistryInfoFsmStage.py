"""This module contains the general information for MgmtRegistryInfoFsmStage ManagedObject."""
...
class MgmtRegistryInfoFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class MgmtRegistryInfoFsmStage(ManagedObject):
    """This is MgmtRegistryInfoFsmStage class."""

    consts = MgmtRegistryInfoFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("MgmtRegistryInfoFsmStage", "mgmtRegistryInfoFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtRegistryInfoFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtRegistryInfoFsmStage", parent_mo_or_dn, **kwargs)
