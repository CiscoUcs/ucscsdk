...
class MgmtSecurity(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtSecurity", "mgmtSecurity", "sec", VersionMeta.Version201a, "InputOutput", 0xf, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'mgmtKmip'], ["get"])
