"""This module contains the general information for MgmtDataImporterFsmStage ManagedObject."""
...
class MgmtDataImporterFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_IMPORT_DATA_BEGIN = "importDataBegin"
    NAME_IMPORT_DATA_DME_IMPORT = "importDataDmeImport"
    NAME_IMPORT_DATA_DOWNLOAD = "importDataDownload"
    NAME_IMPORT_DATA_FAIL = "importDataFail"
    NAME_IMPORT_DATA_REPORT_RESULTS = "importDataReportResults"
    NAME_IMPORT_DATA_SUCCESS = "importDataSuccess"
    NAME_IMPORT_DATA_VERIFY_KEY = "importDataVerifyKey"
    NAME_NOP = "nop"
...
class MgmtDataImporterFsmStage(ManagedObject):
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["importDataBegin", "importDataDmeImport", "importDataDownload", "importDataFail", "importDataReportResults", "importDataSuccess", "importDataVerifyKey", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtDataImporterFsmStage", parent_mo_or_dn, **kwargs)
