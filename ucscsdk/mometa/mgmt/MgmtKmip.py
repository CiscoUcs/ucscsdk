...
class MgmtKmip(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtKmip", "mgmtKmip", "kmip", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'mgmtSecurity'], [u'mgmtKmipOperation'], ["get"])
    ...
    prop_meta = {
        ...
        "cert_sign_request": MoPropertyMeta("cert_sign_request", "certSignRequest", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "cert_status": MoPropertyMeta("cert_status", "certStatus", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["certChainTooLong", "emptyCert", "expired", "failedToVerifyWithPrivateKey", "failedToVerifyWithTp", "notYetValid", "revoked", "selfSignedCertificate", "unknown", "valid"], []), 
        "certificate": MoPropertyMeta("certificate", "certificate", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
