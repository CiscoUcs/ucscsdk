...
class MgmtDataImporterConsts():
    ...
    FSM_PREV_IMPORT_DATA_VERIFY_KEY = "importDataVerifyKey"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_IMPORT_DATA_VERIFY_KEY = "importDataVerifyKey"
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
...
class MgmtDataImporter(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["importDataBegin", "importDataDmeImport", "importDataDownload", "importDataFail", "importDataReportResults", "importDataSuccess", "importDataVerifyKey", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["importDataBegin", "importDataDmeImport", "importDataDownload", "importDataFail", "importDataReportResults", "importDataSuccess", "importDataVerifyKey", "nop"], []), 
