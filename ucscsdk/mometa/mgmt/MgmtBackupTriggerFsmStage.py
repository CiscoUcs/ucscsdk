"""This module contains the general information for MgmtBackupTriggerFsmStage ManagedObject."""
...
class MgmtBackupTriggerFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_TRIGGER_BEGIN = "TriggerBegin"
    NAME_TRIGGER_FAIL = "TriggerFail"
    NAME_TRIGGER_STATE_DISABLE = "TriggerStateDisable"
    NAME_TRIGGER_STATE_ENABLE = "TriggerStateEnable"
    NAME_TRIGGER_SUCCESS = "TriggerSuccess"
    NAME_NOP = "nop"
...
class MgmtBackupTriggerFsmStage(ManagedObject):
    """This is MgmtBackupTriggerFsmStage class."""

    consts = MgmtBackupTriggerFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("MgmtBackupTriggerFsmStage", "mgmtBackupTriggerFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtBackupTriggerFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["TriggerBegin", "TriggerFail", "TriggerStateDisable", "TriggerStateEnable", "TriggerSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtBackupTriggerFsmStage", parent_mo_or_dn, **kwargs)
