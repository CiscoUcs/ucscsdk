"""This module contains the general information for MgmtDataExporterFsmStage ManagedObject."""
...
class MgmtDataExporterFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_EXPORT_DATA_BEGIN = "exportDataBegin"
    NAME_EXPORT_DATA_DME_DATA_EXPORT = "exportDataDmeDataExport"
    NAME_EXPORT_DATA_FAIL = "exportDataFail"
    NAME_EXPORT_DATA_SUCCESS = "exportDataSuccess"
    NAME_EXPORT_DATA_UPLOAD = "exportDataUpload"
    NAME_NOP = "nop"
...
class MgmtDataExporterFsmStage(ManagedObject):
    """This is MgmtDataExporterFsmStage class."""

    consts = MgmtDataExporterFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("MgmtDataExporterFsmStage", "mgmtDataExporterFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtDataExporterFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["exportDataBegin", "exportDataDmeDataExport", "exportDataFail", "exportDataSuccess", "exportDataUpload", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtDataExporterFsmStage", parent_mo_or_dn, **kwargs)
