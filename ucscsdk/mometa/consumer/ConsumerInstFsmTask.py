"""This module contains the general information for ConsumerInstFsmTask ManagedObject."""
...
class ConsumerInstFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_RENAME_CFG_DIR = "RenameCfgDir"
    ITEM_NOP = "nop"


class ConsumerInstFsmTask(ManagedObject):
    """This is ConsumerInstFsmTask class."""

    consts = ConsumerInstFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("ConsumerInstFsmTask", "consumerInstFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'consumerInst'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["RenameCfgDir", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "ConsumerInstFsmTask", parent_mo_or_dn, **kwargs)
