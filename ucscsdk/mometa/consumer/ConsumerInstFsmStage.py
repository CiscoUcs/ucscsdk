"""This module contains the general information for ConsumerInstFsmStage ManagedObject."""
...
class ConsumerInstFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_RENAME_CFG_DIR_BEGIN = "RenameCfgDirBegin"
    NAME_RENAME_CFG_DIR_FAIL = "RenameCfgDirFail"
    NAME_RENAME_CFG_DIR_MOVE_CFG_DIRS_FROM_TMP_LOCATION = "RenameCfgDirMoveCfgDirsFromTmpLocation"
    NAME_RENAME_CFG_DIR_MOVE_CFG_DIRS_TO_TMP_LOCATION = "RenameCfgDirMoveCfgDirsToTmpLocation"
    NAME_RENAME_CFG_DIR_SUCCESS = "RenameCfgDirSuccess"
    NAME_NOP = "nop"
...
class ConsumerInstFsmStage(ManagedObject):
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["RenameCfgDirBegin", "RenameCfgDirFail", "RenameCfgDirMoveCfgDirsFromTmpLocation", "RenameCfgDirMoveCfgDirsToTmpLocation", "RenameCfgDirSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ConsumerInstFsmStage", parent_mo_or_dn, **kwargs)
