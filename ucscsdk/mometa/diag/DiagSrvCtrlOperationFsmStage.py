...
class DiagSrvCtrlOperationFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("DiagSrvCtrlOperationFsmStage", "diagSrvCtrlOperationFsmStage", "stage-[name]", VersionMeta.Version201b, "OutputOnly", 0xf, [], [""], ['diagSrvCtrlOperationFsm'], [], [None])
