...
class DiagSrvCtrlOperationFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("DiagSrvCtrlOperationFsmStage", "diagSrvCtrlOperationFsmStage", "stage-[name]", VersionMeta.Version201b, "OutputOnly", 0xf, [], [""], [u'diagSrvCtrlOperationFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201b, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureRunPolicyResolve", "ConfigureSuccess", "ConfigureTriggerOperation", "ConfigureWaitForRunPolicyResolved", "nop"], []), 
