...
class DiagLogEp(ManagedObject):
    ...
    mo_meta = MoMeta("DiagLogEp", "diagLogEp", "logep-[switch_id]", VersionMeta.Version201a, "InputOutput", 0x1f, [], [""], [u'diagRslt'], [], ["get"])
    ...
    prop_meta = {
        ...
        "log_dn": MoPropertyMeta("log_dn", "logDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "switch_id": MoPropertyMeta("switch_id", "switchId", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x10, None, None, None, ["A", "B", "NONE", "mgmt"], []), 
    }
