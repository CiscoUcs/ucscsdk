"""This module contains the general information for DiagSrvCtrlOperationFsm ManagedObject."""
...
class DiagSrvCtrlOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class DiagSrvCtrlOperationFsm(ManagedObject):
    """This is DiagSrvCtrlOperationFsm class."""

    consts = DiagSrvCtrlOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("DiagSrvCtrlOperationFsm", "diagSrvCtrlOperationFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'diagSrvCtrlOperation'], [u'diagSrvCtrlOperationFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Configure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "DiagSrvCtrlOperationFsm", parent_mo_or_dn, **kwargs)
