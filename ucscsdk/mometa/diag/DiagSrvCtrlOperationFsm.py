...
class DiagSrvCtrlOperationFsm(ManagedObject):
    ...
    mo_meta = MoMeta("DiagSrvCtrlOperationFsm", "diagSrvCtrlOperationFsm", "fsm", VersionMeta.Version201b, "OutputOnly", 0xf, [], [""], ['diagSrvCtrlOperation'], ['diagSrvCtrlOperationFsmStage'], [None])
