...
class DiagSrvCtrlOperationFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("DiagSrvCtrlOperationFsmTask", "diagSrvCtrlOperationFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'diagSrvCtrlOperation'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "nop"], []), 
