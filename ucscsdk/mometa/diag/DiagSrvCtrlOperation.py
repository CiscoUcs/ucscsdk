"""This module contains the general information for DiagSrvCtrlOperation ManagedObject."""
...
class DiagSrvCtrlOperationConsts():
    ...
    FSM_PREV_CONFIGURE_RUN_POLICY_RESOLVE = "ConfigureRunPolicyResolve"
    FSM_PREV_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_PREV_CONFIGURE_TRIGGER_OPERATION = "ConfigureTriggerOperation"
    FSM_PREV_CONFIGURE_WAIT_FOR_RUN_POLICY_RESOLVED = "ConfigureWaitForRunPolicyResolved"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONFIGURE_RUN_POLICY_RESOLVE = "ConfigureRunPolicyResolve"
    FSM_STATUS_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_STATUS_CONFIGURE_TRIGGER_OPERATION = "ConfigureTriggerOperation"
    FSM_STATUS_CONFIGURE_WAIT_FOR_RUN_POLICY_RESOLVED = "ConfigureWaitForRunPolicyResolved"
    FSM_STATUS_NOP = "nop"
...
class DiagSrvCtrlOperation(ManagedObject):
    """This is DiagSrvCtrlOperation class."""

    consts = DiagSrvCtrlOperationConsts()
    naming_props = set([])

    mo_meta = MoMeta("DiagSrvCtrlOperation", "diagSrvCtrlOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x7f, [], ["admin", "pn-equipment", "pn-maintenance"], [u'diagSrvCtrl'], [u'diagSrvCtrlOperationFsm', u'diagSrvCtrlOperationFsmTask', u'eventInst', u'faultInst'], ["get", "set"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureRunPolicyResolve", "ConfigureSuccess", "ConfigureTriggerOperation", "ConfigureWaitForRunPolicyResolved", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureRunPolicyResolve", "ConfigureSuccess", "ConfigureTriggerOperation", "ConfigureWaitForRunPolicyResolved", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "last_modified": MoPropertyMeta("last_modified", "lastModified", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        "remote_error_code": MoPropertyMeta("remote_error_code", "remoteErrorCode", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "remote_error_descr": MoPropertyMeta("remote_error_descr", "remoteErrorDescr", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, 0x8, 0, 256, None, [], []), 
        "run_policy_name_operation": MoPropertyMeta("run_policy_name_operation", "runPolicyNameOperation", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "trigger_status": MoPropertyMeta("trigger_status", "triggerStatus", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["trigger-acked", "trigger-failed", "triggered", "unknown"], []), 
    }
    ...
    prop_map = {
        ...
        "rn": "rn", 
        "runPolicyNameOperation": "run_policy_name_operation", 
        "status": "status", 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.run_policy_name_operation = None
        self.status = None
        self.trigger_status = None

        ManagedObject.__init__(self, "DiagSrvCtrlOperation", parent_mo_or_dn, **kwargs)
