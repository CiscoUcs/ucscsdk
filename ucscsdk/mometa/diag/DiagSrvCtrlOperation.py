...
class DiagSrvCtrlOperation(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureRunPolicyResolve", "ConfigureSuccess", "ConfigureTriggerOperation", "ConfigureWaitForRunPolicyResolved", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureRunPolicyResolve", "ConfigureSuccess", "ConfigureTriggerOperation", "ConfigureWaitForRunPolicyResolved", "nop"], []), 
        ...
        "run_policy_name_operation": MoPropertyMeta("run_policy_name_operation", "runPolicyNameOperation", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
