...
class UuidpoolBlock(ManagedObject):
    ...
    mo_meta = MoMeta("UuidpoolBlock", "uuidpoolBlock", "block-from-[r_from]-to-[to]", VersionMeta.Version101a, "InputOutput", 0x7f, [], ["admin", "pn-policy"], ['uuidpoolPool'], [], ["Add", "Get", "Remove"])
