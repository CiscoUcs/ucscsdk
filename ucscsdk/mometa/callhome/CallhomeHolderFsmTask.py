"""This module contains the general information for CallhomeHolderFsmTask ManagedObject."""
...
class CallhomeHolderFsmTaskConsts():
...
class CallhomeHolderFsmTask(ManagedObject):
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "Inventory", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "CallhomeHolderFsmTask", parent_mo_or_dn, **kwargs)
