"""This module contains the general information for CallhomeHolderFsmStage ManagedObject."""
...
class CallhomeHolderFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CONFIGURE_BEGIN = "ConfigureBegin"
    NAME_CONFIGURE_DISABLE_SMART_CALLHOME = "ConfigureDisableSmartCallhome"
    NAME_CONFIGURE_ENABLE_SMART_CALLHOME = "ConfigureEnableSmartCallhome"
    ...
    NAME_INVENTORY_SEND_INVENTORY = "InventorySendInventory"
...
class CallhomeHolderFsmStage(ManagedObject):
    """This is CallhomeHolderFsmStage class."""

    consts = CallhomeHolderFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("CallhomeHolderFsmStage", "callhomeHolderFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'callhomeHolderFsm'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureBegin", "ConfigureDisableSmartCallhome", "ConfigureEnableSmartCallhome", "ConfigureFail", "ConfigureSuccess", "InventoryBegin", "InventoryFail", "InventorySendInventory", "InventorySuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "CallhomeHolderFsmStage", parent_mo_or_dn, **kwargs)
