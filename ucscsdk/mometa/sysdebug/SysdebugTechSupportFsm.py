...
class SysdebugTechSupportFsm(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupportFsm", "sysdebugTechSupportFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['sysdebugTechSupport'], ['sysdebugTechSupportFsmStage'], [None])
