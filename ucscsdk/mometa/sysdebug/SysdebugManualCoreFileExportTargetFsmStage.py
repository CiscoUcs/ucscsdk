...
class SysdebugManualCoreFileExportTargetFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugManualCoreFileExportTargetFsmStage", "sysdebugManualCoreFileExportTargetFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['sysdebugManualCoreFileExportTargetFsm'], [], [None])
