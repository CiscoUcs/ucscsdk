...
class SysdebugManualCoreFileExportTargetFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugManualCoreFileExportTargetFsmStage", "sysdebugManualCoreFileExportTargetFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'sysdebugManualCoreFileExportTargetFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["ExportBegin", "ExportExecute", "ExportFail", "ExportSuccess", "nop"], []), 
