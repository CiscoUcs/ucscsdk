...
class SysdebugManualCoreFileExportTargetFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugManualCoreFileExportTargetFsmTask", "sysdebugManualCoreFileExportTargetFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], ['sysdebugManualCoreFileExportTarget'], [], [None])
