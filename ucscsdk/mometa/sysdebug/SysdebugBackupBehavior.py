...
class SysdebugBackupBehavior(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugBackupBehavior", "sysdebugBackupBehavior", "backup", VersionMeta.Version101a, "InputOutput", 0x1fff, [], ["admin", "domain-group-management", "operations"], [u'sysdebugMEpLogPolicy'], [], ["Get", "Set"])
