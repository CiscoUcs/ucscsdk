...
class SysdebugTechSupportFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupportFsmTask", "sysdebugTechSupportFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'sysdebugTechSupport'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["DeleteTechSupFile", "Initiate", "nop"], []), 
