...
class SysdebugAutoCoreFileExportTargetFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugAutoCoreFileExportTargetFsmStage", "sysdebugAutoCoreFileExportTargetFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['sysdebugAutoCoreFileExportTargetFsm'], [], [None])
