...
class SysdebugEp(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugEp", "sysdebugEp", "sysdebug", VersionMeta.Version101a, "InputOutput", 0xf, [], ["read-only"], ['topSystem'], ['sysdebugAutoCoreFileExportTarget', 'sysdebugLogControlEp'], ["Get"])
