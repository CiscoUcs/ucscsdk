...
class SysdebugLogControlEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_NOP = "nop"
    NAME_PERSISTENCE_BEGIN = "persistenceBegin"
    NAME_PERSISTENCE_FAIL = "persistenceFail"
    NAME_PERSISTENCE_PERSIST = "persistencePersist"
    NAME_PERSISTENCE_SUCCESS = "persistenceSuccess"
...
class SysdebugLogControlEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugLogControlEpFsmStage", "sysdebugLogControlEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'sysdebugLogControlEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "persistenceBegin", "persistenceFail", "persistencePersist", "persistenceSuccess"], []), 
