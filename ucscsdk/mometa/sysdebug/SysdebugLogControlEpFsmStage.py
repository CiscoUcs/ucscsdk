...
class SysdebugLogControlEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugLogControlEpFsmStage", "sysdebugLogControlEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['sysdebugLogControlEpFsm'], [], [None])
