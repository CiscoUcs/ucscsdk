"""This module contains the general information for GlIdRefEp ManagedObject."""
...
class GlIdRefEpConsts():
    pass


class GlIdRefEp(ManagedObject):
    """This is GlIdRefEp class."""

    consts = GlIdRefEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlIdRefEp", "glIdRefEp", "irefep", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'glComplexRefEp'], [u'glIdRef'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlIdRefEp", parent_mo_or_dn, **kwargs)
