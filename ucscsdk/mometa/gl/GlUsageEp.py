"""This module contains the general information for GlUsageEp ManagedObject."""
...
class GlUsageEpConsts():
    pass


class GlUsageEp(ManagedObject):
    """This is GlUsageEp class."""

    consts = GlUsageEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlUsageEp", "glUsageEp", "uep", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'glPolicy'], [u'glUsage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlUsageEp", parent_mo_or_dn, **kwargs)
