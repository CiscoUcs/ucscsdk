"""This module contains the general information for GlPolicyInvEp ManagedObject."""
...
class GlPolicyInvEpConsts():
    pass


class GlPolicyInvEp(ManagedObject):
    """This is GlPolicyInvEp class."""

    consts = GlPolicyInvEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlPolicyInvEp", "glPolicyInvEp", "policy", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'glInventoryEp'], [u'glPolicy'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlPolicyInvEp", parent_mo_or_dn, **kwargs)
