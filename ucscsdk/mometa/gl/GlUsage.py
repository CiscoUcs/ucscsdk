"""This module contains the general information for GlUsage ManagedObject."""
...
class GlUsage(ManagedObject):
    """This is GlUsage class."""

    consts = GlUsageConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("GlUsage", "glUsage", "sp-[id]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'glUsageEp'], [], [None])
    ...
    prop_meta = {
        ...
        "sp_dn": MoPropertyMeta("sp_dn", "spDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "GlUsage", parent_mo_or_dn, **kwargs)
