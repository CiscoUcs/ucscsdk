...
class GlComplexRefEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlComplexRefEp", "glComplexRefEp", "crefep", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'glPolicyResOp'], [u'glIdRefEp', u'glPolicyRefEp'], [None])
