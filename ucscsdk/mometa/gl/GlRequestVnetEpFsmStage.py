...
class GlRequestVnetEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("GlRequestVnetEpFsmStage", "glRequestVnetEpFsmStage", "stage-[name]", VersionMeta.Version201b, "OutputOnly", 0xf, [], [""], [u'glRequestVnetEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201b, MoPropertyMeta.NAMING, None, None, None, None, ["EvalReqBegin", "EvalReqCreatePolicies", "EvalReqEvaluate", "EvalReqFail", "EvalReqFetchDomainData", "EvalReqGlobalize", "EvalReqSuccess", "EvalReqValidate", "EvalReqWaitGlobalize", "nop"], []), 
