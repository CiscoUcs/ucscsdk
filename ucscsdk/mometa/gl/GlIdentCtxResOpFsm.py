"""This module contains the general information for GlIdentCtxResOpFsm ManagedObject."""
...
class GlIdentCtxResOpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_VALIDATE_ID = "ValidateId"
    CURRENT_FSM_NOP = "nop"
...
class GlIdentCtxResOpFsm(ManagedObject):
    """This is GlIdentCtxResOpFsm class."""

    consts = GlIdentCtxResOpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlIdentCtxResOpFsm", "glIdentCtxResOpFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'glIdentCtxResOp'], [u'glIdentCtxResOpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ValidateId", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlIdentCtxResOpFsm", parent_mo_or_dn, **kwargs)
