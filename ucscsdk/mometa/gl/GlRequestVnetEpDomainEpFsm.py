"""This module contains the general information for GlRequestVnetEpDomainEpFsm ManagedObject."""
...
class GlRequestVnetEpDomainEpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_EVAL_DATA = "EvalData"
    CURRENT_FSM_NOP = "nop"
...
class GlRequestVnetEpDomainEpFsm(ManagedObject):
    """This is GlRequestVnetEpDomainEpFsm class."""

    consts = GlRequestVnetEpDomainEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlRequestVnetEpDomainEpFsm", "glRequestVnetEpDomainEpFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'glRequestVnetEpDomainEp'], [u'glRequestVnetEpDomainEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["EvalData", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlRequestVnetEpDomainEpFsm", parent_mo_or_dn, **kwargs)
