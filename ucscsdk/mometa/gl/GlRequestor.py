"""This module contains the general information for GlRequestor ManagedObject."""
...
class GlRequestorConsts():
    pass


class GlRequestor(ManagedObject):
    """This is GlRequestor class."""

    consts = GlRequestorConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlRequestor", "glRequestor", "", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'glRequestorEp'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlRequestor", parent_mo_or_dn, **kwargs)
