"""This module contains the general information for GlPolicyRef ManagedObject."""
...
class GlPolicyRefConsts():
    pass


class GlPolicyRef(ManagedObject):
    """This is GlPolicyRef class."""

    consts = GlPolicyRefConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("GlPolicyRef", "glPolicyRef", "pref-[id]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'glPolicyRefEp'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "GlPolicyRef", parent_mo_or_dn, **kwargs)
