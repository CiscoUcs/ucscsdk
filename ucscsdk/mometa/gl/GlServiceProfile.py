...
class GlServiceProfile(ManagedObject):
    ...
    mo_meta = MoMeta("GlServiceProfile", "glServiceProfile", "sp-[id]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'glSPInvEp'], [u'glIdentCtxEp', u'glOperationEp', u'messageEp'], [None])
    ...
    prop_meta = {
        ...
        "org_dn": MoPropertyMeta("org_dn", "orgDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "src_template_dn": MoPropertyMeta("src_template_dn", "srcTemplateDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["initial-template", "instance", "updating-template"], []), 
    }
