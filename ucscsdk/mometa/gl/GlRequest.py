...
class GlRequest(ManagedObject):
    ...
    mo_meta = MoMeta("GlRequest", "glRequest", "req-[id]", VersionMeta.Version201a, "InputOutput", 0xff, [], ["admin"], [u'glDomainEp'], [u'eventInst', u'faultInst', u'glInventoryEp', u'glLsp', u'glOperationEp', u'glPathEp', u'glPolicyResolutionEp', u'glRequestFsm', u'glRequestFsmTask', u'glVnicTemplateEp', u'messageEp'], [None])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["evaluate", "globalize", "reevaluate", "terminate"], []), 
        ...
        "globalize_admin_state": MoPropertyMeta("globalize_admin_state", "globalizeAdminState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["apply-rule", "create-global-id-pool", "create-global-policy", "create-global-service-profile", "default", "globalize-lsp", "resolve-conflict", "unbind-template"], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x20, None, None, None, [], []), 
        "index": MoPropertyMeta("index", "index", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "is_server_pool_assigned": MoPropertyMeta("is_server_pool_assigned", "isServerPoolAssigned", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        "num_of_blocks": MoPropertyMeta("num_of_blocks", "numOfBlocks", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "num_of_non_block_conflicts": MoPropertyMeta("num_of_non_block_conflicts", "numOfNonBlockConflicts", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ApplyingRuleAndEvaluating", "EvaluatedWithBlockingIssue", "EvaluatedWithConflict", "EvaluatedWithError", "EvaluatedWithSuccess", "Evaluating", "FetchingDataFromDomain", "GlobalizedWithError", "GlobalizedWithSuccess", "Globalizing", "NotEvaluated"], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, 0x40, 0, 256, None, [], []), 
        "rule_applied_counter": MoPropertyMeta("rule_applied_counter", "ruleAppliedCounter", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "session_state": MoPropertyMeta("session_state", "sessionState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["active", "terminated"], []), 
        "sim_cookie": MoPropertyMeta("sim_cookie", "simCookie", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "sim_error_msg": MoPropertyMeta("sim_error_msg", "simErrorMsg", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "sim_fsm_stage_name": MoPropertyMeta("sim_fsm_stage_name", "simFsmStageName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "sim_is_responsed": MoPropertyMeta("sim_is_responsed", "simIsResponsed", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        "sim_request_time": MoPropertyMeta("sim_request_time", "simRequestTime", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        "sim_status": MoPropertyMeta("sim_status", "simStatus", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
