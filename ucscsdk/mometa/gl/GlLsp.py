...
class GlLsp(ManagedObject):
    ...
    mo_meta = MoMeta("GlLsp", "glLsp", "lsp-[id]", VersionMeta.Version201a, "InputOutput", 0x3f, [], ["admin"], [u'glRequest'], [u'glOperationEp'], [None])
    ...
    prop_meta = {
        ...
        "compute_instance_dn": MoPropertyMeta("compute_instance_dn", "computeInstanceDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x2, 0, 256, None, [], []), 
        ...
        "lsp_dn": MoPropertyMeta("lsp_dn", "lspDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "org_dn": MoPropertyMeta("org_dn", "orgDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
