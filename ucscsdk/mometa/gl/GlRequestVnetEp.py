...
class GlRequestVnetEp(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["EvalReqBegin", "EvalReqCreatePolicies", "EvalReqEvaluate", "EvalReqFail", "EvalReqFetchDomainData", "EvalReqGlobalize", "EvalReqSuccess", "EvalReqValidate", "EvalReqWaitGlobalize", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["EvalReqBegin", "EvalReqCreatePolicies", "EvalReqEvaluate", "EvalReqFail", "EvalReqFetchDomainData", "EvalReqGlobalize", "EvalReqSuccess", "EvalReqValidate", "EvalReqWaitGlobalize", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "globalize_admin_state": MoPropertyMeta("globalize_admin_state", "globalizeAdminState", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["apply-rule", "create-global-id-pool", "create-global-policy", "create-global-service-profile", "default", "globalize-lsp", "resolve-conflict", "unbind-template"], []), 
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["CreateDependencies", "EvaluatedWithError", "EvaluatedWithSuccess", "Evaluating", "FetchingDataFromDomain", "FetchingDependencies", "GlobalizedWithError", "GlobalizedWithSuccess", "Globalizing", "NotEvaluated"], []), 
