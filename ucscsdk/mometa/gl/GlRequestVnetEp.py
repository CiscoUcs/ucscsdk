"""This module contains the general information for GlRequestVnetEp ManagedObject."""
...
class GlRequestVnetEpConsts():
    ...
    FSM_PREV_EVAL_REQ_BEGIN = "EvalReqBegin"
    FSM_PREV_EVAL_REQ_CREATE_POLICIES = "EvalReqCreatePolicies"
    FSM_PREV_EVAL_REQ_EVALUATE = "EvalReqEvaluate"
    FSM_PREV_EVAL_REQ_FAIL = "EvalReqFail"
    FSM_PREV_EVAL_REQ_FETCH_DOMAIN_DATA = "EvalReqFetchDomainData"
    FSM_PREV_EVAL_REQ_GLOBALIZE = "EvalReqGlobalize"
    FSM_PREV_EVAL_REQ_SUCCESS = "EvalReqSuccess"
    FSM_PREV_EVAL_REQ_VALIDATE = "EvalReqValidate"
    FSM_PREV_EVAL_REQ_WAIT_GLOBALIZE = "EvalReqWaitGlobalize"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_EVAL_REQ_BEGIN = "EvalReqBegin"
    FSM_STATUS_EVAL_REQ_CREATE_POLICIES = "EvalReqCreatePolicies"
    FSM_STATUS_EVAL_REQ_EVALUATE = "EvalReqEvaluate"
    FSM_STATUS_EVAL_REQ_FAIL = "EvalReqFail"
    FSM_STATUS_EVAL_REQ_FETCH_DOMAIN_DATA = "EvalReqFetchDomainData"
    FSM_STATUS_EVAL_REQ_GLOBALIZE = "EvalReqGlobalize"
    FSM_STATUS_EVAL_REQ_SUCCESS = "EvalReqSuccess"
    FSM_STATUS_EVAL_REQ_VALIDATE = "EvalReqValidate"
    FSM_STATUS_EVAL_REQ_WAIT_GLOBALIZE = "EvalReqWaitGlobalize"
    FSM_STATUS_NOP = "nop"
    ...
    OPER_STATE_CREATE_DEPENDENCIES = "CreateDependencies"
...
class GlRequestVnetEp(ManagedObject):
    """This is GlRequestVnetEp class."""

    consts = GlRequestVnetEpConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("GlRequestVnetEp", "glRequestVnetEp", "req-[id]", VersionMeta.Version201a, "InputOutput", 0x7f, [], ["admin"], [u'glRequestVnetEpHolder'], [u'eventInst', u'faultInst', u'glRequestVnetEpDomainEp', u'glRequestVnetEpFsm', u'glRequestVnetEpFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["EvalReqBegin", "EvalReqCreatePolicies", "EvalReqEvaluate", "EvalReqFail", "EvalReqFetchDomainData", "EvalReqGlobalize", "EvalReqSuccess", "EvalReqValidate", "EvalReqWaitGlobalize", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["EvalReqBegin", "EvalReqCreatePolicies", "EvalReqEvaluate", "EvalReqFail", "EvalReqFetchDomainData", "EvalReqGlobalize", "EvalReqSuccess", "EvalReqValidate", "EvalReqWaitGlobalize", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "globalize_admin_state": MoPropertyMeta("globalize_admin_state", "globalizeAdminState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["apply-rule", "create-global-id-pool", "create-global-policy", "create-global-service-profile", "default", "globalize-lsp", "resolve-conflict", "unbind-template"], []), 
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["CreateDependencies", "EvaluatedWithError", "EvaluatedWithSuccess", "Evaluating", "FetchingDataFromDomain", "FetchingDependencies", "GlobalizedWithError", "GlobalizedWithSuccess", "Globalizing", "NotEvaluated"], []), 
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "GlRequestVnetEp", parent_mo_or_dn, **kwargs)
