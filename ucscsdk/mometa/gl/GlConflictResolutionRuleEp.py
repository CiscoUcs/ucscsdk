"""This module contains the general information for GlConflictResolutionRuleEp ManagedObject."""
...
class GlConflictResolutionRuleEpConsts():
    pass


class GlConflictResolutionRuleEp(ManagedObject):
    """This is GlConflictResolutionRuleEp class."""

    consts = GlConflictResolutionRuleEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlConflictResolutionRuleEp", "glConflictResolutionRuleEp", "ruleep", VersionMeta.Version201a, "InputOutput", 0xf, [], ["admin"], [u'glDomainEp'], [u'glPolicyNameRuleEp'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlConflictResolutionRuleEp", parent_mo_or_dn, **kwargs)
