"""This module contains the general information for GlRequestVnetEpFsm ManagedObject."""
...
class GlRequestVnetEpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_EVAL_REQ = "EvalReq"
    CURRENT_FSM_NOP = "nop"
...
class GlRequestVnetEpFsm(ManagedObject):
    """This is GlRequestVnetEpFsm class."""

    consts = GlRequestVnetEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlRequestVnetEpFsm", "glRequestVnetEpFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'glRequestVnetEp'], [u'glRequestVnetEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["EvalReq", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlRequestVnetEpFsm", parent_mo_or_dn, **kwargs)
