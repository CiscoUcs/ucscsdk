...
class GlRequestFsm(ManagedObject):
    ...
    mo_meta = MoMeta("GlRequestFsm", "glRequestFsm", "fsm", VersionMeta.Version201b, "OutputOnly", 0xf, [], [""], [u'glRequest'], [u'glRequestFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["CreateGlobalIdPool", "CreateGlobalPolicy", "Evaluate", "Globalize", "nop"], []), 
