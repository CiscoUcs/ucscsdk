...
class GlInventoryEp(ManagedObject):
    ...
    naming_props = set([u'internalId'])

    mo_meta = MoMeta("GlInventoryEp", "glInventoryEp", "inv-[internal_id]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'glPathEp', u'glRequest'], [u'glPolicyInvEp', u'glPoolInvEp', u'glSPInvEp'], [None])
    ...
    prop_meta = {
        ...
        "internal_id": MoPropertyMeta("internal_id", "internalId", "uint", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x4, None, None, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["boot-mgr", "central-mgr", "identifier-mgr", "managed-endpoint", "mgmt-controller", "operation-mgr", "policy-mgr", "resource-aggr", "resource-mgr", "server-mgr", "service-reg", "stats-mgr", "storage-broker", "virtual-switching-mgr", "vm-mgr"], []), 
    }
