...
class GlIdentCtxEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlIdentCtxEp", "glIdentCtxEp", "icp", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'glOperationEp', u'glPolicyResolutionEp', u'glServiceProfile'], [u'glIdentCtxOp', u'glIdentCtxResOp'], [None])
    ...
    prop_meta = {
        ...
        "num_of_server_pool_and_id_conflicts": MoPropertyMeta("num_of_server_pool_and_id_conflicts", "numOfServerPoolAndIdConflicts", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
