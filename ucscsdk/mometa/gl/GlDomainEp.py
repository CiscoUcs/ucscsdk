...
class GlDomainEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlDomainEp", "glDomainEp", "domain-[domain_id]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'glEp'], [u'glConflictResolutionRuleEp', u'glRequest'], [None])
    ...
    prop_meta = {
        ...
        "domain_id": MoPropertyMeta("domain_id", "domainId", "uint", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x4, None, None, None, [], []), 
