...
class GlOperationEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlOperationEp", "glOperationEp", "opep", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'glLsp', u'glPolicy', u'glPool', u'glRequest', u'glServiceProfile', u'glVnicTemplate'], [u'glIdentCtxEp', u'glPolicyEp', u'glPoolEp', u'glTemplateEp', u'glVxanEp'], [None])
