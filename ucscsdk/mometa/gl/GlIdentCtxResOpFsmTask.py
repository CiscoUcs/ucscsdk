...
class GlIdentCtxResOpFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("GlIdentCtxResOpFsmTask", "glIdentCtxResOpFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'glIdentCtxResOp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, None, None, None, None, ["ValidateId", "nop"], []), 
