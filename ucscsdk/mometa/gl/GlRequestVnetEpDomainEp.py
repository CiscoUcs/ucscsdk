...
class GlRequestVnetEpDomainEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlRequestVnetEpDomainEp", "glRequestVnetEpDomainEp", "domain-[domain_id]", VersionMeta.Version201a, "InputOutput", 0x7f, [], ["admin"], [u'glRequestVnetEp'], [u'eventInst', u'faultInst', u'glRequestVnetEpDomainEpFsm', u'glRequestVnetEpDomainEpFsmTask', u'glVnetInvHolder'], [None])

    prop_meta = {
        "ucs_dn": MoPropertyMeta("ucs_dn", "UcsDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "ucs_name": MoPropertyMeta("ucs_name", "UcsName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "domain_id": MoPropertyMeta("domain_id", "domainId", "uint", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x8, None, None, None, [], []), 
        "fsm_descr": MoPropertyMeta("fsm_descr", "fsmDescr", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["EvalDataBegin", "EvalDataFail", "EvalDataFetchDomainData", "EvalDataFetchVnetDependencies", "EvalDataSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["EvalDataBegin", "EvalDataFail", "EvalDataFetchDomainData", "EvalDataFetchVnetDependencies", "EvalDataSuccess", "nop"], []), 
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Completed", "FetchingDependencies", "FetchingDependenciesDone", "FetchingVnets", "FetchingVnetsDone", "NotEvaluated"], []), 
        "org_permit_dn": MoPropertyMeta("org_permit_dn", "orgPermitDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, 0, 256, None, [], []), 
