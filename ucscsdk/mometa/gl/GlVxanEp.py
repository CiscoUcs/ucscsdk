...
class GlVxanEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlVxanEp", "glVxanEp", "vxep", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'glOperationEp', u'glPolicyResolutionEp'], [u'glVxanOp', u'glVxanResOp'], [None])
