...
class GlTemplateResOp(ManagedObject):
    ...
    mo_meta = MoMeta("GlTemplateResOp", "glTemplateResOp", "temprp", VersionMeta.Version201b, "InputOutput", 0x3ff, [], ["admin"], [u'glSpDefEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None])
