...
class GlIdentCtxResOpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("GlIdentCtxResOpFsmStage", "glIdentCtxResOpFsmStage", "stage-[name]", VersionMeta.Version201b, "OutputOnly", 0xf, [], [""], [u'glIdentCtxResOpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201b, MoPropertyMeta.NAMING, None, None, None, None, ["ValidateIdBegin", "ValidateIdFail", "ValidateIdSuccess", "ValidateIdValidate", "nop"], []), 
