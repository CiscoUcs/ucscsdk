"""This module contains the general information for GlTemplateEp ManagedObject."""
...
class GlTemplateEpConsts():
    pass


class GlTemplateEp(ManagedObject):
    """This is GlTemplateEp class."""

    consts = GlTemplateEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlTemplateEp", "glTemplateEp", "tep", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'glOperationEp'], [u'glTemplateOp'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlTemplateEp", parent_mo_or_dn, **kwargs)
