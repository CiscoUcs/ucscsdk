"""This module contains the general information for GlPoolEp ManagedObject."""
...
class GlPoolEpConsts():
    pass


class GlPoolEp(ManagedObject):
    """This is GlPoolEp class."""

    consts = GlPoolEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlPoolEp", "glPoolEp", "pep", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'glOperationEp'], [u'glPoolOp'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlPoolEp", parent_mo_or_dn, **kwargs)
