...
class GlPolicyResOp(ManagedObject):
    ...
    prop_meta = {
        ...
        "is_complex_policy": MoPropertyMeta("is_complex_policy", "isComplexPolicy", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
