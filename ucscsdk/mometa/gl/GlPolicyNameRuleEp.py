...
class GlPolicyNameRuleEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlPolicyNameRuleEp", "glPolicyNameRuleEp", "policyep", VersionMeta.Version201a, "InputOutput", 0x3f, [], ["admin"], [u'glConflictResolutionRuleEp'], [u'glAppendRule'], [None])
    ...
    prop_meta = {
        ...
        "max_rule_apply_times": MoPropertyMeta("max_rule_apply_times", "maxRuleApplyTimes", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["no-auto", "rename-after-evaluate", "rename-before-evaluate"], []), 
    }
