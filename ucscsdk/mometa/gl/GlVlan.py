"""This module contains the general information for GlVlan ManagedObject."""
...
class GlVlan(ManagedObject):
    ...
    mo_meta = MoMeta("GlVlan", "glVlan", "vlan-[id]", VersionMeta.Version201a, "InputOutput", 0x3f, [], ["admin"], [u'glVnetInvHolder'], [u'messageEp'], [None])
    ...
    prop_meta = {
        ...
        "mcast_policy_dn": MoPropertyMeta("mcast_policy_dn", "mcastPolicyDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        ...
        "pub_nw_dn": MoPropertyMeta("pub_nw_dn", "pubNwDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
