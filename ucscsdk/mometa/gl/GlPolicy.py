...
class GlPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("GlPolicy", "glPolicy", "policy-[id]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'glPolicyInvEp'], [u'glOperationEp', u'glUsageEp', u'messageEp'], [None])
