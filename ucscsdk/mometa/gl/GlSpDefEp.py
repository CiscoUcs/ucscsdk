"""This module contains the general information for GlSpDefEp ManagedObject."""
...
class GlSpDefEpConsts():
    pass


class GlSpDefEp(ManagedObject):
    """This is GlSpDefEp class."""

    consts = GlSpDefEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlSpDefEp", "glSpDefEp", "spep", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'glPolicyResolutionEp'], [u'glServerPoolResOp', u'glTemplateResOp'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlSpDefEp", parent_mo_or_dn, **kwargs)
