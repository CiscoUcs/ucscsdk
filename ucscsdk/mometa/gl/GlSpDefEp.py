...
class GlSpDefEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlSpDefEp", "glSpDefEp", "spep", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'glPolicyResolutionEp'], [u'glServerPoolResOp', u'glTemplateResOp'], [None])
