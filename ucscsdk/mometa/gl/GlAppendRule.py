...
class GlAppendRule(ManagedObject):
    ...
    mo_meta = MoMeta("GlAppendRule", "glAppendRule", "appendrule", VersionMeta.Version201a, "InputOutput", 0x7f, [], ["admin"], [u'glPolicyNameRuleEp'], [], [None])
    ...
    prop_meta = {
        ...
        "max": MoPropertyMeta("max", "max", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, [], []), 
        "min": MoPropertyMeta("min", "min", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], []), 
        "pattern": MoPropertyMeta("pattern", "pattern", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["number"], []), 
