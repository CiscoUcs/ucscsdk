...
class GlRequestVnetEpDomainEpFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("GlRequestVnetEpDomainEpFsmTask", "glRequestVnetEpDomainEpFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'glRequestVnetEpDomainEp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, None, None, None, None, ["EvalData", "nop"], []), 
