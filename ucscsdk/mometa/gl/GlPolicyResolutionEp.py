"""This module contains the general information for GlPolicyResolutionEp ManagedObject."""
...
class GlPolicyResolutionEpConsts():
    pass


class GlPolicyResolutionEp(ManagedObject):
    """This is GlPolicyResolutionEp class."""

    consts = GlPolicyResolutionEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlPolicyResolutionEp", "glPolicyResolutionEp", "prep", VersionMeta.Version201a, "InputOutput", 0xf, [], ["admin"], [u'glRequest'], [u'glBlockEp', u'glGlobalDefaultPolicyEp', u'glIdentCtxEp', u'glPolicyEp', u'glSpDefEp', u'glVxanEp'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlPolicyResolutionEp", parent_mo_or_dn, **kwargs)
