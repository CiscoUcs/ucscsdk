"""This module contains the general information for GlSPInvEp ManagedObject."""
...
class GlSPInvEpConsts():
    pass


class GlSPInvEp(ManagedObject):
    """This is GlSPInvEp class."""

    consts = GlSPInvEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlSPInvEp", "glSPInvEp", "sp", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'glInventoryEp'], [u'glServiceProfile'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlSPInvEp", parent_mo_or_dn, **kwargs)
