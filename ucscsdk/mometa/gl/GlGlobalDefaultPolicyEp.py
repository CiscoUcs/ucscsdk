...
class GlGlobalDefaultPolicyEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlGlobalDefaultPolicyEp", "glGlobalDefaultPolicyEp", "gdpep", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'glPolicyResolutionEp'], [u'glPolicyResOp'], [None])
