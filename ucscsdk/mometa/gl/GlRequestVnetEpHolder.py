"""This module contains the general information for GlRequestVnetEpHolder ManagedObject."""
...
class GlRequestVnetEpHolderConsts():
    pass


class GlRequestVnetEpHolder(ManagedObject):
    """This is GlRequestVnetEpHolder class."""

    consts = GlRequestVnetEpHolderConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlRequestVnetEpHolder", "glRequestVnetEpHolder", "reqholder", VersionMeta.Version201a, "InputOutput", 0xf, [], ["admin"], [u'glEp'], [u'glRequestVnetEp'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlRequestVnetEpHolder", parent_mo_or_dn, **kwargs)
