...
class GlRequestFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("GlRequestFsmTask", "glRequestFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'glRequest'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, None, None, None, None, ["CreateGlobalIdPool", "CreateGlobalPolicy", "Evaluate", "Globalize", "nop"], []), 
