...
class GlServerPoolResOp(ManagedObject):
    ...
    mo_meta = MoMeta("GlServerPoolResOp", "glServerPoolResOp", "svrprp", VersionMeta.Version201b, "InputOutput", 0x1ff, [], ["admin"], [u'glSpDefEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None])
