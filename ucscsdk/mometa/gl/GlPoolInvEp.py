"""This module contains the general information for GlPoolInvEp ManagedObject."""
...
class GlPoolInvEpConsts():
    pass


class GlPoolInvEp(ManagedObject):
    """This is GlPoolInvEp class."""

    consts = GlPoolInvEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("GlPoolInvEp", "glPoolInvEp", "pool", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'glInventoryEp'], [u'glPool'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "GlPoolInvEp", parent_mo_or_dn, **kwargs)
