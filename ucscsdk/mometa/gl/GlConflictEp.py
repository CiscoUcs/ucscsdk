...
class GlConflictEp(ManagedObject):
    ...
    mo_meta = MoMeta("GlConflictEp", "glConflictEp", "cep", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'glBlockOp', u'glIdentCtxOp', u'glIdentCtxResOp', u'glPolicyAlgorithmedOp', u'glPolicyOp', u'glPolicyResOp', u'glPoolOp', u'glServerPoolResOp', u'glTemplateOp', u'glTemplateResOp', u'glVxanOp', u'glVxanResOp'], [], [None])
