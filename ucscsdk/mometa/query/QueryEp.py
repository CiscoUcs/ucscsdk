...
class QueryEp(ManagedObject):
    ...
    mo_meta = MoMeta("QueryEp", "queryEp", "query", VersionMeta.Version112a, "InputOutput", 0xf, [], ["admin"], ['topRoot'], ['queryDependencyContext', 'queryImportContext', 'queryUsageContext'], ["Get"])
