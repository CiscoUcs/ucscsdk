...
class MemoryBufferUnitEnvStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryBufferUnitEnvStatsHist", "memoryBufferUnitEnvStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], [u'memoryBufferUnitEnvStats'], [], [None])
