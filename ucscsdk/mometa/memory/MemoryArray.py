...
class MemoryArray(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryArray", "memoryArray", "memarray-[id]", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["read-only"], ['computeBoard'], ['faultInst', 'memoryArrayEnvStats', 'memoryNvDimmBattery', 'memoryNvDimmController', 'memoryUnit'], ["Get"])
