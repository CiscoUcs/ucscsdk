...
class MemoryBufferUnit(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryBufferUnit", "memoryBufferUnit", "sensor-unit-[id]", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["read-only"], ['computeBoard'], ['faultInst', 'memoryBufferUnitEnvStats'], ["Get"])
