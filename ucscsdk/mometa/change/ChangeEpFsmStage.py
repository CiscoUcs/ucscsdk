"""This module contains the general information for ChangeEpFsmStage ManagedObject."""
...
class ChangeEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_SYNC_CHANGE_UCSBEGIN = "SyncChangeUCSBegin"
    NAME_SYNC_CHANGE_UCSFAIL = "SyncChangeUCSFail"
    NAME_SYNC_CHANGE_UCSSUCCESS = "SyncChangeUCSSuccess"
    NAME_SYNC_CHANGE_UCSSYNC = "SyncChangeUCSSync"
    NAME_NOP = "nop"
...
class ChangeEpFsmStage(ManagedObject):
    """This is ChangeEpFsmStage class."""

    consts = ChangeEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ChangeEpFsmStage", "changeEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'changeEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["SyncChangeUCSBegin", "SyncChangeUCSFail", "SyncChangeUCSSuccess", "SyncChangeUCSSync", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ChangeEpFsmStage", parent_mo_or_dn, **kwargs)
