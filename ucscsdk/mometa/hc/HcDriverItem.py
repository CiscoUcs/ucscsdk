...
class HcDriverItem(ManagedObject):
    ...
    mo_meta = MoMeta("HcDriverItem", "hcDriverItem", "driver-[item_id]", VersionMeta.Version151a, "InputOutput", 0x3fff, [], ["admin"], ['hcServerComponent'], ['hcItemNote', 'hcSupportedDriverItem'], [None])
