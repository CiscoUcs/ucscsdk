"""This module contains the general information for HcDriverItem ManagedObject."""
...
class HcDriverItem(ManagedObject):
    """This is HcDriverItem class."""

    consts = HcDriverItemConsts()
    naming_props = set([u'itemId'])

    mo_meta = MoMeta("HcDriverItem", "hcDriverItem", "driver-[item_id]", VersionMeta.Version151a, "InputOutput", 0x3fff, [], ["admin"], [u'hcServerComponent'], [u'hcItemNote', u'hcSupportedDriverItem'], [None])
    ...
    prop_meta = {
        ...
        "item_protocol": MoPropertyMeta("item_protocol", "itemProtocol", "string", VersionMeta.Version151a, MoPropertyMeta.READ_WRITE, 0x20, 0, 510, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, item_id, **kwargs):
        ...
        ManagedObject.__init__(self, "HcDriverItem", parent_mo_or_dn, **kwargs)
