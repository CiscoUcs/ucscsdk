...
class HcSupportedDriverItem(ManagedObject):
    ...
    mo_meta = MoMeta("HcSupportedDriverItem", "hcSupportedDriverItem", "supported-driver-[item_id]", VersionMeta.Version151a, "InputOutput", 0x7ff, [], ["admin"], [u'hcDriverItem'], [], [None])
