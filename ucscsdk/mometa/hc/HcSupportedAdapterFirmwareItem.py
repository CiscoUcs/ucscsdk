...
class HcSupportedAdapterFirmwareItem(ManagedObject):
    ...
    mo_meta = MoMeta("HcSupportedAdapterFirmwareItem", "hcSupportedAdapterFirmwareItem", "supported-adapter-firmware-[item_id]", VersionMeta.Version151a, "InputOutput", 0x3ff, [], ["admin"], [u'hcAdapterFirmwareItem'], [], [None])
