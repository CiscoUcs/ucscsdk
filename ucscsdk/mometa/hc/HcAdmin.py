"""This module contains the general information for HcAdmin ManagedObject."""
...
class HcAdmin(ManagedObject):
    """This is HcAdmin class."""

    consts = HcAdminConsts()
    naming_props = set([])

    mo_meta = MoMeta("HcAdmin", "hcAdmin", "hc-admin", VersionMeta.Version151a, "InputOutput", 0xf, [], ["read-only"], [u'hcHolder'], [u'hcCleanup'], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "HcAdmin", parent_mo_or_dn, **kwargs)
