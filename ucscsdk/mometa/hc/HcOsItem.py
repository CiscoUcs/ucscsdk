...
class HcOsItem(ManagedObject):
    ...
    mo_meta = MoMeta("HcOsItem", "hcOsItem", "os-[item_id]", VersionMeta.Version151a, "InputOutput", 0x1fff, [], ["admin"], [u'hcServerComponent'], [u'hcItemNote', u'hcSupportedOsItem'], [None])
