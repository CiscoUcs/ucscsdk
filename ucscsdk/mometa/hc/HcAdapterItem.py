...
class HcAdapterItem(ManagedObject):
    ...
    mo_meta = MoMeta("HcAdapterItem", "hcAdapterItem", "adapter-[item_id]", VersionMeta.Version151a, "InputOutput", 0x3fff, [], ["admin"], ['hcServerComponent'], ['hcItemNote', 'hcSupportedAdapterItem'], [None])
