...
class OrgSourceMask(ManagedObject):
    ...
    prop_meta = {
        ...
        "mask": MoPropertyMeta("mask", "mask", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|policy-mgr|managed-endpoint),){0,2}(defaultValue|policy-mgr|managed-endpoint){0,1}""", [], []), 
