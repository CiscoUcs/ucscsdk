"""This module contains the general information for OrgOrgFsmStage ManagedObject."""
...
class OrgOrgFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CONFIGURE_BEGIN = "configureBegin"
    NAME_CONFIGURE_CONFIG = "configureConfig"
    NAME_CONFIGURE_FAIL = "configureFail"
    NAME_CONFIGURE_PEER_BEGIN = "configurePeerBegin"
    NAME_CONFIGURE_PEER_CONFIG = "configurePeerConfig"
    NAME_CONFIGURE_PEER_FAIL = "configurePeerFail"
    NAME_CONFIGURE_PEER_SUCCESS = "configurePeerSuccess"
...
class OrgOrgFsmStage(ManagedObject):
    """This is OrgOrgFsmStage class."""

    consts = OrgOrgFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("OrgOrgFsmStage", "orgOrgFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'orgOrgFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["configureBegin", "configureConfig", "configureFail", "configurePeerBegin", "configurePeerConfig", "configurePeerFail", "configurePeerSuccess", "configureSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "OrgOrgFsmStage", parent_mo_or_dn, **kwargs)
