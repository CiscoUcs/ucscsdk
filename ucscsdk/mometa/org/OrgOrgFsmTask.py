"""This module contains the general information for OrgOrgFsmTask ManagedObject."""
...
class OrgOrgFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_CONFIGURE = "configure"
    ITEM_CONFIGURE_PEER = "configurePeer"
    ITEM_NOP = "nop"


class OrgOrgFsmTask(ManagedObject):
    """This is OrgOrgFsmTask class."""

    consts = OrgOrgFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("OrgOrgFsmTask", "orgOrgFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'orgOrg'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["configure", "configurePeer", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "OrgOrgFsmTask", parent_mo_or_dn, **kwargs)
