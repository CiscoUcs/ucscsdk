...
class FirmwareDownloaderFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDownloaderFsm", "firmwareDownloaderFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['firmwareDownloader'], ['firmwareDownloaderFsmStage'], [None])
