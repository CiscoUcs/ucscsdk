...
class FirmwareDistributableFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributableFsmStage", "firmwareDistributableFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['firmwareDistributableFsm'], [], [None])
