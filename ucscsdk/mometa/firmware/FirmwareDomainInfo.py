...
class FirmwareDomainInfo(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDomainInfo", "firmwareDomainInfo", "domain-info-[id]", VersionMeta.Version151a, "InputOutput", 0x1f, [], ["admin", "operations"], [u'firmwareDomainInfraProfile'], [], ["Get"])
