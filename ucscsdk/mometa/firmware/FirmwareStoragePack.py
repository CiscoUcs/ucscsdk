...
class FirmwareStoragePack(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareStoragePack", "firmwareStoragePack", "storage-pack-[vendor]-[model]-[revision]", VersionMeta.Version101a, "InputOutput", 0x3ff, [], ["admin"], [u'orgOrg'], [], [None])
