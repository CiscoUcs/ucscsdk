...
class FirmwareDistributableFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributableFsmTask", "firmwareDistributableFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'firmwareDistributable'], [], [None])
