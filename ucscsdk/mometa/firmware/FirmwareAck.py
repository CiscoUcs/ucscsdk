...
class FirmwareAck(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareAck", "firmwareAck", "ack", VersionMeta.Version201a, "InputOutput", 0xff, [], ["admin"], [u'fabricLanCloud', u'fabricSanCloud', u'firmwareSystem', u'qosclassDefinition'], [u'faultInst'], ["get", "set"])

    prop_meta = {
        "acked": MoPropertyMeta("acked", "acked", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        "acked_by": MoPropertyMeta("acked_by", "ackedBy", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 32, None, [], []), 
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["trigger", "trigger-immediate", "triggered", "untriggered", "user-ack"], []), 
        "auto_delete": MoPropertyMeta("auto_delete", "autoDelete", "string", VersionMeta.Version201a, MoPropertyMeta.CREATE_ONLY, 0x4, None, None, None, ["false", "no", "true", "yes"], []), 
        "change_by": MoPropertyMeta("change_by", "changeBy", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 32, None, [], []), 
        "change_details": MoPropertyMeta("change_details", "changeDetails", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|graphics-card-mode|storage-snic-config|oob-local-storage-config|storage-target-id|bootmode-config|host-eth-if-qos-host-control|checkpoint|pin|blade-identity|boot-local-storage|ip|disk-zoning-config|host-fcoe-if|host-virt-fc-if-pers-bind|local-disk-fw|adaptor-host-fw|host-eth-if-qos|local-disk-data-loss|activate-fw|fan-speed-config|remote-storage-config|secureboot-config|host-if-pcie|sol|agent-policy|boot-virt-pxe|boot-order|sas-exp-reg-fw|vif|bmc-update-bios-fw|host-nonvirt-fc-if-pers-bind|adaptor-nw-fw|host-eth-if-nw-ctrl|host-virt-eth-if|local-storage-security|storage-dev-bridge-fw|vmedia-config|flexflash-config|implicit-host-eth-if-profile-redeploy|implicit-host-fc-if-profile-redeploy|ep-auth|boot-nonvirt-pxe|boot-virt-vnic|config-server-sioc-conn-state|vlan|host-fc-if-profile|sas-expander-fw|host-virt-fc-if|mgmt-controller-fw|host-nonvirt-eth-if|asset-tag-config|powercap-config|storage-appliance-sw|flexflash-reboot|storage-path|bios-profile|local-disk-policy|boot-nonvirt-vnic|vsan|host-fc-if-qos|implicit-reboot|board-controller-fw|host-nonvirt-fc-if|host-eth-if-profile|binding|bios-fw|storage-controller-fw|graphics-card-fw),){0,68}(defaultValue|graphics-card-mode|storage-snic-config|oob-local-storage-config|storage-target-id|bootmode-config|host-eth-if-qos-host-control|checkpoint|pin|blade-identity|boot-local-storage|ip|disk-zoning-config|host-fcoe-if|host-virt-fc-if-pers-bind|local-disk-fw|adaptor-host-fw|host-eth-if-qos|local-disk-data-loss|activate-fw|fan-speed-config|remote-storage-config|secureboot-config|host-if-pcie|sol|agent-policy|boot-virt-pxe|boot-order|sas-exp-reg-fw|vif|bmc-update-bios-fw|host-nonvirt-fc-if-pers-bind|adaptor-nw-fw|host-eth-if-nw-ctrl|host-virt-eth-if|local-storage-security|storage-dev-bridge-fw|vmedia-config|flexflash-config|implicit-host-eth-if-profile-redeploy|implicit-host-fc-if-profile-redeploy|ep-auth|boot-nonvirt-pxe|boot-virt-vnic|config-server-sioc-conn-state|vlan|host-fc-if-profile|sas-expander-fw|host-virt-fc-if|mgmt-controller-fw|host-nonvirt-eth-if|asset-tag-config|powercap-config|storage-appliance-sw|flexflash-reboot|storage-path|bios-profile|local-disk-policy|boot-nonvirt-vnic|vsan|host-fc-if-qos|implicit-reboot|board-controller-fw|host-nonvirt-fc-if|host-eth-if-profile|binding|bios-fw|storage-controller-fw|graphics-card-fw){0,1}""", [], []), 
        "changes": MoPropertyMeta("changes", "changes", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|storage|boot-order|chassis-assignment|server-assignment|operational-policies|chassis-identity|local-storage|server-identity|networking|vnic-vhba-placement),){0,10}(defaultValue|storage|boot-order|chassis-assignment|server-assignment|operational-policies|chassis-identity|local-storage|server-identity|networking|vnic-vhba-placement){0,1}""", [], []), 
        ...
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        "disr": MoPropertyMeta("disr", "disr", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|ac-power-cycle|local-storage-config-deployment|storage-access|local-storage-config-deployment-immediate|storage-uptime|up-time),){0,6}(defaultValue|ac-power-cycle|local-storage-config-deployment|storage-access|local-storage-config-deployment-immediate|storage-uptime|up-time){0,1}""", [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, 0x10, 0, 256, None, [], []), 
        "ignore_cap": MoPropertyMeta("ignore_cap", "ignoreCap", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "modified": MoPropertyMeta("modified", "modified", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "oper_scheduler": MoPropertyMeta("oper_scheduler", "operScheduler", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["applied", "apply-pending", "evaluated", "evaluation-pending", "untriggered", "waiting-for-dependency", "waiting-for-maint-window", "waiting-for-user"], []), 
        ...
        "prev_oper_state": MoPropertyMeta("prev_oper_state", "prevOperState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["applied", "apply-pending", "evaluated", "evaluation-pending", "untriggered", "waiting-for-dependency", "waiting-for-maint-window", "waiting-for-user"], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, 0x20, 0, 256, None, [], []), 
        "scheduler": MoPropertyMeta("scheduler", "scheduler", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x40, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "trigger_config_state": MoPropertyMeta("trigger_config_state", "triggerConfigState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["none", "waiting-for-next-boot"], []), 
    }
