...
class FirmwareSystem(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareSystem", "firmwareSystem", "fw-system", VersionMeta.Version101a, "InputOutput", 0xf, [], ["admin", "ls-config-policy", "ls-server-policy"], [u'topSystem'], [u'firmwareInfra'], ["Get"])
