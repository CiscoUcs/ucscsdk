"""This module contains the general information for CertRepairEpFsmStage ManagedObject."""
...
class CertRepairEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_NOP = "nop"
...
class CertRepairEpFsmStage(ManagedObject):
    """This is CertRepairEpFsmStage class."""

    consts = CertRepairEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("CertRepairEpFsmStage", "certRepairEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'certRepairEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "repairCertBegin", "repairCertFail", "repairCertRequest", "repairCertSuccess", "repairCertVerify"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "CertRepairEpFsmStage", parent_mo_or_dn, **kwargs)
