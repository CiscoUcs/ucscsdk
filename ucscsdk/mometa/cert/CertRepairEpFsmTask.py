"""This module contains the general information for CertRepairEpFsmTask ManagedObject."""
...
class CertRepairEpFsmTaskConsts():
...
class CertRepairEpFsmTask(ManagedObject):
    """This is CertRepairEpFsmTask class."""

    consts = CertRepairEpFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("CertRepairEpFsmTask", "certRepairEpFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'certRepairEp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "repairCert"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "CertRepairEpFsmTask", parent_mo_or_dn, **kwargs)
