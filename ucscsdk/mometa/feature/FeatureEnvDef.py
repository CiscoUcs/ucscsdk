...
class FeatureEnvDef(ManagedObject):
    ...
    mo_meta = MoMeta("FeatureEnvDef", "featureEnvDef", "env-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1f, [], ["admin"], [u'featureCatalogEp'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"])
    ...
    prop_meta = {
        ...
        "feature_mask": MoPropertyMeta("feature_mask", "featureMask", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|none|remote_operation_feature_mask|ucs_registration_feature_mask|power_group_feature_mask|estimate_impact_on_reconnect_feature_mask|health_reporting_feature_mask|dc_power_group_feature_mask),){0,7}(defaultValue|none|remote_operation_feature_mask|ucs_registration_feature_mask|power_group_feature_mask|estimate_impact_on_reconnect_feature_mask|health_reporting_feature_mask|dc_power_group_feature_mask){0,1}""", [], []), 
