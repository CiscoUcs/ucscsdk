...
class LsSPMeta(ManagedObject):
    ...
    mo_meta = MoMeta("LsSPMeta", "lsSPMeta", "spmeta", VersionMeta.Version111a, "InputOutput", 0x7f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-oper", "ls-server-policy"], [u'lsServer'], [u'faultInst', u'messageEntry', u'messageEp'], ["Get"])
    ...
    prop_meta = {
        ...
        "globalization_state": MoPropertyMeta("globalization_state", "globalizationState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["Globalized", "globalizing", "no-op"], []), 
