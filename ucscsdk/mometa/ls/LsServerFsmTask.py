...
class LsServerFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("LsServerFsmTask", "lsServerFsmTask", "task-[item]", VersionMeta.Version111a, "OutputOnly", 0xf, [], [""], [u'lsServer'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version111a, MoPropertyMeta.NAMING, None, None, None, None, ["Configure", "nop"], []), 
