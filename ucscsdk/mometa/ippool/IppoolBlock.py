...
class IppoolBlock(ManagedObject):
    ...
    mo_meta = MoMeta("IppoolBlock", "ippoolBlock", "block-[r_from]-[to]", VersionMeta.Version101a, "InputOutput", 0xfff, [], ["admin", "domain-group-management", "ls-network-policy"], ['ippoolPool'], [], ["Add", "Get", "Remove", "Set"])
