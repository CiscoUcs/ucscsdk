...
class LsbootIScsi(ManagedObject):
    ...
    mo_meta = MoMeta("LsbootIScsi", "lsbootIScsi", "iscsi", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], ['lsbootDef', 'lsbootPolicy'], ['lsbootIScsiImagePath'], ["Add", "Get", "Remove", "Set"])
