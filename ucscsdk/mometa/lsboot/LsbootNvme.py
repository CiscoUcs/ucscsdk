...
class LsbootNvme(ManagedObject):
    ...
    mo_meta = MoMeta("LsbootNvme", "lsbootNvme", "nvme", VersionMeta.Version201f, "InputOutput", 0x1f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], ['lsbootLocalStorage'], ['lsbootNvmeDiskSsd', 'lsbootNvmePciSsd', 'lsbootUEFIBootParam'], [None])
