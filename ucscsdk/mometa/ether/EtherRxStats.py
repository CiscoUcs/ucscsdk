...
class EtherRxStats(ManagedObject):
    ...
    mo_meta = MoMeta("EtherRxStats", "etherRxStats", "rx-stats", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], [u'etherServerIntFIo'], [u'etherRxStatsHist'], [None])
