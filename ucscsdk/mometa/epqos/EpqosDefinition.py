...
class EpqosDefinition(ManagedObject):
    ...
    mo_meta = MoMeta("EpqosDefinition", "epqosDefinition", "ep-qos-[name]", VersionMeta.Version111a, "InputOutput", 0x3f, [], ["admin", "ls-network", "ls-network-policy", "ls-qos-policy", "read-only"], ['orgOrg'], ['epqosEgress'], ["Add", "Get", "Remove", "Set"])
