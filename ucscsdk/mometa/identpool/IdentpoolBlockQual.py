"""This module contains the general information for IdentpoolBlockQual ManagedObject."""
...
class IdentpoolBlockQualConsts():
    INT_ID_NONE = "none"
...
class IdentpoolBlockQual(ManagedObject):
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "IdentpoolBlockQual", parent_mo_or_dn, **kwargs)
