...
class AaaRadiusEp(ManagedObject):
    ...
    mo_meta = MoMeta("AaaRadiusEp", "aaaRadiusEp", "radius-ext", VersionMeta.Version101a, "InputOutput", 0xff, [], ["aaa", "admin"], ['orgDomainGroup', 'policyDeviceProfile', 'topSystem'], ['aaaEpFsm', 'aaaEpFsmTask', 'aaaProviderGroup', 'aaaRadiusEpFsm', 'aaaRadiusProvider', 'eventInst', 'faultInst'], ["Add", "Get", "Remove", "Set"])
