...
class AaaEpAuthProfile(ManagedObject):
    ...
    mo_meta = MoMeta("AaaEpAuthProfile", "aaaEpAuthProfile", "auth-profile-[name]", VersionMeta.Version101a, "InputOutput", 0x7f, [], ["read-only"], ['orgDomainGroup', 'orgOrg'], ['aaaEpUser'], ["Add", "Get", "Remove", "Set"])
