...
class AaaUserPreferences(ManagedObject):
    ...
    prop_meta = {
        ...
        "favorites": MoPropertyMeta("favorites", "favorites", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], []), 
        ...
        "restored_tabs": MoPropertyMeta("restored_tabs", "restoredTabs", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x800, None, None, None, [], []), 
        ...
        "tab_restore_mode": MoPropertyMeta("tab_restore_mode", "tabRestoreMode", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10000, None, None, None, ["auto-restore", "do-not-restore", "prompt-user"], []), 
