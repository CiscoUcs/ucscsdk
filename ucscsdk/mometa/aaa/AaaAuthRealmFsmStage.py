...
class AaaAuthRealmFsmStageConsts():
    ...
    NAME_UPDATE_REALM_SET_REALM = "updateRealmSetRealm"
...
class AaaAuthRealmFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("AaaAuthRealmFsmStage", "aaaAuthRealmFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'aaaAuthRealmFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateRealmBegin", "updateRealmFail", "updateRealmSetRealm", "updateRealmSuccess"], []), 
