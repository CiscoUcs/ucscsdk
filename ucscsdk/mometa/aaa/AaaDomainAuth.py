...
class AaaDomainAuth(ManagedObject):
    ...
    mo_meta = MoMeta("AaaDomainAuth", "aaaDomainAuth", "domain-auth", VersionMeta.Version101a, "InputOutput", 0xff, [], ["aaa", "admin", "domain-group-management"], [u'aaaDomain'], [], ["Add", "Get", "Remove", "Set"])
