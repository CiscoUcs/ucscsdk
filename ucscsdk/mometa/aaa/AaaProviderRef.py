...
class AaaProviderRef(ManagedObject):
    ...
    mo_meta = MoMeta("AaaProviderRef", "aaaProviderRef", "provider-ref-[name]", VersionMeta.Version101a, "InputOutput", 0x7f, [], ["aaa", "admin", "domain-group-management"], [u'aaaProviderGroup'], [], ["Add", "Get", "Remove", "Set"])
