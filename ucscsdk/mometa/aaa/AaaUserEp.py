...
class AaaUserEp(ManagedObject):
    ...
    mo_meta = MoMeta("AaaUserEp", "aaaUserEp", "user-ext", VersionMeta.Version101a, "InputOutput", 0x7f, [], ["aaa", "admin"], ['topSystem'], ['aaaEpLogin', 'aaaExtMgmtCutThruTkn', 'aaaLocale', 'aaaPwdProfile', 'aaaRemoteUser', 'aaaRole', 'aaaShellLogin', 'aaaUser', 'aaaUserEpFsm', 'aaaUserEpFsmTask', 'aaaUserPreferences', 'aaaWebLogin', 'eventInst', 'faultInst'], ["Get", "Set"])
