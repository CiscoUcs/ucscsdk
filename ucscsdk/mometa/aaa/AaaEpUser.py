...
class AaaEpUser(ManagedObject):
    ...
    mo_meta = MoMeta("AaaEpUser", "aaaEpUser", "user-[name]", VersionMeta.Version101a, "InputOutput", 0xff, [], ["aaa", "admin", "ls-security", "ls-security-policy"], ['aaaEpAuthProfile'], [], ["Add", "Get", "Remove", "Set"])
