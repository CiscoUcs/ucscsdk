...
class AaaModLR(ManagedObject):
    ...
    prop_meta = {
        ...
        "src_dme": MoPropertyMeta("src_dme", "srcDme", "string", VersionMeta.Version121a, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["central-mgr", "identifier-mgr", "mgmt-controller", "operation-mgr", "policy-mgr", "resource-mgr", "service-reg", "stats-mgr", "unknown"], []), 
