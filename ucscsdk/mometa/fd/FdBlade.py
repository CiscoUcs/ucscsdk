"""This module contains the general information for FdBlade ManagedObject."""
...
class FdBladeConsts():
    ...
    FSM_PREV_CONFIGURE_COLLECT_ID_CONTEXTS = "ConfigureCollectIdContexts"
    ...
    FSM_PREV_CONFIGURE_VALIDATE_NETWORK_DESIGN = "ConfigureValidateNetworkDesign"
    ...
    FSM_STATUS_CONFIGURE_COLLECT_ID_CONTEXTS = "ConfigureCollectIdContexts"
    ...
    FSM_STATUS_CONFIGURE_VALIDATE_NETWORK_DESIGN = "ConfigureValidateNetworkDesign"
    FSM_STATUS_CONFIGURE_WAIT_FOR_CONSUMER_RECEIVING_VXAN = "ConfigureWaitForConsumerReceivingVxan"
    FSM_STATUS_NOP = "nop"


class FdBlade(ManagedObject):
    """This is FdBlade class."""

    consts = FdBladeConsts()
    naming_props = set([u'slotId'])

    mo_meta = MoMeta("FdBlade", "fdBlade", "blade-[slot_id]", VersionMeta.Version201a, "InputOutput", 0x7f, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fdChassis'], [u'eventInst', u'faultInst', u'fdBladeFsm', u'fdPhysicalFsm', u'fdPhysicalFsmTask', u'identRequestEp', u'messageEp', u'vnicMgmt', u'vnicOutbandMgmtEp'], ["get"])

    prop_meta = {
        "chassis_id": MoPropertyMeta("chassis_id", "chassisId", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["N/A"], ["0-255"]), 
        ...
        "fsm_flags": MoPropertyMeta("fsm_flags", "fsmFlags", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, [], ["0-4294967295"]), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureApplyConfig", "ConfigureApplyThrottle", "ConfigureBegin", "ConfigureCollectIdContexts", "ConfigureConsumerVxanDeployment", "ConfigureFail", "ConfigurePushPolicies", "ConfigureResolveIdentifiers", "ConfigureResolvePolicies", "ConfigureSuccess", "ConfigureThrottleWait", "ConfigureValidateNetworkDesign", "ConfigureWaitForConsumerReceivingVxan", "nop"], []), 
        ...
        "kmip_certificate_policy_name": MoPropertyMeta("kmip_certificate_policy_name", "kmipCertificatePolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x20, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, slot_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FdBlade", parent_mo_or_dn, **kwargs)
