"""This module contains the general information for FdBladeFsm ManagedObject."""
...
class FdBladeFsm(ManagedObject):
    """This is FdBladeFsm class."""

    consts = FdBladeFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FdBladeFsm", "fdBladeFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'fdBlade'], [u'fdBladeFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FdBladeFsm", parent_mo_or_dn, **kwargs)
