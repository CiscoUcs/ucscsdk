...
class FdRackUnit(ManagedObject):
    ...
    mo_meta = MoMeta("FdRackUnit", "fdRackUnit", "rack-unit-[id]", VersionMeta.Version201b, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricSystem'], [u'eventInst', u'faultInst', u'fdPhysicalFsm', u'fdPhysicalFsmTask', u'fdRackUnitFsm', u'identRequestEp', u'messageEp', u'vnicMgmt', u'vnicOutbandMgmtEp'], ["get"])
    ...
    prop_meta = {
        ...
        "fsm_flags": MoPropertyMeta("fsm_flags", "fsmFlags", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, [], ["0-4294967295"]), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureApplyConfig", "ConfigureApplyThrottle", "ConfigureBegin", "ConfigureCollectIdContexts", "ConfigureConsumerVxanDeployment", "ConfigureFail", "ConfigurePushPolicies", "ConfigureResolveIdentifiers", "ConfigureResolvePolicies", "ConfigureSuccess", "ConfigureThrottleWait", "ConfigureValidateNetworkDesign", "ConfigureWaitForConsumerReceivingVxan", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureApplyConfig", "ConfigureApplyThrottle", "ConfigureBegin", "ConfigureCollectIdContexts", "ConfigureConsumerVxanDeployment", "ConfigureFail", "ConfigurePushPolicies", "ConfigureResolveIdentifiers", "ConfigureResolvePolicies", "ConfigureSuccess", "ConfigureThrottleWait", "ConfigureValidateNetworkDesign", "ConfigureWaitForConsumerReceivingVxan", "nop"], []), 
        ...
        "kmip_certificate_policy_name": MoPropertyMeta("kmip_certificate_policy_name", "kmipCertificatePolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
