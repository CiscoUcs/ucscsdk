...
class FdRackUnit(ManagedObject):
    ...
    mo_meta = MoMeta("FdRackUnit", "fdRackUnit", "rack-unit-[id]", VersionMeta.Version201b, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy"], ['fabricSystem'], ['eventInst', 'faultInst', 'fdPhysicalFsm', 'fdPhysicalFsmTask', 'fdRackUnitFsm', 'identRequestEp', 'messageEp', 'vnicMgmt', 'vnicOutbandMgmtEp'], ["get"])
