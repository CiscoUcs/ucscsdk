"""This module contains the general information for FdRackUnit ManagedObject."""
...
class FdRackUnit(ManagedObject):
    """This is FdRackUnit class."""

    consts = FdRackUnitConsts()
    naming_props = set([u'id'])

    mo_meta = MoMeta("FdRackUnit", "fdRackUnit", "rack-unit-[id]", VersionMeta.Version201a, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricSystem'], [u'eventInst', u'faultInst', u'fdPhysicalFsm', u'fdPhysicalFsmTask', u'fdRackUnitFsm', u'identRequestEp', u'messageEp', u'vnicMgmt', u'vnicOutbandMgmtEp'], ["get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x4, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        ManagedObject.__init__(self, "FdRackUnit", parent_mo_or_dn, **kwargs)
