"""This module contains the general information for FdRackUnitFsm ManagedObject."""
...
class FdRackUnitFsm(ManagedObject):
    """This is FdRackUnitFsm class."""

    consts = FdRackUnitFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FdRackUnitFsm", "fdRackUnitFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'fdRackUnit'], [u'fdRackUnitFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FdRackUnitFsm", parent_mo_or_dn, **kwargs)
