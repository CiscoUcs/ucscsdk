"""This module contains the general information for FdPhysicalFsm ManagedObject."""
...
class FdPhysicalFsm(ManagedObject):
    """This is FdPhysicalFsm class."""

    consts = FdPhysicalFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FdPhysicalFsm", "fdPhysicalFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'fdBlade', u'fdRackUnit'], [u'fdPhysicalFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FdPhysicalFsm", parent_mo_or_dn, **kwargs)
