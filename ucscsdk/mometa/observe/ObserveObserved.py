...
class ObserveObserved(ManagedObject):
    ...
    mo_meta = MoMeta("ObserveObserved", "observeObserved", "observed-[data_src_sys_id]-[id]", VersionMeta.Version101a, "InputOutput", 0x1ff, [], ["admin"], ['extpolClient', 'extpolController', 'extpolProvider', 'extpolRegistry', 'observeObservedCont'], ['eventInst', 'faultInst', 'observeFilter', 'observeObservedFsm', 'observeObservedFsmTask'], [None])
