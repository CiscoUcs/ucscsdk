...
class PkiEpFsmStageConsts():
    ...
    NAME_UPDATE_EP_SET_CERT_CONF_LOCAL = "updateEpSetCertConfLocal"
...
class PkiEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("PkiEpFsmStage", "pkiEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'pkiEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpSetCertConfLocal", "updateEpSuccess"], []), 
