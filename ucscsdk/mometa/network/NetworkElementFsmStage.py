"""This module contains the general information for NetworkElementFsmStage ManagedObject."""
...
class NetworkElementFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_NOP = "nop"
    NAME_UPDATE_ELEMENT_BEGIN = "updateElementBegin"
    NAME_UPDATE_ELEMENT_FAIL = "updateElementFail"
    NAME_UPDATE_ELEMENT_SUCCESS = "updateElementSuccess"
    NAME_UPDATE_ELEMENT_UPDATE_ATTR = "updateElementUpdateAttr"
...
class NetworkElementFsmStage(ManagedObject):
    """This is NetworkElementFsmStage class."""

    consts = NetworkElementFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("NetworkElementFsmStage", "networkElementFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'networkElementFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateElementBegin", "updateElementFail", "updateElementSuccess", "updateElementUpdateAttr"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "NetworkElementFsmStage", parent_mo_or_dn, **kwargs)
