"""This module contains the general information for NetworkElementFsmTask ManagedObject."""
...
class NetworkElementFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_NOP = "nop"
    ITEM_UPDATE_ELEMENT = "updateElement"


class NetworkElementFsmTask(ManagedObject):
    """This is NetworkElementFsmTask class."""

    consts = NetworkElementFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("NetworkElementFsmTask", "networkElementFsmTask", "task-[item]", VersionMeta.Version101a, "OutputOnly", 0xf, [], [""], [u'networkElement'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "updateElement"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "NetworkElementFsmTask", parent_mo_or_dn, **kwargs)
