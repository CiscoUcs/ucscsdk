...
class AdaptorMenloHostPortStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloHostPortStatsHist", "adaptorMenloHostPortStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], ['adaptorMenloHostPortStats'], [], [None])
