...
class AdaptorHostEthIfOperation(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorHostEthIfOperation", "adaptorHostEthIfOperation", "remote-oper", VersionMeta.Version201b, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'adaptorHostEthIf'], [u'faultInst'], ["get", "set"])
