...
class AdaptorMenloEthErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloEthErrorStatsHist", "adaptorMenloEthErrorStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], ['adaptorMenloEthErrorStats'], [], [None])
