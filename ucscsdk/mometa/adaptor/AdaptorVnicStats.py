...
class AdaptorVnicStats(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorVnicStats", "adaptorVnicStats", "virtual-interface-stats", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["admin", "operations", "read-only"], ['adaptorHostEthIf', 'adaptorHostFcIf', 'adaptorHostIscsiIf', 'adaptorHostScsiIf', 'vmNic'], ['adaptorVnicStatsHist'], [None])
