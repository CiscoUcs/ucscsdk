...
class AdaptorMenloQErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloQErrorStatsHist", "adaptorMenloQErrorStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], [u'adaptorMenloQErrorStats'], [], [None])
