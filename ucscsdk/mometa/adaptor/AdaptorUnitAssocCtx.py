...
class AdaptorUnitAssocCtx(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorUnitAssocCtx", "adaptorUnitAssocCtx", "adaptorunit-assoc-ctx-[id]", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["read-only"], [u'lsServerAssocCtx'], [], ["Get"])
