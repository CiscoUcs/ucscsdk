...
class AdaptorMenloMcpuErrorStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorMenloMcpuErrorStatsHist", "adaptorMenloMcpuErrorStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], ['adaptorMenloMcpuErrorStats'], [], [None])
