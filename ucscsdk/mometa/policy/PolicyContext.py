...
class PolicyContext(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyContext", "policyContext", "context-[name]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'policySourceApp'], [u'policyScope'], ["get"])
    ...
    prop_meta = {
        ...
        "context": MoPropertyMeta("context", "context", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
