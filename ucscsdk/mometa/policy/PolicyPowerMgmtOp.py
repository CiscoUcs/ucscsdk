...
class PolicyPowerMgmtOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPowerMgmtOp", "policyPowerMgmtOp", "powermgmt-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "power-mgmt"], ['policyControlEpOp'], ['faultInst'], ["Get", "Set"])
