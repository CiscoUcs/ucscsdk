"""This module contains the general information for PolicyPowerMgmtOp ManagedObject."""
...
class PolicyPowerMgmtOp(ManagedObject):
    """This is PolicyPowerMgmtOp class."""

    consts = PolicyPowerMgmtOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyPowerMgmtOp", "policyPowerMgmtOp", "powermgmt-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "power-mgmt"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyPowerMgmtOp", parent_mo_or_dn, **kwargs)
