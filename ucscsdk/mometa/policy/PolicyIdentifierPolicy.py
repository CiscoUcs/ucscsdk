"""This module contains the general information for PolicyIdentifierPolicy ManagedObject."""
...
class PolicyIdentifierPolicyConsts():
    INT_ID_NONE = "none"
...
class PolicyIdentifierPolicy(ManagedObject):
    """This is PolicyIdentifierPolicy class."""

    consts = PolicyIdentifierPolicyConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyIdentifierPolicy", "policyIdentifierPolicy", "identifier-policy", VersionMeta.Version101a, "InputOutput", 0x7f, [], ["admin", "ls-config"], [u'orgDomainGroup', u'orgOrg'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "soak_interval": MoPropertyMeta("soak_interval", "soakInterval", "uint", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], ["0-86400"]), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyIdentifierPolicy", parent_mo_or_dn, **kwargs)
