...
class PolicyPortConfigOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPortConfigOp", "policyPortConfigOp", "portconfig-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-policy"], ['policyControlEpOp'], ['faultInst'], ["Get", "Set"])
