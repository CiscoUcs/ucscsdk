...
class PolicySourceApp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicySourceApp", "policySourceApp", "source-[source_dme]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'policyControlEp'], [u'policyContext'], ["get"])
    ...
    prop_meta = {
        ...
        "source_dme": MoPropertyMeta("source_dme", "sourceDme", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x8, 1, 510, None, [], []), 
