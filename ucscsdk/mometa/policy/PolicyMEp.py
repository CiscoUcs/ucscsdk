...
class PolicyMEp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyMEp", "policyMEp", "mep-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["admin", "operations"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
