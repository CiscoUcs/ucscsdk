...
class PolicyMEp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyMEp", "policyMEp", "mep-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["admin", "operations"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], ["Add", "Get", "Set"])
