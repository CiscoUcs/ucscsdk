...
class PolicyDiscoveryOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDiscoveryOp", "policyDiscoveryOp", "discovery-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "pn-policy"], ['policyControlEpOp'], ['faultInst'], ["Get", "Set"])
