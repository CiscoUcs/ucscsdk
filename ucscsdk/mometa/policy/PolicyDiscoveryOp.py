"""This module contains the general information for PolicyDiscoveryOp ManagedObject."""
...
class PolicyDiscoveryOp(ManagedObject):
    """This is PolicyDiscoveryOp class."""

    consts = PolicyDiscoveryOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyDiscoveryOp", "policyDiscoveryOp", "discovery-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyDiscoveryOp", parent_mo_or_dn, **kwargs)
