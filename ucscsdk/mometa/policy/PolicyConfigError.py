...
class PolicyConfigError(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyConfigError", "policyConfigError", "policy-error", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'extpolClient'], [u'faultInst'], ["get"])
    ...
    prop_meta = {
        ...
        "error_code": MoPropertyMeta("error_code", "errorCode", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "error_location": MoPropertyMeta("error_location", "errorLocation", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "timestamp": MoPropertyMeta("timestamp", "timestamp", "ulong", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
    }
