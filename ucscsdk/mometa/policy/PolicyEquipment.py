...
class PolicyEquipment(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyEquipment", "policyEquipment", "equipment-ctrl", VersionMeta.Version141a, "InputOutput", 0x1f, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Get"])
