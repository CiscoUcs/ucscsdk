"""This module contains the general information for PolicyDateTimeOp ManagedObject."""
...
class PolicyDateTimeOp(ManagedObject):
    """This is PolicyDateTimeOp class."""

    consts = PolicyDateTimeOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyDateTimeOp", "policyDateTimeOp", "datetime-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-security", "operations"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyDateTimeOp", parent_mo_or_dn, **kwargs)
