...
class PolicyDateTimeOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDateTimeOp", "policyDateTimeOp", "datetime-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-security", "operations"], ['policyControlEpOp'], ['faultInst'], ["Get", "Set"])
