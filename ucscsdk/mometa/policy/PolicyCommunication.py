...
class PolicyCommunication(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyCommunication", "policyCommunication", "comm-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["aaa", "admin"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], ["Add", "Get", "Set"])
