...
class PolicyDestClass(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDestClass", "policyDestClass", "dest-[name]", VersionMeta.Version201b, "InputOutput", 0x1f, [], ["read-only"], ['policyDestEp', 'policyPolicyDestClass'], ['policyChildClass'], ["get"])
