...
class PolicyDestClass(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDestClass", "policyDestClass", "dest-[name]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'policyDestEp', u'policyPolicyDestClass'], [u'policyChildClass'], ["get"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x4, 1, 128, None, [], []), 
