"""This module contains the general information for PolicyPsuOp ManagedObject."""
...
class PolicyPsuOp(ManagedObject):
    """This is PolicyPsuOp class."""

    consts = PolicyPsuOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyPsuOp", "policyPsuOp", "psu-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyPsuOp", parent_mo_or_dn, **kwargs)
