...
class PolicyPsuOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPsuOp", "policyPsuOp", "psu-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-policy"], ['policyControlEpOp'], ['faultInst'], ["Get", "Set"])
