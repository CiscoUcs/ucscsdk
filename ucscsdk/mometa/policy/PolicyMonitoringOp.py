"""This module contains the general information for PolicyMonitoringOp ManagedObject."""
...
class PolicyMonitoringOpConsts():
    SOURCE_LOCAL = "local"
...
class PolicyMonitoringOp(ManagedObject):
    """This is PolicyMonitoringOp class."""

    consts = PolicyMonitoringOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyMonitoringOp", "policyMonitoringOp", "monitoring-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "operations"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyMonitoringOp", parent_mo_or_dn, **kwargs)
