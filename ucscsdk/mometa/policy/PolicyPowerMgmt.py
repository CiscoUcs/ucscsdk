...
class PolicyPowerMgmt(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPowerMgmt", "policyPowerMgmt", "powermgmt-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["admin", "power-mgmt"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
