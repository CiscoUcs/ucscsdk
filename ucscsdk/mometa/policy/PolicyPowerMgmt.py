...
class PolicyPowerMgmt(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPowerMgmt", "policyPowerMgmt", "powermgmt-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["admin", "power-mgmt"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], ["Add", "Get", "Set"])
