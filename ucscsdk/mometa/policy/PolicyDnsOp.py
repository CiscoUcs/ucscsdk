"""This module contains the general information for PolicyDnsOp ManagedObject."""
...
class PolicyDnsOp(ManagedObject):
    """This is PolicyDnsOp class."""

    consts = PolicyDnsOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyDnsOp", "policyDnsOp", "dns-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["aaa", "admin", "ext-lan-config"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyDnsOp", parent_mo_or_dn, **kwargs)
