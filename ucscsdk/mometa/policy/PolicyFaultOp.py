"""This module contains the general information for PolicyFaultOp ManagedObject."""
...
class PolicyFaultOp(ManagedObject):
    """This is PolicyFaultOp class."""

    consts = PolicyFaultOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyFaultOp", "policyFaultOp", "fault-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "fault"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyFaultOp", parent_mo_or_dn, **kwargs)
