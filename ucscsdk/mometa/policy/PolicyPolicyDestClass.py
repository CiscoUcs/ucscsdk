...
class PolicyPolicyDestClass(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyDestClass", "policyPolicyDestClass", "destclass", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'policyScope'], [u'policyDestClass'], ["get"])

    prop_meta = {
        "action": MoPropertyMeta("action", "action", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["delete", "localize", "no-action"], []), 
        ...
        "overwrite": MoPropertyMeta("overwrite", "overwrite", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
