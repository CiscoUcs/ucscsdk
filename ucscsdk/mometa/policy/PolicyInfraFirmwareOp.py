...
class PolicyInfraFirmwareOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyInfraFirmwareOp", "policyInfraFirmwareOp", "fabric-fw-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "operations"], ['policyControlEpOp'], ['faultInst'], ["Get", "Set"])
