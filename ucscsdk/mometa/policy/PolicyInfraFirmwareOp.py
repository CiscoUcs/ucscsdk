"""This module contains the general information for PolicyInfraFirmwareOp ManagedObject."""
...
class PolicyInfraFirmwareOpConsts():
    SOURCE_LOCAL = "local"
...
class PolicyInfraFirmwareOp(ManagedObject):
    """This is PolicyInfraFirmwareOp class."""

    consts = PolicyInfraFirmwareOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyInfraFirmwareOp", "policyInfraFirmwareOp", "fabric-fw-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "operations"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyInfraFirmwareOp", parent_mo_or_dn, **kwargs)
