...
class PolicyDns(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDns", "policyDns", "dns-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["aaa", "admin", "ext-lan-config"], [u'policyControlEp'], [u'policyControlledInstance', u'policyControlledType'], ["Add", "Get", "Set"])
