...
class PolicyDns(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDns", "policyDns", "dns-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["aaa", "admin", "ext-lan-config"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], ["Add", "Get", "Set"])
