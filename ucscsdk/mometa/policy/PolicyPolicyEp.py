...
class PolicyPolicyEp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPolicyEp", "policyPolicyEp", "policy-ep", VersionMeta.Version101a, "InputOutput", 0xf, [], ["admin"], ['topRoot'], ['policyPolicyScopeCont', 'policySystemEp'], [None])
