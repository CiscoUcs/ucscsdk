...
class PolicyFault(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyFault", "policyFault", "fault-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["admin", "fault"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], ["Add", "Get", "Set"])
