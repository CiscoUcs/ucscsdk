...
class PolicyCommunicationOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyCommunicationOp", "policyCommunicationOp", "comm-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["aaa", "admin"], ['policyControlEpOp'], ['faultInst'], ["Get", "Set"])
