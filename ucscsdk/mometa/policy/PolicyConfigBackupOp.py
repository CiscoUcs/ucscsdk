...
class PolicyConfigBackupOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyConfigBackupOp", "policyConfigBackupOp", "cfg-backup-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "operations"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
