...
class PolicyStorageAutoConfig(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyStorageAutoConfig", "policyStorageAutoConfig", "storage-autoconfig-ctrl", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["admin", "ls-storage", "pn-policy"], ['policyControlEp'], ['policyControlledInstance', 'policyControlledType'], [None])
