"""This module contains the general information for PolicyMEpOp ManagedObject."""
...
class PolicyMEpOp(ManagedObject):
    """This is PolicyMEpOp class."""

    consts = PolicyMEpOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyMEpOp", "policyMEpOp", "mep-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "operations"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyMEpOp", parent_mo_or_dn, **kwargs)
