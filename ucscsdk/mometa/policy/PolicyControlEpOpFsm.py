"""This module contains the general information for PolicyControlEpOpFsm ManagedObject."""
...
class PolicyControlEpOpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_REMOTE_DOMAIN_REG = "RemoteDomainReg"
    CURRENT_FSM_REMOTE_DOMAIN_UN_REG = "RemoteDomainUnReg"
    CURRENT_FSM_NOP = "nop"
...
class PolicyControlEpOpFsm(ManagedObject):
    """This is PolicyControlEpOpFsm class."""
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version151a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["RemoteDomainReg", "RemoteDomainUnReg", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyControlEpOpFsm", parent_mo_or_dn, **kwargs)
