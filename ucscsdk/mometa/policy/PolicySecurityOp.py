"""This module contains the general information for PolicySecurityOp ManagedObject."""
...
class PolicySecurityOp(ManagedObject):
    """This is PolicySecurityOp class."""

    consts = PolicySecurityOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicySecurityOp", "policySecurityOp", "security-ctrl", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["aaa", "admin"], [u'policyControlEpOp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicySecurityOp", parent_mo_or_dn, **kwargs)
