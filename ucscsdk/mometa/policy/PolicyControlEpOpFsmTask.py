"""This module contains the general information for PolicyControlEpOpFsmTask ManagedObject."""
...
class PolicyControlEpOpFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_REMOTE_DOMAIN_REG = "RemoteDomainReg"
    ITEM_REMOTE_DOMAIN_UN_REG = "RemoteDomainUnReg"
    ITEM_NOP = "nop"


class PolicyControlEpOpFsmTask(ManagedObject):
    """This is PolicyControlEpOpFsmTask class."""

    consts = PolicyControlEpOpFsmTaskConsts()
    naming_props = set([u'item'])

    mo_meta = MoMeta("PolicyControlEpOpFsmTask", "policyControlEpOpFsmTask", "task-[item]", VersionMeta.Version151a, "OutputOnly", 0xf, [], [""], [u'policyControlEpOp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version151a, MoPropertyMeta.NAMING, None, None, None, None, ["RemoteDomainReg", "RemoteDomainUnReg", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyControlEpOpFsmTask", parent_mo_or_dn, **kwargs)
