...
class EquipmentRackUnitFanStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitFanStatsHist", "equipmentRackUnitFanStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], ['equipmentRackUnitFanStats'], [], [None])
