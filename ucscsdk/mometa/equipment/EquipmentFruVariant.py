...
class EquipmentFruVariant(ManagedObject):
    ...
    prop_meta = {
        ...
        "pid": MoPropertyMeta("pid", "pid", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x10, 1, 510, None, [], []), 
    }
