...
class EquipmentComputeConnPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentComputeConnPolicy", "equipmentComputeConnPolicy", "compute-conn-policy-[name]", VersionMeta.Version201a, "InputOutput", 0x7f, [], ["read-only"], [u'orgOrg'], [], ["add", "get", "remove", "set"])
    ...
    prop_meta = {
        ...
        "server_sioc_connectivity": MoPropertyMeta("server_sioc_connectivity", "serverSiocConnectivity", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["single-server-dual-sioc", "single-server-single-sioc"], []), 
