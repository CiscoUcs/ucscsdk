...
class EquipmentComputeConn(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentComputeConn", "equipmentComputeConn", "compute-conn", VersionMeta.Version201a, "InputOutput", 0xf, [], [""], [u'equipmentChassis'], [], ["get"])
    ...
    prop_meta = {
        ...
        "server_sioc_connectivity": MoPropertyMeta("server_sioc_connectivity", "serverSiocConnectivity", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["single-server-dual-sioc", "single-server-single-sioc"], []), 
