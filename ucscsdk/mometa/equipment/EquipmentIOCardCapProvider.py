...
class EquipmentIOCardCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentIOCardCapProvider", "equipmentIOCardCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101a, "InputOutput", 0xff, [], ["admin"], ['capabilityCatalogue'], ['equipmentFanModulesDef', 'equipmentFruVariant', 'equipmentManufacturingDef', 'equipmentPicture'], ["Get"])
