...
class EquipmentTemplateMapping(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentTemplateMapping", "equipmentTemplateMapping", "chassis-templmap-[name]", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin"], [u'computeSystem'], [], ["Get"])
