...
class EquipmentPciDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPciDef", "equipmentPciDef", "pci-[name]", VersionMeta.Version151a, "InputOutput", 0x1f, [], [""], ['equipmentGraphicsCardCapProvider', 'equipmentLocalDiskControllerCapProvider'], [], ["Get"])
