...
class EquipmentChassisProfileAssocCtx(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisProfileAssocCtx", "equipmentChassisProfileAssocCtx", "cp-assoc-ctx", VersionMeta.Version151a, "InputOutput", 0xf, [], ["read-only"], ['equipmentChassisProfile'], ['equipmentChassisAssocCtx'], ["Get"])
