...
class EquipmentChassisProfileFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisProfileFsm", "equipmentChassisProfileFsm", "fsm", VersionMeta.Version151a, "OutputOnly", 0xf, [], [""], ['equipmentChassisProfile'], ['equipmentChassisProfileFsmStage'], [None])
