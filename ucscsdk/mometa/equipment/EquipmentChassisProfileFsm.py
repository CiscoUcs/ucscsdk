...
class EquipmentChassisProfileFsm(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisProfileFsm", "equipmentChassisProfileFsm", "fsm", VersionMeta.Version151a, "OutputOnly", 0xf, [], [""], [u'equipmentChassisProfile'], [u'equipmentChassisProfileFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version151a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Configure", "nop"], []), 
