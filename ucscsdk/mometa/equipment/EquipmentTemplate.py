...
class EquipmentTemplate(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentTemplate", "equipmentTemplate", "chassis-templ-[name]", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["read-only"], [u'orgOrg'], [u'equipmentChassisProfile', u'equipmentLocalTemplDef'], ["Get"])
