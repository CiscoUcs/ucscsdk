...
class EquipmentPsuOutputStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPsuOutputStatsHist", "equipmentPsuOutputStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], ['equipmentPsuOutputStats'], [], [None])
