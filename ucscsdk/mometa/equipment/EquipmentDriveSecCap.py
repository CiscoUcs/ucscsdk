...
class EquipmentDriveSecCap(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentDriveSecCap", "equipmentDriveSecCap", "drive-sec-cap", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentRackUnitCapProvider'], [], ["get"])
    ...
    prop_meta = {
        ...
        "is_supported": MoPropertyMeta("is_supported", "isSupported", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["no", "yes"], []), 
        "min_version": MoPropertyMeta("min_version", "minVersion", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
