...
class EquipmentDriveSecCap(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentDriveSecCap", "equipmentDriveSecCap", "drive-sec-cap", VersionMeta.Version201b, "InputOutput", 0xf, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentRackUnitCapProvider'], [], ["get"])
