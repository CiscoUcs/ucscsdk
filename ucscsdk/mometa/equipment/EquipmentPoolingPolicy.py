...
class EquipmentPoolingPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPoolingPolicy", "equipmentPoolingPolicy", "chassis-pooling-policy-[name]", VersionMeta.Version151a, "InputOutput", 0xff, [], ["read-only"], ['orgOrg'], [], [None])
