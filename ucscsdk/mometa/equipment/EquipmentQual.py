...
class EquipmentQual(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentQual", "equipmentQual", "chassis-qualifier-[name]", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "pn-policy"], [u'orgOrg'], [u'equipmentChassisQual', u'equipmentPhysicalQual'], [None])
