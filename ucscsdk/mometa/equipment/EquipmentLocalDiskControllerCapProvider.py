...
class EquipmentLocalDiskControllerCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentLocalDiskControllerCapProvider", "equipmentLocalDiskControllerCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0xff, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPciDef', u'equipmentPicture'], ["Get"])
    ...
    prop_meta = {
        ...
        "form": MoPropertyMeta("form", "form", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["embedded", "mezzanine", "none", "on-board", "pci"], []), 
        "gencount": MoPropertyMeta("gencount", "gencount", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "internalports": MoPropertyMeta("internalports", "internalports", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
