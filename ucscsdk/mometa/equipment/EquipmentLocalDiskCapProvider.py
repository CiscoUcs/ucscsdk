...
class EquipmentLocalDiskCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentLocalDiskCapProvider", "equipmentLocalDiskCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0xff, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentLocalDiskDef', u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"])
