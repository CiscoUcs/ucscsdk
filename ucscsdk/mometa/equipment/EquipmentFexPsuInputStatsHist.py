...
class EquipmentFexPsuInputStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentFexPsuInputStatsHist", "equipmentFexPsuInputStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], ['equipmentFexPsuInputStats'], [], [None])
