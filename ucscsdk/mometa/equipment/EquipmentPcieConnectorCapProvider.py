...
class EquipmentPcieConnectorCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPcieConnectorCapProvider", "equipmentPcieConnectorCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version201v, "InputOutput", 0xff, [], ["admin"], ['capabilityCatalogue'], ['equipmentFruVariant', 'equipmentManufacturingDef', 'equipmentPicture'], [None])
