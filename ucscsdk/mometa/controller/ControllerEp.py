...
class ControllerEp(ManagedObject):
    ...
    mo_meta = MoMeta("ControllerEp", "controllerEp", "controller", VersionMeta.Version111a, "InputOutput", 0xf, [], ["read-only"], ['topRoot'], ['controllerEpFsm', 'controllerEpFsmTask', 'eventInst', 'faultInst'], [None])
