...
class VnicLifVsan(ManagedObject):
    ...
    mo_meta = MoMeta("VnicLifVsan", "vnicLifVsan", "vsan-[vnet]", VersionMeta.Version131a, "InputOutput", 0x3f, [], ["admin", "ls-config", "ls-network", "ls-server", "read-only"], [], [u'vnicFault'], ["Get"])
    ...
    prop_meta = {
        ...
        "initiator": MoPropertyMeta("initiator", "initiator", "string", VersionMeta.Version131a, MoPropertyMeta.READ_ONLY, None, 0, 256, r"""(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
        ...
        "vnet": MoPropertyMeta("vnet", "vnet", "uint", VersionMeta.Version131a, MoPropertyMeta.NAMING, 0x20, None, None, None, [], ["1-4093"]), 
    }
