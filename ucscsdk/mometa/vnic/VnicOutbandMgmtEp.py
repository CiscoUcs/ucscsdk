"""This module contains the general information for VnicOutbandMgmtEp ManagedObject."""
...
class VnicOutbandMgmtEpConsts():
    FSM_PREV_CONFIGURE_OUTBAND_APPLY_CONFIG = "ConfigureOutbandApplyConfig"
    FSM_PREV_CONFIGURE_OUTBAND_BEGIN = "ConfigureOutbandBegin"
    FSM_PREV_CONFIGURE_OUTBAND_COLLECT_ID_CONTEXTS = "ConfigureOutbandCollectIdContexts"
    FSM_PREV_CONFIGURE_OUTBAND_FAIL = "ConfigureOutbandFail"
    FSM_PREV_CONFIGURE_OUTBAND_RESOLVE_IDENTIFIERS = "ConfigureOutbandResolveIdentifiers"
    FSM_PREV_CONFIGURE_OUTBAND_RESOLVE_OUTBAND_POOL = "ConfigureOutbandResolveOutbandPool"
    FSM_PREV_CONFIGURE_OUTBAND_SUCCESS = "ConfigureOutbandSuccess"
    FSM_PREV_CONFIGURE_OUTBAND_VALIDATE = "ConfigureOutbandValidate"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONFIGURE_OUTBAND_APPLY_CONFIG = "ConfigureOutbandApplyConfig"
    FSM_STATUS_CONFIGURE_OUTBAND_BEGIN = "ConfigureOutbandBegin"
    FSM_STATUS_CONFIGURE_OUTBAND_COLLECT_ID_CONTEXTS = "ConfigureOutbandCollectIdContexts"
    FSM_STATUS_CONFIGURE_OUTBAND_FAIL = "ConfigureOutbandFail"
    FSM_STATUS_CONFIGURE_OUTBAND_RESOLVE_IDENTIFIERS = "ConfigureOutbandResolveIdentifiers"
    FSM_STATUS_CONFIGURE_OUTBAND_RESOLVE_OUTBAND_POOL = "ConfigureOutbandResolveOutbandPool"
    FSM_STATUS_CONFIGURE_OUTBAND_SUCCESS = "ConfigureOutbandSuccess"
    FSM_STATUS_CONFIGURE_OUTBAND_VALIDATE = "ConfigureOutbandValidate"
    FSM_STATUS_NOP = "nop"


class VnicOutbandMgmtEp(ManagedObject):
    """This is VnicOutbandMgmtEp class."""

    consts = VnicOutbandMgmtEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("VnicOutbandMgmtEp", "vnicOutbandMgmtEp", "outband-ep", VersionMeta.Version201a, "InputOutput", 0xf, [], ["read-only"], [u'fdBlade', u'fdRackUnit'], [u'eventInst', u'faultInst', u'messageEp', u'vnicIpV4PooledAddr', u'vnicIpV4StaticAddr', u'vnicOutbandMgmtEpFsm', u'vnicOutbandMgmtEpFsmTask'], ["get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "VnicOutbandMgmtEp", parent_mo_or_dn, **kwargs)
