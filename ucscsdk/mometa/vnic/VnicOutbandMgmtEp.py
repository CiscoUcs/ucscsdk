...
class VnicOutbandMgmtEp(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureOutbandApplyConfig", "ConfigureOutbandBegin", "ConfigureOutbandCollectIdContexts", "ConfigureOutbandFail", "ConfigureOutbandResolveIdentifiers", "ConfigureOutbandResolveOutbandPool", "ConfigureOutbandSuccess", "ConfigureOutbandValidate", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureOutbandApplyConfig", "ConfigureOutbandBegin", "ConfigureOutbandCollectIdContexts", "ConfigureOutbandFail", "ConfigureOutbandResolveIdentifiers", "ConfigureOutbandResolveOutbandPool", "ConfigureOutbandSuccess", "ConfigureOutbandValidate", "nop"], []), 
