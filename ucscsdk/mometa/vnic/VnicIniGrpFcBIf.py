...
class VnicIniGrpFcBIf(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIniGrpFcBIf", "vnicIniGrpFcBIf", "inigrp-fcb-if-[name]", VersionMeta.Version201b, "InputOutput", 0x1f, [], ["admin", "ls-config", "ls-network", "ls-server"], ['vnicIniGrpFcB'], ['vnicFault'], ["get"])
