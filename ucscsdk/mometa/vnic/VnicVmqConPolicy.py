...
class VnicVmqConPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("VnicVmqConPolicy", "vnicVmqConPolicy", "vmq-con-[name]", VersionMeta.Version112a, "InputOutput", 0xff, [], ["admin", "ls-compute", "ls-network", "ls-network-policy", "ls-server"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "intr_count": MoPropertyMeta("intr_count", "intrCount", "ushort", VersionMeta.Version112a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], ["1-128"]), 
        ...
        "vmq_count": MoPropertyMeta("vmq_count", "vmqCount", "ushort", VersionMeta.Version112a, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, [], ["1-128"]), 
    }
