...
class VnicFcGroupDef(ManagedObject):
    ...
    mo_meta = MoMeta("VnicFcGroupDef", "vnicFcGroupDef", "fc-group", VersionMeta.Version111a, "InputOutput", 0xff, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], ['storageIniGroup'], ['faultInst', 'storageConnectionDef', 'vnicIniGrpFc', 'vnicIniGrpFcB'], ["Add", "Get", "Set"])
