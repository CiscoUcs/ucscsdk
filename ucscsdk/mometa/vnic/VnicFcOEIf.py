...
class VnicFcOEIf(ManagedObject):
    ...
    mo_meta = MoMeta("VnicFcOEIf", "vnicFcOEIf", "fcoe", VersionMeta.Version111a, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy", "ls-config", "ls-network", "ls-server", "ls-storage"], [u'vnicEther', u'vnicLanConnTempl'], [u'vnicFault'], ["Get"])
    ...
    prop_meta = {
        ...
        "initiator": MoPropertyMeta("initiator", "initiator", "string", VersionMeta.Version111a, MoPropertyMeta.READ_WRITE, 0x4, 0, 256, r"""(([A-Fa-f0-9][A-Fa-f0-9]:){7}[A-Fa-f0-9][A-Fa-f0-9])|0""", [], []), 
