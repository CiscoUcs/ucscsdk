...
class VnicFcOEIf(ManagedObject):
    ...
    mo_meta = MoMeta("VnicFcOEIf", "vnicFcOEIf", "fcoe", VersionMeta.Version111a, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy", "ls-config", "ls-network", "ls-server", "ls-storage"], ['vnicEther', 'vnicLanConnTempl'], ['vnicFault'], ["Get"])
