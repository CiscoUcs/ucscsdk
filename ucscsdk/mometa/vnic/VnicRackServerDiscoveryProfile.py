...
class VnicRackServerDiscoveryProfile(ManagedObject):
    ...
    mo_meta = MoMeta("VnicRackServerDiscoveryProfile", "vnicRackServerDiscoveryProfile", "vnic-[name]", VersionMeta.Version141a, "InputOutput", 0x7f, [], ["read-only"], [u'vnicProfileSet'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "max_ports": MoPropertyMeta("max_ports", "maxPorts", "ushort", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], ["1-4096"]), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{1,80}""", [], []), 
