"""This module contains the general information for VnicOutbandMgmtEpFsm ManagedObject."""
...
class VnicOutbandMgmtEpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONFIGURE_OUTBAND = "ConfigureOutband"
    CURRENT_FSM_NOP = "nop"
...
class VnicOutbandMgmtEpFsm(ManagedObject):
    """This is VnicOutbandMgmtEpFsm class."""

    consts = VnicOutbandMgmtEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("VnicOutbandMgmtEpFsm", "vnicOutbandMgmtEpFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'vnicOutbandMgmtEp'], [u'vnicOutbandMgmtEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ConfigureOutband", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "VnicOutbandMgmtEpFsm", parent_mo_or_dn, **kwargs)
