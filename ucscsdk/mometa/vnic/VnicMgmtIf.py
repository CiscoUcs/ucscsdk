...
class VnicMgmtIf(ManagedObject):
    ...
    prop_meta = {
        ...
        "oper_inband_profile_dn": MoPropertyMeta("oper_inband_profile_dn", "operInbandProfileDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_net_group_dn": MoPropertyMeta("oper_net_group_dn", "operNetGroupDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
