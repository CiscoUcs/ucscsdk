...
class VnicNetGroupRef(ManagedObject):
    ...
    mo_meta = MoMeta("VnicNetGroupRef", "vnicNetGroupRef", "ngref-[name]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["admin"], [u'vnicNetGroup'], [u'vnicEther'], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x4, 1, 1024, None, [], []), 
        "oper_net_group_ref_dn": MoPropertyMeta("oper_net_group_ref_dn", "operNetGroupRefDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
