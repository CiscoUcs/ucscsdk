...
class VersionEp(ManagedObject):
    ...
    mo_meta = MoMeta("VersionEp", "versionEp", "version", VersionMeta.Version101a, "InputOutput", 0xf, [], ["read-only"], ['topSystem'], ['versionApplication', 'versionMatrix', 'versionProduct'], [None])
