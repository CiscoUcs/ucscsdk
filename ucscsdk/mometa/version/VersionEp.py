...
class VersionEp(ManagedObject):
    ...
    mo_meta = MoMeta("VersionEp", "versionEp", "version", VersionMeta.Version101a, "InputOutput", 0xf, [], ["read-only"], [u'topSystem'], [u'versionApplication', u'versionMatrix', u'versionProduct'], [None])
