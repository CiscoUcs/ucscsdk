...
class CimcvmediaActualMountList(ManagedObject):
    ...
    mo_meta = MoMeta("CimcvmediaActualMountList", "cimcvmediaActualMountList", "actual-mount-list", VersionMeta.Version121e, "InputOutput", 0xf, [], ["read-only"], ['mgmtController'], ['cimcvmediaActualMountEntry', 'cimcvmediaExtMgmtRuleEntry'], ["Get"])
