...
class CimcvmediaMountConfigPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("CimcvmediaMountConfigPolicy", "cimcvmediaMountConfigPolicy", "mnt-cfg-policy-[name]", VersionMeta.Version121e, "InputOutput", 0x7f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], ['orgOrg'], ['cimcvmediaConfigMountEntry'], ["Add", "Get", "Remove", "Set"])
