"""This module contains the general information for TopSystemFsmTask ManagedObject."""
...
class TopSystemFsmTask(ManagedObject):
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["HostName", "PeerHostName", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "TopSystemFsmTask", parent_mo_or_dn, **kwargs)
