"""This module contains the general information for TopSystemFsmStage ManagedObject."""
...
class TopSystemFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_HOST_NAME_BEGIN = "HostNameBegin"
    NAME_HOST_NAME_CONFIG = "HostNameConfig"
    NAME_HOST_NAME_CONFIG_PEER = "HostNameConfigPeer"
    NAME_HOST_NAME_FAIL = "HostNameFail"
    NAME_HOST_NAME_SUCCESS = "HostNameSuccess"
    NAME_PEER_HOST_NAME_BEGIN = "PeerHostNameBegin"
    NAME_PEER_HOST_NAME_CONFIG = "PeerHostNameConfig"
    NAME_PEER_HOST_NAME_FAIL = "PeerHostNameFail"
    NAME_PEER_HOST_NAME_SUCCESS = "PeerHostNameSuccess"
    NAME_NOP = "nop"
...
class TopSystemFsmStage(ManagedObject):
    """This is TopSystemFsmStage class."""

    consts = TopSystemFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("TopSystemFsmStage", "topSystemFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'topSystemFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["HostNameBegin", "HostNameConfig", "HostNameConfigPeer", "HostNameFail", "HostNameSuccess", "PeerHostNameBegin", "PeerHostNameConfig", "PeerHostNameFail", "PeerHostNameSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "TopSystemFsmStage", parent_mo_or_dn, **kwargs)
