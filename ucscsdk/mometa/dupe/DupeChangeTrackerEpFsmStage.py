"""This module contains the general information for DupeChangeTrackerEpFsmStage ManagedObject."""
...
class DupeChangeTrackerEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_CONFIGURE_BEGIN = "ConfigureBegin"
    NAME_CONFIGURE_FAIL = "ConfigureFail"
    NAME_CONFIGURE_SEND_CHANGE = "ConfigureSendChange"
...
class DupeChangeTrackerEpFsmStage(ManagedObject):
    """This is DupeChangeTrackerEpFsmStage class."""

    consts = DupeChangeTrackerEpFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("DupeChangeTrackerEpFsmStage", "dupeChangeTrackerEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'dupeChangeTrackerEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureSendChange", "ConfigureSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "DupeChangeTrackerEpFsmStage", parent_mo_or_dn, **kwargs)
