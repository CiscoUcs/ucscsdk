...
class DupeChangeTrackerEp(ManagedObject):
    ...
    mo_meta = MoMeta("DupeChangeTrackerEp", "dupeChangeTrackerEp", "changetracker-ep", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["read-only"], ['dupeEp'], ['dupeChangeTracker', 'dupeChangeTrackerEpFsm', 'dupeChangeTrackerEpFsmTask', 'eventInst', 'faultInst'], [None])
