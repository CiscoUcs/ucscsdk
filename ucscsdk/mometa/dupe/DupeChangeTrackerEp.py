...
class DupeChangeTrackerEp(ManagedObject):
    ...
    mo_meta = MoMeta("DupeChangeTrackerEp", "dupeChangeTrackerEp", "changetracker-ep", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["read-only"], [u'dupeEp'], [u'dupeChangeTracker', u'dupeChangeTrackerEpFsm', u'dupeChangeTrackerEpFsmTask', u'eventInst', u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "latest_send_time": MoPropertyMeta("latest_send_time", "latestSendTime", "ulong", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, [], []), 
