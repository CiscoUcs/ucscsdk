"""This module contains the general information for TrigPendingAckCount ManagedObject."""
...
class TrigPendingAckCountConsts():
    pass


class TrigPendingAckCount(ManagedObject):
    """This is TrigPendingAckCount class."""

    consts = TrigPendingAckCountConsts()
    naming_props = set([])

    mo_meta = MoMeta("TrigPendingAckCount", "trigPendingAckCount", "pending-ack-count", VersionMeta.Version121a, "InputOutput", 0xf, [], ["admin", "ls-compute", "ls-config", "ls-server"], [u'orgDomainGroup'], [], ["Get"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "TrigPendingAckCount", parent_mo_or_dn, **kwargs)
