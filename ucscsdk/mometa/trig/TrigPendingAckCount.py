...
class TrigPendingAckCount(ManagedObject):
    ...
    mo_meta = MoMeta("TrigPendingAckCount", "trigPendingAckCount", "pending-ack-count", VersionMeta.Version121a, "InputOutput", 0xf, [], ["admin", "ls-compute", "ls-config", "ls-server"], ['orgDomainGroup'], [], ["Get"])
