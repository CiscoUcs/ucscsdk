...
class DomainProfileFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("DomainProfileFsmStage", "domainProfileFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'domainProfileFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureBegin", "ConfigureConfigure", "ConfigureConsumerVxanDeployment", "ConfigureFail", "ConfigurePushPolicies", "ConfigureSuccess", "ConfigureWaitForConsumerReceivingVxan", "nop"], []), 
