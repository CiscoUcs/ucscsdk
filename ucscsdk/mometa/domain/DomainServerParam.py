...
class DomainServerParam(ManagedObject):
    ...
    mo_meta = MoMeta("DomainServerParam", "domainServerParam", "server-param-[name]", VersionMeta.Version112a, "InputOutput", 0x3f, [], ["admin"], ['domainChassisFeature', 'domainEnvironmentFeature', 'domainFeatureCatalog', 'domainNetworkFeature', 'domainServerFeature', 'domainStorageFeature', 'featureChassisDef', 'featureEnvDef', 'featureNetworkDef', 'featureServerDef', 'featureStorageDef'], [], ["Get"])
