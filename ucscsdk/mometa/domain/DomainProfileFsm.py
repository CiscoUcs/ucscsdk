"""This module contains the general information for DomainProfileFsm ManagedObject."""
...
class DomainProfileFsm(ManagedObject):
    """This is DomainProfileFsm class."""

    consts = DomainProfileFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("DomainProfileFsm", "domainProfileFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0xf, [], [""], [u'domainProfile'], [u'domainProfileFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "DomainProfileFsm", parent_mo_or_dn, **kwargs)
