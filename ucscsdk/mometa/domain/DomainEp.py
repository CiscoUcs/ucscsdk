"""This module contains the general information for DomainEp ManagedObject."""
...
class DomainEpConsts():
    pass


class DomainEp(ManagedObject):
    """This is DomainEp class."""

    consts = DomainEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("DomainEp", "domainEp", "catalog", VersionMeta.Version112a, "InputOutput", 0xf, [], ["admin"], [u'topRoot'], [u'domainFeatureCatalog'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "DomainEp", **kwargs)
