...
class DomainChassisParam(ManagedObject):
    ...
    mo_meta = MoMeta("DomainChassisParam", "domainChassisParam", "chassis-param-[name]", VersionMeta.Version201a, "InputOutput", 0x3f, [], ["admin"], [u'domainChassisFeature', u'domainEnvironmentFeature', u'domainFeatureCatalog', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature', u'featureChassisDef', u'featureEnvDef', u'featureNetworkDef', u'featureServerDef', u'featureStorageDef'], [], ["get"])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x4, 1, 510, None, [], []), 
        ...
        "value": MoPropertyMeta("value", "value", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x20, 0, 510, None, [], []), 
    }
