"""This module contains the general information for DomainProfile ManagedObject."""
...
class DomainProfile(ManagedObject):
    """This is DomainProfile class."""

    consts = DomainProfileConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("DomainProfile", "domainProfile", "domain-profile-[name]", VersionMeta.Version201a, "InputOutput", 0x7fff, [], ["admin", "domain-group-management"], [u'fabricSystem', u'orgDomainGroup'], [u'domainProfileFsm', u'domainProfileFsmTask', u'eventInst', u'faultInst', u'messageEp'], ["get", "set"])
    ...
    prop_meta = {
        ...
        "flt_aggr": MoPropertyMeta("flt_aggr", "fltAggr", "ulong", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "fsm_descr": MoPropertyMeta("fsm_descr", "fsmDescr", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureConfigure", "ConfigureConsumerVxanDeployment", "ConfigureFail", "ConfigurePushPolicies", "ConfigureSuccess", "ConfigureWaitForConsumerReceivingVxan", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureConfigure", "ConfigureConsumerVxanDeployment", "ConfigureFail", "ConfigurePushPolicies", "ConfigureSuccess", "ConfigureWaitForConsumerReceivingVxan", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "hw_change_disc_policy_name": MoPropertyMeta("hw_change_disc_policy_name", "hwChangeDiscPolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "inband_policy_name": MoPropertyMeta("inband_policy_name", "inbandPolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "int_id": MoPropertyMeta("int_id", "intId", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["none"], ["0-4294967295"]), 
        "kmip_certificate_policy_name": MoPropertyMeta("kmip_certificate_policy_name", "kmipCertificatePolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x40, None, None, r"""[\-\.:_a-zA-Z0-9]{2,32}""", [], []), 
        "net_group_dn": MoPropertyMeta("net_group_dn", "netGroupDn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_hw_change_disc_policy_name": MoPropertyMeta("oper_hw_change_disc_policy_name", "operHwChangeDiscPolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_inband_policy_name": MoPropertyMeta("oper_inband_policy_name", "operInbandPolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_kmip_certificate_policy_name": MoPropertyMeta("oper_kmip_certificate_policy_name", "operKmipCertificatePolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_port_disc_policy_name": MoPropertyMeta("oper_port_disc_policy_name", "operPortDiscPolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_qosclass_definition_name": MoPropertyMeta("oper_qosclass_definition_name", "operQosclassDefinitionName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_src_templ_name": MoPropertyMeta("oper_src_templ_name", "operSrcTemplName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "outband_mgmt_pool": MoPropertyMeta("outband_mgmt_pool", "outbandMgmtPool", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x80, None, None, r"""[\-\.:_a-zA-Z0-9]{0,32}""", [], []), 
        "policy_level": MoPropertyMeta("policy_level", "policyLevel", "uint", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "port_disc_policy_name": MoPropertyMeta("port_disc_policy_name", "portDiscPolicyName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x100, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "qosclass_definition_name": MoPropertyMeta("qosclass_definition_name", "qosclassDefinitionName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x200, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "refresh": MoPropertyMeta("refresh", "refresh", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x400, None, None, None, ["disabled", "enabled"], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, 0x800, 0, 256, None, [], []), 
        "src_templ_name": MoPropertyMeta("src_templ_name", "srcTemplName", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x1000, None, None, None, [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x2000, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version201a, MoPropertyMeta.CREATE_ONLY, 0x4000, None, None, None, ["initial-template", "instance", "updating-template"], []), 
    }
    ...
    prop_map = {
        ...
        "fsmTry": "fsm_try", 
        "hwChangeDiscPolicyName": "hw_change_disc_policy_name", 
        "inbandPolicyName": "inband_policy_name", 
        "intId": "int_id", 
        "kmipCertificatePolicyName": "kmip_certificate_policy_name", 
        "name": "name", 
        "netGroupDn": "net_group_dn", 
        "operHwChangeDiscPolicyName": "oper_hw_change_disc_policy_name", 
        "operInbandPolicyName": "oper_inband_policy_name", 
        "operKmipCertificatePolicyName": "oper_kmip_certificate_policy_name", 
        "operPortDiscPolicyName": "oper_port_disc_policy_name", 
        "operQosclassDefinitionName": "oper_qosclass_definition_name", 
        "operSrcTemplName": "oper_src_templ_name", 
        "outbandMgmtPool": "outband_mgmt_pool", 
        "policyLevel": "policy_level", 
        "policyOwner": "policy_owner", 
        "portDiscPolicyName": "port_disc_policy_name", 
        "qosclassDefinitionName": "qosclass_definition_name", 
        "refresh": "refresh", 
        "rn": "rn", 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        self.fsm_try = None
        self.hw_change_disc_policy_name = None
        self.inband_policy_name = None
        self.int_id = None
        self.kmip_certificate_policy_name = None
        self.net_group_dn = None
        self.oper_hw_change_disc_policy_name = None
        self.oper_inband_policy_name = None
        self.oper_kmip_certificate_policy_name = None
        self.oper_port_disc_policy_name = None
        self.oper_qosclass_definition_name = None
        self.oper_src_templ_name = None
        self.outband_mgmt_pool = None
        self.policy_level = None
        self.policy_owner = None
        self.port_disc_policy_name = None
        self.qosclass_definition_name = None
        self.refresh = None
        self.src_templ_name = None
        self.status = None
        self.type = None

        ManagedObject.__init__(self, "DomainProfile", parent_mo_or_dn, **kwargs)
