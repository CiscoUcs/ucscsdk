...
class DomainProfile(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureConfigure", "ConfigureConsumerVxanDeployment", "ConfigureFail", "ConfigurePushPolicies", "ConfigureSuccess", "ConfigureWaitForConsumerReceivingVxan", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureConfigure", "ConfigureConsumerVxanDeployment", "ConfigureFail", "ConfigurePushPolicies", "ConfigureSuccess", "ConfigureWaitForConsumerReceivingVxan", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "hw_change_disc_policy_name": MoPropertyMeta("hw_change_disc_policy_name", "hwChangeDiscPolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "inband_policy_name": MoPropertyMeta("inband_policy_name", "inbandPolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "kmip_certificate_policy_name": MoPropertyMeta("kmip_certificate_policy_name", "kmipCertificatePolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201b, MoPropertyMeta.NAMING, 0x40, None, None, r"""[\-\.:_a-zA-Z0-9]{2,32}""", [], []), 
        ...
        "oper_hw_change_disc_policy_name": MoPropertyMeta("oper_hw_change_disc_policy_name", "operHwChangeDiscPolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_inband_policy_name": MoPropertyMeta("oper_inband_policy_name", "operInbandPolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_kmip_certificate_policy_name": MoPropertyMeta("oper_kmip_certificate_policy_name", "operKmipCertificatePolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_port_disc_policy_name": MoPropertyMeta("oper_port_disc_policy_name", "operPortDiscPolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_qosclass_definition_name": MoPropertyMeta("oper_qosclass_definition_name", "operQosclassDefinitionName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_src_templ_name": MoPropertyMeta("oper_src_templ_name", "operSrcTemplName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "outband_mgmt_pool": MoPropertyMeta("outband_mgmt_pool", "outbandMgmtPool", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x80, None, None, r"""[\-\.:_a-zA-Z0-9]{0,32}""", [], []), 
        ...
        "port_disc_policy_name": MoPropertyMeta("port_disc_policy_name", "portDiscPolicyName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x100, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "qosclass_definition_name": MoPropertyMeta("qosclass_definition_name", "qosclassDefinitionName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x200, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        "refresh": MoPropertyMeta("refresh", "refresh", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x400, None, None, None, ["disabled", "enabled"], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version201b, MoPropertyMeta.READ_ONLY, 0x800, 0, 256, None, [], []), 
        "src_templ_name": MoPropertyMeta("src_templ_name", "srcTemplName", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x1000, None, None, None, [], []), 
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x2000, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version201b, MoPropertyMeta.CREATE_ONLY, 0x4000, None, None, None, ["initial-template", "instance", "updating-template"], []), 
    }
