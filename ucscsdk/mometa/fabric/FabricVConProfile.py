...
class FabricVConProfile(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVConProfile", "fabricVConProfile", "vcon-profile-[name]", VersionMeta.Version111a, "InputOutput", 0x7f, [], ["read-only"], [u'orgOrg'], [u'fabricVCon'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "mezz_mapping": MoPropertyMeta("mezz_mapping", "mezzMapping", "string", VersionMeta.Version111a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["linear-ordered", "linear-ordered-to-round-robin", "round-robin", "round-robin-to-linear-ordered"], []), 
