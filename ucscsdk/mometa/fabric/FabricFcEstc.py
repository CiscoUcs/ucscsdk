...
class FabricFcEstc(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcEstc", "fabricFcEstc", "[id]", VersionMeta.Version111a, "InputOutput", 0x3f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstcCloud'], [u'fabricFcEstcEp', u'fabricFcEstcEpOperation', u'fabricFcoeEstcEp', u'fabricFcoeEstcEpOperation', u'fabricSubGroup', u'fabricVsan'], ["Get"])
