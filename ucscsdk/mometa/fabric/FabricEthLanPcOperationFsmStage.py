"""This module contains the general information for FabricEthLanPcOperationFsmStage ManagedObject."""
...
class FabricEthLanPcOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricEthLanPcOperationFsmStage(ManagedObject):
    """This is FabricEthLanPcOperationFsmStage class."""

    consts = FabricEthLanPcOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricEthLanPcOperationFsmStage", "fabricEthLanPcOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthLanPcOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthLanPcOperationFsmStage", parent_mo_or_dn, **kwargs)
