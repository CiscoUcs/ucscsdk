"""This module contains the general information for FabricFcSanPcOperationFsmStage ManagedObject."""
...
class FabricFcSanPcOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricFcSanPcOperationFsmStage(ManagedObject):
    """This is FabricFcSanPcOperationFsmStage class."""

    consts = FabricFcSanPcOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricFcSanPcOperationFsmStage", "fabricFcSanPcOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcSanPcOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcSanPcOperationFsmStage", parent_mo_or_dn, **kwargs)
