"""This module contains the general information for FabricFcPortOperationFsmStage ManagedObject."""
...
class FabricFcPortOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricFcPortOperationFsmStage(ManagedObject):
    """This is FabricFcPortOperationFsmStage class."""

    consts = FabricFcPortOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricFcPortOperationFsmStage", "fabricFcPortOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcPortOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcPortOperationFsmStage", parent_mo_or_dn, **kwargs)
