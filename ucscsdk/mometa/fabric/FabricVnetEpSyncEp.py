...
class FabricVnetEpSyncEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVnetEpSyncEp", "fabricVnetEpSyncEp", "syncEp", VersionMeta.Version111a, "InputOutput", 0xf, [], ["read-only"], ['extpolClient'], ['eventInst', 'fabricChangedObjectRef', 'fabricVnetEpSyncEpFsm', 'fabricVnetEpSyncEpFsmTask', 'faultInst'], [None])
