...
class FabricLanPinGroup(ManagedObject):
    ...
    mo_meta = MoMeta("FabricLanPinGroup", "fabricLanPinGroup", "lan-pin-group-[name]", VersionMeta.Version141a, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricLanCloud'], [u'fabricLanPinTarget'], ["Get"])
    ...
    prop_meta = {
        ...
        "size": MoPropertyMeta("size", "size", "uint", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
