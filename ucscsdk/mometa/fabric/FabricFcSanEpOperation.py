...
class FabricFcSanEpOperation(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcSanEpOperation", "fabricFcSanEpOperation", "remoper-phys-slot-[slot_id]-port-[port_id]", VersionMeta.Version141a, "InputOutput", 0x7ff, [], ["admin", "ext-san-config", "ext-san-policy"], ['fabricFcSan'], ['eventInst', 'fabricFIPortOperationFsm', 'fabricFIPortOperationFsmTask', 'fabricFcMonSrcEpOperation', 'fabricFcPortOperationFsm', 'fabricFcSanEpOperationFsm', 'faultInst', 'messageEp', 'vnicFc', 'vnicMonSesFc'], ["Add", "Get", "Remove", "Set"])
