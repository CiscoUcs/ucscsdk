...
class FabricSanCloud(ManagedObject):
    ...
    mo_meta = MoMeta("FabricSanCloud", "fabricSanCloud", "san", VersionMeta.Version111a, "InputOutput", 0x1f, [], [""], [u'fabricEp'], [u'fabricFcSan', u'fabricFcUplinkOperation', u'fabricSanPinGroup', u'fabricSanPinGroupOperation', u'statsThresholdPolicy'], ["Get", "Set"])
