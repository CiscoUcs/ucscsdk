...
class FabricVsanEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVsanEp", "fabricVsanEp", "vsan-[id]", VersionMeta.Version141a, "InputOutput", 0xff, [], ["read-only"], ['fabricFcEstcEp', 'fabricFcSanEp', 'fabricFcSanPc', 'fabricFcoeEstcEp', 'fabricFcoeSanEp'], ['fabricConsumer', 'fabricEtherRef'], ["Get"])
