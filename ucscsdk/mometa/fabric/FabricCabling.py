...
class FabricCabling(ManagedObject):
    ...
    mo_meta = MoMeta("FabricCabling", "fabricCabling", "Cabling", VersionMeta.Version141a, "InputOutput", 0xf, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy"], ['fabricEp'], ['fabricCablingSw', 'statsThresholdPolicy'], ["Get"])
