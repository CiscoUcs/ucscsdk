...
class FabricVnetEpSyncEpFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_SYNC_VNET_EP_UCSBEGIN = "SyncVnetEpUCSBegin"
    NAME_SYNC_VNET_EP_UCSFAIL = "SyncVnetEpUCSFail"
    NAME_SYNC_VNET_EP_UCSSUCCESS = "SyncVnetEpUCSSuccess"
    NAME_SYNC_VNET_EP_UCSSYNC = "SyncVnetEpUCSSync"
    NAME_NOP = "nop"
...
class FabricVnetEpSyncEpFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVnetEpSyncEpFsmStage", "fabricVnetEpSyncEpFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricVnetEpSyncEpFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["SyncVnetEpUCSBegin", "SyncVnetEpUCSFail", "SyncVnetEpUCSSuccess", "SyncVnetEpUCSSync", "nop"], []), 
