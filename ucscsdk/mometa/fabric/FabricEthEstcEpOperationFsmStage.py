"""This module contains the general information for FabricEthEstcEpOperationFsmStage ManagedObject."""
...
class FabricEthEstcEpOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricEthEstcEpOperationFsmStage(ManagedObject):
    """This is FabricEthEstcEpOperationFsmStage class."""

    consts = FabricEthEstcEpOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricEthEstcEpOperationFsmStage", "fabricEthEstcEpOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthEstcEpOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthEstcEpOperationFsmStage", parent_mo_or_dn, **kwargs)
