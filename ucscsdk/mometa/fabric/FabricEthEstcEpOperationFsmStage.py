...
class FabricEthEstcEpOperationFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEthEstcEpOperationFsmStage", "fabricEthEstcEpOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['fabricEthEstcEpOperationFsm'], [], [None])
