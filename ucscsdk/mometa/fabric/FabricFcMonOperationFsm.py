"""This module contains the general information for FabricFcMonOperationFsm ManagedObject."""
...
class FabricFcMonOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricFcMonOperationFsm(ManagedObject):
    """This is FabricFcMonOperationFsm class."""

    consts = FabricFcMonOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricFcMonOperationFsm", "fabricFcMonOperationFsm", "fsm", VersionMeta.Version151a, "OutputOnly", 0xf, [], [""], [u'fabricFcMonOperation'], [u'fabricFcMonOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcMonOperationFsm", parent_mo_or_dn, **kwargs)
