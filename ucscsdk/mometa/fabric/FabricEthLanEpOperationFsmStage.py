"""This module contains the general information for FabricEthLanEpOperationFsmStage ManagedObject."""
...
class FabricEthLanEpOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricEthLanEpOperationFsmStage(ManagedObject):
    """This is FabricEthLanEpOperationFsmStage class."""

    consts = FabricEthLanEpOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricEthLanEpOperationFsmStage", "fabricEthLanEpOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthLanEpOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthLanEpOperationFsmStage", parent_mo_or_dn, **kwargs)
