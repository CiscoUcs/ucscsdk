...
class FabricFcoeSanPcOperationFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcoeSanPcOperationFsm", "fabricFcoeSanPcOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['fabricFcoeSanPcOperation'], ['fabricFcoeSanPcOperationFsmStage'], [None])
