...
class FabricFcZoneProfileFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcZoneProfileFsmStage", "fabricFcZoneProfileFsmStage", "stage-[name]", VersionMeta.Version201b, "OutputOnly", 0xf, [], [""], [u'fabricFcZoneProfileFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201b, MoPropertyMeta.NAMING, None, None, None, None, ["ConfigureApplyConfig", "ConfigureBegin", "ConfigureConsumerVsanDeployment", "ConfigureFail", "ConfigureSuccess", "ConfigureValidation", "ConfigureWaitForRecvVsan", "nop"], []), 
