...
class FabricFcZoneProfileFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcZoneProfileFsm", "fabricFcZoneProfileFsm", "fsm", VersionMeta.Version201b, "OutputOnly", 0xf, [], [""], ['fabricFcZoneProfile'], ['fabricFcZoneProfileFsmStage'], [None])
