...
class FabricLanPinGroupOperation(ManagedObject):
    ...
    mo_meta = MoMeta("FabricLanPinGroupOperation", "fabricLanPinGroupOperation", "remoper-lan-pin-group-[name]", VersionMeta.Version141a, "InputOutput", 0x7f, [], ["admin", "ext-lan-config", "ext-lan-policy"], ['fabricLanCloud'], ['fabricLanPinTargetOperation', 'faultInst'], ["Add", "Get", "Remove", "Set"])
