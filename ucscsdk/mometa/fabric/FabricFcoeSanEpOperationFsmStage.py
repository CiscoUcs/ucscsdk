"""This module contains the general information for FabricFcoeSanEpOperationFsmStage ManagedObject."""
...
class FabricFcoeSanEpOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricFcoeSanEpOperationFsmStage(ManagedObject):
    """This is FabricFcoeSanEpOperationFsmStage class."""

    consts = FabricFcoeSanEpOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricFcoeSanEpOperationFsmStage", "fabricFcoeSanEpOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcoeSanEpOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeSanEpOperationFsmStage", parent_mo_or_dn, **kwargs)
