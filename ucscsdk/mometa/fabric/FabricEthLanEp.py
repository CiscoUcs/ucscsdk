...
class FabricEthLanEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEthLanEp", "fabricEthLanEp", "phys-slot-[slot_id]-port-[port_id]", VersionMeta.Version121a, "InputOutput", 0x1fff, [], ["admin", "ext-lan-config", "ext-lan-policy"], ['fabricEthLan', 'fabricSubGroup'], ['fabricEthMonSrcEp', 'fabricNetGroupEp', 'fabricVlanEp', 'faultInst'], ["Get", "Set"])
