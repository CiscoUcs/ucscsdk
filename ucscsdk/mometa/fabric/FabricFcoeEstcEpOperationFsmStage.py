"""This module contains the general information for FabricFcoeEstcEpOperationFsmStage ManagedObject."""
...
class FabricFcoeEstcEpOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricFcoeEstcEpOperationFsmStage(ManagedObject):
    """This is FabricFcoeEstcEpOperationFsmStage class."""

    consts = FabricFcoeEstcEpOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricFcoeEstcEpOperationFsmStage", "fabricFcoeEstcEpOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcoeEstcEpOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeEstcEpOperationFsmStage", parent_mo_or_dn, **kwargs)
