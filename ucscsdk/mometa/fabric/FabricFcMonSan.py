...
class FabricFcMonSan(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcMonSan", "fabricFcMonSan", "[id]", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSanMonCloud'], [u'fabricFcMon', u'fabricFcMonOperation'], ["Get"])
