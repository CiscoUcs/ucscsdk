"""This module contains the general information for FabricCartridgeSlotEpOperation ManagedObject."""
...
class FabricCartridgeSlotEpOperationConsts():
...
class FabricCartridgeSlotEpOperation(ManagedObject):
    """This is FabricCartridgeSlotEpOperation class."""

    consts = FabricCartridgeSlotEpOperationConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricCartridgeSlotEpOperation", "fabricCartridgeSlotEpOperation", "remote-oper", VersionMeta.Version131a, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'fabricCartridgeSlotEp'], [u'faultInst'], ["Get", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricCartridgeSlotEpOperation", parent_mo_or_dn, **kwargs)
