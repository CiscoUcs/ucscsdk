"""This module contains the general information for FabricFcEstcEpOperationFsmStage ManagedObject."""
...
class FabricFcEstcEpOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricFcEstcEpOperationFsmStage(ManagedObject):
    """This is FabricFcEstcEpOperationFsmStage class."""

    consts = FabricFcEstcEpOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricFcEstcEpOperationFsmStage", "fabricFcEstcEpOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcEstcEpOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcEstcEpOperationFsmStage", parent_mo_or_dn, **kwargs)
