...
class FabricEthMonLan(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEthMonLan", "fabricEthMonLan", "[id]", VersionMeta.Version151a, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-policy"], ['fabricLanMonCloud'], ['fabricEthMon', 'fabricEthMonOperation'], ["Get"])
