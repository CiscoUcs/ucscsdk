...
class FabricNetGroupReq(ManagedObject):
    ...
    mo_meta = MoMeta("FabricNetGroupReq", "fabricNetGroupReq", "ngreq-[name]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["admin", "ext-lan-config", "ext-lan-policy", "ls-network"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "config_issues": MoPropertyMeta("config_issues", "configIssues", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|not-applicable|permit-unresolved),){0,2}(defaultValue|not-applicable|permit-unresolved){0,1}""", [], []), 
