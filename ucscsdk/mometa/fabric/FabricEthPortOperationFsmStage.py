"""This module contains the general information for FabricEthPortOperationFsmStage ManagedObject."""
...
class FabricEthPortOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricEthPortOperationFsmStage(ManagedObject):
    """This is FabricEthPortOperationFsmStage class."""

    consts = FabricEthPortOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricEthPortOperationFsmStage", "fabricEthPortOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthPortOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthPortOperationFsmStage", parent_mo_or_dn, **kwargs)
