"""This module contains the general information for FabricLanPinTargetOperation ManagedObject."""
...
class FabricLanPinTargetOperationConsts():
    FABRIC_ID_A = "A"
    FABRIC_ID_B = "B"
    FABRIC_ID_NONE = "NONE"
    FABRIC_ID_DUAL = "dual"
...
class FabricLanPinTargetOperation(ManagedObject):
    ...
    def __init__(self, parent_mo_or_dn, fabric_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricLanPinTargetOperation", parent_mo_or_dn, **kwargs)
