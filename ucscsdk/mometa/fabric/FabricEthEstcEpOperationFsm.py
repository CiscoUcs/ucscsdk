...
class FabricEthEstcEpOperationFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEthEstcEpOperationFsm", "fabricEthEstcEpOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['fabricEthEstcEpOperation'], ['fabricEthEstcEpOperationFsmStage'], [None])
