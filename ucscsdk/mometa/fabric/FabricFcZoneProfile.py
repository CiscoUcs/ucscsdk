...
class FabricFcZoneProfile(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcZoneProfile", "fabricFcZoneProfile", "zone-profile-[name]", VersionMeta.Version201b, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstcCloud'], [u'eventInst', u'fabricFcUserZone', u'fabricFcZoneProfileFsm', u'fabricFcZoneProfileFsmTask', u'faultInst'], [None])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version201b, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["disabled", "enabled"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureApplyConfig", "ConfigureBegin", "ConfigureConsumerVsanDeployment", "ConfigureFail", "ConfigureSuccess", "ConfigureValidation", "ConfigureWaitForRecvVsan", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201b, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureApplyConfig", "ConfigureBegin", "ConfigureConsumerVsanDeployment", "ConfigureFail", "ConfigureSuccess", "ConfigureValidation", "ConfigureWaitForRecvVsan", "nop"], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201b, MoPropertyMeta.NAMING, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{2,16}""", [], []), 
