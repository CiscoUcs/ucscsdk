...
class FabricFcZoneProfileConsts():
    ...
    FSM_PREV_CONFIGURE_CONSUMER_VSAN_DEPLOYMENT = "ConfigureConsumerVsanDeployment"
    FSM_PREV_CONFIGURE_FAIL = "ConfigureFail"
    FSM_PREV_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_PREV_CONFIGURE_VALIDATION = "ConfigureValidation"
    FSM_PREV_CONFIGURE_WAIT_FOR_RECV_VSAN = "ConfigureWaitForRecvVsan"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONFIGURE_CONSUMER_VSAN_DEPLOYMENT = "ConfigureConsumerVsanDeployment"
    FSM_STATUS_CONFIGURE_FAIL = "ConfigureFail"
    FSM_STATUS_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_STATUS_CONFIGURE_VALIDATION = "ConfigureValidation"
    FSM_STATUS_CONFIGURE_WAIT_FOR_RECV_VSAN = "ConfigureWaitForRecvVsan"
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
...
class FabricFcZoneProfile(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcZoneProfile", "fabricFcZoneProfile", "zone-profile-[name]", VersionMeta.Version201a, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstcCloud'], [u'eventInst', u'fabricFcUserZone', u'fabricFcZoneProfileFsm', u'fabricFcZoneProfileFsmTask', u'faultInst'], [None])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["disabled", "enabled"], []), 
        ...
        "descr": MoPropertyMeta("descr", "descr", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x4, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,256}""", [], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureApplyConfig", "ConfigureBegin", "ConfigureConsumerVsanDeployment", "ConfigureFail", "ConfigureSuccess", "ConfigureValidation", "ConfigureWaitForRecvVsan", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version201a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureApplyConfig", "ConfigureBegin", "ConfigureConsumerVsanDeployment", "ConfigureFail", "ConfigureSuccess", "ConfigureValidation", "ConfigureWaitForRecvVsan", "nop"], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version201a, MoPropertyMeta.NAMING, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{2,16}""", [], []), 
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["misconfigured", "ok"], []), 
