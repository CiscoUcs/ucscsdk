...
class FabricEthMonOperationFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEthMonOperationFsm", "fabricEthMonOperationFsm", "fsm", VersionMeta.Version151a, "OutputOnly", 0xf, [], [""], ['fabricEthMonOperation'], ['fabricEthMonOperationFsmStage'], [None])
