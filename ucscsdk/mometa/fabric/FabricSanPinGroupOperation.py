"""This module contains the general information for FabricSanPinGroupOperation ManagedObject."""
...
class FabricSanPinGroupOperationConsts():
...
class FabricSanPinGroupOperation(ManagedObject):
    """This is FabricSanPinGroupOperation class."""

    consts = FabricSanPinGroupOperationConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricSanPinGroupOperation", "fabricSanPinGroupOperation", "remoper-san-pin-group-[name]", VersionMeta.Version141a, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSanCloud'], [u'fabricSanPinTargetOperation', u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricSanPinGroupOperation", parent_mo_or_dn, **kwargs)
