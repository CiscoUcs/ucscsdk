...
class FabricSanPinGroupOperation(ManagedObject):
    ...
    mo_meta = MoMeta("FabricSanPinGroupOperation", "fabricSanPinGroupOperation", "remoper-san-pin-group-[name]", VersionMeta.Version141a, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy"], ['fabricSanCloud'], ['fabricSanPinTargetOperation', 'faultInst'], ["Add", "Get", "Remove", "Set"])
