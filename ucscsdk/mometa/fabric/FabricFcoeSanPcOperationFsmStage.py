"""This module contains the general information for FabricFcoeSanPcOperationFsmStage ManagedObject."""
...
class FabricFcoeSanPcOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricFcoeSanPcOperationFsmStage(ManagedObject):
    """This is FabricFcoeSanPcOperationFsmStage class."""

    consts = FabricFcoeSanPcOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricFcoeSanPcOperationFsmStage", "fabricFcoeSanPcOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcoeSanPcOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeSanPcOperationFsmStage", parent_mo_or_dn, **kwargs)
