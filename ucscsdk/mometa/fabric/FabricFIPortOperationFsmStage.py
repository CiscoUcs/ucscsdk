"""This module contains the general information for FabricFIPortOperationFsmStage ManagedObject."""
...
class FabricFIPortOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricFIPortOperationFsmStage(ManagedObject):
    """This is FabricFIPortOperationFsmStage class."""

    consts = FabricFIPortOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricFIPortOperationFsmStage", "fabricFIPortOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFIPortOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFIPortOperationFsmStage", parent_mo_or_dn, **kwargs)
