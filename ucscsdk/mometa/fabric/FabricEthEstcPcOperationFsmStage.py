"""This module contains the general information for FabricEthEstcPcOperationFsmStage ManagedObject."""
...
class FabricEthEstcPcOperationFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
...
class FabricEthEstcPcOperationFsmStage(ManagedObject):
    """This is FabricEthEstcPcOperationFsmStage class."""

    consts = FabricEthEstcPcOperationFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricEthEstcPcOperationFsmStage", "fabricEthEstcPcOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthEstcPcOperationFsm'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthEstcPcOperationFsmStage", parent_mo_or_dn, **kwargs)
