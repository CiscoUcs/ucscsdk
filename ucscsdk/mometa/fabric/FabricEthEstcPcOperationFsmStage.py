...
class FabricEthEstcPcOperationFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEthEstcPcOperationFsmStage", "fabricEthEstcPcOperationFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], ['fabricEthEstcPcOperationFsm'], [], [None])
