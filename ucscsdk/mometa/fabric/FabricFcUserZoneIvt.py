...
class FabricFcUserZoneIvt(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcUserZoneIvt", "fabricFcUserZoneIvt", "zone-ivt-[name]", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcZoneProfileIvt'], [u'storageVsanRefIvt'], [None])
