...
class LicenseFileFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseFileFsmStage", "licenseFileFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'licenseFileFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["ClearBegin", "ClearFail", "ClearLocal", "ClearSuccess", "InstallBegin", "InstallFail", "InstallLocal", "InstallSuccess", "nop"], []), 
