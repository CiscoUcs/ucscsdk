...
class LicenseProp(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseProp", "licenseProp", "prop-[name]", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["read-only"], [u'licenseDownloader', u'licenseInstance'], [], ["Get"])
    ...
    prop_meta = {
        ...
        "value": MoPropertyMeta("value", "value", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    }
