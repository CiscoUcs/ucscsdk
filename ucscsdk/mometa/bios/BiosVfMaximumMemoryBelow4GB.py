...
class BiosVfMaximumMemoryBelow4GB(ManagedObject):
    ...
    prop_meta = {
        ...
        "vp_maximum_memory_below4_gb": MoPropertyMeta("vp_maximum_memory_below4_gb", "vpMaximumMemoryBelow4GB", "string", VersionMeta.Version111a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], []), 
    }
