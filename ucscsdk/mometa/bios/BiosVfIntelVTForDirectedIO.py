...
class BiosVfIntelVTForDirectedIO(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfIntelVTForDirectedIO", "biosVfIntelVTForDirectedIO", "Intel-VT-for-directed-IO", VersionMeta.Version111a, "InputOutput", 0x1ff, [], ["read-only"], [u'biosVProfile'], [], ["Get", "Set"])
