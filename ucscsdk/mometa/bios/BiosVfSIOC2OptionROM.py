...
class BiosVfSIOC2OptionROM(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfSIOC2OptionROM", "biosVfSIOC2OptionROM", "SIOC2-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'biosVProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "vp_sio_c2_option_rom": MoPropertyMeta("vp_sio_c2_option_rom", "vpSIOC2OptionROM", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["disabled", "enabled", "legacy-only", "platform-default", "platform-recommended", "uefi-only"], []), 
    }
