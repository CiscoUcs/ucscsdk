...
class BiosVfProcessorCMCI(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfProcessorCMCI", "biosVfProcessorCMCI", "Processor-CMCI", VersionMeta.Version201a, "InputOutput", 0x1f, [], ["read-only"], [u'biosVProfile'], [], [None])
    ...
    prop_meta = {
        ...
        "vp_processor_cmci": MoPropertyMeta("vp_processor_cmci", "vpProcessorCMCI", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["disabled", "enabled", "platform-default", "platform-recommended"], []), 
    }
