...
class BiosBootDevGrp(ManagedObject):
    ...
    mo_meta = MoMeta("BiosBootDevGrp", "biosBootDevGrp", "bdg-[order]", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["read-only"], [u'biosBOT'], [u'biosBootDev'], ["Get"])
    ...
    prop_meta = {
        ...
        "err_val": MoPropertyMeta("err_val", "errVal", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["FAILURE", "SUCCESS"], []), 
