...
class LstorageLocal(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageLocal", "lstorageLocal", "local", VersionMeta.Version201a, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [], ["add", "get", "remove", "set"])
    ...
    prop_meta = {
        ...
        "security_key": MoPropertyMeta("security_key", "securityKey", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, 32, 32, None, [], []), 
