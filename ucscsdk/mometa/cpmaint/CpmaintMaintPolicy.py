...
class CpmaintMaintPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("CpmaintMaintPolicy", "cpmaintMaintPolicy", "chassis-profile-maint-[name]", VersionMeta.Version151a, "InputOutput", 0x1ff, [], ["read-only"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"])
