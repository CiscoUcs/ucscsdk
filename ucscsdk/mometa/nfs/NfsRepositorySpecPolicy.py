"""This module contains the general information for NfsRepositorySpecPolicy ManagedObject."""
...
class NfsRepositorySpecPolicyConsts():
    INT_ID_NONE = "none"
...
class NfsRepositorySpecPolicy(ManagedObject):
    """This is NfsRepositorySpecPolicy class."""

    consts = NfsRepositorySpecPolicyConsts()
    naming_props = set([])

    mo_meta = MoMeta("NfsRepositorySpecPolicy", "nfsRepositorySpecPolicy", "repository-spec", VersionMeta.Version111a, "InputOutput", 0x3f, [], ["admin", "read-only"], [u'orgDomainGroup'], [], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "NfsRepositorySpecPolicy", parent_mo_or_dn, **kwargs)
