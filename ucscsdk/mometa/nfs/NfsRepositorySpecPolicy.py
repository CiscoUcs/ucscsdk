...
class NfsRepositorySpecPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("NfsRepositorySpecPolicy", "nfsRepositorySpecPolicy", "repository-spec", VersionMeta.Version111a, "InputOutput", 0x3f, [], ["admin", "read-only"], ['orgDomainGroup'], [], [None])
