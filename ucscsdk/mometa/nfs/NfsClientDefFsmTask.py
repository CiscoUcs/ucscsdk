"""This module contains the general information for NfsClientDefFsmTask ManagedObject."""
...
class NfsClientDefFsmTaskConsts():
    COMPLETION_CANCELLED = "cancelled"
    COMPLETION_COMPLETED = "completed"
    COMPLETION_PROCESSING = "processing"
    COMPLETION_SCHEDULED = "scheduled"
    ITEM_ADD_CONFIG = "AddConfig"
    ITEM_DELETE_CONFIG = "DeleteConfig"
    ITEM_NOP = "nop"


class NfsClientDefFsmTask(ManagedObject):
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, None, None, None, None, ["AddConfig", "DeleteConfig", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, item, **kwargs):
        ...
        ManagedObject.__init__(self, "NfsClientDefFsmTask", parent_mo_or_dn, **kwargs)
