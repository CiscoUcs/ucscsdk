"""This module contains the general information for NfsExportDefFsmStage ManagedObject."""
...
class NfsExportDefFsmStageConsts():
    LAST_UPDATE_TIME_ = ""
    NAME_ADD_REPO_BEGIN = "AddRepoBegin"
    NAME_ADD_REPO_FAIL = "AddRepoFail"
    NAME_ADD_REPO_LOCAL = "AddRepoLocal"
    NAME_ADD_REPO_SUCCESS = "AddRepoSuccess"
    NAME_IMAGE_SYNC_BEGIN = "ImageSyncBegin"
    NAME_IMAGE_SYNC_FAIL = "ImageSyncFail"
    NAME_IMAGE_SYNC_LOCAL = "ImageSyncLocal"
    NAME_IMAGE_SYNC_SUCCESS = "ImageSyncSuccess"
    NAME_NOP = "nop"
...
class NfsExportDefFsmStage(ManagedObject):
    """This is NfsExportDefFsmStage class."""

    consts = NfsExportDefFsmStageConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("NfsExportDefFsmStage", "nfsExportDefFsmStage", "stage-[name]", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'nfsExportDefFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version141a, MoPropertyMeta.NAMING, None, None, None, None, ["AddRepoBegin", "AddRepoFail", "AddRepoLocal", "AddRepoSuccess", "ImageSyncBegin", "ImageSyncFail", "ImageSyncLocal", "ImageSyncSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "NfsExportDefFsmStage", parent_mo_or_dn, **kwargs)
