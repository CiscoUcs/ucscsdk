...
class DpsecMac(ManagedObject):
    ...
    mo_meta = MoMeta("DpsecMac", "dpsecMac", "mac-sec", VersionMeta.Version111a, "InputOutput", 0x7f, [], ["admin", "ls-network", "ls-network-policy"], [u'nwctrlDefinition'], [], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "forge": MoPropertyMeta("forge", "forge", "string", VersionMeta.Version111a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["allow", "deny"], []), 
