...
class DpsecMac(ManagedObject):
    ...
    mo_meta = MoMeta("DpsecMac", "dpsecMac", "mac-sec", VersionMeta.Version111a, "InputOutput", 0x7f, [], ["admin", "ls-network", "ls-network-policy"], ['nwctrlDefinition'], [], ["Add", "Get", "Remove", "Set"])
