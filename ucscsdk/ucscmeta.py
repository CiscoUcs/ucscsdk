...
class VersionMeta:
    ...
    Version201a = UcscVersion("2.0(1a)")
...
MO_CLASS_META = {
    ...
    "AdaptorExtEthIfOperation": MoMeta("AdaptorExtEthIfOperation", "adaptorExtEthIfOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'adaptorExtEthIf'], [u'faultInst'], ["get", "set"]),
    ...
    "AdaptorHostEthIfOperation": MoMeta("AdaptorHostEthIfOperation", "adaptorHostEthIfOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'adaptorHostEthIf'], [u'faultInst'], ["get", "set"]),
    ...
    "AdaptorHostFcIfOperation": MoMeta("AdaptorHostFcIfOperation", "adaptorHostFcIfOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'adaptorHostFcIf'], [u'faultInst'], ["get", "set"]),
    ...
    "AdaptorHostIscsiIf": MoMeta("AdaptorHostIscsiIf", "adaptorHostIscsiIf", "host-iscsi-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance", "read-only"], [u'adaptorUnit'], [u'adaptorHostIscsiIfOperation', u'adaptorVlan', u'adaptorVnicStats', u'faultInst'], ["get"]),
    "AdaptorHostIscsiIfOperation": MoMeta("AdaptorHostIscsiIfOperation", "adaptorHostIscsiIfOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance"], [u'adaptorHostIscsiIf'], [u'faultInst'], ["get", "set"]),
    ...
    "AdaptorUnitExtn": MoMeta("AdaptorUnitExtn", "adaptorUnitExtn", "adaptor-extn-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'adaptorUnit'], [], ["get"]),
    ...
    "BiosVfEnergyPerformanceTuning": MoMeta("BiosVfEnergyPerformanceTuning", "biosVfEnergyPerformanceTuning", "Energy-Performance-Tuning", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfEnhancedPowerCappingSupport": MoMeta("BiosVfEnhancedPowerCappingSupport", "biosVfEnhancedPowerCappingSupport", "Enhanced-PowerCapping-Support", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfIOEMezz1OptionROM": MoMeta("BiosVfIOEMezz1OptionROM", "biosVfIOEMezz1OptionROM", "IOEMezz1-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    "BiosVfIOENVMe1OptionROM": MoMeta("BiosVfIOENVMe1OptionROM", "biosVfIOENVMe1OptionROM", "IOENVMe1-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    "BiosVfIOENVMe2OptionROM": MoMeta("BiosVfIOENVMe2OptionROM", "biosVfIOENVMe2OptionROM", "IOENVMe2-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    "BiosVfIOESlot1OptionROM": MoMeta("BiosVfIOESlot1OptionROM", "biosVfIOESlot1OptionROM", "IOESlot1-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    "BiosVfIOESlot2OptionROM": MoMeta("BiosVfIOESlot2OptionROM", "biosVfIOESlot2OptionROM", "IOESlot2-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfOutOfBandManagement": MoMeta("BiosVfOutOfBandManagement", "biosVfOutOfBandManagement", "Out-of-Band-Management", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    "BiosVfPCHSATAMode": MoMeta("BiosVfPCHSATAMode", "biosVfPCHSATAMode", "PCH-SATA-Mode", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfPCIROMCLP": MoMeta("BiosVfPCIROMCLP", "biosVfPCIROMCLP", "PCI-ROM-CLP", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfProcessorCMCI": MoMeta("BiosVfProcessorCMCI", "biosVfProcessorCMCI", "Processor-CMCI", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfRedirectionAfterBIOSPOST": MoMeta("BiosVfRedirectionAfterBIOSPOST", "biosVfRedirectionAfterBIOSPOST", "Redirection-After-BIOS-POST", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfSBMezz1OptionROM": MoMeta("BiosVfSBMezz1OptionROM", "biosVfSBMezz1OptionROM", "SBMezz1-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    "BiosVfSBNVMe1OptionROM": MoMeta("BiosVfSBNVMe1OptionROM", "biosVfSBNVMe1OptionROM", "SBNVMe1-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    "BiosVfSIOC1OptionROM": MoMeta("BiosVfSIOC1OptionROM", "biosVfSIOC1OptionROM", "SIOC1-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    "BiosVfSIOC2OptionROM": MoMeta("BiosVfSIOC2OptionROM", "biosVfSIOC2OptionROM", "SIOC2-OptionROM", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfTPMSupport": MoMeta("BiosVfTPMSupport", "biosVfTPMSupport", "TPM-Support", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "BiosVfWorkloadConfiguration": MoMeta("BiosVfWorkloadConfiguration", "biosVfWorkloadConfiguration", "Workload-Configuration", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'biosVProfile'], [], [None]),
    ...
    "ComputeChassisFeatMask": MoMeta("ComputeChassisFeatMask", "computeChassisFeatMask", "chassis-feat-mask", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'computeSystem', u'equipmentChassis', u'equipmentChassisProfile', u'extpolDomain'], [], ["get"]),
    ...
    "ComputeDomainHwChangeDiscPolicy": MoMeta("ComputeDomainHwChangeDiscPolicy", "computeDomainHwChangeDiscPolicy", "hw-change-disc-policy-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "domain-group-management", "pn-policy", "read-only"], [u'orgDomainGroup', u'orgOrg'], [], ["add", "get", "remove", "set"]),
    ...
    "ComputeDomainPortDiscPolicy": MoMeta("ComputeDomainPortDiscPolicy", "computeDomainPortDiscPolicy", "port-discovery-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "domain-group-management", "pn-policy"], [u'orgDomainGroup', u'orgOrg'], [], ["add", "get", "remove", "set"]),
    ...
    "ComputeFabricEthMonSrcEp": MoMeta("ComputeFabricEthMonSrcEp", "computeFabricEthMonSrcEp", "src-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'computeFabricEthMonSrcEpCont'], [], [None]),
    "ComputeFabricEthMonSrcEpCont": MoMeta("ComputeFabricEthMonSrcEpCont", "computeFabricEthMonSrcEpCont", "eth-mon", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "operations"], [u'computeSystem'], [u'computeFabricEthMonSrcEp'], [None]),
    "ComputeFabricFcMonSrcEp": MoMeta("ComputeFabricFcMonSrcEp", "computeFabricFcMonSrcEp", "src-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'computeFabricFcMonSrcEpCont'], [], [None]),
    "ComputeFabricFcMonSrcEpCont": MoMeta("ComputeFabricFcMonSrcEpCont", "computeFabricFcMonSrcEpCont", "fc-mon", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "operations"], [u'computeSystem'], [u'computeFabricFcMonSrcEp'], [None]),
    "ComputeFactoryResetOp": MoMeta("ComputeFactoryResetOp", "computeFactoryResetOp", "factory-reset-remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'faultInst'], ["get", "set"]),
    ...
    "ComputeGraphicsCardPolicy": MoMeta("ComputeGraphicsCardPolicy", "computeGraphicsCardPolicy", "graphics-card-policy-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-server-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'orgOrg'], [], ["add", "get", "remove", "set"]),
    ...
    "ComputeGroupMembershipRef": MoMeta("ComputeGroupMembershipRef", "computeGroupMembershipRef", "membershipref-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'orgDomainGroup'], [], ["get"]),
    "ComputeHwChangeDiscPolicy": MoMeta("ComputeHwChangeDiscPolicy", "computeHwChangeDiscPolicy", "hw-change-disc-policy", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "domain-group-management", "pn-policy", "read-only"], [u'orgDomainGroup', u'orgOrg'], [], ["add", "get", "remove", "set"]),
    ...
    "ComputePhysicalExtension": MoMeta("ComputePhysicalExtension", "computePhysicalExtension", "phys-extension", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], ["get"]),
    ...
    "ComputePortDiscPolicy": MoMeta("ComputePortDiscPolicy", "computePortDiscPolicy", "port-discovery", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "domain-group-management", "pn-policy", "read-only"], [u'orgDomainGroup', u'orgOrg'], [], ["get", "set"]),
    "ComputePowerSyncDef": MoMeta("ComputePowerSyncDef", "computePowerSyncDef", "power-sync-def", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config-policy", "ls-server", "ls-server-policy"], [u'lsServer'], [], [None]),
    "ComputePowerSyncPolicy": MoMeta("ComputePowerSyncPolicy", "computePowerSyncPolicy", "power-sync-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config-policy", "ls-server", "ls-server-policy"], [u'orgOrg'], [], ["add", "get", "remove", "set"]),
    ...
    "ComputeRebootLog": MoMeta("ComputeRebootLog", "computeRebootLog", "reboot-log-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], ["get"]),
    ...
    "ConfigNetRefItem": MoMeta("ConfigNetRefItem", "configNetRefItem", "", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [], [], [None]),
    ...
    "ConfigSpotLightItem": MoMeta("ConfigSpotLightItem", "configSpotLightItem", "spotlight-[composite_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
    ...
    "DcxVIf": MoMeta("DcxVIf", "dcxVIf", "vif-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'adaptorExtEthIf', u'adaptorHostEthIf', u'adaptorHostFcIf'], [], ["get"]),
    ...
    "DiagLogEp": MoMeta("DiagLogEp", "diagLogEp", "logep-[switch_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], [""], [u'diagRslt'], [], ["get"]),
    "DiagMemoryTest": MoMeta("DiagMemoryTest", "diagMemoryTest", "test-[order]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'diagRunPolicy'], [], ["get"]),
    "DiagRslt": MoMeta("DiagRslt", "diagRslt", "rslt-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], [""], [u'diagSrvCtrl'], [u'diagLogEp'], ["get"]),
    "DiagRunPolicy": MoMeta("DiagRunPolicy", "diagRunPolicy", "diag-policy-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'diagSrvCtrl', u'orgDomainGroup', u'orgOrg'], [u'diagMemoryTest'], ["get", "set"]),
    "DiagSrvCapProvider": MoMeta("DiagSrvCapProvider", "diagSrvCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentFruVariant', u'equipmentManufacturingDef', u'equipmentPicture'], ["get"]),
    "DiagSrvCtrl": MoMeta("DiagSrvCtrl", "diagSrvCtrl", "diag", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'diagRslt', u'diagRunPolicy', u'diagSrvCtrlOperation', u'etherServerIntFIo'], ["get"]),
    "DiagSrvCtrlOperation": MoMeta("DiagSrvCtrlOperation", "diagSrvCtrlOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance"], [u'diagSrvCtrl'], [u'diagSrvCtrlOperationFsm', u'diagSrvCtrlOperationFsmTask', u'eventInst', u'faultInst'], ["get", "set"]),
    "DiagSrvCtrlOperationFsm": MoMeta("DiagSrvCtrlOperationFsm", "diagSrvCtrlOperationFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'diagSrvCtrlOperation'], [u'diagSrvCtrlOperationFsmStage'], [None]),
    "DiagSrvCtrlOperationFsmStage": MoMeta("DiagSrvCtrlOperationFsmStage", "diagSrvCtrlOperationFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'diagSrvCtrlOperationFsm'], [], [None]),
    "DiagSrvCtrlOperationFsmTask": MoMeta("DiagSrvCtrlOperationFsmTask", "diagSrvCtrlOperationFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'diagSrvCtrlOperation'], [], [None]),
    "DomainChassisFeature": MoMeta("DomainChassisFeature", "domainChassisFeature", "chassis-feature-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], [""], [u'computeSystem', u'domainFeatureCatalog', u'extpolDomain'], [u'domainChassisParam', u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["get"]),
    ...
    "DomainProfile": MoMeta("DomainProfile", "domainProfile", "domain-profile-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "domain-group-management"], [u'fabricSystem', u'orgDomainGroup'], [u'domainProfileFsm', u'domainProfileFsmTask', u'eventInst', u'faultInst', u'messageEp'], ["get", "set"]),
    "DomainProfileFsm": MoMeta("DomainProfileFsm", "domainProfileFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'domainProfile'], [u'domainProfileFsmStage'], [None]),
    "DomainProfileFsmStage": MoMeta("DomainProfileFsmStage", "domainProfileFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'domainProfileFsm'], [], [None]),
    "DomainProfileFsmTask": MoMeta("DomainProfileFsmTask", "domainProfileFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'domainProfile'], [], [None]),
    ...
    "EquipmentComputeConn": MoMeta("EquipmentComputeConn", "equipmentComputeConn", "compute-conn", VersionMeta.Version201a, "InputOutput", 0x1, [], [""], [u'equipmentChassis'], [], ["get"]),
    "EquipmentComputeConnPolicy": MoMeta("EquipmentComputeConnPolicy", "equipmentComputeConnPolicy", "compute-conn-policy-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [], ["add", "get", "remove", "set"]),
    "EquipmentDriveSecCap": MoMeta("EquipmentDriveSecCap", "equipmentDriveSecCap", "drive-sec-cap", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'equipmentBladeCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentRackUnitCapProvider'], [], ["get"]),
    ...
    "EquipmentFruVariant": MoMeta("EquipmentFruVariant", "equipmentFruVariant", "fruVariant-[type]", VersionMeta.Version201a, "InputOutput", 0x1, [], [""], [u'adaptorFruCapProvider', u'diagSrvCapProvider', u'equipmentBladeCapProvider', u'equipmentChassisCapProvider', u'equipmentFanModuleCapProvider', u'equipmentFexCapProvider', u'equipmentGemCapProvider', u'equipmentHostIfCapProvider', u'equipmentIOCardCapProvider', u'equipmentLocalDiskCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentMemoryUnitCapProvider', u'equipmentProcessorUnitCapProvider', u'equipmentPsuCapProvider', u'equipmentRackUnitCapProvider', u'equipmentServerUnitCapProvider', u'equipmentSwitchCapProvider', u'equipmentSwitchIOCardCapProvider', u'equipmentSystemFruCapProvider'], [], ["get"]),
    ...
    "FabricFcEndpoint": MoMeta("FabricFcEndpoint", "fabricFcEndpoint", "endpoint-[wwpn]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcUserZone'], [], [None]),
    ...
    "FabricFcUserZone": MoMeta("FabricFcUserZone", "fabricFcUserZone", "zone-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcZoneProfile'], [u'fabricFcEndpoint', u'messageEp', u'storageVsanRef'], [None]),
    "FabricFcUserZoneIvt": MoMeta("FabricFcUserZoneIvt", "fabricFcUserZoneIvt", "zone-ivt-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcZoneProfileIvt'], [u'storageVsanRefIvt'], [None]),
    ...
    "FabricFcZoneProfile": MoMeta("FabricFcZoneProfile", "fabricFcZoneProfile", "zone-profile-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstcCloud'], [u'eventInst', u'fabricFcUserZone', u'fabricFcZoneProfileFsm', u'fabricFcZoneProfileFsmTask', u'faultInst'], [None]),
    "FabricFcZoneProfileFsm": MoMeta("FabricFcZoneProfileFsm", "fabricFcZoneProfileFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fabricFcZoneProfile'], [u'fabricFcZoneProfileFsmStage'], [None]),
    "FabricFcZoneProfileFsmStage": MoMeta("FabricFcZoneProfileFsmStage", "fabricFcZoneProfileFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fabricFcZoneProfileFsm'], [], [None]),
    "FabricFcZoneProfileFsmTask": MoMeta("FabricFcZoneProfileFsmTask", "fabricFcZoneProfileFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fabricFcZoneProfile'], [], [None]),
    "FabricFcZoneProfileIvt": MoMeta("FabricFcZoneProfileIvt", "fabricFcZoneProfileIvt", "zone-profile-ivt-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstcCloud'], [u'fabricFcUserZoneIvt'], [None]),
    ...
    "FabricNetGroupEp": MoMeta("FabricNetGroupEp", "fabricNetGroupEp", "ng-ep-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'fabricEthLanEp', u'fabricEthLanPc'], [], [None]),
    "FabricNetGroupPermit": MoMeta("FabricNetGroupPermit", "fabricNetGroupPermit", "ng-permit-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], [""], [u'orgOrg'], [], [None]),
    "FabricNetGroupRef": MoMeta("FabricNetGroupRef", "fabricNetGroupRef", "net-group-ref-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "ls-config", "ls-network", "ls-server"], [u'dcxVc', u'vnicEther', u'vnicLanConnTempl', u'vnicSanConnTempl'], [u'faultInst'], [None]),
    "FabricNetGroupReq": MoMeta("FabricNetGroupReq", "fabricNetGroupReq", "ngreq-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "ls-network"], [u'orgOrg'], [], [None]),
    ...
    "FabricSanGroup": MoMeta("FabricSanGroup", "fabricSanGroup", "san-group-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [], [], [None]),
    "FabricSanGroupRef": MoMeta("FabricSanGroupRef", "fabricSanGroupRef", "san-group-ref-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'dcxVc', u'vnicLanConnTempl', u'vnicSanConnTempl'], [u'faultInst'], [None]),
    ...
    "FdBlade": MoMeta("FdBlade", "fdBlade", "blade-[slot_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fdChassis'], [u'eventInst', u'faultInst', u'fdBladeFsm', u'fdPhysicalFsm', u'fdPhysicalFsmTask', u'identRequestEp', u'messageEp', u'vnicMgmt', u'vnicOutbandMgmtEp'], ["get"]),
    "FdBladeFsm": MoMeta("FdBladeFsm", "fdBladeFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fdBlade'], [u'fdBladeFsmStage'], [None]),
    "FdBladeFsmStage": MoMeta("FdBladeFsmStage", "fdBladeFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fdBladeFsm'], [], [None]),
    "FdChassis": MoMeta("FdChassis", "fdChassis", "chassis-[chassis_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricSystem'], [u'fdBlade', u'messageEp'], ["get"]),
    "FdPhysicalFsm": MoMeta("FdPhysicalFsm", "fdPhysicalFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fdBlade', u'fdRackUnit'], [u'fdPhysicalFsmStage'], [None]),
    "FdPhysicalFsmStage": MoMeta("FdPhysicalFsmStage", "fdPhysicalFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fdPhysicalFsm'], [], [None]),
    "FdPhysicalFsmTask": MoMeta("FdPhysicalFsmTask", "fdPhysicalFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fdBlade', u'fdRackUnit'], [], [None]),
    "FdRackUnit": MoMeta("FdRackUnit", "fdRackUnit", "rack-unit-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricSystem'], [u'eventInst', u'faultInst', u'fdPhysicalFsm', u'fdPhysicalFsmTask', u'fdRackUnitFsm', u'identRequestEp', u'messageEp', u'vnicMgmt', u'vnicOutbandMgmtEp'], ["get"]),
    "FdRackUnitFsm": MoMeta("FdRackUnitFsm", "fdRackUnitFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fdRackUnit'], [u'fdRackUnitFsmStage'], [None]),
    "FdRackUnitFsmStage": MoMeta("FdRackUnitFsmStage", "fdRackUnitFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'fdRackUnitFsm'], [], [None]),
    ...
    "FeatureChassisDef": MoMeta("FeatureChassisDef", "featureChassisDef", "chassis-feature-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'featureCatalogEp'], [u'domainChassisParam', u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["get"]),
    ...
    "FirmwareAck": MoMeta("FirmwareAck", "firmwareAck", "ack", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'fabricLanCloud', u'fabricSanCloud', u'firmwareSystem', u'qosclassDefinition'], [u'faultInst'], ["get", "set"]),
    ...
    "GlAppendRule": MoMeta("GlAppendRule", "glAppendRule", "appendrule", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glPolicyNameRuleEp'], [], [None]),
    "GlBlockEp": MoMeta("GlBlockEp", "glBlockEp", "blockep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicyResolutionEp'], [u'glBlockOp'], [None]),
    "GlBlockOp": MoMeta("GlBlockOp", "glBlockOp", "block-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glBlockEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlByMo": MoMeta("GlByMo", "glByMo", "by-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicyOp', u'glPolicyResOp', u'glRefsEp'], [], [None]),
    "GlComplexRefEp": MoMeta("GlComplexRefEp", "glComplexRefEp", "crefep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicyResOp'], [u'glIdRefEp', u'glPolicyRefEp'], [None]),
    "GlConflictEp": MoMeta("GlConflictEp", "glConflictEp", "cep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glBlockOp', u'glIdentCtxOp', u'glIdentCtxResOp', u'glPolicyAlgorithmedOp', u'glPolicyOp', u'glPolicyResOp', u'glPoolOp', u'glServerPoolResOp', u'glTemplateOp', u'glTemplateResOp', u'glVxanOp', u'glVxanResOp'], [], [None]),
    "GlConflictResolutionRuleEp": MoMeta("GlConflictResolutionRuleEp", "glConflictResolutionRuleEp", "ruleep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glDomainEp'], [u'glPolicyNameRuleEp'], [None]),
    "GlDomainEp": MoMeta("GlDomainEp", "glDomainEp", "domain-[domain_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glEp'], [u'glConflictResolutionRuleEp', u'glRequest'], [None]),
    "GlEp": MoMeta("GlEp", "glEp", "gl", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'topRoot'], [u'glDomainEp', u'glRequestVnetEpHolder'], [None]),
    "GlGlobalDefaultPolicyEp": MoMeta("GlGlobalDefaultPolicyEp", "glGlobalDefaultPolicyEp", "gdpep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicyResolutionEp'], [u'glPolicyResOp'], [None]),
    "GlIdRef": MoMeta("GlIdRef", "glIdRef", "iref-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glIdRefEp'], [], [None]),
    "GlIdRefEp": MoMeta("GlIdRefEp", "glIdRefEp", "irefep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glComplexRefEp'], [u'glIdRef'], [None]),
    "GlIdentCtxEp": MoMeta("GlIdentCtxEp", "glIdentCtxEp", "icp", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glOperationEp', u'glPolicyResolutionEp', u'glServiceProfile'], [u'glIdentCtxOp', u'glIdentCtxResOp'], [None]),
    "GlIdentCtxOp": MoMeta("GlIdentCtxOp", "glIdentCtxOp", "icop-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glIdentCtxEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlIdentCtxResOp": MoMeta("GlIdentCtxResOp", "glIdentCtxResOp", "icrop-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glIdentCtxEp'], [u'eventInst', u'faultInst', u'glConflictEp', u'glIdentCtxResOpFsm', u'glIdentCtxResOpFsmTask', u'glRefsEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlIdentCtxResOpFsm": MoMeta("GlIdentCtxResOpFsm", "glIdentCtxResOpFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glIdentCtxResOp'], [u'glIdentCtxResOpFsmStage'], [None]),
    "GlIdentCtxResOpFsmStage": MoMeta("GlIdentCtxResOpFsmStage", "glIdentCtxResOpFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glIdentCtxResOpFsm'], [], [None]),
    "GlIdentCtxResOpFsmTask": MoMeta("GlIdentCtxResOpFsmTask", "glIdentCtxResOpFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glIdentCtxResOp'], [], [None]),
    "GlInventoryEp": MoMeta("GlInventoryEp", "glInventoryEp", "inv-[internal_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPathEp', u'glRequest'], [u'glPolicyInvEp', u'glPoolInvEp', u'glSPInvEp'], [None]),
    "GlLsp": MoMeta("GlLsp", "glLsp", "lsp-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glRequest'], [u'glOperationEp'], [None]),
    "GlMcastPolicy": MoMeta("GlMcastPolicy", "glMcastPolicy", "mc-policy[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glVnetInvHolder'], [u'messageEp'], [None]),
    "GlOperationEp": MoMeta("GlOperationEp", "glOperationEp", "opep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glLsp', u'glPolicy', u'glPool', u'glRequest', u'glServiceProfile', u'glVnicTemplate'], [u'glIdentCtxEp', u'glPolicyEp', u'glPoolEp', u'glTemplateEp', u'glVxanEp'], [None]),
    "GlPathEp": MoMeta("GlPathEp", "glPathEp", "path-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glRequest'], [u'glInventoryEp'], [None]),
    "GlPolicy": MoMeta("GlPolicy", "glPolicy", "policy-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicyInvEp'], [u'glOperationEp', u'glUsageEp', u'messageEp'], [None]),
    "GlPolicyAlgorithmedOp": MoMeta("GlPolicyAlgorithmedOp", "glPolicyAlgorithmedOp", "paop-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicyEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlPolicyEp": MoMeta("GlPolicyEp", "glPolicyEp", "paep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glOperationEp', u'glPolicyResolutionEp'], [u'glPolicyAlgorithmedOp', u'glPolicyOp', u'glPolicyResOp'], [None]),
    "GlPolicyInvEp": MoMeta("GlPolicyInvEp", "glPolicyInvEp", "policy", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glInventoryEp'], [u'glPolicy'], [None]),
    "GlPolicyNameRuleEp": MoMeta("GlPolicyNameRuleEp", "glPolicyNameRuleEp", "policyep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glConflictResolutionRuleEp'], [u'glAppendRule'], [None]),
    "GlPolicyOp": MoMeta("GlPolicyOp", "glPolicyOp", "pop-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glPolicyEp'], [u'glByMo', u'glConflictEp', u'glRefsEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlPolicyRef": MoMeta("GlPolicyRef", "glPolicyRef", "pref-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicyRefEp'], [], [None]),
    "GlPolicyRefEp": MoMeta("GlPolicyRefEp", "glPolicyRefEp", "prefep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glComplexRefEp'], [u'glPolicyRef'], [None]),
    "GlPolicyResOp": MoMeta("GlPolicyResOp", "glPolicyResOp", "presp-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glGlobalDefaultPolicyEp', u'glPolicyEp'], [u'glByMo', u'glComplexRefEp', u'glConflictEp', u'glRefsEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlPolicyResolutionEp": MoMeta("GlPolicyResolutionEp", "glPolicyResolutionEp", "prep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glRequest'], [u'glBlockEp', u'glGlobalDefaultPolicyEp', u'glIdentCtxEp', u'glPolicyEp', u'glSpDefEp', u'glVxanEp'], [None]),
    "GlPool": MoMeta("GlPool", "glPool", "pool-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPoolInvEp'], [u'glOperationEp', u'messageEp'], [None]),
    "GlPoolEp": MoMeta("GlPoolEp", "glPoolEp", "pep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glOperationEp'], [u'glPoolOp'], [None]),
    "GlPoolInvEp": MoMeta("GlPoolInvEp", "glPoolInvEp", "pool", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glInventoryEp'], [u'glPool'], [None]),
    "GlPoolOp": MoMeta("GlPoolOp", "glPoolOp", "", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPoolEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlRefsEp": MoMeta("GlRefsEp", "glRefsEp", "refsep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glIdentCtxResOp', u'glPolicyOp', u'glPolicyResOp'], [u'glByMo'], [None]),
    "GlRequest": MoMeta("GlRequest", "glRequest", "req-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glDomainEp'], [u'eventInst', u'faultInst', u'glInventoryEp', u'glLsp', u'glOperationEp', u'glPathEp', u'glPolicyResolutionEp', u'glRequestFsm', u'glRequestFsmTask', u'glVnicTemplateEp', u'messageEp'], [None]),
    "GlRequestFsm": MoMeta("GlRequestFsm", "glRequestFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequest'], [u'glRequestFsmStage'], [None]),
    "GlRequestFsmStage": MoMeta("GlRequestFsmStage", "glRequestFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequestFsm'], [], [None]),
    "GlRequestFsmTask": MoMeta("GlRequestFsmTask", "glRequestFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequest'], [], [None]),
    "GlRequestVnetEp": MoMeta("GlRequestVnetEp", "glRequestVnetEp", "req-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glRequestVnetEpHolder'], [u'eventInst', u'faultInst', u'glRequestVnetEpDomainEp', u'glRequestVnetEpFsm', u'glRequestVnetEpFsmTask'], [None]),
    "GlRequestVnetEpDomainEp": MoMeta("GlRequestVnetEpDomainEp", "glRequestVnetEpDomainEp", "domain-[domain_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glRequestVnetEp'], [u'eventInst', u'faultInst', u'glRequestVnetEpDomainEpFsm', u'glRequestVnetEpDomainEpFsmTask', u'glVnetInvHolder'], [None]),
    "GlRequestVnetEpDomainEpFsm": MoMeta("GlRequestVnetEpDomainEpFsm", "glRequestVnetEpDomainEpFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequestVnetEpDomainEp'], [u'glRequestVnetEpDomainEpFsmStage'], [None]),
    "GlRequestVnetEpDomainEpFsmStage": MoMeta("GlRequestVnetEpDomainEpFsmStage", "glRequestVnetEpDomainEpFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequestVnetEpDomainEpFsm'], [], [None]),
    "GlRequestVnetEpDomainEpFsmTask": MoMeta("GlRequestVnetEpDomainEpFsmTask", "glRequestVnetEpDomainEpFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequestVnetEpDomainEp'], [], [None]),
    "GlRequestVnetEpFsm": MoMeta("GlRequestVnetEpFsm", "glRequestVnetEpFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequestVnetEp'], [u'glRequestVnetEpFsmStage'], [None]),
    "GlRequestVnetEpFsmStage": MoMeta("GlRequestVnetEpFsmStage", "glRequestVnetEpFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequestVnetEpFsm'], [], [None]),
    "GlRequestVnetEpFsmTask": MoMeta("GlRequestVnetEpFsmTask", "glRequestVnetEpFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'glRequestVnetEp'], [], [None]),
    "GlRequestVnetEpHolder": MoMeta("GlRequestVnetEpHolder", "glRequestVnetEpHolder", "reqholder", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glEp'], [u'glRequestVnetEp'], [None]),
    "GlRequestor": MoMeta("GlRequestor", "glRequestor", "", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glRequestorEp'], [], [None]),
    ...
    "GlSPInvEp": MoMeta("GlSPInvEp", "glSPInvEp", "sp", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glInventoryEp'], [u'glServiceProfile'], [None]),
    "GlServerPoolResOp": MoMeta("GlServerPoolResOp", "glServerPoolResOp", "svrprp", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glSpDefEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlServiceProfile": MoMeta("GlServiceProfile", "glServiceProfile", "sp-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glSPInvEp'], [u'glIdentCtxEp', u'glOperationEp', u'messageEp'], [None]),
    "GlSpDefEp": MoMeta("GlSpDefEp", "glSpDefEp", "spep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicyResolutionEp'], [u'glServerPoolResOp', u'glTemplateResOp'], [None]),
    "GlTemplateEp": MoMeta("GlTemplateEp", "glTemplateEp", "tep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glOperationEp'], [u'glTemplateOp'], [None]),
    "GlTemplateOp": MoMeta("GlTemplateOp", "glTemplateOp", "", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glTemplateEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlTemplateResOp": MoMeta("GlTemplateResOp", "glTemplateResOp", "temprp", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glSpDefEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlUsage": MoMeta("GlUsage", "glUsage", "sp-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glUsageEp'], [], [None]),
    "GlUsageEp": MoMeta("GlUsageEp", "glUsageEp", "uep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glPolicy'], [u'glUsage'], [None]),
    "GlVlan": MoMeta("GlVlan", "glVlan", "vlan-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glVnetInvHolder'], [u'messageEp'], [None]),
    "GlVnetInvHolder": MoMeta("GlVnetInvHolder", "glVnetInvHolder", "vnet", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glRequestVnetEpDomainEp'], [u'glMcastPolicy', u'glVlan', u'glVsan'], [None]),
    "GlVnicTemplate": MoMeta("GlVnicTemplate", "glVnicTemplate", "vt-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glVnicTemplateEp'], [u'glOperationEp'], [None]),
    "GlVnicTemplateEp": MoMeta("GlVnicTemplateEp", "glVnicTemplateEp", "vtep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glRequest'], [u'glVnicTemplate'], [None]),
    "GlVsan": MoMeta("GlVsan", "glVsan", "vsan-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glVnetInvHolder'], [u'messageEp'], [None]),
    "GlVxanEp": MoMeta("GlVxanEp", "glVxanEp", "vxep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'glOperationEp', u'glPolicyResolutionEp'], [u'glVxanOp', u'glVxanResOp'], [None]),
    "GlVxanOp": MoMeta("GlVxanOp", "glVxanOp", "vxanop-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glVxanEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    "GlVxanResOp": MoMeta("GlVxanResOp", "glVxanResOp", "vxanresop-[id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'glVxanEp'], [u'glConflictEp', u'glRequestorEp', u'messageEp'], [None]),
    ...
    "InbandPolicy": MoMeta("InbandPolicy", "inbandPolicy", "inband-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'orgDomainGroup'], [], ["get", "set"]),
    ...
    "InventoryDomainEp": MoMeta("InventoryDomainEp", "inventoryDomainEp", "domain-[sys_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "operations"], [u'inventoryHolder'], [u'inventoryInventoryMoMeta'], ["get", "set"]),
    "InventoryEp": MoMeta("InventoryEp", "inventoryEp", "inventory", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "operations"], [u'topRoot'], [u'inventoryHolder'], ["get"]),
    "InventoryGlobalEp": MoMeta("InventoryGlobalEp", "inventoryGlobalEp", "global-ep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "operations"], [u'inventoryHolder'], [u'inventoryInventoryMoMeta'], [None]),
    "InventoryHolder": MoMeta("InventoryHolder", "inventoryHolder", "holder-[type]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "operations"], [u'inventoryEp'], [u'inventoryDomainEp', u'inventoryGlobalEp'], [None]),
    "InventoryInventoryMoMeta": MoMeta("InventoryInventoryMoMeta", "inventoryInventoryMoMeta", "mo-[inst_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "operations"], [u'inventoryDomainEp', u'inventoryGlobalEp'], [], [None]),
    ...
    "LstorageDriveSecurity": MoMeta("LstorageDriveSecurity", "lstorageDriveSecurity", "drive", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageSecurity'], [u'lstorageLocal', u'lstorageRemote'], ["add", "get", "remove"]),
    ...
    "LstorageLocal": MoMeta("LstorageLocal", "lstorageLocal", "local", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [], ["add", "get", "remove", "set"]),
    "LstorageLocalDef": MoMeta("LstorageLocalDef", "lstorageLocalDef", "local-def", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard'], [], [None]),
    ...
    "LstorageLogin": MoMeta("LstorageLogin", "lstorageLogin", "login", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageRemote', u'lstorageRemoteDef'], [], ["add", "get", "remove", "set"]),
    ...
    "LstorageRemote": MoMeta("LstorageRemote", "lstorageRemote", "remote", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard', u'lstorageDriveSecurity'], [u'lstorageLogin'], ["add", "get", "remove", "set"]),
    "LstorageRemoteDef": MoMeta("LstorageRemoteDef", "lstorageRemoteDef", "remote-def", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBoard'], [u'lstorageLogin'], [None]),
    "LstorageRequestCtx": MoMeta("LstorageRequestCtx", "lstorageRequestCtx", "", VersionMeta.Version131a, "InputOutput", 0x1, [], ["read-only"], [], [], [None]),
    "LstorageSecurity": MoMeta("LstorageSecurity", "lstorageSecurity", "security", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'lstorageProfile', u'lstorageProfileDef', u'storageLocalDiskConfigDef', u'storageLocalDiskConfigPolicy'], [u'lstorageDriveSecurity'], ["add", "get", "remove", "set"]),
    ...
    "MgmtKmip": MoMeta("MgmtKmip", "mgmtKmip", "kmip", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'mgmtSecurity'], [u'mgmtKmipOperation'], ["get"]),
    "MgmtKmipCertPolicy": MoMeta("MgmtKmipCertPolicy", "mgmtKmipCertPolicy", "kmip-cert", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-oper", "ls-server-policy", "read-only"], [u'orgDomainGroup'], [], ["add", "get", "remove", "set"]),
    "MgmtKmipOperation": MoMeta("MgmtKmipOperation", "mgmtKmipOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'mgmtKmip'], [u'faultInst'], ["get", "set"]),
    "MgmtNamedKmipCertPolicy": MoMeta("MgmtNamedKmipCertPolicy", "mgmtNamedKmipCertPolicy", "kmip-cert-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["aaa", "admin", "domain-group-management", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-oper", "ls-server-policy", "read-only"], [u'orgDomainGroup'], [], ["add", "get", "remove", "set"]),
    ...
    "MgmtSecurity": MoMeta("MgmtSecurity", "mgmtSecurity", "sec", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-storage", "ls-storage-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'mgmtKmip'], ["get"]),
    ...
    "NetNetGroupPermit": MoMeta("NetNetGroupPermit", "netNetGroupPermit", "ngperm-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], [""], [u'orgOrg'], [], [None]),
    ...
    "NetworkElementOperation": MoMeta("NetworkElementOperation", "networkElementOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-config"], [u'networkElement'], [u'faultInst'], ["get", "set"]),
    ...
    "PolicyChildClass": MoMeta("PolicyChildClass", "policyChildClass", "child-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'policyDestClass'], [], ["get"]),
    ...
    "PolicyConfigError": MoMeta("PolicyConfigError", "policyConfigError", "policy-error", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'extpolClient'], [u'faultInst'], ["get"]),
    "PolicyContext": MoMeta("PolicyContext", "policyContext", "context-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'policySourceApp'], [u'policyScope'], ["get"]),
    ...
    "PolicyDestClass": MoMeta("PolicyDestClass", "policyDestClass", "dest-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'policyDestEp', u'policyPolicyDestClass'], [u'policyChildClass'], ["get"]),
    "PolicyDestEp": MoMeta("PolicyDestEp", "policyDestEp", "dest-ep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'policyControlEp'], [u'policyDestClass'], ["get"]),
    ...
    "PolicyPolicyDestClass": MoMeta("PolicyPolicyDestClass", "policyPolicyDestClass", "destclass", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'policyScope'], [u'policyDestClass'], ["get"]),
    ...
    "PolicyRequestor": MoMeta("PolicyRequestor", "policyRequestor", "requestor-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'policyScope'], [], ["get"]),
    "PolicyScope": MoMeta("PolicyScope", "policyScope", "scope-[policy_type]-[resolve_type]-[policy_name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'policyContext'], [u'policyPolicyDestClass', u'policyRequestor'], ["get"]),
    ...
    "PolicySourceApp": MoMeta("PolicySourceApp", "policySourceApp", "source-[source_dme]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'policyControlEp'], [u'policyContext'], ["get"]),
    ...
    "QosclassPolicy": MoMeta("QosclassPolicy", "qosclassPolicy", "qosclass-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [u'orgDomainGroup'], [u'qosclassEthBE', u'qosclassEthClassified', u'qosclassFc'], ["add", "get", "remove", "set"]),
    ...
    "StorageDiskEnvStats": MoMeta("StorageDiskEnvStats", "storageDiskEnvStats", "disk-env-stats", VersionMeta.Version201a, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'storageLocalDisk'], [u'storageDiskEnvStatsHist'], [None]),
    "StorageDiskEnvStatsHist": MoMeta("StorageDiskEnvStatsHist", "storageDiskEnvStatsHist", "[id]", VersionMeta.Version201a, "OutputOnly", 0x1, [], ["read-only"], [u'storageDiskEnvStats'], [], [None]),
    ...
    "StorageFlexFlashControllerOperation": MoMeta("StorageFlexFlashControllerOperation", "storageFlexFlashControllerOperation", "remote-oper", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'storageFlexFlashController'], [u'faultInst'], [None]),
    ...
    "StorageNvmeStats": MoMeta("StorageNvmeStats", "storageNvmeStats", "nvme-stats", VersionMeta.Version201a, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'storageController'], [u'storageNvmeStatsHist'], [None]),
    "StorageNvmeStatsHist": MoMeta("StorageNvmeStatsHist", "storageNvmeStatsHist", "[id]", VersionMeta.Version201a, "OutputOnly", 0x1, [], ["read-only"], [u'storageNvmeStats'], [], [None]),
    "StorageNvmeStorage": MoMeta("StorageNvmeStorage", "storageNvmeStorage", "nvme-storage", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController'], [], [None]),
    ...
    "StorageSsdHealthStats": MoMeta("StorageSsdHealthStats", "storageSsdHealthStats", "ssd-health-stats-[id]", VersionMeta.Version201a, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'storageController'], [u'storageSsdHealthStatsHist'], [None]),
    "StorageSsdHealthStatsHist": MoMeta("StorageSsdHealthStatsHist", "storageSsdHealthStatsHist", "[id]", VersionMeta.Version201a, "OutputOnly", 0x1, [], ["read-only"], [u'storageSsdHealthStats'], [], [None]),
    ...
    "StorageVsanRefIvt": MoMeta("StorageVsanRefIvt", "storageVsanRefIvt", "vsan-ref-ivt", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy", "ls-storage", "ls-storage-policy"], [u'fabricFcUserZoneIvt'], [], [None]),
    ...
    "SysdebugDiagnosticLog": MoMeta("SysdebugDiagnosticLog", "sysdebugDiagnosticLog", "diag-log-[name]-[switch_id]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "operations"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], [None]),
    ...
    "VnicIniGrpFcB": MoMeta("VnicIniGrpFcB", "vnicIniGrpFcB", "inigrp-fcb", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-storage"], [u'lsServer', u'vnicFcGroupDef'], [u'fabricEthMonSrcEp', u'fabricFcMonSrcEp', u'faultInst', u'vnicIniGrpFcBIf'], ["get"]),
    "VnicIniGrpFcBIf": MoMeta("VnicIniGrpFcBIf", "vnicIniGrpFcBIf", "inigrp-fcb-if-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'vnicIniGrpFcB'], [u'vnicFault'], ["get"]),
    ...
    "VnicNetGroup": MoMeta("VnicNetGroup", "vnicNetGroup", "ng-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'fabricLanCloud'], [u'vnicEther', u'vnicNetGroupRef'], [None]),
    "VnicNetGroupRef": MoMeta("VnicNetGroupRef", "vnicNetGroupRef", "ngref-[name]", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin"], [u'vnicNetGroup'], [u'vnicEther'], [None]),
    "VnicOutbandMgmtEp": MoMeta("VnicOutbandMgmtEp", "vnicOutbandMgmtEp", "outband-ep", VersionMeta.Version201a, "InputOutput", 0x1, [], ["read-only"], [u'fdBlade', u'fdRackUnit'], [u'eventInst', u'faultInst', u'messageEp', u'vnicIpV4PooledAddr', u'vnicIpV4StaticAddr', u'vnicOutbandMgmtEpFsm', u'vnicOutbandMgmtEpFsmTask'], ["get"]),
    "VnicOutbandMgmtEpFsm": MoMeta("VnicOutbandMgmtEpFsm", "vnicOutbandMgmtEpFsm", "fsm", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'vnicOutbandMgmtEp'], [u'vnicOutbandMgmtEpFsmStage'], [None]),
    "VnicOutbandMgmtEpFsmStage": MoMeta("VnicOutbandMgmtEpFsmStage", "vnicOutbandMgmtEpFsmStage", "stage-[name]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'vnicOutbandMgmtEpFsm'], [], [None]),
    "VnicOutbandMgmtEpFsmTask": MoMeta("VnicOutbandMgmtEpFsmTask", "vnicOutbandMgmtEpFsmTask", "task-[item]", VersionMeta.Version201a, "OutputOnly", 0x1, [], [""], [u'vnicOutbandMgmtEp'], [], [None]),
