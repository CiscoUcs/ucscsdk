...
class VersionMeta:
    ...
    Version210a = UcscVersion("2.1(0a)")
...
MO_CLASS_META = {
    ...
    "AdaptorSriovHpnConnDef": MoMeta("AdaptorSriovHpnConnDef", "adaptorSriovHpnConnDef", "sriov-hpn-conn-def-[con_policy_name]", VersionMeta.Version210a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "read-only"], ['adaptorHostEthIf'], [], [None]),
    ...
    "VnicSriovHpnConPolicy": MoMeta("VnicSriovHpnConPolicy", "vnicSriovHpnConPolicy", "sriov-hpn-con-[name]", VersionMeta.Version210a, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy", "ls-server"], ['orgOrg'], [], [None]),
    "VnicSriovHpnConPolicyRef": MoMeta("VnicSriovHpnConPolicyRef", "vnicSriovHpnConPolicyRef", "sriov-hpn-con-ref", VersionMeta.Version210a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], ['vnicEther', 'vnicLanConnTempl'], ['faultInst'], [None]),
