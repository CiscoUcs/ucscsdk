...
from .ucscentralcoremeta import MoMeta

class VersionMeta:
    """ This class contains all the UcsCentralVersion supported by this package."""
    Version101a = UcsCentralVersion("1.0(1a)")
    Version111a = UcsCentralVersion("1.1(1a)")
    Version111b = UcsCentralVersion("1.1(1b)")
    Version112a = UcsCentralVersion("1.1(2a)")
    Version121a = UcsCentralVersion("1.2(1a)")
    Version121e = UcsCentralVersion("1.2(1e)")
    Version131a = UcsCentralVersion("1.3(1a)")
    Version141a = UcsCentralVersion("1.4(1a)")
...
MO_CLASS_META = {
    ...
    "AdaptorEthAdvFilterProfile": MoMeta("AdaptorEthAdvFilterProfile", "adaptorEthAdvFilterProfile", "eth-adv-filter", None, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIfProfile'], [], [None]),
    ...
    "AdaptorEthInterruptScalingProfile": MoMeta("AdaptorEthInterruptScalingProfile", "adaptorEthInterruptScalingProfile", "eth-interrupt-scaling", None, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-network", "ls-server-policy"], [u'adaptorHostEthIfProfile', u'adaptorUsnicConnDef'], [], [None]),
    ...
    "AdaptorExtEthIf": MoMeta("AdaptorExtEthIf", "adaptorExtEthIf", "ext-eth-[id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance", "read-only"], [u'adaptorUnit'], [u'fabricEthMonSrcEp', u'fabricEthMonSrcEpOperation'], ["Get"]),
    ...
    "AdaptorFcFnicProfile": MoMeta("AdaptorFcFnicProfile", "adaptorFcFnicProfile", "fc-fnic", None, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-server-policy", "ls-storage"], [u'adaptorHostFcIfProfile'], [], [None]),
    ...
    "AdaptorFruCapProvider": MoMeta("AdaptorFruCapProvider", "adaptorFruCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'adaptorCapSpec', u'adaptorIScsiCap', u'adaptorRnicCapSpec', u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "AdaptorHostIfConfig": MoMeta("AdaptorHostIfConfig", "adaptorHostIfConfig", "host-if-config-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], [None]),
    ...
    "AdaptorVlan": MoMeta("AdaptorVlan", "adaptorVlan", "vlan-[id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [u'adaptorHostEthIf'], [u'adaptorEtherIfStats', u'fabricConsumer', u'fabricEtherRef', u'faultInst'], ["Get"]),
    "AdaptorVnicStats": MoMeta("AdaptorVnicStats", "adaptorVnicStats", "virtual-interface-stats", VersionMeta.Version111a, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [u'adaptorHostEthIf', u'adaptorHostFcIf', u'adaptorHostScsiIf', u'vmNic'], [u'adaptorVnicStatsHist'], [None]),
    ...
    "CommDateTimeFsm": MoMeta("CommDateTimeFsm", "commDateTimeFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'commDateTime'], [u'commDateTimeFsmStage'], [None]),
    "CommDateTimeFsmStage": MoMeta("CommDateTimeFsmStage", "commDateTimeFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'commDateTimeFsm'], [], [None]),
    "CommDateTimeFsmTask": MoMeta("CommDateTimeFsmTask", "commDateTimeFsmTask", "task-[item]", None, "OutputOnly", 0x1, [], [""], [u'commDateTime'], [], [None]),
    ...
    "ComputeBoardController": MoMeta("ComputeBoardController", "computeBoardController", "boardController", VersionMeta.Version141a, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeExtBoard', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis'], [u'mgmtController'], ["Get"]),
    ...
    "ComputeChassisConnPolicy": MoMeta("ComputeChassisConnPolicy", "computeChassisConnPolicy", "chassis-conn-policy-chassis-[chassis_id]-fabric-[switch_id]", None, "InputOutput", 0x1, [], ["admin", "domain-group-management", "pn-policy"], [u'computeSystem', u'orgDomainGroup', u'orgOrg'], [u'computeChassisConnPolicyOperation'], [None]),
    "ComputeChassisConnPolicyOperation": MoMeta("ComputeChassisConnPolicyOperation", "computeChassisConnPolicyOperation", "remote-oper", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'computeChassisConnPolicy'], [u'faultInst'], [None]),
    ...
    "ComputeFactoryResetOperation": MoMeta("ComputeFactoryResetOperation", "computeFactoryResetOperation", "factory-reset", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [], [None]),
    ...
    "ComputeQual": MoMeta("ComputeQual", "computeQual", "blade-qualifier-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'adaptorQual', u'computeDomainQual', u'computePhysicalQual', u'memoryQual', u'processorQual', u'storageQual'], ["Add", "Get", "Remove", "Set"]),
    ...
    "ConfigFilterGroup": MoMeta("ConfigFilterGroup", "configFilterGroup", "", None, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
    "ConfigFilterItem": MoMeta("ConfigFilterItem", "configFilterItem", "", None, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
    ...
    "ConfigPolicyUsageItem": MoMeta("ConfigPolicyUsageItem", "configPolicyUsageItem", "policy-usage-item", None, "InputOutput", 0x1, [], ["read-only"], [], [], [None]),
    ...
    "CpmaintAck": MoMeta("CpmaintAck", "cpmaintAck", "ack", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile', u'equipmentInstance'], [u'faultInst'], [None]),
    "CpmaintMaintPolicy": MoMeta("CpmaintMaintPolicy", "cpmaintMaintPolicy", "chassis-profile-maint-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [], [None]),
    "DcxVc": MoMeta("DcxVc", "dcxVc", "vc-[id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [], [], ["Get"]),
    "DomainChassisProfileItem": MoMeta("DomainChassisProfileItem", "domainChassisProfileItem", "CP[chassis_profile_dn]", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-server", "pn-equipment", "pn-maintenance", "pn-policy"], [], [], [None]),
    "DomainEnvironmentFeature": MoMeta("DomainEnvironmentFeature", "domainEnvironmentFeature", "env-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'computeSystem', u'domainFeatureCatalog', u'extpolDomain'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"]),
    "DomainEnvironmentParam": MoMeta("DomainEnvironmentParam", "domainEnvironmentParam", "env-param-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'domainEnvironmentFeature', u'domainFeatureCatalog', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature', u'featureEnvDef', u'featureNetworkDef', u'featureServerDef', u'featureStorageDef'], [], ["Get"]),
    ...
    "DomainFeatureCatalog": MoMeta("DomainFeatureCatalog", "domainFeatureCatalog", "catalog-[version]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'domainEp'], [u'domainEnvironmentFeature', u'domainEnvironmentParam', u'domainNetworkFeature', u'domainNetworkParam', u'domainServerFeature', u'domainServerParam', u'domainStorageFeature', u'domainStorageParam'], ["Get"]),
    "DomainNetworkFeature": MoMeta("DomainNetworkFeature", "domainNetworkFeature", "network-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'computeSystem', u'domainFeatureCatalog', u'extpolDomain'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"]),
    "DomainNetworkParam": MoMeta("DomainNetworkParam", "domainNetworkParam", "network-param-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'domainEnvironmentFeature', u'domainFeatureCatalog', u'domainNetworkFeature', u'domainServerFeature', u'domainStorageFeature', u'featureEnvDef', u'featureNetworkDef', u'featureServerDef', u'featureStorageDef'], [], ["Get"]),
    "DomainServerFeature": MoMeta("DomainServerFeature", "domainServerFeature", "server-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'computeSystem', u'domainFeatureCatalog', u'extpolDomain'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"]),
    ...
    "DomainStorageFeature": MoMeta("DomainStorageFeature", "domainStorageFeature", "storage-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'computeSystem', u'domainFeatureCatalog', u'extpolDomain'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"]),
    ...
    "EquipmentBinding": MoMeta("EquipmentBinding", "equipmentBinding", "chassis", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy", "read-only"], [u'equipmentChassisProfile'], [], [None]),
    "EquipmentBladeCapProvider": MoMeta("EquipmentBladeCapProvider", "equipmentBladeCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentAdvancedBootOrder', u'equipmentCimcVmedia', u'equipmentManufacturingDef', u'equipmentPicture', u'equipmentSecureBoot', u'equipmentServerFeatureCap', u'equipmentStorageProcessorCap'], ["Get"]),
    ...
    "EquipmentCPMeta": MoMeta("EquipmentCPMeta", "equipmentCPMeta", "cpmeta", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'messageEp'], [None]),
    ...
    "EquipmentChassisAssocCtx": MoMeta("EquipmentChassisAssocCtx", "equipmentChassisAssocCtx", "cp-assoc-ctx", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassisProfileAssocCtx'], [], [None]),
    "EquipmentChassisCapProvider": MoMeta("EquipmentChassisCapProvider", "equipmentChassisCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    "EquipmentChassisIssues": MoMeta("EquipmentChassisIssues", "equipmentChassisIssues", "config-issue", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile', u'equipmentInstance'], [], [None]),
    ...
    "EquipmentChassisProfile": MoMeta("EquipmentChassisProfile", "equipmentChassisProfile", "cp-[name]", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentTemplate', u'equipmentTier', u'orgOrg'], [u'cpmaintAck', u'equipmentBinding', u'equipmentCPMeta', u'equipmentChassisIssues', u'equipmentChassisProfileAssocCtx', u'equipmentChassisProfileFsm', u'equipmentChassisProfileFsmTask', u'equipmentRequirement', u'eventInst', u'faultInst', u'lstorageDiskZoningConfigDef'], [None]),
    "EquipmentChassisProfileAssocCtx": MoMeta("EquipmentChassisProfileAssocCtx", "equipmentChassisProfileAssocCtx", "cp-assoc-ctx", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassisProfile'], [u'equipmentChassisAssocCtx'], [None]),
    "EquipmentChassisProfileFsm": MoMeta("EquipmentChassisProfileFsm", "equipmentChassisProfileFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'equipmentChassisProfile'], [u'equipmentChassisProfileFsmStage'], [None]),
    "EquipmentChassisProfileFsmStage": MoMeta("EquipmentChassisProfileFsmStage", "equipmentChassisProfileFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'equipmentChassisProfileFsm'], [], [None]),
    "EquipmentChassisProfileFsmTask": MoMeta("EquipmentChassisProfileFsmTask", "equipmentChassisProfileFsmTask", "task-[item]", None, "OutputOnly", 0x1, [], [""], [u'equipmentChassisProfile'], [], [None]),
    "EquipmentChassisQual": MoMeta("EquipmentChassisQual", "equipmentChassisQual", "chassis-from-[min_id]-to-[max_id]", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'equipmentQual'], [], [None]),
    "EquipmentChassisRequirement": MoMeta("EquipmentChassisRequirement", "equipmentChassisRequirement", "chassis-req-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'equipmentInstance'], [None]),
    ...
    "EquipmentFanModuleCapProvider": MoMeta("EquipmentFanModuleCapProvider", "equipmentFanModuleCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentFexCapProvider": MoMeta("EquipmentFexCapProvider", "equipmentFexCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentGemCapProvider": MoMeta("EquipmentGemCapProvider", "equipmentGemCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture', u'equipmentUnifiedPortCapProvider'], ["Get"]),
    ...
    "EquipmentHostIfCapProvider": MoMeta("EquipmentHostIfCapProvider", "equipmentHostIfCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentIOCardCapProvider": MoMeta("EquipmentIOCardCapProvider", "equipmentIOCardCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentInstance": MoMeta("EquipmentInstance", "equipmentInstance", "inst-[id]", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server"], [u'equipmentChassisRequirement'], [u'cpmaintAck', u'equipmentChassisIssues'], [None]),
    "EquipmentInstanceMapping": MoMeta("EquipmentInstanceMapping", "equipmentInstanceMapping", "instmap-[name]", None, "InputOutput", 0x1, [], ["admin"], [u'computeSystem'], [], [None]),
    "EquipmentLocalDiskCapProvider": MoMeta("EquipmentLocalDiskCapProvider", "equipmentLocalDiskCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentLocalDiskDef', u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    "EquipmentLocalDiskControllerCapProvider": MoMeta("EquipmentLocalDiskControllerCapProvider", "equipmentLocalDiskControllerCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPciDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentLocalTemplDef": MoMeta("EquipmentLocalTemplDef", "equipmentLocalTemplDef", "inst-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentTemplate'], [], [None]),
    ...
    "EquipmentManufacturingDef": MoMeta("EquipmentManufacturingDef", "equipmentManufacturingDef", "manufacturing", VersionMeta.Version101a, "InputOutput", 0x1, [], [""], [u'adaptorFruCapProvider', u'equipmentBladeCapProvider', u'equipmentChassisCapProvider', u'equipmentFanModuleCapProvider', u'equipmentFexCapProvider', u'equipmentGemCapProvider', u'equipmentHostIfCapProvider', u'equipmentIOCardCapProvider', u'equipmentLocalDiskCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentMemoryUnitCapProvider', u'equipmentProcessorUnitCapProvider', u'equipmentPsuCapProvider', u'equipmentRackUnitCapProvider', u'equipmentServerUnitCapProvider', u'equipmentSwitchCapProvider', u'equipmentSwitchIOCardCapProvider', u'equipmentSystemFruCapProvider'], [], ["Get"]),
    "EquipmentMemoryUnitCapProvider": MoMeta("EquipmentMemoryUnitCapProvider", "equipmentMemoryUnitCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentPciDef": MoMeta("EquipmentPciDef", "equipmentPciDef", "pci-[name]", None, "InputOutput", 0x1, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], [None]),
    "EquipmentPhysicalQual": MoMeta("EquipmentPhysicalQual", "equipmentPhysicalQual", "physicalqual", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'equipmentQual'], [], [None]),
    "EquipmentPicture": MoMeta("EquipmentPicture", "equipmentPicture", "picture-[type]", VersionMeta.Version101a, "InputOutput", 0x1, [], [""], [u'adaptorFruCapProvider', u'equipmentBladeCapProvider', u'equipmentChassisCapProvider', u'equipmentFanModuleCapProvider', u'equipmentFexCapProvider', u'equipmentGemCapProvider', u'equipmentHostIfCapProvider', u'equipmentIOCardCapProvider', u'equipmentLocalDiskCapProvider', u'equipmentLocalDiskControllerCapProvider', u'equipmentMemoryUnitCapProvider', u'equipmentProcessorUnitCapProvider', u'equipmentPsuCapProvider', u'equipmentRackUnitCapProvider', u'equipmentServerUnitCapProvider', u'equipmentSwitchCapProvider', u'equipmentSwitchIOCardCapProvider', u'equipmentSystemFruCapProvider'], [], ["Get"]),
    "EquipmentPool": MoMeta("EquipmentPool", "equipmentPool", "equipment-pool-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [], [None]),
    "EquipmentPoolable": MoMeta("EquipmentPoolable", "equipmentPoolable", "chassis-pool-[id]", None, "InputOutput", 0x1, [], ["read-only"], [], [], [None]),
    "EquipmentPoolingPolicy": MoMeta("EquipmentPoolingPolicy", "equipmentPoolingPolicy", "chassis-pooling-policy-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [], [None]),
    "EquipmentProcessorUnitCapProvider": MoMeta("EquipmentProcessorUnitCapProvider", "equipmentProcessorUnitCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentPsuCapProvider": MoMeta("EquipmentPsuCapProvider", "equipmentPsuCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentQual": MoMeta("EquipmentQual", "equipmentQual", "chassis-qualifier-[name]", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'orgOrg'], [u'equipmentChassisQual', u'equipmentPhysicalQual'], [None]),
    ...
    "EquipmentRequirement": MoMeta("EquipmentRequirement", "equipmentRequirement", "chassis-req", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy", "read-only"], [u'equipmentChassisProfile'], [u'faultInst'], [None]),
    ...
    "EquipmentSiocTempStats": MoMeta("EquipmentSiocTempStats", "equipmentSiocTempStats", "temp-stats", None, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [], [u'equipmentSiocTempStatsHist'], [None]),
    "EquipmentSiocTempStatsHist": MoMeta("EquipmentSiocTempStatsHist", "equipmentSiocTempStatsHist", "[id]", None, "OutputOnly", 0x1, [], ["read-only"], [u'equipmentSiocTempStats'], [], [None]),
    ...
    "EquipmentSwitchCapProvider": MoMeta("EquipmentSwitchCapProvider", "equipmentSwitchCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentBreakoutCap', u'equipmentManufacturingDef', u'equipmentPicture', u'equipmentUnifiedPortCapProvider'], ["Get"]),
    ...
    "EquipmentSwitchIOCardCapProvider": MoMeta("EquipmentSwitchIOCardCapProvider", "equipmentSwitchIOCardCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture', u'equipmentUnifiedPortCapProvider'], ["Get"]),
    "EquipmentSystemFruCapProvider": MoMeta("EquipmentSystemFruCapProvider", "equipmentSystemFruCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version131a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    "EquipmentSystemIOController": MoMeta("EquipmentSystemIOController", "equipmentSystemIOController", "slot-[id]", None, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassis'], [u'equipmentSharedIOModule', u'equipmentSystemIOControllerOperation', u'mgmtController'], [None]),
    "EquipmentSystemIOControllerOperation": MoMeta("EquipmentSystemIOControllerOperation", "equipmentSystemIOControllerOperation", "remote-oper", None, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentSystemIOController'], [u'faultInst'], [None]),
    "EquipmentTemplate": MoMeta("EquipmentTemplate", "equipmentTemplate", "chassis-templ-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'equipmentChassisProfile', u'equipmentLocalTemplDef'], [None]),
    "EquipmentTemplateMapping": MoMeta("EquipmentTemplateMapping", "equipmentTemplateMapping", "chassis-templmap-[name]", None, "InputOutput", 0x1, [], ["admin"], [u'computeSystem'], [], [None]),
    "EquipmentTier": MoMeta("EquipmentTier", "equipmentTier", "cp-tier-[name]", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy"], [u'orgOrg'], [u'equipmentChassisProfile'], [None]),
    ...
    "EtherServerIntFIo": MoMeta("EtherServerIntFIo", "etherServerIntFIo", "port-[port_id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [u'portGroup'], [u'equipmentXcvr', u'etherErrStats', u'etherLossStats', u'etherPauseStats', u'etherRxStats', u'etherTxStats', u'faultInst'], ["Get"]),
    ...
    "ExtpolClient": MoMeta("ExtpolClient", "extpolClient", "client-[id]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'extpolClientCont'], [u'dupeEp', u'eventInst', u'extpolClientFsm', u'extpolClientFsmTask', u'fabricVnetEpSyncEp', u'faultInst', u'mgmtBackup', u'observeObserved', u'policyPolicyScopeCont', u'statsInventoryMeta'], ["Get", "Remove"]),
    ...
    "FabricDceSwSrvPc": MoMeta("FabricDceSwSrvPc", "fabricDceSwSrvPc", "pc-[port_id]", None, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricDceSwSrv'], [u'fabricDceSwSrvPcEp', u'fabricSubGroup'], [None]),
    "FabricDceSwSrvPcEp": MoMeta("FabricDceSwSrvPcEp", "fabricDceSwSrvPcEp", "ep-slot-[slot_id]-port-[port_id]", None, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricDceSwSrvPc', u'fabricSubGroup'], [], [None]),
    "FabricDceSwSrvPcEpOperation": MoMeta("FabricDceSwSrvPcEpOperation", "fabricDceSwSrvPcEpOperation", "remoper-ep-slot-[slot_id]-port-[port_id]", None, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricDceSwSrvPcOperation', u'fabricSubGroup'], [u'faultInst'], [None]),
    ...
    "FabricDceSwSrvPcOperationFsm": MoMeta("FabricDceSwSrvPcOperationFsm", "fabricDceSwSrvPcOperationFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'fabricDceSwSrvPcOperation'], [u'fabricDceSwSrvPcOperationFsmStage'], [None]),
    "FabricDceSwSrvPcOperationFsmStage": MoMeta("FabricDceSwSrvPcOperationFsmStage", "fabricDceSwSrvPcOperationFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'fabricDceSwSrvPcOperationFsm'], [], [None]),
    "FabricDomainEp": MoMeta("FabricDomainEp", "fabricDomainEp", "domain-ep", None, "InputOutput", 0x1, [], ["admin"], [u'fabricHolder'], [u'fabricSystem', u'policyControlEpOp'], [None]),
    ...
    "FabricEthLan": MoMeta("FabricEthLan", "fabricEthLan", "[id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricLanCloud'], [u'fabricEthLanEp', u'fabricEthLanEpOperation', u'fabricEthLanPc', u'fabricEthLanPcOperation', u'fabricSubGroup'], ["Get"]),
    "FabricEthLanEp": MoMeta("FabricEthLanEp", "fabricEthLanEp", "phys-slot-[slot_id]-port-[port_id]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthLan', u'fabricSubGroup'], [u'fabricEthMonSrcEp', u'fabricVlanEp', u'faultInst'], ["Get", "Set"]),
    ...
    "FabricEthLanPc": MoMeta("FabricEthLanPc", "fabricEthLanPc", "pc-[port_id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthLan'], [u'fabricEthLanPcEp', u'fabricEthMonSrcEp', u'fabricSubGroup', u'fabricVlanEp', u'faultInst'], ["Get"]),
    ...
    "FabricEthMon": MoMeta("FabricEthMon", "fabricEthMon", "eth-mon-[name]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthMonLan'], [u'fabricEthMonDestEp', u'fabricEthMonSrcRef', u'fabricSubGroup'], [None]),
    "FabricEthMonDestEp": MoMeta("FabricEthMonDestEp", "fabricEthMonDestEp", "dest-slot-[slot_id]-port-[port_id]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthMon', u'fabricEthMonOperation', u'fabricFcMon', u'fabricSubGroup'], [], [None]),
    "FabricEthMonDestEpOperation": MoMeta("FabricEthMonDestEpOperation", "fabricEthMonDestEpOperation", "remoper-dest-slot-[slot_id]-port-[port_id]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthMonOperation', u'fabricFcMonOperation', u'fabricSubGroup'], [u'faultInst'], [None]),
    "FabricEthMonLan": MoMeta("FabricEthMonLan", "fabricEthMonLan", "[id]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricLanMonCloud'], [u'fabricEthMon', u'fabricEthMonOperation'], [None]),
    "FabricEthMonOperation": MoMeta("FabricEthMonOperation", "fabricEthMonOperation", "remoper-eth-mon-[name]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthMonLan'], [u'eventInst', u'fabricEthMonDestEp', u'fabricEthMonDestEpOperation', u'fabricEthMonOperationFsm', u'fabricEthPortOperationFsm', u'fabricFIPortOperationFsm', u'fabricFIPortOperationFsmTask', u'fabricSubGroup', u'faultInst', u'messageEp', u'vnicEther'], [None]),
    "FabricEthMonOperationFsm": MoMeta("FabricEthMonOperationFsm", "fabricEthMonOperationFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'fabricEthMonOperation'], [u'fabricEthMonOperationFsmStage'], [None]),
    "FabricEthMonOperationFsmStage": MoMeta("FabricEthMonOperationFsmStage", "fabricEthMonOperationFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'fabricEthMonOperationFsm'], [], [None]),
    "FabricEthMonSrcEp": MoMeta("FabricEthMonSrcEp", "fabricEthMonSrcEp", "mon-src-[name]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'adaptorExtEthIf', u'fabricDceSwSrvEp', u'fabricEthEstcEp', u'fabricEthEstcPc', u'fabricEthLanEp', u'fabricEthLanPc', u'fabricFcoeEstcEp', u'fabricFcoeSanEp', u'fabricFcoeSanPc', u'fabricVlan', u'vmNic', u'vnicEther', u'vnicFc', u'vnicIScsi', u'vnicIScsiLCP', u'vnicIniGrpFc', u'vnicLstorageIScsi', u'vnicMgmt', u'vnicMonSesFc'], [], [None]),
    "FabricEthMonSrcEpOperation": MoMeta("FabricEthMonSrcEpOperation", "fabricEthMonSrcEpOperation", "remoper-mon-src-[name]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'adaptorExtEthIf', u'fabricDceSwSrvEp', u'fabricEthEstcEpOperation', u'fabricEthEstcPc', u'fabricEthLanEpOperation', u'fabricEthLanPcOperation', u'fabricFcoeEstcEpOperation', u'fabricFcoeSanEpOperation', u'fabricFcoeSanPcOperation', u'fabricVlan', u'vnicEther'], [u'faultInst'], [None]),
    "FabricEthMonSrcRef": MoMeta("FabricEthMonSrcRef", "fabricEthMonSrcRef", "src-ref-[id]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthMon'], [], [None]),
    ...
    "FabricEthVlanPc": MoMeta("FabricEthVlanPc", "fabricEthVlanPc", "pc-switch-[switch_id]-pc-[port_id]", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricVlan'], [], ["Add", "Get", "Remove", "Set"]),
    "FabricEthVlanPortEp": MoMeta("FabricEthVlanPortEp", "fabricEthVlanPortEp", "phys-switch-[switch_id]-slot-[slot_id]-port-[port_id]", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricSwSubGroup', u'fabricVlan'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "FabricFcEstcCloud": MoMeta("FabricFcEstcCloud", "fabricFcEstcCloud", "fc-estc", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricEp'], [u'fabricFcEstc', u'fabricVsan', u'statsThresholdPolicy'], ["Get"]),
    ...
    "FabricFcMon": MoMeta("FabricFcMon", "fabricFcMon", "fc-mon-[name]", None, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcMonSan'], [u'fabricEthMonDestEp', u'fabricFcMonDestEp', u'fabricFcMonSrcRef', u'fabricSubGroup'], [None]),
    "FabricFcMonDestEp": MoMeta("FabricFcMonDestEp", "fabricFcMonDestEp", "dest-slot-[slot_id]-port-[port_id]", None, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcMon', u'fabricFcMonOperation'], [], [None]),
    "FabricFcMonDestEpOperation": MoMeta("FabricFcMonDestEpOperation", "fabricFcMonDestEpOperation", "remoper-dest-slot-[slot_id]-port-[port_id]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricFcMonOperation', u'fabricSubGroup'], [u'faultInst'], [None]),
    "FabricFcMonOperation": MoMeta("FabricFcMonOperation", "fabricFcMonOperation", "remoper-fc-mon-[name]", None, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcMonSan'], [u'eventInst', u'fabricEthMonDestEpOperation', u'fabricFIPortOperationFsm', u'fabricFIPortOperationFsmTask', u'fabricFcMonDestEp', u'fabricFcMonDestEpOperation', u'fabricFcMonOperationFsm', u'fabricFcPortOperationFsm', u'fabricSubGroup', u'faultInst', u'messageEp', u'vnicFc', u'vnicMonSesFc'], [None]),
    "FabricFcMonOperationFsm": MoMeta("FabricFcMonOperationFsm", "fabricFcMonOperationFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'fabricFcMonOperation'], [u'fabricFcMonOperationFsmStage'], [None]),
    "FabricFcMonOperationFsmStage": MoMeta("FabricFcMonOperationFsmStage", "fabricFcMonOperationFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'fabricFcMonOperationFsm'], [], [None]),
    "FabricFcMonSan": MoMeta("FabricFcMonSan", "fabricFcMonSan", "[id]", None, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSanMonCloud'], [u'fabricFcMon', u'fabricFcMonOperation'], [None]),
    "FabricFcMonSrcEp": MoMeta("FabricFcMonSrcEp", "fabricFcMonSrcEp", "mon-src-[name]", None, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstcEp', u'fabricFcSanEp', u'fabricFcSanPc', u'fabricVsan', u'vmNic', u'vnicEther', u'vnicFc', u'vnicIScsi', u'vnicIScsiLCP', u'vnicIniGrpFc', u'vnicLstorageIScsi', u'vnicMgmt', u'vnicMonSesFc'], [], [None]),
    "FabricFcMonSrcEpOperation": MoMeta("FabricFcMonSrcEpOperation", "fabricFcMonSrcEpOperation", "remoper-mon-src-[name]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricFcEstcEpOperation', u'fabricFcSanEpOperation', u'fabricFcSanPcOperation', u'fabricVsan', u'vnicFc'], [u'faultInst'], [None]),
    "FabricFcMonSrcRef": MoMeta("FabricFcMonSrcRef", "fabricFcMonSrcRef", "src-ref-[id]", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricFcMon'], [], [None]),
    ...
    "FabricHolder": MoMeta("FabricHolder", "fabricHolder", "holder", None, "InputOutput", 0x1, [], ["admin"], [u'topRoot'], [u'fabricDomainEp', u'tagDefEp', u'tagInstanceEp'], [None]),
    ...
    "FabricLanCloudPolicy": MoMeta("FabricLanCloudPolicy", "fabricLanCloudPolicy", "lan-policy", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'orgDomainGroup'], [], ["Get", "Set"]),
    "FabricLanMonCloud": MoMeta("FabricLanMonCloud", "fabricLanMonCloud", "lanmon", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEp'], [u'fabricEthMonLan', u'statsThresholdPolicy'], [None]),
    ...
    "FabricMulticastPolicy": MoMeta("FabricMulticastPolicy", "fabricMulticastPolicy", "mc-policy-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"]),
    "FabricNetGroup": MoMeta("FabricNetGroup", "fabricNetGroup", "net-group-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "FabricPooledVlan": MoMeta("FabricPooledVlan", "fabricPooledVlan", "net-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [], [], ["Add", "Get", "Remove"]),
    "FabricSanCloud": MoMeta("FabricSanCloud", "fabricSanCloud", "san", VersionMeta.Version111a, "InputOutput", 0x1, [], [""], [u'fabricEp'], [u'fabricFcSan', u'fabricFcUplinkOperation', u'fabricSanPinGroup', u'fabricSanPinGroupOperation', u'statsThresholdPolicy'], ["Get", "Set"]),
    "FabricSanMonCloud": MoMeta("FabricSanMonCloud", "fabricSanMonCloud", "sanmon", None, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricEp'], [u'fabricFcMonSan', u'statsThresholdPolicy'], [None]),
    ...
    "FabricSwSubGroup": MoMeta("FabricSwSubGroup", "fabricSwSubGroup", "sw-[switch_id]-slot-[slot_id]-aggr-port-[aggr_port_id]", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricVlan', u'fabricVsan'], [u'fabricEthVlanPortEp', u'fabricFcoeVsanPortEp'], ["Get"]),
    "FabricSystem": MoMeta("FabricSystem", "fabricSystem", "system-[id]", None, "InputOutput", 0x1, [], ["admin"], [u'fabricDomainEp'], [u'fabricEp'], [None]),
    ...
    "FabricVlanReq": MoMeta("FabricVlanReq", "fabricVlanReq", "vlan-req-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ls-network"], [u'orgOrg'], [], ["Add", "Get", "Remove"]),
    ...
    "FeatureCatalogEp": MoMeta("FeatureCatalogEp", "featureCatalogEp", "feature-catalog", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'topSystem'], [u'featureEnvDef', u'featureNetworkDef', u'featureServerDef', u'featureStorageDef'], ["Get"]),
    "FeatureEnvDef": MoMeta("FeatureEnvDef", "featureEnvDef", "env-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'featureCatalogEp'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"]),
    "FeatureNetworkDef": MoMeta("FeatureNetworkDef", "featureNetworkDef", "network-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'featureCatalogEp'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"]),
    "FeatureServerDef": MoMeta("FeatureServerDef", "featureServerDef", "server-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'featureCatalogEp'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"]),
    "FeatureStorageDef": MoMeta("FeatureStorageDef", "featureStorageDef", "storage-feature-[name]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'featureCatalogEp'], [u'domainEnvironmentParam', u'domainNetworkParam', u'domainServerParam', u'domainStorageParam'], ["Get"]),
    ...
    "FirmwareCatalogPackConfig": MoMeta("FirmwareCatalogPackConfig", "firmwareCatalogPackConfig", "fw-catalog-pack-config[name]", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'firmwareDomainInfraProfile', u'orgDomainGroup', u'orgOrg'], [], [None]),
    ...
    "FirmwareChassisComponentSpec": MoMeta("FirmwareChassisComponentSpec", "firmwareChassisComponentSpec", "chassis-component-spec-[type]", None, "InputOutput", 0x1, [], [""], [u'firmwareBundleTypeCapProvider'], [], [None]),
    "FirmwareChassisPack": MoMeta("FirmwareChassisPack", "firmwareChassisPack", "fw-chassis-pack-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'orgDomainGroup', u'orgOrg'], [u'firmwareExcludeChassisComponent'], [None]),
    ...
    "FirmwareConnectionPolicy": MoMeta("FirmwareConnectionPolicy", "firmwareConnectionPolicy", "conn-policy-[type]", None, "InputOutput", 0x1, [], ["admin"], [u'orgDomainGroup'], [], [None]),
    ...
    "FirmwareDomainInfo": MoMeta("FirmwareDomainInfo", "firmwareDomainInfo", "domain-info-[id]", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'firmwareDomainInfraProfile'], [], [None]),
    "FirmwareDomainInfraProfile": MoMeta("FirmwareDomainInfraProfile", "firmwareDomainInfraProfile", "domain-infra-profile-[name]", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'orgOrg'], [u'firmwareCatalogPack', u'firmwareCatalogPackConfig', u'firmwareDomainInfo', u'firmwareProductFamily', u'trigMeta', u'trigSched'], [None]),
    ...
    "FirmwareExcludeChassisComponent": MoMeta("FirmwareExcludeChassisComponent", "firmwareExcludeChassisComponent", "exclude-chassis-component-[chassis_component]", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'firmwareChassisPack'], [], [None]),
    ...
    "FirmwareInfraPackConfig": MoMeta("FirmwareInfraPackConfig", "firmwareInfraPackConfig", "fw-infra-pack-config[name]", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'firmwareProductFamily', u'orgDomainGroup', u'orgOrg'], [], [None]),
    ...
    "FirmwareSystem": MoMeta("FirmwareSystem", "firmwareSystem", "fw-system", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "ls-config-policy", "ls-server-policy"], [u'topSystem'], [u'firmwareInfra'], ["Get"]),
    ...
    "FirmwareUpdatable": MoMeta("FirmwareUpdatable", "firmwareUpdatable", "", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'equipmentPsu', u'storageOnboardDevice'], [], ["Get", "Set"]),
    ...
    "HcAdapterFirmwareItem": MoMeta("HcAdapterFirmwareItem", "hcAdapterFirmwareItem", "adapter-firmware-[item_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcServerComponent'], [u'hcItemNote', u'hcSupportedAdapterFirmwareItem'], [None]),
    "HcAdapterItem": MoMeta("HcAdapterItem", "hcAdapterItem", "adapter-[item_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcServerComponent'], [u'hcItemNote', u'hcSupportedAdapterItem'], [None]),
    "HcAdmin": MoMeta("HcAdmin", "hcAdmin", "hc-admin", None, "InputOutput", 0x1, [], ["read-only"], [u'hcHolder'], [u'hcCleanup'], [None]),
    "HcCatalog": MoMeta("HcCatalog", "hcCatalog", "hc-catalog-[id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcHolder'], [], [None]),
    "HcCatalogList": MoMeta("HcCatalogList", "hcCatalogList", "catalog-list", None, "InputOutput", 0x1, [], ["admin"], [u'hcHolder'], [u'hcCatalogSource'], [None]),
    "HcCatalogSource": MoMeta("HcCatalogSource", "hcCatalogSource", "catalog-source-[type]", None, "InputOutput", 0x1, [], ["admin"], [u'hcCatalogList'], [u'hcDownloadPolicy'], [None]),
    "HcCatalogVersion": MoMeta("HcCatalogVersion", "hcCatalogVersion", "hc-catalog-version-[id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcHolder'], [], [None]),
    "HcCleanup": MoMeta("HcCleanup", "hcCleanup", "cleanup-[ref_dn]", None, "InputOutput", 0x1, [], ["read-only"], [u'hcAdmin'], [], [None]),
    "HcDownloadPolicy": MoMeta("HcDownloadPolicy", "hcDownloadPolicy", "hc-dl-policy-[type]", None, "InputOutput", 0x1, [], ["admin"], [u'hcCatalogSource', u'orgDomainGroup'], [], [None]),
    "HcDownloader": MoMeta("HcDownloader", "hcDownloader", "dnld-[file_name]", None, "InputOutput", 0x1, [], ["admin"], [u'hcHolder'], [], [None]),
    "HcDriverInfoItem": MoMeta("HcDriverInfoItem", "hcDriverInfoItem", "driver-[id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcHolder'], [], [None]),
    "HcDriverItem": MoMeta("HcDriverItem", "hcDriverItem", "driver-[item_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcServerComponent'], [u'hcItemNote', u'hcSupportedDriverItem'], [None]),
    "HcHolder": MoMeta("HcHolder", "hcHolder", "hc-ep", None, "InputOutput", 0x1, [], ["read-only"], [u'topRoot'], [u'hcAdmin', u'hcCatalog', u'hcCatalogList', u'hcCatalogVersion', u'hcDownloader', u'hcDriverInfoItem', u'hcOsInfoItem', u'hcReport', u'hcUcsVersionItem'], [None]),
    "HcItemNote": MoMeta("HcItemNote", "hcItemNote", "note-[ref_item_id]-[id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcAdapterFirmwareItem', u'hcAdapterItem', u'hcDriverItem', u'hcOsItem'], [], [None]),
    "HcOsInfoItem": MoMeta("HcOsInfoItem", "hcOsInfoItem", "os-[id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcHolder'], [], [None]),
    "HcOsItem": MoMeta("HcOsItem", "hcOsItem", "os-[item_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcServerComponent'], [u'hcItemNote', u'hcSupportedOsItem'], [None]),
    "HcReport": MoMeta("HcReport", "hcReport", "report-[name]", None, "InputOutput", 0x1, [], ["admin"], [u'hcHolder'], [u'hcScopeDn', u'hcServerComponent'], [None]),
    "HcScopeDn": MoMeta("HcScopeDn", "hcScopeDn", "scope-dn-[id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcReport'], [], [None]),
    "HcServerComponent": MoMeta("HcServerComponent", "hcServerComponent", "server-[component_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcReport'], [u'hcAdapterFirmwareItem', u'hcAdapterItem', u'hcDriverItem', u'hcOsItem'], [None]),
    "HcSupportedAdapterFirmwareItem": MoMeta("HcSupportedAdapterFirmwareItem", "hcSupportedAdapterFirmwareItem", "supported-adapter-firmware-[item_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcAdapterFirmwareItem'], [], [None]),
    "HcSupportedAdapterItem": MoMeta("HcSupportedAdapterItem", "hcSupportedAdapterItem", "supported-adapter-[item_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcAdapterItem'], [], [None]),
    "HcSupportedDriverItem": MoMeta("HcSupportedDriverItem", "hcSupportedDriverItem", "supported-driver-[item_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcDriverItem'], [], [None]),
    "HcSupportedOsItem": MoMeta("HcSupportedOsItem", "hcSupportedOsItem", "supported-os-[item_id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcOsItem'], [], [None]),
    "HcUcsVersionItem": MoMeta("HcUcsVersionItem", "hcUcsVersionItem", "ucsversion-[id]", None, "InputOutput", 0x1, [], ["admin"], [u'hcHolder'], [], [None]),
    ...
    "IdentRequestEp": MoMeta("IdentRequestEp", "identRequestEp", "IdentQ", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [u'lsServer'], [], [None]),
    ...
    "IppoolBlock": MoMeta("IppoolBlock", "ippoolBlock", "block-[r_from]-[to]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "ls-network-policy"], [u'ippoolPool'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "IppoolIpV6Block": MoMeta("IppoolIpV6Block", "ippoolIpV6Block", "v6block-[r_from]-[to]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin", "ls-network-policy"], [u'ippoolPool'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "IppoolPool": MoMeta("IppoolPool", "ippoolPool", "ip-pool-[name]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'faultInst', u'ippoolBlock', u'ippoolIpV6Block', u'ippoolIpV6Pooled', u'ippoolPooled'], ["Add", "Get", "Remove", "Set"]),
    ...
    "LsIdentityInfo": MoMeta("LsIdentityInfo", "lsIdentityInfo", "ls-identity-info", None, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'lsServer'], [u'faultInst'], [None]),
    ...
    "LsbootEFIShell": MoMeta("LsbootEFIShell", "lsbootEFIShell", "efi-shell", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-config-policy", "ls-server", "ls-server-policy", "ls-storage", "ls-storage-policy"], [u'lsbootDef', u'lsbootPolicy'], [], [None]),
    ...
    "LstorageControllerRef": MoMeta("LstorageControllerRef", "lstorageControllerRef", "server-[server_id]-controller-[controller_type]-[controller_id]", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'lstorageDiskSlot'], [], [None]),
    ...
    "LstorageDiskSlot": MoMeta("LstorageDiskSlot", "lstorageDiskSlot", "disk-slot-[id]", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'lstorageDiskZoningConfigDef', u'lstorageDiskZoningPolicy'], [u'lstorageControllerRef'], [None]),
    "LstorageDiskZoningConfigDef": MoMeta("LstorageDiskZoningConfigDef", "lstorageDiskZoningConfigDef", "disk-zoning-def", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'lstorageDiskSlot'], [None]),
    "LstorageDiskZoningPolicy": MoMeta("LstorageDiskZoningPolicy", "lstorageDiskZoningPolicy", "disk-zoning-policy-[name]", None, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'lstorageDiskSlot'], [None]),
    ...
    "LstorageProfile": MoMeta("LstorageProfile", "lstorageProfile", "profile-[name]", VersionMeta.Version131a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'orgOrg'], [u'lstorageControllerDef', u'lstorageDasScsiLun'], ["Add", "Get", "Remove", "Set"]),
    ...
    "LstorageProfileDef": MoMeta("LstorageProfileDef", "lstorageProfileDef", "profile-def", VersionMeta.Version131a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'lsServer'], [u'lstorageControllerDef', u'lstorageDasScsiLun'], ["Add", "Get", "Remove", "Set"]),
    ...
    "MessageEp": MoMeta("MessageEp", "messageEp", "ep", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentCPMeta', u'fabricDceSwSrvPcOperation', u'fabricEthEstcEpOperation', u'fabricEthEstcPcOperation', u'fabricEthLanEpOperation', u'fabricEthLanPcOperation', u'fabricEthMonOperation', u'fabricFcEstcEpOperation', u'fabricFcMonOperation', u'fabricFcSanEpOperation', u'fabricFcSanPcOperation', u'fabricFcoeEstcEpOperation', u'fabricFcoeSanEpOperation', u'fabricFcoeSanPcOperation', u'lsSPMeta'], [u'messageEntry'], [None]),
    ...
    "MgmtCmcSecureBoot": MoMeta("MgmtCmcSecureBoot", "mgmtCmcSecureBoot", "mgmt-cmc-secure-boot", None, "InputOutput", 0x1, [], ["admin", "ls-compute"], [u'mgmtController'], [u'mgmtCmcSecureBootOperation'], [None]),
    "MgmtCmcSecureBootOperation": MoMeta("MgmtCmcSecureBootOperation", "mgmtCmcSecureBootOperation", "remote-oper", None, "InputOutput", 0x1, [], ["admin", "ls-compute"], [u'mgmtCmcSecureBoot'], [u'faultInst'], [None]),
    ...
    "OrgDomainFirmwareInfo": MoMeta("OrgDomainFirmwareInfo", "orgDomainFirmwareInfo", "domain-fw-info-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'orgMaintTagFirmwareReport'], [], [None]),
    ...
    "OrgMaintTagFirmwareReport": MoMeta("OrgMaintTagFirmwareReport", "orgMaintTagFirmwareReport", "firmware-report-[maint_tag]", None, "InputOutput", 0x1, [], ["read-only"], [], [u'orgDomainFirmwareInfo'], [None]),
    ...
    "PolicyCommunicationOp": MoMeta("PolicyCommunicationOp", "policyCommunicationOp", "comm-ctrl", None, "InputOutput", 0x1, [], ["aaa", "admin"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyControlEpOpFsm": MoMeta("PolicyControlEpOpFsm", "policyControlEpOpFsm", "fsm", None, "OutputOnly", 0x1, [], [""], [u'policyControlEpOp'], [u'policyControlEpOpFsmStage'], [None]),
    "PolicyControlEpOpFsmStage": MoMeta("PolicyControlEpOpFsmStage", "policyControlEpOpFsmStage", "stage-[name]", None, "OutputOnly", 0x1, [], [""], [u'policyControlEpOpFsm'], [], [None]),
    "PolicyControlEpOpFsmTask": MoMeta("PolicyControlEpOpFsmTask", "policyControlEpOpFsmTask", "task-[item]", None, "OutputOnly", 0x1, [], [""], [u'policyControlEpOp'], [], [None]),
    ...
    "PolicyDateTimeOp": MoMeta("PolicyDateTimeOp", "policyDateTimeOp", "datetime-ctrl", None, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-security", "operations"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyDiscoveryOp": MoMeta("PolicyDiscoveryOp", "policyDiscoveryOp", "discovery-ctrl", None, "InputOutput", 0x1, [], ["admin", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyDnsOp": MoMeta("PolicyDnsOp", "policyDnsOp", "dns-ctrl", None, "InputOutput", 0x1, [], ["aaa", "admin", "ext-lan-config"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyEquipmentOp": MoMeta("PolicyEquipmentOp", "policyEquipmentOp", "equipment-ctrl", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyFaultOp": MoMeta("PolicyFaultOp", "policyFaultOp", "fault-ctrl", None, "InputOutput", 0x1, [], ["admin", "fault"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyInfraFirmwareOp": MoMeta("PolicyInfraFirmwareOp", "policyInfraFirmwareOp", "fabric-fw-ctrl", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyMEpOp": MoMeta("PolicyMEpOp", "policyMEpOp", "mep-ctrl", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyMonitoringOp": MoMeta("PolicyMonitoringOp", "policyMonitoringOp", "monitoring-ctrl", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyPortConfigOp": MoMeta("PolicyPortConfigOp", "policyPortConfigOp", "portconfig-ctrl", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyPowerMgmtOp": MoMeta("PolicyPowerMgmtOp", "policyPowerMgmtOp", "powermgmt-ctrl", None, "InputOutput", 0x1, [], ["admin", "power-mgmt"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyPsuOp": MoMeta("PolicyPsuOp", "policyPsuOp", "psu-ctrl", None, "InputOutput", 0x1, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicySecurityOp": MoMeta("PolicySecurityOp", "policySecurityOp", "security-ctrl", None, "InputOutput", 0x1, [], ["aaa", "admin"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PolicyStorageAutoConfigOp": MoMeta("PolicyStorageAutoConfigOp", "policyStorageAutoConfigOp", "storage-autoconfig-ctrl", None, "InputOutput", 0x1, [], ["admin", "ls-storage", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], [None]),
    ...
    "PowerGroupQual": MoMeta("PowerGroupQual", "powerGroupQual", "power-group-[group_name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [], [], [None]),
    ...
    "QosclassDefinition": MoMeta("QosclassDefinition", "qosclassDefinition", "classes", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [u'fabricLanCloud'], [u'qosclassEthBE', u'qosclassEthClassified', u'qosclassFc'], ["Get", "Set"]),
    "QosclassEthBE": MoMeta("QosclassEthBE", "qosclassEthBE", "class-best-effort", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [u'qosclassDefinition'], [], ["Get", "Set"]),
    "QosclassEthClassified": MoMeta("QosclassEthClassified", "qosclassEthClassified", "class-[priority]", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [u'qosclassDefinition'], [], ["Get", "Set"]),
    "QosclassFc": MoMeta("QosclassFc", "qosclassFc", "class-fc", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [u'qosclassDefinition'], [], ["Get", "Set"]),
    ...
    "SesDiskSlotEp": MoMeta("SesDiskSlotEp", "sesDiskSlotEp", "disk-slot-ep-[enc_id]-id-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'sesEnclosure'], [], [None]),
    "SesEnclosure": MoMeta("SesEnclosure", "sesEnclosure", "ses-enc-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'equipmentChassis'], [u'sesDiskSlotEp'], [None]),
    ...
    "StorageController": MoMeta("StorageController", "storageController", "storage-[type]-[id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'computeBoard', u'equipmentChassis'], [u'firmwareBootDefinition', u'firmwareRunning', u'lstorageControllerDef', u'mgmtController', u'storageControllerOperation', u'storageEmbeddedStorage', u'storageEnclosure', u'storageLocalDisk', u'storageLocalDiskConfigDef', u'storageLocalDiskEp', u'storageLocalLun', u'storageMezzFlashLife', u'storageOnboardDevice', u'storageOperation', u'storageRaidBattery', u'storageVirtualDrive', u'storageVirtualDriveEp'], ["Get"]),
    "StorageControllerEp": MoMeta("StorageControllerEp", "storageControllerEp", "controller-ep-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'storageLocalDisk', u'storageVirtualDrive'], [], [None]),
    ...
    "StorageControllerRef": MoMeta("StorageControllerRef", "storageControllerRef", "server-[server_id]-controller-[controller_type]-[controller_id]", None, "InputOutput", 0x1, [], ["read-only"], [u'storageEnclosureDiskSlotEp'], [], [None]),
    ...
    "StorageEmbeddedStorage": MoMeta("StorageEmbeddedStorage", "storageEmbeddedStorage", "embedded-storage", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController'], [], [None]),
    ...
    "StorageEnclosureDiskSlotEp": MoMeta("StorageEnclosureDiskSlotEp", "storageEnclosureDiskSlotEp", "disk-slot-[id]", VersionMeta.Version131a, "InputOutput", 0x1, [], ["read-only"], [u'storageEnclosure'], [u'storageControllerRef'], [None]),
    "StorageEnclosureLocalDiskConfig": MoMeta("StorageEnclosureLocalDiskConfig", "storageEnclosureLocalDiskConfig", "enc-disk-config-[id]", None, "InputOutput", 0x1, [], ["read-only"], [], [u'storageSasPort'], [None]),
    ...
    "StorageFlexFlashController": MoMeta("StorageFlexFlashController", "storageFlexFlashController", "storage-flexflash-[id]", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin"], [u'computeBoard'], [u'firmwareRunning', u'storageFlexFlashCard', u'storageFlexFlashVirtualDrive', u'storageLocalDiskConfigDef'], ["Get"]),
    ...
    "StorageHddMotherBoardTempStats": MoMeta("StorageHddMotherBoardTempStats", "storageHddMotherBoardTempStats", "hdd-mobo-temp-stats", None, "OutputOnly", 0x1, [], ["admin", "operations", "read-only"], [], [u'storageHddMotherBoardTempStatsHist'], [None]),
    "StorageHddMotherBoardTempStatsHist": MoMeta("StorageHddMotherBoardTempStatsHist", "storageHddMotherBoardTempStatsHist", "[id]", None, "OutputOnly", 0x1, [], ["read-only"], [u'storageHddMotherBoardTempStats'], [], [None]),
    ...
    "StorageLocalDiskConfigPolicy": MoMeta("StorageLocalDiskConfigPolicy", "storageLocalDiskConfigPolicy", "local-disk-config-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'storageLocalDiskPartition'], ["Add", "Get", "Remove", "Set"]),
    ...
    "StorageOnboardDevice": MoMeta("StorageOnboardDevice", "storageOnboardDevice", "onboard-device-[device_type]-[id]", None, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController', u'storageSasExpander'], [u'firmwareBootDefinition', u'firmwareRunning', u'firmwareUpdatable'], [None]),
    ...
    "StorageSasPort": MoMeta("StorageSasPort", "storageSasPort", "sas-port-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'storageEnclosureLocalDiskConfig', u'storageLocalDisk'], [], [None]),
    "StorageSasUpLink": MoMeta("StorageSasUpLink", "storageSasUpLink", "sas-uplink-server-[server_id]-controller-[controller_type]-[controller_id]-id-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'storageSasExpander'], [], [None]),
    ...
    "StorageVirtualDriveContainer": MoMeta("StorageVirtualDriveContainer", "storageVirtualDriveContainer", "vd-container-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis'], [u'storageVirtualDrive'], [None]),
    "StorageVirtualDriveEp": MoMeta("StorageVirtualDriveEp", "storageVirtualDriveEp", "vd-ep-[container_id]-id-[id]", None, "InputOutput", 0x1, [], ["read-only"], [u'storageController'], [], [None]),
    ...
    "StorageVsanRef": MoMeta("StorageVsanRef", "storageVsanRef", "vsan-ref", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy", "ls-storage", "ls-storage-policy"], [u'storageFcTargetEp'], [u'faultInst'], ["Add", "Get", "Set"]),
    ...
    "SysdebugTechSupportOp": MoMeta("SysdebugTechSupportOp", "sysdebugTechSupportOp", "remote-oper-[creation_ts]", None, "InputOutput", 0x1, [], ["admin", "operations"], [u'sysdebugTechSupFileRepository'], [u'faultInst', u'sysdebugTechSupportCmdOpt'], [None]),
    ...
    "VnicFault": MoMeta("VnicFault", "vnicFault", "fault-if", VersionMeta.Version112a, "InputOutput", 0x1, [], ["read-only"], [u'storageEthLif', u'vnicEtherIf', u'vnicFcIf', u'vnicFcOEIf', u'vnicIPv4If', u'vnicIPv6If', u'vnicIniGrpFcIf', u'vnicLifVlan', u'vnicLifVsan', u'vnicMgmtIf', u'vnicMonSesFcIf', u'vnicStorageEthLif', u'vnicVlan'], [u'faultInst'], ["Get"]),
    ...
    "VnicFcGroupDef": MoMeta("VnicFcGroupDef", "vnicFcGroupDef", "fc-group", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageIniGroup'], [u'faultInst', u'storageConnectionDef', u'vnicIniGrpFc'], ["Add", "Get", "Set"]),
    ...
    "VnicIpV4PooledAddr": MoMeta("VnicIpV4PooledAddr", "vnicIpV4PooledAddr", "ipv4-pooled-addr", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], [u'computeInstance', u'lsServer', u'mgmtController', u'mgmtVnet', u'vnicIPv4If', u'vnicMgmtIf'], [u'faultInst'], ["Get"]),
    ...
    "VnicIpV4StaticAddr": MoMeta("VnicIpV4StaticAddr", "vnicIpV4StaticAddr", "ipv4-static-addr", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-network", "ls-server"], [u'computeInstance', u'lsServer', u'lsbootLanImagePath', u'mgmtController', u'mgmtVnet', u'vnicIPv4If', u'vnicMgmtIf'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicLanConnTempl": MoMeta("VnicLanConnTempl", "vnicLanConnTempl", "lan-conn-templ-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'faultInst', u'vnicDynamicConPolicyRef', u'vnicEtherIf', u'vnicFcOEIf', u'vnicUsnicConPolicyRef', u'vnicVmqConPolicyRef'], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicMgmt": MoMeta("VnicMgmt", "vnicMgmt", "mgmt", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-storage"], [u'lsServer'], [u'fabricEthMonSrcEp', u'fabricFcMonSrcEp', u'faultInst', u'vnicMgmtIf'], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicMonSesFc": MoMeta("VnicMonSesFc", "vnicMonSesFc", "monses-fc-[name]", None, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-storage"], [u'fabricFcEstcEpOperation', u'fabricFcMonOperation', u'fabricFcSanEpOperation', u'fabricFcSanPcOperation', u'fabricFcoeEstcEpOperation', u'fabricFcoeSanEpOperation', u'fabricFcoeSanPcOperation', u'lsServer'], [u'fabricEthMonSrcEp', u'fabricFcMonSrcEp', u'faultInst', u'vnicMonSesFcIf'], [None]),
    "VnicMonSesFcIf": MoMeta("VnicMonSesFcIf", "vnicMonSesFcIf", "monses-fc-if-[name]", None, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'vnicMonSesFc'], [u'vnicFault'], [None]),
    ...
    "VnicSanConnTempl": MoMeta("VnicSanConnTempl", "vnicSanConnTempl", "san-conn-templ-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg'], [u'faultInst', u'vnicFcIf'], ["Add", "Get", "Remove", "Set"]),
...
OTHER_TYPE_CLASS_ID = {
    "Method": "ucscentralbasetype",
    "MethodSet": "ucscentralbasetype",
    "AllbitsFilter": "ucscentralfiltertype",
    "AndFilter": "ucscentralfiltertype",
    "AnybitFilter": "ucscentralfiltertype",
    "BwFilter": "ucscentralfiltertype",
    "ClassId": "ucscentralbasetype",
    "ClassIdSet": "ucscentralbasetype",
    "ConfigConfig": "ucscentralbasetype",
    "ConfigMap": "ucscentralbasetype",
    "ConfigSet": "ucscentralbasetype",
    "Dn": "ucscentralbasetype",
    "DnSet": "ucscentralbasetype",
    "EqFilter": "ucscentralfiltertype",
    "FilterFilter": "ucscentralbasetype",
    "GeFilter": "ucscentralfiltertype",
    "GtFilter": "ucscentralfiltertype",
    "Id": "ucscentralbasetype",
    "IdSet": "ucscentralbasetype",
    "LeFilter": "ucscentralfiltertype",
    "LtFilter": "ucscentralfiltertype",
    "NeFilter": "ucscentralfiltertype",
    "NotFilter": "ucscentralfiltertype",
    "OrFilter": "ucscentralfiltertype",
    "Pair": "ucscentralbasetype",
    "WcardFilter": "ucscentralfiltertype",
}
