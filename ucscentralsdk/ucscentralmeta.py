...
MO_CLASS_META = {
    ...
    "AdaptorExtEthIf": MoMeta("AdaptorExtEthIf", "adaptorExtEthIf", "ext-eth-[id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy", "pn-equipment", "pn-maintenance", "read-only"], [u'adaptorUnit'], [], ["Get"]),
    ...
    "CommDateTime": MoMeta("CommDateTime", "commDateTime", "datetime-svc", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-security", "operations"], [u'commLocale', u'commSvcEp', u'commSvcPolicy', u'orgDomainGroup', u'orgOrg', u'policyDeviceProfile'], [u'commNtpProvider'], ["Add", "Get", "Remove", "Set"]),
    ...
    "ComputeBoardController": MoMeta("ComputeBoardController", "computeBoardController", "boardController", VersionMeta.Version141a, "InputOutput", 0x1, [], ["read-only"], [u'computeBlade', u'computeExtBoard', u'computeRackUnit', u'computeServerUnit'], [u'mgmtController'], ["Get"]),
    ...
    "ComputePhysicalOperation": MoMeta("ComputePhysicalOperation", "computePhysicalOperation", "remote-oper", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin", "kvm", "pn-equipment", "pn-maintenance", "pn-policy"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit'], [u'faultInst'], ["Get", "Set"]),
    ...
    "EquipmentLocalDiskControllerCapProvider": MoMeta("EquipmentLocalDiskControllerCapProvider", "equipmentLocalDiskControllerCapProvider", "manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'equipmentManufacturingDef', u'equipmentPicture'], ["Get"]),
    ...
    "EquipmentSharedIOModule": MoMeta("EquipmentSharedIOModule", "equipmentSharedIOModule", "shared-io-module", VersionMeta.Version131a, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassis'], [u'mgmtController', u'portGroup'], ["Get"]),
    ...
    "FabricDceSwSrv": MoMeta("FabricDceSwSrv", "fabricDceSwSrv", "sw-[id]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin", "ls-network-policy"], [u'fabricDceSrv'], [u'fabricDceSwSrvEp', u'fabricDceSwSrvEpOperation', u'fabricSubGroup'], ["Get"]),
    "FabricDceSwSrvEp": MoMeta("FabricDceSwSrvEp", "fabricDceSwSrvEp", "slot-[slot_id]-port-[port_id]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricDceSwSrv', u'fabricSubGroup'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "FabricEp": MoMeta("FabricEp", "fabricEp", "fabric", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin"], [u'computeSystem', u'orgDomainGroup'], [u'fabricCabling', u'fabricDceSrv', u'fabricEthEstcCloud', u'fabricFcEstcCloud', u'fabricLanAccessMgr', u'fabricLanCloud', u'fabricSanCloud'], ["Get"]),
    ...
    "FabricEthEstcEp": MoMeta("FabricEthEstcEp", "fabricEthEstcEp", "phys-eth-slot-[slot_id]-port-[port_id]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthEstc', u'fabricSubGroup'], [u'fabricEthTargetEp', u'fabricVlanEp', u'faultInst'], ["Get", "Set"]),
    ...
    "FabricEthEstcPc": MoMeta("FabricEthEstcPc", "fabricEthEstcPc", "pc-[port_id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthEstc'], [u'fabricEthEstcPcEp', u'fabricEthTargetEp', u'fabricSubGroup', u'fabricVlanEp', u'faultInst'], ["Get"]),
    ...
    "FabricEthLanEp": MoMeta("FabricEthLanEp", "fabricEthLanEp", "phys-slot-[slot_id]-port-[port_id]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthLan', u'fabricSubGroup'], [u'fabricVlanEp', u'faultInst'], ["Get", "Set"]),
    ...
    "FabricEthLanPc": MoMeta("FabricEthLanPc", "fabricEthLanPc", "pc-[port_id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthLan'], [u'fabricEthLanPcEp', u'fabricSubGroup', u'fabricVlanEp', u'faultInst'], ["Get"]),
    ...
    "FabricEthPortOperationFsm": MoMeta("FabricEthPortOperationFsm", "fabricEthPortOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0x1, [], [""], [u'fabricEthEstcEpOperation', u'fabricEthEstcPcOperation', u'fabricEthLanEpOperation', u'fabricEthLanPcOperation'], [u'fabricEthPortOperationFsmStage'], [None]),
    ...
    "FabricFcEstcEp": MoMeta("FabricFcEstcEp", "fabricFcEstcEp", "phys-fc-slot-[slot_id]-port-[port_id]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstc'], [u'fabricVsanEp'], ["Get", "Set"]),
    ...
    "FabricFcSanEp": MoMeta("FabricFcSanEp", "fabricFcSanEp", "phys-slot-[slot_id]-port-[port_id]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan'], [u'fabricVsanEp', u'fabricVsanMembership'], ["Add", "Get", "Set"]),
    ...
    "FabricFcSanPc": MoMeta("FabricFcSanPc", "fabricFcSanPc", "pc-[port_id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan'], [u'fabricFcSanPcEp', u'fabricVsanEp'], [None]),
    ...
    "FabricFcoeEstcEp": MoMeta("FabricFcoeEstcEp", "fabricFcoeEstcEp", "phys-fcoe-slot-[slot_id]-port-[port_id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstc', u'fabricSubGroup'], [u'etherFcoeInterfaceStats', u'fabricVsanEp', u'fabricVsanMembership', u'faultInst'], ["Get", "Set"]),
    ...
    "FabricFcoeSanEp": MoMeta("FabricFcoeSanEp", "fabricFcoeSanEp", "phys-fcoesanep-slot-[slot_id]-port-[port_id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan', u'fabricSubGroup'], [u'fabricVsanEp', u'fabricVsanMembership', u'faultInst'], ["Get", "Set"]),
    ...
    "FabricFcoeSanPc": MoMeta("FabricFcoeSanPc", "fabricFcoeSanPc", "fcoesanpc-[port_id]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan'], [u'fabricFcoeSanPcEp', u'fabricSubGroup', u'faultInst'], [None]),
    ...
    "FaultInst": MoMeta("FaultInst", "faultInst", "fault-[code]", VersionMeta.Version101a, "OutputOnly", 0x1, [], ["admin", "fault", "operations"], [u'aaaAuthRealm', u'aaaLdapEp', u'aaaRadiusEp', u'aaaTacacsPlusEp', u'aaaUserEp', u'adaptorHostEthIf', u'adaptorHostFcIf', u'adaptorHostScsiIf', u'adaptorUnit', u'adaptorVlan', u'callhomeHolder', u'certRepairEp', u'changeEp', u'commSvcEp', u'computeAutoconfigPolicy', u'computeBlade', u'computeBladeInheritPolicy', u'computeBoard', u'computeCartridgeOperation', u'computeGroupMembership', u'computeIOHub', u'computeInstance', u'computePhysicalOperation', u'computePool', u'computeRemoteOpStatus', u'computeSystem', u'configBackup', u'configConsumerCatalogue', u'configDbConfig', u'consumerInst', u'controllerEp', u'dupeChangeTrackerEp', u'equipmentChassis', u'equipmentChassisOperation', u'equipmentFan', u'equipmentFanModule', u'equipmentFex', u'equipmentFexOperation', u'equipmentIOCard', u'equipmentLocatorLedOperation', u'equipmentPsu', u'etherServerIntFIo', u'extpolClient', u'extpolController', u'extpolEp', u'extpolProvider', u'extpolRegistry', u'fabricBreakoutOperation', u'fabricCartridgeSlotEpOperation', u'fabricChangedObjectRef', u'fabricComputePhEpOperation', u'fabricComputeSlotEpOperation', u'fabricDceSwSrvEpOperation', u'fabricEnclosurePhEpOperation', u'fabricEnclosureSlotEpOperation', u'fabricEthEstcEp', u'fabricEthEstcEpOperation', u'fabricEthEstcPc', u'fabricEthEstcPcEpOperation', u'fabricEthEstcPcOperation', u'fabricEthLanEp', u'fabricEthLanEpOperation', u'fabricEthLanPc', u'fabricEthLanPcEp', u'fabricEthLanPcEpOperation', u'fabricEthLanPcOperation', u'fabricEthLinkProfile', u'fabricEthTargetEpOperation', u'fabricFcEstcEpOperation', u'fabricFcSanEpOperation', u'fabricFcSanPcEpOperation', u'fabricFcSanPcOperation', u'fabricFcUplinkOperation', u'fabricFcoeEstcEp', u'fabricFcoeEstcEpOperation', u'fabricFcoeSanEp', u'fabricFcoeSanEpOperation', u'fabricFcoeSanPc', u'fabricFcoeSanPcEp', u'fabricFcoeSanPcEpOperation', u'fabricFcoeSanPcOperation', u'fabricLanPinGroupOperation', u'fabricLanPinTargetOperation', u'fabricSanPinGroupOperation', u'fabricSanPinTargetOperation', u'fabricSwChPhEpOperation', u'fabricVlan', u'fabricVnetEpSyncEp', u'fcpoolAddr', u'fcpoolInitiators', u'firmwareDistributable', u'firmwareDownloadPolicy', u'firmwareDownloader', u'firmwareInfra', u'firmwareSource', u'identIdentRequest', u'identMetaSystem', u'ippoolAddr', u'ippoolIpV6Addr', u'ippoolPool', u'iqnpoolAddr', u'iqnpoolPool', u'licenseDownloader', u'licenseFile', u'licenseInstance', u'lsBinding', u'lsIssues', u'lsRequirement', u'lsSPMeta', u'lsServer', u'lsServerOperation', u'lsmaintAck', u'lsmaintMaintPolicy', u'lstorageAck', u'lstorageCtrlServiceOperation', u'lstorageDasScsiLun', u'lstorageProfileBinding', u'macpoolAddr', u'macpoolPool', u'memoryArray', u'memoryBufferUnit', u'memoryUnit', u'mgmtBackup', u'mgmtBackupOperation', u'mgmtBackupPolicy', u'mgmtBackupTrigger', u'mgmtCfgExportPolicy', u'mgmtDataExporter', u'mgmtDataImporter', u'mgmtIf', u'mgmtImportItem', u'mgmtImporter', u'mgmtRegistryInfo', u'networkElement', u'nfsClientDef', u'nfsExportDef', u'observeObserved', u'orgDomainGroupPolicy', u'orgOrg', u'pkiEp', u'pkiKeyRing', u'pkiTP', u'policyControlEpOperation', u'policyPolicyScope', u'policySystemProfile', u'processorUnit', u'queryDependencyContext', u'queryImportContext', u'queryUsageContext', u'smartlicenseAgent', u'smartlicenseEntitlement', u'smartlicenseEntitlementEp', u'smartlicenseHolder', u'smartlicenseTest', u'storageComputeBladeOperation', u'storageConnectionDef', u'storageConnectionPolicy', u'storageControllerOperation', u'storageIniGroup', u'storageInitiator', u'storageIpV4PooledAddr', u'storageItem', u'storageLocalDiskOperation', u'storageLunReplica', u'storageLunSnapshot', u'storageMeta', u'storageScsiLun', u'storageVirtualDriveOperation', u'storageVirtualDriveRefOperation', u'storageVsanRef', u'sysdebugAutoCoreFileExportTarget', u'sysdebugCore', u'sysdebugLogControlEp', u'sysdebugManualCoreFileExportTarget', u'sysdebugTechSupport', u'sysdebugTechSupportOperation', u'sysfileMutation', u'testingServiceProfile', u'topSystem', u'trigTest', u'uuidpoolAddr', u'uuidpoolPool', u'vmNic', u'vnicConnDef', u'vnicDynamicConPolicyRef', u'vnicEther', u'vnicEtherIf', u'vnicFault', u'vnicFc', u'vnicFcGroupDef', u'vnicFcGroupTempl', u'vnicFcIf', u'vnicFcNode', u'vnicIPv4PooledIscsiAddr', u'vnicIScsi', u'vnicIScsiBootVnic', u'vnicIScsiLCP', u'vnicIScsiNode', u'vnicIScsiStaticTargetIf', u'vnicIniGrpFc', u'vnicIpV4MgmtPooledAddr', u'vnicIpV4PooledAddr', u'vnicIpV6MgmtPooledAddr', u'vnicLanConnTempl', u'vnicLstorageIScsi', u'vnicMgmt', u'vnicMgmtIf', u'vnicSanConnTempl', u'vnicStorageEthLif', u'vnicUsnicConPolicyRef', u'vnicVmqConPolicyRef'], [], ["Get"]),
    ...
    "FirmwareBootDefinition": MoMeta("FirmwareBootDefinition", "firmwareBootDefinition", "fw-boot-def", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'equipmentPsu', u'osController', u'storageController', u'storageLocalDisk', u'storageSasExpander'], [u'firmwareBootUnit'], ["Get"]),
    ...
    "FirmwareBundleTypeCapProvider": MoMeta("FirmwareBundleTypeCapProvider", "firmwareBundleTypeCapProvider", "bundle-type-cap", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'capabilityCatalogue'], [u'firmwareBundleType', u'firmwareComponentSpec'], ["Get"]),
    "FirmwareCatalogPack": MoMeta("FirmwareCatalogPack", "firmwareCatalogPack", "fw-catalog-pack-[name]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "operations"], [u'orgDomainGroup', u'orgOrg'], [], ["Add", "Get", "Remove", "Set"]),
    ...
    "FirmwareProductFamily": MoMeta("FirmwareProductFamily", "firmwareProductFamily", "fw-family-[family_name]", VersionMeta.Version121a, "InputOutput", 0x1, [], ["admin", "operations"], [u'firmwareInfraPolicy'], [u'firmwareInfraPack'], ["Get"]),
    ...
    "FirmwareRunning": MoMeta("FirmwareRunning", "firmwareRunning", "fw-[deployment]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["read-only"], [u'biosUnit', u'equipmentPsu', u'graphicsCard', u'mgmtController', u'osController', u'storageController', u'storageFlexFlashController', u'storageLocalDisk', u'storageSasExpander'], [], ["Get"]),
    ...
    "FirmwareUpdatable": MoMeta("FirmwareUpdatable", "firmwareUpdatable", "", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin"], [u'equipmentPsu'], [], ["Get", "Set"]),
    ...
    "LsServerOperation": MoMeta("LsServerOperation", "lsServerOperation", "remote-oper", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin", "kvm", "ls-compute", "ls-config", "ls-server", "ls-server-oper", "ls-server-policy"], [u'computeInstance', u'lsServer'], [u'faultInst'], ["Get", "Set"]),
    ...
    "LsbootPolicy": MoMeta("LsbootPolicy", "lsbootPolicy", "boot-policy-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["read-only"], [u'orgOrg', u'policySystemEp'], [u'lsbootBootSecurity', u'lsbootIScsi', u'lsbootLan', u'lsbootSan', u'lsbootStorage', u'lsbootUpgradeStatus', u'lsbootVirtualMedia'], ["Add", "Get", "Remove", "Set"]),
    ...
    "MessageEntry": MoMeta("MessageEntry", "messageEntry", "entry-[id]", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin"], [u'lsSPMeta'], [], ["Get"]),
    ...
    "QosclassDefinition": MoMeta("QosclassDefinition", "qosclassDefinition", "classes", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [u'fabricLanCloud'], [], ["Get", "Set"]),
    "QosclassEthBE": MoMeta("QosclassEthBE", "qosclassEthBE", "class-best-effort", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [], [], ["Get", "Set"]),
    "QosclassEthClassified": MoMeta("QosclassEthClassified", "qosclassEthClassified", "class-[priority]", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [], [], ["Get", "Set"]),
    "QosclassFc": MoMeta("QosclassFc", "qosclassFc", "class-fc", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ext-lan-qos", "ext-san-qos", "ls-network", "ls-network-policy", "ls-qos-policy"], [], [], ["Get", "Set"]),
    ...
    "StatsThresholdPolicy": MoMeta("StatsThresholdPolicy", "statsThresholdPolicy", "thr-policy-[name]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["read-only"], [u'fabricCabling', u'fabricDceSrv', u'fabricEthEstcCloud', u'fabricFcEstcCloud', u'fabricLanCloud', u'fabricSanCloud', u'orgOrg'], [u'statsThresholdClass'], ["Add", "Get", "Remove", "Set"]),
    ...
    "StorageComputeBladeOperation": MoMeta("StorageComputeBladeOperation", "storageComputeBladeOperation", "remote-oper", VersionMeta.Version131a, "InputOutput", 0x1, [], ["admin", "kvm", "pn-equipment", "pn-maintenance", "pn-policy"], [u'storageBlade'], [u'faultInst'], ["Get"]),
    ...
    "StorageEnclosure": MoMeta("StorageEnclosure", "storageEnclosure", "enc-[id]", VersionMeta.Version131a, "InputOutput", 0x1, [], ["read-only"], [u'storageBlade', u'storageController'], [u'storageLocalDisk'], ["Get"]),
    ...
    "StorageSasExpander": MoMeta("StorageSasExpander", "storageSasExpander", "sas-expander-[id]", VersionMeta.Version131a, "InputOutput", 0x1, [], ["read-only"], [u'computeBoard'], [u'firmwareBootDefinition', u'firmwareRunning'], [None]),
    ...
    "StorageVirtualDrive": MoMeta("StorageVirtualDrive", "storageVirtualDrive", "vd-[id]", VersionMeta.Version131a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController'], [u'storageLunDisk', u'storageOperation', u'storageScsiLunRef', u'storageVDMemberEp', u'storageVirtualDriveOperation'], ["Get", "Set"]),
    ...
    "SysdebugTechSupFileRepository": MoMeta("SysdebugTechSupFileRepository", "sysdebugTechSupFileRepository", "tech-support-files", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "operations"], [u'computeSystem', u'topSystem'], [u'sysdebugTechSupport', u'sysdebugTechSupportOperation'], ["Get"]),
    ...
    "SysdebugTechSupportCmdOpt": MoMeta("SysdebugTechSupportCmdOpt", "sysdebugTechSupportCmdOpt", "tech-support-cmd-opt", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "operations"], [u'sysdebugTechSupport', u'sysdebugTechSupportOperation'], [], ["Add", "Get", "Set"]),
    ...
    "TrigAbsWindow": MoMeta("TrigAbsWindow", "trigAbsWindow", "abs-[name]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server"], [u'trigSched'], [], ["Add", "Get", "Remove", "Set"]),
    "TrigMeta": MoMeta("TrigMeta", "trigMeta", "meta-trig-[sched_name]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["read-only"], [u'orgDomainGroup', u'storageCloud', u'topSystem'], [u'trigServerToken', u'trigTokenRequestor', u'trigTriggered'], ["Get"]),
    ...
    "TrigSched": MoMeta("TrigSched", "trigSched", "sched-[name]", VersionMeta.Version101a, "InputOutput", 0x1, [], ["admin", "ls-compute", "ls-config", "ls-server"], [u'orgDomainGroup', u'storageCloud', u'topSystem'], [u'lstorageRecurrWindow', u'trigAbsWindow', u'trigRecurrWindow'], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicFault": MoMeta("VnicFault", "vnicFault", "fault-if", VersionMeta.Version112a, "InputOutput", 0x1, [], ["read-only"], [u'storageEthLif', u'vnicEtherIf', u'vnicFcIf', u'vnicFcOEIf', u'vnicIPv4If', u'vnicIPv6If', u'vnicIniGrpFcIf', u'vnicLifVlan', u'vnicLifVsan', u'vnicMgmtIf', u'vnicStorageEthLif', u'vnicVlan'], [u'faultInst'], ["Get"]),
    ...
    "VnicIScsi": MoMeta("VnicIScsi", "vnicIScsi", "iscsi-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], [u'computeInstance', u'computeLocalTemplDef', u'lsServer'], [u'faultInst', u'vnicIPv4IscsiAddr', u'vnicIScsiAutoTargetIf', u'vnicIScsiInitiatorParams', u'vnicIScsiStaticTargetIf', u'vnicVlan'], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicIScsiLCP": MoMeta("VnicIScsiLCP", "vnicIScsiLCP", "iscsi-[name]", VersionMeta.Version111a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], [u'lsServer', u'vnicLanConnPolicy'], [u'faultInst', u'vnicIScsiInitiatorParams', u'vnicVlan'], ["Add", "Get", "Remove", "Set"]),
    ...
    "VnicIniGrpFc": MoMeta("VnicIniGrpFc", "vnicIniGrpFc", "inigrp-fc", VersionMeta.Version141a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], [u'lsServer', u'vnicFcGroupDef'], [u'faultInst', u'vnicIniGrpFcIf'], ["Get"]),
    ...
    "VnicLstorageIScsi": MoMeta("VnicLstorageIScsi", "vnicLstorageIScsi", "lstorageIScsi-[name]", VersionMeta.Version131a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], [u'lsServer'], [u'faultInst', u'vnicVlan'], ["Get"]),
    ...
    "VnicMgmt": MoMeta("VnicMgmt", "vnicMgmt", "mgmt", VersionMeta.Version112a, "InputOutput", 0x1, [], ["admin", "ls-config", "ls-server", "ls-storage"], [u'lsServer'], [u'faultInst', u'vnicMgmtIf'], ["Add", "Get", "Remove", "Set"]),
