...
class LicenseInstance(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseInstance", "licenseInstance", "inst-[scope]", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["admin"], [u'licenseFeature'], [u'eventInst', u'faultInst', u'licenseInstanceFsm', u'licenseInstanceFsmTask', u'licenseProp', u'licenseSourceFile'], ["Get"])

    prop_meta = {
        "abs_quant": MoPropertyMeta("abs_quant", "absQuant", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "def_quant": MoPropertyMeta("def_quant", "defQuant", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, 0x2, 0, 256, None, [], []), 
        "feature": MoPropertyMeta("feature", "feature", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, 1, 64, None, [], []), 
        "fsm_descr": MoPropertyMeta("fsm_descr", "fsmDescr", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["UpdateFlexlmBegin", "UpdateFlexlmFail", "UpdateFlexlmLocal", "UpdateFlexlmSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["UpdateFlexlmBegin", "UpdateFlexlmFail", "UpdateFlexlmLocal", "UpdateFlexlmSuccess", "nop"], []), 
        ...
        "is_present": MoPropertyMeta("is_present", "isPresent", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["license-expired", "license-graceperiod", "license-insufficient", "license-ok", "not-applicable", "unknown"], []), 
        "peer_status": MoPropertyMeta("peer_status", "peerStatus", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["exceeds", "lacks", "matching", "no-peer", "unknown"], []), 
        ...
        "used_quant": MoPropertyMeta("used_quant", "usedQuant", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
    }
