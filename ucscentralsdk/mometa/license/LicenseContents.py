...
class LicenseContents(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseContents", "licenseContents", "contents-[feature_name]", VersionMeta.Version111a, "InputOutput", 0x1f, [], ["read-only"], [u'licenseFile'], [u'licenseFeatureLine'], ["Get"])
