...
class LicenseFeatureCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseFeatureCapProvider", "licenseFeatureCapProvider", "feature-[feature_name]-[lic_vendor]|[lic_version]manufacturer-[vendor]-model-[model]-revision-[revision]", VersionMeta.Version111a, "InputOutput", 0x1fff, [], ["admin"], [u'capabilityCatalogue'], [], ["Get"])
