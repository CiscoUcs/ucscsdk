...
class LicenseFileFsm(ManagedObject):
    ...
    mo_meta = MoMeta("LicenseFileFsm", "licenseFileFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'licenseFile'], [u'licenseFileFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Clear", "Install", "nop"], []), 
