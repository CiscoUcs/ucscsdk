...
class MemoryNvDimmBatteryConsts():
    CAPACITY_LOWER_CRITICAL = "lower-critical"
    CAPACITY_LOWER_NON_CRITICAL = "lower-non-critical"
    CAPACITY_LOWER_NON_RECOVERABLE = "lower-non-recoverable"
    CAPACITY_NOT_SUPPORTED = "not-supported"
    CAPACITY_OK = "ok"
    CAPACITY_UNKNOWN = "unknown"
    CAPACITY_UPPER_CRITICAL = "upper-critical"
    CAPACITY_UPPER_NON_CRITICAL = "upper-non-critical"
    CAPACITY_UPPER_NON_RECOVERABLE = "upper-non-recoverable"
    HEALTH_LOWER_CRITICAL = "lower-critical"
    HEALTH_LOWER_NON_CRITICAL = "lower-non-critical"
    HEALTH_LOWER_NON_RECOVERABLE = "lower-non-recoverable"
    HEALTH_NOT_SUPPORTED = "not-supported"
    HEALTH_OK = "ok"
    HEALTH_UNKNOWN = "unknown"
    HEALTH_UPPER_CRITICAL = "upper-critical"
    HEALTH_UPPER_NON_CRITICAL = "upper-non-critical"
    HEALTH_UPPER_NON_RECOVERABLE = "upper-non-recoverable"
...
class MemoryNvDimmBattery(ManagedObject):
    ...
    prop_meta = {
        ...
        "health": MoPropertyMeta("health", "health", "string", VersionMeta.Version131a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["lower-critical", "lower-non-critical", "lower-non-recoverable", "not-supported", "ok", "unknown", "upper-critical", "upper-non-critical", "upper-non-recoverable"], []), 
