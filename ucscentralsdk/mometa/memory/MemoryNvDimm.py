...
class MemoryNvDimm(ManagedObject):
    ...
    mo_meta = MoMeta("MemoryNvDimm", "memoryNvDimm", "nvdimm-[id]", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["read-only"], [u'memoryNvDimmController'], [], ["Get"])

    prop_meta = {
        "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version131a, MoPropertyMeta.INTERNAL, None, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version131a, MoPropertyMeta.READ_ONLY, 0x2, 0, 256, None, [], []), 
        "health": MoPropertyMeta("health", "health", "string", VersionMeta.Version131a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["hardware-fault", "healthy", "not-present", "software-fault", "unknown"], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version131a, MoPropertyMeta.NAMING, 0x4, None, None, None, [], ["1-16"]), 
