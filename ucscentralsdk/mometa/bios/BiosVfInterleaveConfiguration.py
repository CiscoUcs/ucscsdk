...
class BiosVfInterleaveConfiguration(ManagedObject):
    ...
    mo_meta = MoMeta("BiosVfInterleaveConfiguration", "biosVfInterleaveConfiguration", "Interleave-Configuration", VersionMeta.Version121a, "InputOutput", 0x7f, [], ["read-only"], [u'biosVProfile'], [], ["Get", "Set"])
