...
class TopSystemConsts():
    FSM_PREV_HOST_NAME_BEGIN = "HostNameBegin"
    FSM_PREV_HOST_NAME_CONFIG = "HostNameConfig"
    FSM_PREV_HOST_NAME_CONFIG_PEER = "HostNameConfigPeer"
    FSM_PREV_HOST_NAME_FAIL = "HostNameFail"
    FSM_PREV_HOST_NAME_SUCCESS = "HostNameSuccess"
    FSM_PREV_PEER_HOST_NAME_BEGIN = "PeerHostNameBegin"
    FSM_PREV_PEER_HOST_NAME_CONFIG = "PeerHostNameConfig"
    FSM_PREV_PEER_HOST_NAME_FAIL = "PeerHostNameFail"
    FSM_PREV_PEER_HOST_NAME_SUCCESS = "PeerHostNameSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_HOST_NAME_BEGIN = "HostNameBegin"
    FSM_STATUS_HOST_NAME_CONFIG = "HostNameConfig"
    FSM_STATUS_HOST_NAME_CONFIG_PEER = "HostNameConfigPeer"
    FSM_STATUS_HOST_NAME_FAIL = "HostNameFail"
    FSM_STATUS_HOST_NAME_SUCCESS = "HostNameSuccess"
    FSM_STATUS_PEER_HOST_NAME_BEGIN = "PeerHostNameBegin"
    FSM_STATUS_PEER_HOST_NAME_CONFIG = "PeerHostNameConfig"
    FSM_STATUS_PEER_HOST_NAME_FAIL = "PeerHostNameFail"
    FSM_STATUS_PEER_HOST_NAME_SUCCESS = "PeerHostNameSuccess"
    FSM_STATUS_NOP = "nop"
...
class TopSystem(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["HostNameBegin", "HostNameConfig", "HostNameConfigPeer", "HostNameFail", "HostNameSuccess", "PeerHostNameBegin", "PeerHostNameConfig", "PeerHostNameFail", "PeerHostNameSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["HostNameBegin", "HostNameConfig", "HostNameConfigPeer", "HostNameFail", "HostNameSuccess", "PeerHostNameBegin", "PeerHostNameConfig", "PeerHostNameFail", "PeerHostNameSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "ipv6_addr": MoPropertyMeta("ipv6_addr", "ipv6Addr", "string", VersionMeta.Version112a, MoPropertyMeta.READ_WRITE, 0x10, 0, 256, None, [], []), 
        "mode": MoPropertyMeta("mode", "mode", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["cluster", "stand-alone", "unspecified"], []), 
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[a-zA-Z][a-zA-Z0-9-]{0,29}""", [], []), 
        "owner": MoPropertyMeta("owner", "owner", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, 0x40, 0, 256, None, [], []), 
        "site": MoPropertyMeta("site", "site", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], []), 
        ...
        "system_org": MoPropertyMeta("system_org", "systemOrg", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "system_up_time": MoPropertyMeta("system_up_time", "systemUpTime", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, r"""(([1-9]*[0-9]{2}:)|)([0-1][0-9]||[2][0-3]):([0-5][0-9]):([0-5][0-9])||(([0-5][0-9]):|)([0-5][0-9])""", [], []), 
    }
