"""This module contains the general information for TopSystemFsm ManagedObject."""
...
class TopSystemFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_HOST_NAME = "HostName"
    CURRENT_FSM_PEER_HOST_NAME = "PeerHostName"
    CURRENT_FSM_NOP = "nop"
...
class TopSystemFsm(ManagedObject):
    """This is TopSystemFsm class."""

    consts = TopSystemFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("TopSystemFsm", "topSystemFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'topSystem'], [u'topSystemFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["HostName", "PeerHostName", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "TopSystemFsm", parent_mo_or_dn, **kwargs)
