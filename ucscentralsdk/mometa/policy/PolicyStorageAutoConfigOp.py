"""This module contains the general information for PolicyStorageAutoConfigOp ManagedObject."""
...
class PolicyStorageAutoConfigOpConsts():
    SOURCE_LOCAL = "local"
...
class PolicyStorageAutoConfigOp(ManagedObject):
    """This is PolicyStorageAutoConfigOp class."""

    consts = PolicyStorageAutoConfigOpConsts()
    naming_props = set([])

    mo_meta = MoMeta("PolicyStorageAutoConfigOp", "policyStorageAutoConfigOp", "storage-autoconfig-ctrl", None, "InputOutput", 0x3f, [], ["admin", "ls-storage", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "PolicyStorageAutoConfigOp", parent_mo_or_dn, **kwargs)
