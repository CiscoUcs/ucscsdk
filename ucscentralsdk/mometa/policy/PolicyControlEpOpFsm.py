...
class PolicyControlEpOpFsm(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyControlEpOpFsm", "policyControlEpOpFsm", "fsm", None, "OutputOnly", 0xf, [], [""], [u'policyControlEpOp'], [u'policyControlEpOpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["RemoteDomainReg", "RemoteDomainUnReg", "nop"], []), 
        ...
        "fsm_instance_id": MoPropertyMeta("fsm_instance_id", "fsmInstanceId", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
