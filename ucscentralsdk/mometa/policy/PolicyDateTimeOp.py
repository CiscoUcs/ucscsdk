...
class PolicyDateTimeOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyDateTimeOp", "policyDateTimeOp", "datetime-ctrl", None, "InputOutput", 0x3f, [], ["admin", "ext-lan-config", "ext-lan-security", "operations"], [u'policyControlEpOp'], [u'faultInst'], [None])
