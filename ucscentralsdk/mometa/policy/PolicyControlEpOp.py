...
class PolicyControlEpOp(ManagedObject):
    ...
    naming_props = set([u'hostNameOrIP'])

    mo_meta = MoMeta("PolicyControlEpOp", "policyControlEpOp", "control-ep-[host_name_or_ip]", None, "InputOutput", 0x7ff, [], ["admin"], [u'fabricDomainEp'], [u'eventInst', u'faultInst', u'policyCommunicationOp', u'policyConfigBackupOp', u'policyControlEpOpFsm', u'policyControlEpOpFsmTask', u'policyDateTimeOp', u'policyDiscoveryOp', u'policyDnsOp', u'policyEquipmentOp', u'policyFaultOp', u'policyInfraFirmwareOp', u'policyMEpOp', u'policyMonitoringOp', u'policyPortConfigOp', u'policyPowerMgmtOp', u'policyPsuOp', u'policySecurityOp', u'policyStorageAutoConfigOp'], [None])

    prop_meta = {
        "action_event": MoPropertyMeta("action_event", "actionEvent", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["register", "unknown", "unregister"], []), 
        "auth_status": MoPropertyMeta("auth_status", "authStatus", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["fail", "ok", "unknown"], []), 
        "central_ip": MoPropertyMeta("central_ip", "centralIp", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "child_action": MoPropertyMeta("child_action", "childAction", "string", None, MoPropertyMeta.INTERNAL, None, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "cleanup_mode": MoPropertyMeta("cleanup_mode", "cleanupMode", "string", None, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["deep-remove-global", "localize-global"], []), 
        "create_ts": MoPropertyMeta("create_ts", "createTs", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", None, MoPropertyMeta.READ_ONLY, 0x8, 0, 256, None, [], []), 
        "dual_stack": MoPropertyMeta("dual_stack", "dualStack", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["off", "on"], []), 
        "fsm_descr": MoPropertyMeta("fsm_descr", "fsmDescr", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["RemoteDomainRegBegin", "RemoteDomainRegCheckStatus", "RemoteDomainRegFail", "RemoteDomainRegPushSharedSecret", "RemoteDomainRegRegistration", "RemoteDomainRegSuccess", "RemoteDomainUnRegBegin", "RemoteDomainUnRegFail", "RemoteDomainUnRegSuccess", "RemoteDomainUnRegUnRegistration", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["RemoteDomainRegBegin", "RemoteDomainRegCheckStatus", "RemoteDomainRegFail", "RemoteDomainRegPushSharedSecret", "RemoteDomainRegRegistration", "RemoteDomainRegSuccess", "RemoteDomainUnRegBegin", "RemoteDomainUnRegFail", "RemoteDomainUnRegSuccess", "RemoteDomainUnRegUnRegistration", "nop"], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.READ_WRITE, 0x20, 0, 510, None, [], []), 
        "normalized_ipv4": MoPropertyMeta("normalized_ipv4", "normalizedIpv4", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "normalized_ipv6": MoPropertyMeta("normalized_ipv6", "normalizedIpv6", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "password": MoPropertyMeta("password", "password", "string", None, MoPropertyMeta.READ_WRITE, 0x40, None, None, r"""[!""#%&'\(\)\*\+,\-\./:;<>@\[\\\]\^_`\{\|\}~a-zA-Z0-9]{0,64}""", [], []), 
        "registration_state": MoPropertyMeta("registration_state", "registrationState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["failed", "inprogress", "lost-visibility", "registered", "unregistered"], []), 
        ...
        "shared_secret_push_state": MoPropertyMeta("shared_secret_push_state", "sharedSecretPushState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["fail", "ok", "unknown"], []), 
        "src_addr_fmt": MoPropertyMeta("src_addr_fmt", "srcAddrFmt", "string", None, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["hostname", "ipv4", "ipv6"], []), 
        ...
        "trigger_status": MoPropertyMeta("trigger_status", "triggerStatus", "string", None, MoPropertyMeta.READ_WRITE, 0x400, None, None, None, ["trigger-acked", "trigger-failed", "triggered", "unknown"], []), 
        "unregistration_state": MoPropertyMeta("unregistration_state", "unregistrationState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["fail", "ok", "unknown"], []), 
    }
