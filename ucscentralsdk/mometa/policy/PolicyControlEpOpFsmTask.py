...
class PolicyControlEpOpFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyControlEpOpFsmTask", "policyControlEpOpFsmTask", "task-[item]", None, "OutputOnly", 0xf, [], [""], [u'policyControlEpOp'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["RemoteDomainReg", "RemoteDomainUnReg", "nop"], []), 
