...
class PolicyPortConfigOp(ManagedObject):
    ...
    mo_meta = MoMeta("PolicyPortConfigOp", "policyPortConfigOp", "portconfig-ctrl", None, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-policy"], [u'policyControlEpOp'], [u'faultInst'], [None])
