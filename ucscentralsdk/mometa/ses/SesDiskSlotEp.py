...
class SesDiskSlotEp(ManagedObject):
    ...
    mo_meta = MoMeta("SesDiskSlotEp", "sesDiskSlotEp", "disk-slot-ep-[enc_id]-id-[id]", None, "InputOutput", 0x3f, [], ["read-only"], [u'sesEnclosure'], [], [None])

    prop_meta = {
        "child_action": MoPropertyMeta("child_action", "childAction", "string", None, MoPropertyMeta.INTERNAL, None, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "disk_dn": MoPropertyMeta("disk_dn", "diskDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "disk_present": MoPropertyMeta("disk_present", "diskPresent", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", None, MoPropertyMeta.READ_ONLY, 0x2, 0, 256, None, [], []), 
        "enc_id": MoPropertyMeta("enc_id", "encId", "uint", None, MoPropertyMeta.NAMING, 0x4, None, None, None, [], []), 
        ...
        "slot_dn": MoPropertyMeta("slot_dn", "slotDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
