...
class FaultDomainInst(ManagedObject):
    ...
    prop_meta = {
        ...
        "src_dme": MoPropertyMeta("src_dme", "srcDme", "string", VersionMeta.Version131a, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["central-mgr", "identifier-mgr", "mgmt-controller", "operation-mgr", "policy-mgr", "resource-mgr", "service-reg", "stats-mgr", "unknown"], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version131a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["admin", "any", "comm-svc-not-deployed", "configuration", "connectivity", "environmental", "equipment", "forward", "fsm", "generic", "management", "network", "operational", "policy", "security", "server", "servergroup", "storage", "sysdebug"], []), 
    }
