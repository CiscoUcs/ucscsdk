...
class FirmwareDistributableFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDistributableFsm", "firmwareDistributableFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'firmwareDistributable'], [u'firmwareDistributableFsmStage'], [None])
