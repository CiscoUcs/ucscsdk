...
class FirmwareDistributable(ManagedObject):
    ...
    prop_meta = {
        ...
        "oper_dnld_status": MoPropertyMeta("oper_dnld_status", "operDnldStatus", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["deleting", "downloaded", "downloading", "failed", "not-downloaded", "triggered"], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["b-series-bundle", "c-series-bundle", "catalog", "full-bundle", "image", "infrastructure-bundle", "m-series-bundle", "provider-bundle", "s-series-bundle", "unknown"], []), 
