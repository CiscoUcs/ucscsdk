...
class FirmwareDomainInfraProfile(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDomainInfraProfile", "firmwareDomainInfraProfile", "domain-infra-profile-[name]", None, "InputOutput", 0x7f, [], ["admin", "operations"], [u'orgOrg'], [u'firmwareCatalogPack', u'firmwareCatalogPackConfig', u'firmwareDomainInfo', u'firmwareProductFamily', u'trigMeta', u'trigSched'], [None])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["trigger", "trigger-immediate", "triggered", "untriggered", "user-ack"], []), 
        ...
        "infra_profile_status": MoPropertyMeta("infra_profile_status", "infraProfileStatus", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["failed-to-trigger", "pending", "triggered", "triggered-active"], []), 
        ...
        "sched_date": MoPropertyMeta("sched_date", "schedDate", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        ...
        "tag_name": MoPropertyMeta("tag_name", "tagName", "string", None, MoPropertyMeta.READ_WRITE, 0x40, 0, 64, r"""[a-zA-Z0-9=\[\]!#$%()*+\\,-./:;@_\s{|}~?]+""", [], []), 
    }
