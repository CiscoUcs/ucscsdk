...
class FirmwareBootDefinition(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareBootDefinition", "firmwareBootDefinition", "fw-boot-def", VersionMeta.Version101a, "InputOutput", 0xf, [], ["admin"], [u'equipmentPsu', u'osController', u'storageController', u'storageLocalDisk', u'storageSasExpander'], [u'firmwareBootUnit'], ["Get"])
