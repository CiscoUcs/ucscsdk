...
class FirmwareUpgradeInfo(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareUpgradeInfo", "firmwareUpgradeInfo", "validate-upgrade", VersionMeta.Version141a, "InputOutput", 0xf, [], ["admin"], [u'computeSystem'], [u'firmwareUpgradeDetail'], ["Get"])
