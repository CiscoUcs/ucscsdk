...
class FirmwareDownloaderFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareDownloaderFsm", "firmwareDownloaderFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'firmwareDownloader'], [u'firmwareDownloaderFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Download", "nop"], []), 
