...
class FirmwareBundleTypeCapProvider(ManagedObject):
    ...
    mo_meta = MoMeta("FirmwareBundleTypeCapProvider", "firmwareBundleTypeCapProvider", "bundle-type-cap", VersionMeta.Version101a, "InputOutput", 0xf, [], ["admin"], [u'capabilityCatalogue'], [u'firmwareBundleType', u'firmwareComponentSpec'], ["Get"])
