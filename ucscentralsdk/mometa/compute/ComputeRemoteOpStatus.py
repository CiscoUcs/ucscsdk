...
class ComputeRemoteOpStatus(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeRemoteOpStatus", "computeRemoteOpStatus", "remote-op-status", VersionMeta.Version121a, "InputOutput", 0xf, [], ["read-only"], [u'mgmtBackup'], [u'faultInst'], ["Get"])
