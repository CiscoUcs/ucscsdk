...
class ComputeSession(ManagedObject):
    ...
    naming_props = set([u'systemName'])

    mo_meta = MoMeta("ComputeSession", "computeSession", "session-[system_name]", VersionMeta.Version101a, "InputOutput", 0x1f, [], ["aaa", "admin"], [u'computeUser'], [], [None])
