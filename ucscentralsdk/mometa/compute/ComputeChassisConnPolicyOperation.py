...
class ComputeChassisConnPolicyOperation(ManagedObject):
    ...
    mo_meta = MoMeta("ComputeChassisConnPolicyOperation", "computeChassisConnPolicyOperation", "remote-oper", None, "InputOutput", 0x7f, [], ["admin", "pn-policy"], [u'computeChassisConnPolicy'], [u'faultInst'], [None])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["global", "none", "port-channel", "unspecified"], []), 
        "backplane_speed_pref": MoPropertyMeta("backplane_speed_pref", "backplaneSpeedPref", "string", None, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["40G", "4x10G", "global", "unspecified"], []), 
