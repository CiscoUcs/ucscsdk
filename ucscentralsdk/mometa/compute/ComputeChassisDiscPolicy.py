...
class ComputeChassisDiscPolicy(ManagedObject):
    ...
    prop_meta = {
        ...
        "backplane_speed_pref": MoPropertyMeta("backplane_speed_pref", "backplaneSpeedPref", "string", None, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["40G", "4x10G"], []), 
        ...
        "multicast_hw_hash": MoPropertyMeta("multicast_hw_hash", "multicastHwHash", "string", None, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, [], []), 
