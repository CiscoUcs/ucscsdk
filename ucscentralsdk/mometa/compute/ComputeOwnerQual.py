"""This module contains the general information for ComputeOwnerQual ManagedObject."""
...
class ComputeOwnerQualConsts():
    pass


class ComputeOwnerQual(ManagedObject):
    """This is ComputeOwnerQual class."""

    consts = ComputeOwnerQualConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("ComputeOwnerQual", "computeOwnerQual", "owner-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["admin", "pn-policy", "read-only"], [u'computeDomainQual', u'computeSystemQual'], [], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeOwnerQual", parent_mo_or_dn, **kwargs)
