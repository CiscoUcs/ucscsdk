"""This module contains the general information for ComputeSystemFsm ManagedObject."""
...
class ComputeSystemFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_REGISTER = "Register"
    CURRENT_FSM_NOP = "nop"
...
class ComputeSystemFsm(ManagedObject):
    """This is ComputeSystemFsm class."""

    consts = ComputeSystemFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ComputeSystemFsm", "computeSystemFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'computeSystem'], [u'computeSystemFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Register", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ComputeSystemFsm", parent_mo_or_dn, **kwargs)
