...
class IdentpoolMetaVerse(ManagedObject):
    ...
    mo_meta = MoMeta("IdentpoolMetaVerse", "identpoolMetaVerse", "metaverse", VersionMeta.Version101a, "InputOutput", 0x1f, [], ["read-only"], [u'topRoot'], [u'identpoolMetaSystem'], [None])
