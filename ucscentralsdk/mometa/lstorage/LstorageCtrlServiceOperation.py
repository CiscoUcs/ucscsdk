...
class LstorageCtrlServiceOperation(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageCtrlServiceOperation", "lstorageCtrlServiceOperation", "remote-oper", VersionMeta.Version131a, "InputOutput", 0x7f, [], ["admin", "ls-storage", "pn-equipment", "pn-maintenance", "pn-policy"], [], [u'faultInst'], [None])
