...
class LstorageDiskZoningPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageDiskZoningPolicy", "lstorageDiskZoningPolicy", "disk-zoning-policy-[name]", None, "InputOutput", 0x7f, [], ["read-only"], [u'orgOrg'], [u'lstorageDiskSlot'], [None])
