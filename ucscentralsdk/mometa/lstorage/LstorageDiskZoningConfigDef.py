...
class LstorageDiskZoningConfigDef(ManagedObject):
    ...
    mo_meta = MoMeta("LstorageDiskZoningConfigDef", "lstorageDiskZoningConfigDef", "disk-zoning-def", None, "InputOutput", 0x7f, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'lstorageDiskSlot'], [None])
    ...
    prop_meta = {
        ...
        "preserve_config": MoPropertyMeta("preserve_config", "preserveConfig", "string", None, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["false", "no", "true", "yes"], []), 
