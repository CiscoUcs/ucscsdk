...
class CommDateTime(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "timezoneBegin", "timezoneChange", "timezoneFail", "timezoneSuccess"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "timezoneBegin", "timezoneChange", "timezoneFail", "timezoneSuccess"], []), 
