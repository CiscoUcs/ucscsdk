...
class CommDateTimeFsmTask(ManagedObject):
    ...
    mo_meta = MoMeta("CommDateTimeFsmTask", "commDateTimeFsmTask", "task-[item]", None, "OutputOnly", 0xf, [], [""], [u'commDateTime'], [], [None])
    ...
    prop_meta = {
        ...
        "item": MoPropertyMeta("item", "item", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "timezone"], []), 
