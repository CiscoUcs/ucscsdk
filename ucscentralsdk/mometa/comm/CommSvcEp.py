...
class CommSvcEpConsts():
    ...
    FSM_PREV_RESTART_WEB_SVC_RESTART = "restartWebSvcRestart"
    ...
    FSM_STATUS_RESTART_WEB_SVC_RESTART = "restartWebSvcRestart"
...
class CommSvcEp(ManagedObject):
    ...
    mo_meta = MoMeta("CommSvcEp", "commSvcEp", "svc-ext", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["aaa", "admin"], [u'computeSystem', u'topSystem'], [u'commDateTime', u'commHttps', u'commSvcEpFsm', u'commSvcEpFsmTask', u'eventInst', u'faultInst'], ["Get"])
    ...
    prop_meta = {
        ...
        "config_status_message": MoPropertyMeta("config_status_message", "configStatusMessage", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "restartWebSvcBegin", "restartWebSvcFail", "restartWebSvcRestart", "restartWebSvcSuccess"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "restartWebSvcBegin", "restartWebSvcFail", "restartWebSvcRestart", "restartWebSvcSuccess"], []), 
