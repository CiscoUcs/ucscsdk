...
class CommDateTimeFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("CommDateTimeFsmStage", "commDateTimeFsmStage", "stage-[name]", None, "OutputOnly", 0xf, [], [""], [u'commDateTimeFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["nop", "timezoneBegin", "timezoneChange", "timezoneFail", "timezoneSuccess"], []), 
