...
class CommSyslogConsole(ManagedObject):
    ...
    mo_meta = MoMeta("CommSyslogConsole", "commSyslogConsole", "console", VersionMeta.Version101a, "InputOutput", 0xff, [], ["admin", "operations"], [u'commSyslog'], [], ["Add", "Get", "Set"])
    ...
    prop_meta = {
        ...
        "severity": MoPropertyMeta("severity", "severity", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["alerts", "critical", "emergencies"], []), 
