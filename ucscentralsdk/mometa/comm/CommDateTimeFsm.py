...
class CommDateTimeFsm(ManagedObject):
    ...
    mo_meta = MoMeta("CommDateTimeFsm", "commDateTimeFsm", "fsm", None, "OutputOnly", 0xf, [], [""], [u'commDateTime'], [u'commDateTimeFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "timezone"], []), 
