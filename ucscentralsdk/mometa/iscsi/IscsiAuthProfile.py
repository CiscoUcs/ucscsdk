...
class IscsiAuthProfile(ManagedObject):
    ...
    mo_meta = MoMeta("IscsiAuthProfile", "iscsiAuthProfile", "iscsi-auth-profile-[name]", VersionMeta.Version111a, "InputOutput", 0xff, [], ["read-only"], [u'orgOrg'], [], ["Add", "Get", "Remove", "Set"])
