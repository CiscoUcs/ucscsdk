"""This module contains the general information for ExtpolClientFsm ManagedObject."""
...
class ExtpolClientFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_UPDATE_CONTEXT_FSM = "UpdateContextFsm"
    CURRENT_FSM_NOP = "nop"
...
class ExtpolClientFsm(ManagedObject):
    """This is ExtpolClientFsm class."""

    consts = ExtpolClientFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ExtpolClientFsm", "extpolClientFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'extpolClient'], [u'extpolClientFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["UpdateContextFsm", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ExtpolClientFsm", parent_mo_or_dn, **kwargs)
