...
class StatsThresholdPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("StatsThresholdPolicy", "statsThresholdPolicy", "thr-policy-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["read-only"], [u'fabricCabling', u'fabricDceSrv', u'fabricEthEstcCloud', u'fabricFcEstcCloud', u'fabricLanCloud', u'fabricSanCloud', u'orgOrg'], [u'statsThresholdClass'], ["Add", "Get", "Remove", "Set"])
