...
class StatsPasadenaCollectionPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("StatsPasadenaCollectionPolicy", "statsPasadenaCollectionPolicy", "pasadena-coll-policy", VersionMeta.Version111b, "InputOutput", 0x7ff, [], ["admin", "operations"], [u'statsHolder'], [], ["Get"])
