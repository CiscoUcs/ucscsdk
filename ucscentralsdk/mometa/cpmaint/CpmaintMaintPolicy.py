...
class CpmaintMaintPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("CpmaintMaintPolicy", "cpmaintMaintPolicy", "chassis-profile-maint-[name]", None, "InputOutput", 0x1ff, [], ["read-only"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "oper_sched_name": MoPropertyMeta("oper_sched_name", "operSchedName", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "sched_name": MoPropertyMeta("sched_name", "schedName", "string", None, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "trigger_config": MoPropertyMeta("trigger_config", "triggerConfig", "string", None, MoPropertyMeta.READ_WRITE, 0x80, None, None, r"""((defaultValue|none|on-next-boot),){0,2}(defaultValue|none|on-next-boot){0,1}""", [], []), 
        "uptime_disr": MoPropertyMeta("uptime_disr", "uptimeDisr", "string", None, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["user-ack"], []), 
    }
