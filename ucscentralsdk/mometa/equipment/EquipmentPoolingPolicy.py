...
class EquipmentPoolingPolicy(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPoolingPolicy", "equipmentPoolingPolicy", "chassis-pooling-policy-[name]", None, "InputOutput", 0xff, [], ["read-only"], [u'orgOrg'], [], [None])
    ...
    prop_meta = {
        ...
        "pool_dn": MoPropertyMeta("pool_dn", "poolDn", "string", None, MoPropertyMeta.READ_WRITE, 0x10, 0, 256, None, [], []), 
        "qualifier": MoPropertyMeta("qualifier", "qualifier", "string", None, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
