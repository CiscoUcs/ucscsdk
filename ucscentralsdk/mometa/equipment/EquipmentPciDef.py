...
class EquipmentPciDef(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentPciDef", "equipmentPciDef", "pci-[name]", None, "InputOutput", 0x1f, [], [""], [u'equipmentLocalDiskControllerCapProvider'], [], [None])

    prop_meta = {
        "child_action": MoPropertyMeta("child_action", "childAction", "string", None, MoPropertyMeta.INTERNAL, None, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "device": MoPropertyMeta("device", "device", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, 0x4, 1, 512, None, [], []), 
        ...
        "subdevice": MoPropertyMeta("subdevice", "subdevice", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "subvendor": MoPropertyMeta("subvendor", "subvendor", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "vendor": MoPropertyMeta("vendor", "vendor", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
    }
