...
class EquipmentTemplate(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentTemplate", "equipmentTemplate", "chassis-templ-[name]", None, "InputOutput", 0x3f, [], ["read-only"], [u'orgOrg'], [u'equipmentChassisProfile', u'equipmentLocalTemplDef'], [None])
