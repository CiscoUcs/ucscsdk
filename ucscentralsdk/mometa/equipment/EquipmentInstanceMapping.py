...
class EquipmentInstanceMapping(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentInstanceMapping", "equipmentInstanceMapping", "instmap-[name]", None, "InputOutput", 0x3f, [], ["admin"], [u'computeSystem'], [], [None])
    ...
    prop_meta = {
        ...
        "instance_dn": MoPropertyMeta("instance_dn", "instanceDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
