"""This module contains the general information for EquipmentSystemIOControllerOperation ManagedObject."""
...
class EquipmentSystemIOControllerOperation(ManagedObject):
    """This is EquipmentSystemIOControllerOperation class."""

    consts = EquipmentSystemIOControllerOperationConsts()
    naming_props = set([])

    mo_meta = MoMeta("EquipmentSystemIOControllerOperation", "equipmentSystemIOControllerOperation", "remote-oper", None, "InputOutput", 0x7f, [], ["admin", "ls-network", "ls-network-policy", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentSystemIOController'], [u'faultInst'], [None])

    prop_meta = {
        "admin_power_state": MoPropertyMeta("admin_power_state", "adminPowerState", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["cycle-immediate", "cycle-wait", "policy", "remoteAdminPowerTrigger"], []), 
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", None, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["acknowledged", "auto-acknowledge", "decommission", "disable-port-channel", "enable-port-channel", "re-acknowledge", "remoteTrigger", "remove"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "EquipmentSystemIOControllerOperation", parent_mo_or_dn, **kwargs)
