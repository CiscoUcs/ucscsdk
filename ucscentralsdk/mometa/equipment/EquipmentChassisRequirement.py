...
class EquipmentChassisRequirement(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisRequirement", "equipmentChassisRequirement", "chassis-req-[name]", None, "InputOutput", 0x3f, [], ["read-only"], [u'orgOrg'], [u'equipmentInstance'], [None])
    ...
    prop_meta = {
        ...
        "placement_ref_cnt": MoPropertyMeta("placement_ref_cnt", "placementRefCnt", "ushort", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
