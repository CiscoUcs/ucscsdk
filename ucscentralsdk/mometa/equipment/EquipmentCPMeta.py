...
class EquipmentCPMeta(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentCPMeta", "equipmentCPMeta", "cpmeta", None, "InputOutput", 0x3f, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile'], [u'messageEp'], [None])
    ...
    prop_meta = {
        ...
        "config_qualifier": MoPropertyMeta("config_qualifier", "configQualifier", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|not-applicable),){0,1}(defaultValue|not-applicable){0,1}""", [], []), 
        "cp_refresh": MoPropertyMeta("cp_refresh", "cpRefresh", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["disabled", "enabled"], []), 
        ...
        "is_rename": MoPropertyMeta("is_rename", "isRename", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        "need_id_re_evaluate": MoPropertyMeta("need_id_re_evaluate", "needIdReEvaluate", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["no", "yes"], []), 
        "new_cpdn": MoPropertyMeta("new_cpdn", "newCPDN", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "old_cpdn": MoPropertyMeta("old_cpdn", "oldCPDN", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "operation_code": MoPropertyMeta("operation_code", "operationCode", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["associate", "deletion", "disassociate", "no-op", "rename"], []), 
        "operation_code_clearance": MoPropertyMeta("operation_code_clearance", "operationCodeClearance", "string", None, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["disabled", "enabled"], []), 
        "ownership_state": MoPropertyMeta("ownership_state", "ownershipState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["delete-pending", "disassoc-pending", "global-controlled", "localized"], []), 
