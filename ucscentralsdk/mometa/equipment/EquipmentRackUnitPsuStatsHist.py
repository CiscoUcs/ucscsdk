...
class EquipmentRackUnitPsuStatsHist(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentRackUnitPsuStatsHist", "equipmentRackUnitPsuStatsHist", "[id]", VersionMeta.Version111a, "OutputOnly", 0xf, [], ["read-only"], [u'equipmentRackUnitPsuStats'], [], [None])
    ...
    prop_meta = {
        ...
        "output_voltage": MoPropertyMeta("output_voltage", "outputVoltage", "float", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
