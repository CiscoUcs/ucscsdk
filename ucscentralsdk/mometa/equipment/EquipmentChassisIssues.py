...
class EquipmentChassisIssues(ManagedObject):
    ...
    mo_meta = MoMeta("EquipmentChassisIssues", "equipmentChassisIssues", "config-issue", None, "InputOutput", 0xf, [], ["admin", "pn-equipment", "pn-maintenance", "pn-policy"], [u'equipmentChassisProfile', u'equipmentInstance'], [], [None])
    ...
    prop_meta = {
        ...
        "config_warnings": MoPropertyMeta("config_warnings", "configWarnings", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|not-applicable),){0,1}(defaultValue|not-applicable){0,1}""", [], []), 
