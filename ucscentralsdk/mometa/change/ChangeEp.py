"""This module contains the general information for ChangeEp ManagedObject."""
...
class ChangeEpConsts():
    FSM_PREV_SYNC_CHANGE_UCSBEGIN = "SyncChangeUCSBegin"
    FSM_PREV_SYNC_CHANGE_UCSFAIL = "SyncChangeUCSFail"
    FSM_PREV_SYNC_CHANGE_UCSSUCCESS = "SyncChangeUCSSuccess"
    FSM_PREV_SYNC_CHANGE_UCSSYNC = "SyncChangeUCSSync"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_SYNC_CHANGE_UCSBEGIN = "SyncChangeUCSBegin"
    FSM_STATUS_SYNC_CHANGE_UCSFAIL = "SyncChangeUCSFail"
    FSM_STATUS_SYNC_CHANGE_UCSSUCCESS = "SyncChangeUCSSuccess"
    FSM_STATUS_SYNC_CHANGE_UCSSYNC = "SyncChangeUCSSync"
    FSM_STATUS_NOP = "nop"
...
class ChangeEp(ManagedObject):
    """This is ChangeEp class."""

    consts = ChangeEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("ChangeEp", "changeEp", "syncEp", VersionMeta.Version111a, "InputOutput", 0xf, [], ["read-only"], [u'extpolDomain'], [u'changeChangedObjectRef', u'changeEpFsm', u'changeEpFsmTask', u'eventInst', u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["SyncChangeUCSBegin", "SyncChangeUCSFail", "SyncChangeUCSSuccess", "SyncChangeUCSSync", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["SyncChangeUCSBegin", "SyncChangeUCSFail", "SyncChangeUCSSuccess", "SyncChangeUCSSync", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "gen_num_sync": MoPropertyMeta("gen_num_sync", "genNumSync", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "is_changed_object_update": MoPropertyMeta("is_changed_object_update", "isChangedObjectUpdate", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ChangeEp", parent_mo_or_dn, **kwargs)
