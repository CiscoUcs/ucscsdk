"""This module contains the general information for ChangeEpFsm ManagedObject."""
...
class ChangeEpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_SYNC_CHANGE_UCS = "SyncChangeUCS"
    CURRENT_FSM_NOP = "nop"
...
class ChangeEpFsm(ManagedObject):
    """This is ChangeEpFsm class."""

    consts = ChangeEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ChangeEpFsm", "changeEpFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'changeEp'], [u'changeEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["SyncChangeUCS", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ChangeEpFsm", parent_mo_or_dn, **kwargs)
