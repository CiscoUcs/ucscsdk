...
class FabricDceSwSrvPcOperationFsmStage(ManagedObject):
    ...
    mo_meta = MoMeta("FabricDceSwSrvPcOperationFsmStage", "fabricDceSwSrvPcOperationFsmStage", "stage-[name]", None, "OutputOnly", 0xf, [], [""], [u'fabricDceSwSrvPcOperationFsm'], [], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, None, None, None, None, ["FIPortBegin", "FIPortCleanUp", "FIPortFail", "FIPortPushVxan", "FIPortRoleConfig", "FIPortSuccess", "FIPortVxanConfig", "FIPortWait", "nop"], []), 
