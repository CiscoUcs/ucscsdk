"""This module contains the general information for FabricEthEstcPcOperation ManagedObject."""
...
class FabricEthEstcPcOperationConsts():
...
class FabricEthEstcPcOperation(ManagedObject):
    ...
    prop_meta = {
        ...
        "flow_ctrl_policy": MoPropertyMeta("flow_ctrl_policy", "flowCtrlPolicy", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "lacp_policy_name": MoPropertyMeta("lacp_policy_name", "lacpPolicyName", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x40, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "nw_ctrl_policy_name": MoPropertyMeta("nw_ctrl_policy_name", "nwCtrlPolicyName", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x100, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "pin_group_name": MoPropertyMeta("pin_group_name", "pinGroupName", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x200, 0, 510, None, [], []), 
        ...
        "prio": MoPropertyMeta("prio", "prio", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x1000, None, None, None, ["best-effort", "bronze", "fc", "gold", "platinum", "silver"], []), 
        "protocol": MoPropertyMeta("protocol", "protocol", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x2000, None, None, None, ["lacp", "static"], []), 
        ...
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, 0x4000, 0, 256, None, [], []), 
        ...
        "trigger_status": MoPropertyMeta("trigger_status", "triggerStatus", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x10000, None, None, None, ["trigger-acked", "trigger-failed", "triggered", "unknown"], []), 
        "vlan_name": MoPropertyMeta("vlan_name", "vlanName", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x20000, 0, 510, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthEstcPcOperation", parent_mo_or_dn, **kwargs)
