...
class FabricFcMon(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcMon", "fabricFcMon", "fc-mon-[name]", None, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcMonSan'], [u'fabricEthMonDestEp', u'fabricFcMonDestEp', u'fabricFcMonSrcRef', u'fabricSubGroup'], [None])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "string", None, MoPropertyMeta.CREATE_ONLY, 0x8, None, None, None, ["A", "B", "NONE", "mgmt"], []), 
