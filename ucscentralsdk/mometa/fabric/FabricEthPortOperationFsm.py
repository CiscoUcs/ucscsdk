"""This module contains the general information for FabricEthPortOperationFsm ManagedObject."""
...
class FabricEthPortOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricEthPortOperationFsm(ManagedObject):
    """This is FabricEthPortOperationFsm class."""

    consts = FabricEthPortOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricEthPortOperationFsm", "fabricEthPortOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthEstcEpOperation', u'fabricEthEstcPcOperation', u'fabricEthLanEpOperation', u'fabricEthLanPcOperation'], [u'fabricEthPortOperationFsmStage'], [None])
