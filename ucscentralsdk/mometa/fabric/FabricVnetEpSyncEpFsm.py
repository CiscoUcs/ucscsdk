...
class FabricVnetEpSyncEpFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_SYNC_VNET_EP_UCS = "SyncVnetEpUCS"
    CURRENT_FSM_NOP = "nop"
...
class FabricVnetEpSyncEpFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVnetEpSyncEpFsm", "fabricVnetEpSyncEpFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricVnetEpSyncEp'], [u'fabricVnetEpSyncEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["SyncVnetEpUCS", "nop"], []), 
