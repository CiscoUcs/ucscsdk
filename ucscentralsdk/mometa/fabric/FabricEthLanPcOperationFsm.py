"""This module contains the general information for FabricEthLanPcOperationFsm ManagedObject."""
...
class FabricEthLanPcOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricEthLanPcOperationFsm(ManagedObject):
    """This is FabricEthLanPcOperationFsm class."""

    consts = FabricEthLanPcOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricEthLanPcOperationFsm", "fabricEthLanPcOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthLanPcOperation'], [u'fabricEthLanPcOperationFsmStage'], [None])
