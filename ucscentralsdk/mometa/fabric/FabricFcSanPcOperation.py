"""This module contains the general information for FabricFcSanPcOperation ManagedObject."""
...
class FabricFcSanPcOperationConsts():
...
class FabricFcSanPcOperation(ManagedObject):
    """This is FabricFcSanPcOperation class."""

    consts = FabricFcSanPcOperationConsts()
    naming_props = set([u'portId'])

    mo_meta = MoMeta("FabricFcSanPcOperation", "fabricFcSanPcOperation", "remoper-pc-[port_id]", VersionMeta.Version141a, "InputOutput", 0x7ff, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan'], [u'eventInst', u'fabricFIPortOperationFsm', u'fabricFIPortOperationFsmTask', u'fabricFcPortOperationFsm', u'fabricFcSanPcEpOperation', u'fabricFcSanPcOperationFsm', u'faultInst', u'vnicFc'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcSanPcOperation", parent_mo_or_dn, **kwargs)
