"""This module contains the general information for FabricFcoeSanEpOperation ManagedObject."""
...
class FabricFcoeSanEpOperationConsts():
...
class FabricFcoeSanEpOperation(ManagedObject):
    """This is FabricFcoeSanEpOperation class."""

    consts = FabricFcoeSanEpOperationConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("FabricFcoeSanEpOperation", "fabricFcoeSanEpOperation", "remoper-phys-fcoesanep-slot-[slot_id]-port-[port_id]", VersionMeta.Version141a, "InputOutput", 0x7ff, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan', u'fabricSubGroup'], [u'eventInst', u'fabricFIPortOperationFsm', u'fabricFIPortOperationFsmTask', u'fabricFcPortOperationFsm', u'fabricFcoeSanEpOperationFsm', u'faultInst', u'vnicFc'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeSanEpOperation", parent_mo_or_dn, **kwargs)
