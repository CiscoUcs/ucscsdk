...
class FabricSubGroup(ManagedObject):
    ...
    mo_meta = MoMeta("FabricSubGroup", "fabricSubGroup", "slot-[slot_id]-aggr-port-[aggr_port_id]", VersionMeta.Version121a, "InputOutput", 0x7f, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy", "ls-network", "ls-network-policy"], [u'fabricDceSwSrv', u'fabricEthEstc', u'fabricEthEstcPc', u'fabricEthEstcPcOperation', u'fabricEthLan', u'fabricEthLanPc', u'fabricEthLanPcOperation', u'fabricFcEstc', u'fabricFcSan', u'fabricFcoeSanPc', u'fabricFcoeSanPcOperation'], [u'fabricDceSwSrvEp', u'fabricDceSwSrvEpOperation', u'fabricEthEstcEp', u'fabricEthEstcEpOperation', u'fabricEthEstcPcEp', u'fabricEthEstcPcEpOperation', u'fabricEthLanEp', u'fabricEthLanEpOperation', u'fabricEthLanPcEp', u'fabricEthLanPcEpOperation', u'fabricFcoeEstcEp', u'fabricFcoeEstcEpOperation', u'fabricFcoeSanEp', u'fabricFcoeSanEpOperation', u'fabricFcoeSanPcEp', u'fabricFcoeSanPcEpOperation'], ["Get", "Set"])

    prop_meta = {
        "aggr_port_id": MoPropertyMeta("aggr_port_id", "aggrPortId", "uint", VersionMeta.Version121a, MoPropertyMeta.NAMING, 0x2, None, None, None, [], ["1-48"]), 
