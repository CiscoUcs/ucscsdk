"""This module contains the general information for FabricFcoeSanPcOperation ManagedObject."""
...
class FabricFcoeSanPcOperationConsts():
...
class FabricFcoeSanPcOperation(ManagedObject):
    """This is FabricFcoeSanPcOperation class."""

    consts = FabricFcoeSanPcOperationConsts()
    naming_props = set([u'portId'])

    mo_meta = MoMeta("FabricFcoeSanPcOperation", "fabricFcoeSanPcOperation", "remoper-fcoesanpc-[port_id]", VersionMeta.Version141a, "InputOutput", 0x7ff, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan'], [u'eventInst', u'fabricFIPortOperationFsm', u'fabricFIPortOperationFsmTask', u'fabricFcPortOperationFsm', u'fabricFcoeSanPcEpOperation', u'fabricFcoeSanPcOperationFsm', u'fabricSubGroup', u'faultInst', u'vnicFc'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "lacp_policy_name": MoPropertyMeta("lacp_policy_name", "lacpPolicyName", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version141a, MoPropertyMeta.NAMING, 0x40, None, None, None, [], ["1-256"]), 
        ...
        "trigger_status": MoPropertyMeta("trigger_status", "triggerStatus", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, ["trigger-acked", "trigger-failed", "triggered", "unknown"], []), 
        "vsan_name": MoPropertyMeta("vsan_name", "vsanName", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x400, 0, 510, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeSanPcOperation", parent_mo_or_dn, **kwargs)
