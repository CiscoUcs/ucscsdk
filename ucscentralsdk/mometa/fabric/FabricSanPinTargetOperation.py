...
class FabricSanPinTargetOperation(ManagedObject):
    ...
    mo_meta = MoMeta("FabricSanPinTargetOperation", "fabricSanPinTargetOperation", "remoper-target-[fabric_id]", VersionMeta.Version141a, "InputOutput", 0x7f, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricSanPinGroupOperation'], [u'faultInst'], ["Add", "Get", "Remove", "Set"])
