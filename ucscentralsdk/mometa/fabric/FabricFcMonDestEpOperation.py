"""This module contains the general information for FabricFcMonDestEpOperation ManagedObject."""
...
class FabricFcMonDestEpOperationConsts():
...
class FabricFcMonDestEpOperation(ManagedObject):
    """This is FabricFcMonDestEpOperation class."""

    consts = FabricFcMonDestEpOperationConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("FabricFcMonDestEpOperation", "fabricFcMonDestEpOperation", "remoper-dest-slot-[slot_id]-port-[port_id]", None, "InputOutput", 0x3ff, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricFcMonOperation', u'fabricSubGroup'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", None, MoPropertyMeta.NAMING, 0x80, None, None, None, [], ["1-5"]), 
        ...
        "trigger_status": MoPropertyMeta("trigger_status", "triggerStatus", "string", None, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, ["trigger-acked", "trigger-failed", "triggered", "unknown"], []), 
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcMonDestEpOperation", parent_mo_or_dn, **kwargs)
