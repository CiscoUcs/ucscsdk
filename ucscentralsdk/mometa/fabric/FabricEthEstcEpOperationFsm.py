"""This module contains the general information for FabricEthEstcEpOperationFsm ManagedObject."""
...
class FabricEthEstcEpOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricEthEstcEpOperationFsm(ManagedObject):
    """This is FabricEthEstcEpOperationFsm class."""

    consts = FabricEthEstcEpOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricEthEstcEpOperationFsm", "fabricEthEstcEpOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthEstcEpOperation'], [u'fabricEthEstcEpOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthEstcEpOperationFsm", parent_mo_or_dn, **kwargs)
