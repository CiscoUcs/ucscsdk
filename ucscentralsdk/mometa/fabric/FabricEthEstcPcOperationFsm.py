"""This module contains the general information for FabricEthEstcPcOperationFsm ManagedObject."""
...
class FabricEthEstcPcOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricEthEstcPcOperationFsm(ManagedObject):
    """This is FabricEthEstcPcOperationFsm class."""

    consts = FabricEthEstcPcOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricEthEstcPcOperationFsm", "fabricEthEstcPcOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthEstcPcOperation'], [u'fabricEthEstcPcOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthEstcPcOperationFsm", parent_mo_or_dn, **kwargs)
