"""This module contains the general information for FabricFcMonOperation ManagedObject."""
...
class FabricFcMonOperationConsts():
...
class FabricFcMonOperation(ManagedObject):
    """This is FabricFcMonOperation class."""

    consts = FabricFcMonOperationConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("FabricFcMonOperation", "fabricFcMonOperation", "remoper-fc-mon-[name]", None, "InputOutput", 0xff, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcMonSan'], [u'eventInst', u'fabricEthMonDestEpOperation', u'fabricFIPortOperationFsm', u'fabricFIPortOperationFsmTask', u'fabricFcMonDestEp', u'fabricFcMonDestEpOperation', u'fabricFcMonOperationFsm', u'fabricFcPortOperationFsm', u'fabricSubGroup', u'faultInst', u'messageEp', u'vnicFc', u'vnicMonSesFc'], [None])
    ...
    prop_meta = {
        ...
        "config_fail_reason": MoPropertyMeta("config_fail_reason", "configFailReason", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["FIPortBegin", "FIPortCleanUp", "FIPortFail", "FIPortPushVxan", "FIPortRoleConfig", "FIPortSuccess", "FIPortVxanConfig", "FIPortWait", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", None, MoPropertyMeta.INTERNAL, None, None, None, None, ["FIPortBegin", "FIPortCleanUp", "FIPortFail", "FIPortPushVxan", "FIPortRoleConfig", "FIPortSuccess", "FIPortVxanConfig", "FIPortWait", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", None, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "is_config_success": MoPropertyMeta("is_config_success", "isConfigSuccess", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["down", "error", "unknown", "up"], []), 
        "oper_state_reason": MoPropertyMeta("oper_state_reason", "operStateReason", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Active", "Generic_Error", "No_Destination_Configured", "No_Flow-id_Specified", "No_Hardware_Resource", "No_Operational_Src_Dst", "No_Source_Destination_Configured", "No_Sources_Configured", "Session_Admin_Shut", "Tunnel_Misconf_Down", "Unknown", "Wrong_Destination_Mode", "Wrong_Source_Mode"], []), 
        ...
        "session": MoPropertyMeta("session", "session", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["1-255"]), 
        ...
        "trigger_status": MoPropertyMeta("trigger_status", "triggerStatus", "string", None, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["trigger-acked", "trigger-failed", "triggered", "unknown"], []), 
        ...
        "vsan_name": MoPropertyMeta("vsan_name", "vsanName", "string", None, MoPropertyMeta.READ_WRITE, 0x80, 0, 510, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcMonOperation", parent_mo_or_dn, **kwargs)
