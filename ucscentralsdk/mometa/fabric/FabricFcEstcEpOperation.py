"""This module contains the general information for FabricFcEstcEpOperation ManagedObject."""
...
class FabricFcEstcEpOperationConsts():
...
class FabricFcEstcEpOperation(ManagedObject):
    ...
    prop_meta = {
        ...
        "fill_pattern": MoPropertyMeta("fill_pattern", "fillPattern", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["arbff", "idle"], []), 
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", VersionMeta.Version141a, MoPropertyMeta.NAMING, 0x20, None, None, None, [], ["1-48"]), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version141a, MoPropertyMeta.NAMING, 0x80, None, None, None, [], ["1-5"]), 
        ...
        "usr_lbl": MoPropertyMeta("usr_lbl", "usrLbl", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x400, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], []), 
        "vsan_name": MoPropertyMeta("vsan_name", "vsanName", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x800, 0, 510, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcEstcEpOperation", parent_mo_or_dn, **kwargs)
