...
class FabricDceSwSrvPcOperationFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricDceSwSrvPcOperationFsm", "fabricDceSwSrvPcOperationFsm", "fsm", None, "OutputOnly", 0xf, [], [""], [u'fabricDceSwSrvPcOperation'], [u'fabricDceSwSrvPcOperationFsmStage'], [None])
