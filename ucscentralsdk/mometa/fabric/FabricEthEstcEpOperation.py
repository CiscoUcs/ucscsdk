"""This module contains the general information for FabricEthEstcEpOperation ManagedObject."""
...
class FabricEthEstcEpOperation(ManagedObject):
    """This is FabricEthEstcEpOperation class."""

    consts = FabricEthEstcEpOperationConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("FabricEthEstcEpOperation", "fabricEthEstcEpOperation", "remoper-phys-eth-slot-[slot_id]-port-[port_id]", VersionMeta.Version141a, "InputOutput", 0xffff, [], ["admin", "ext-lan-config", "ext-lan-policy"], [u'fabricEthEstc', u'fabricSubGroup'], [u'eventInst', u'fabricEthEstcEpOperationFsm', u'fabricEthPortOperationFsm', u'fabricEthTargetEpOperation', u'fabricFIPortOperationFsm', u'fabricFIPortOperationFsmTask', u'faultInst', u'vnicEther'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["disabled", "enabled", "remoteTrigger"], []), 
        ...
        "flow_ctrl_policy": MoPropertyMeta("flow_ctrl_policy", "flowCtrlPolicy", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", VersionMeta.Version141a, MoPropertyMeta.NAMING, 0x800, None, None, None, [], ["1-4"]), 
        ...
        "usr_lbl": MoPropertyMeta("usr_lbl", "usrLbl", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x4000, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], []), 
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthEstcEpOperation", parent_mo_or_dn, **kwargs)
