...
class FabricEthMonOperationFsm(ManagedObject):
    ...
    mo_meta = MoMeta("FabricEthMonOperationFsm", "fabricEthMonOperationFsm", "fsm", None, "OutputOnly", 0xf, [], [""], [u'fabricEthMonOperation'], [u'fabricEthMonOperationFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["FIPort", "nop"], []), 
