"""This module contains the general information for FabricFcSanPcOperationFsm ManagedObject."""
...
class FabricFcSanPcOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricFcSanPcOperationFsm(ManagedObject):
    """This is FabricFcSanPcOperationFsm class."""

    consts = FabricFcSanPcOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricFcSanPcOperationFsm", "fabricFcSanPcOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcSanPcOperation'], [u'fabricFcSanPcOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcSanPcOperationFsm", parent_mo_or_dn, **kwargs)
