...
class FabricExtension(ManagedObject):
    ...
    mo_meta = MoMeta("FabricExtension", "fabricExtension", "extension", VersionMeta.Version141a, "InputOutput", 0x1f, [], ["admin", "ext-lan-config", "ext-lan-policy", "ext-san-config", "ext-san-policy"], [u'fabricVlan', u'fabricVsan'], [], [None])
