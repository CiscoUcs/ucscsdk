...
class FabricFcoeEstcEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricFcoeEstcEp", "fabricFcoeEstcEp", "phys-fcoe-slot-[slot_id]-port-[port_id]", VersionMeta.Version111a, "InputOutput", 0x3ff, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcEstc', u'fabricSubGroup'], [u'etherFcoeInterfaceStats', u'fabricVsanEp', u'fabricVsanMembership', u'faultInst'], ["Get", "Set"])
