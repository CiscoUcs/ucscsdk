"""This module contains the general information for FabricFcoeSanEpOperationFsm ManagedObject."""
...
class FabricFcoeSanEpOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricFcoeSanEpOperationFsm(ManagedObject):
    """This is FabricFcoeSanEpOperationFsm class."""

    consts = FabricFcoeSanEpOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricFcoeSanEpOperationFsm", "fabricFcoeSanEpOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcoeSanEpOperation'], [u'fabricFcoeSanEpOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeSanEpOperationFsm", parent_mo_or_dn, **kwargs)
