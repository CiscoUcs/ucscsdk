"""This module contains the general information for FabricDceSwSrvPcOperation ManagedObject."""
...
class FabricDceSwSrvPcOperationConsts():
...
class FabricDceSwSrvPcOperation(ManagedObject):
    ...
    prop_meta = {
        ...
        "oper_speed": MoPropertyMeta("oper_speed", "operSpeed", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["10gbps", "1gbps", "20gbps", "40gbps", "indeterminate"], []), 
        "port_id": MoPropertyMeta("port_id", "portId", "uint", None, MoPropertyMeta.NAMING, 0x20, None, None, None, [], ["1024-4096"]), 
        ...
        "trigger_status": MoPropertyMeta("trigger_status", "triggerStatus", "string", None, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["trigger-acked", "trigger-failed", "triggered", "unknown"], []), 
    ...
    def __init__(self, parent_mo_or_dn, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricDceSwSrvPcOperation", parent_mo_or_dn, **kwargs)
