"""This module contains the general information for FabricFcEstcEpOperationFsm ManagedObject."""
...
class FabricFcEstcEpOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricFcEstcEpOperationFsm(ManagedObject):
    """This is FabricFcEstcEpOperationFsm class."""

    consts = FabricFcEstcEpOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricFcEstcEpOperationFsm", "fabricFcEstcEpOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcEstcEpOperation'], [u'fabricFcEstcEpOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcEstcEpOperationFsm", parent_mo_or_dn, **kwargs)
