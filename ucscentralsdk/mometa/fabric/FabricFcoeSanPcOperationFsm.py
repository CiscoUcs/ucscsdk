"""This module contains the general information for FabricFcoeSanPcOperationFsm ManagedObject."""
...
class FabricFcoeSanPcOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricFcoeSanPcOperationFsm(ManagedObject):
    """This is FabricFcoeSanPcOperationFsm class."""

    consts = FabricFcoeSanPcOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricFcoeSanPcOperationFsm", "fabricFcoeSanPcOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcoeSanPcOperation'], [u'fabricFcoeSanPcOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcoeSanPcOperationFsm", parent_mo_or_dn, **kwargs)
