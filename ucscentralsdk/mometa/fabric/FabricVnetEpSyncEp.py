...
class FabricVnetEpSyncEpConsts():
    FSM_PREV_SYNC_VNET_EP_UCSBEGIN = "SyncVnetEpUCSBegin"
    FSM_PREV_SYNC_VNET_EP_UCSFAIL = "SyncVnetEpUCSFail"
    FSM_PREV_SYNC_VNET_EP_UCSSUCCESS = "SyncVnetEpUCSSuccess"
    FSM_PREV_SYNC_VNET_EP_UCSSYNC = "SyncVnetEpUCSSync"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_SYNC_VNET_EP_UCSBEGIN = "SyncVnetEpUCSBegin"
    FSM_STATUS_SYNC_VNET_EP_UCSFAIL = "SyncVnetEpUCSFail"
    FSM_STATUS_SYNC_VNET_EP_UCSSUCCESS = "SyncVnetEpUCSSuccess"
    FSM_STATUS_SYNC_VNET_EP_UCSSYNC = "SyncVnetEpUCSSync"
    FSM_STATUS_NOP = "nop"
...
class FabricVnetEpSyncEp(ManagedObject):
    ...
    mo_meta = MoMeta("FabricVnetEpSyncEp", "fabricVnetEpSyncEp", "syncEp", VersionMeta.Version111a, "InputOutput", 0xf, [], ["read-only"], [u'extpolClient'], [u'eventInst', u'fabricChangedObjectRef', u'fabricVnetEpSyncEpFsm', u'fabricVnetEpSyncEpFsmTask', u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["SyncVnetEpUCSBegin", "SyncVnetEpUCSFail", "SyncVnetEpUCSSuccess", "SyncVnetEpUCSSync", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["SyncVnetEpUCSBegin", "SyncVnetEpUCSFail", "SyncVnetEpUCSSuccess", "SyncVnetEpUCSSync", "nop"], []), 
