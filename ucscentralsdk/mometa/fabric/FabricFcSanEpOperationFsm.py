"""This module contains the general information for FabricFcSanEpOperationFsm ManagedObject."""
...
class FabricFcSanEpOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricFcSanEpOperationFsm(ManagedObject):
    """This is FabricFcSanEpOperationFsm class."""

    consts = FabricFcSanEpOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricFcSanEpOperationFsm", "fabricFcSanEpOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcSanEpOperation'], [u'fabricFcSanEpOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcSanEpOperationFsm", parent_mo_or_dn, **kwargs)
