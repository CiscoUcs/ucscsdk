...
class FabricDceSwSrvPcEpOperation(ManagedObject):
    ...
    mo_meta = MoMeta("FabricDceSwSrvPcEpOperation", "fabricDceSwSrvPcEpOperation", "remoper-ep-slot-[slot_id]-port-[port_id]", None, "InputOutput", 0x1ff, [], ["admin", "ls-network", "ls-network-policy"], [u'fabricDceSwSrvPcOperation', u'fabricSubGroup'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "port_id": MoPropertyMeta("port_id", "portId", "uint", None, MoPropertyMeta.NAMING, 0x8, None, None, None, [], ["1-48"]), 
        ...
        "slot_id": MoPropertyMeta("slot_id", "slotId", "uint", None, MoPropertyMeta.NAMING, 0x20, None, None, None, [], ["1-4"]), 
        ...
        "trigger_status": MoPropertyMeta("trigger_status", "triggerStatus", "string", None, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["trigger-acked", "trigger-failed", "triggered", "unknown"], []), 
        "usr_lbl": MoPropertyMeta("usr_lbl", "usrLbl", "string", None, MoPropertyMeta.READ_WRITE, 0x100, None, None, r"""[ !#$%&\(\)\*\+,\-\./:;\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], []), 
    }
