"""This module contains the general information for FabricFcSanEpOperation ManagedObject."""
...
class FabricFcSanEpOperationConsts():
...
class FabricFcSanEpOperation(ManagedObject):
    """This is FabricFcSanEpOperation class."""

    consts = FabricFcSanEpOperationConsts()
    naming_props = set([u'slotId', u'portId'])

    mo_meta = MoMeta("FabricFcSanEpOperation", "fabricFcSanEpOperation", "remoper-phys-slot-[slot_id]-port-[port_id]", VersionMeta.Version141a, "InputOutput", 0x7ff, [], ["admin", "ext-san-config", "ext-san-policy"], [u'fabricFcSan'], [u'eventInst', u'fabricFIPortOperationFsm', u'fabricFIPortOperationFsmTask', u'fabricFcPortOperationFsm', u'fabricFcSanEpOperationFsm', u'faultInst', u'vnicFc'], ["Add", "Get", "Remove", "Set"])
    ...
    def __init__(self, parent_mo_or_dn, slot_id, port_id, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcSanEpOperation", parent_mo_or_dn, **kwargs)
