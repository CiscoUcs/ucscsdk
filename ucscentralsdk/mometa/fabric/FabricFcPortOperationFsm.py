"""This module contains the general information for FabricFcPortOperationFsm ManagedObject."""
...
class FabricFcPortOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricFcPortOperationFsm(ManagedObject):
    """This is FabricFcPortOperationFsm class."""

    consts = FabricFcPortOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricFcPortOperationFsm", "fabricFcPortOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricFcEstcEpOperation', u'fabricFcSanEpOperation', u'fabricFcSanPcOperation', u'fabricFcoeEstcEpOperation', u'fabricFcoeSanEpOperation', u'fabricFcoeSanPcOperation'], [u'fabricFcPortOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricFcPortOperationFsm", parent_mo_or_dn, **kwargs)
