"""This module contains the general information for FabricEthLanEpOperationFsm ManagedObject."""
...
class FabricEthLanEpOperationFsmConsts():
    COMPLETION_TIME_ = ""
...
class FabricEthLanEpOperationFsm(ManagedObject):
    """This is FabricEthLanEpOperationFsm class."""

    consts = FabricEthLanEpOperationFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("FabricEthLanEpOperationFsm", "fabricEthLanEpOperationFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'fabricEthLanEpOperation'], [u'fabricEthLanEpOperationFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "FabricEthLanEpOperationFsm", parent_mo_or_dn, **kwargs)
