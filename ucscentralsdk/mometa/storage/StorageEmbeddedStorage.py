...
class StorageEmbeddedStorage(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEmbeddedStorage", "storageEmbeddedStorage", "embedded-storage", None, "InputOutput", 0xf, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController'], [], [None])
