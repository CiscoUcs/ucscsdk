...
class StorageEnclosure(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEnclosure", "storageEnclosure", "enc-[id]", VersionMeta.Version131a, "InputOutput", 0x7f, [], ["admin", "ls-storage"], [u'computeBlade', u'computeRackUnit', u'computeServerUnit', u'equipmentChassis', u'storageBlade', u'storageController'], [u'storageEnclosureDiskSlotEp', u'storageLocalDisk'], ["Get"])

    prop_meta = {
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["acknowledged", "remove", "remove-failed", "removing"], []), 
        "chassis_id": MoPropertyMeta("chassis_id", "chassisId", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "server_id": MoPropertyMeta("server_id", "serverId", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "type": MoPropertyMeta("type", "type", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["dedicated-rear-ssd-enclosure", "hdd-expansion-tray", "hdd-mother-board", "ioe-nvme-enclosure", "sb-nvme-enclosure", "unknown"], []), 
