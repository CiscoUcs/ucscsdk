...
class StorageEnclosure(ManagedObject):
    ...
    mo_meta = MoMeta("StorageEnclosure", "storageEnclosure", "enc-[id]", VersionMeta.Version131a, "InputOutput", 0x3f, [], ["read-only"], [u'storageBlade', u'storageController'], [u'storageLocalDisk'], ["Get"])
    ...
    prop_meta = {
        ...
        "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version131a, MoPropertyMeta.NAMING, 0x8, None, None, None, [], ["1-2"]), 
