...
class StorageOnboardDevice(ManagedObject):
    ...
    mo_meta = MoMeta("StorageOnboardDevice", "storageOnboardDevice", "onboard-device-[device_type]-[id]", None, "InputOutput", 0x3f, [], ["admin", "ls-compute", "ls-config", "ls-server", "ls-storage"], [u'storageController', u'storageSasExpander'], [u'firmwareBootDefinition', u'firmwareRunning', u'firmwareUpdatable'], [None])
    ...
    prop_meta = {
        ...
        "device_type": MoPropertyMeta("device_type", "deviceType", "string", None, MoPropertyMeta.NAMING, 0x2, None, None, None, ["cpld", "sas-exp-reg-fw-dev", "sbr", "unknown"], []), 
