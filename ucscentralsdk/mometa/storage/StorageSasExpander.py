...
class StorageSasExpander(ManagedObject):
    ...
    prop_meta = {
        ...
        "current_epfb": MoPropertyMeta("current_epfb", "currentEPFB", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version131a, MoPropertyMeta.READ_ONLY, 0x2, 0, 256, None, [], []), 
        "elid": MoPropertyMeta("elid", "elid", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "expander_state": MoPropertyMeta("expander_state", "expanderState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["degraded", "inoperable", "not-ready", "operable", "resource-unavailable", "unknown", "unreachable"], []), 
        ...
        "mfg_major_rev": MoPropertyMeta("mfg_major_rev", "mfgMajorRev", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "mfg_minor_rev": MoPropertyMeta("mfg_minor_rev", "mfgMinorRev", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "mfg_platform_id": MoPropertyMeta("mfg_platform_id", "mfgPlatformId", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "persisted_epfb": MoPropertyMeta("persisted_epfb", "persistedEPFB", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "start_slot_num": MoPropertyMeta("start_slot_num", "startSlotNum", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "temperature": MoPropertyMeta("temperature", "temperature", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-applicable"], ["0-4294967295"]), 
        ...
        "total_slots": MoPropertyMeta("total_slots", "totalSlots", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "uplink_state": MoPropertyMeta("uplink_state", "uplinkState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["misconnect", "optimal", "sub-optimal", "unknown"], []), 
        "uplink_state_reason": MoPropertyMeta("uplink_state_reason", "uplinkStateReason", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
