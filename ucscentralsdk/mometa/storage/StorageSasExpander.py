...
class StorageSasExpander(ManagedObject):
    ...
    mo_meta = MoMeta("StorageSasExpander", "storageSasExpander", "sas-expander-[id]", VersionMeta.Version131a, "InputOutput", 0x1f, [], ["read-only"], [u'computeBoard'], [u'firmwareBootDefinition', u'firmwareRunning'], [None])
