...
class StorageControllerRef(ManagedObject):
    ...
    mo_meta = MoMeta("StorageControllerRef", "storageControllerRef", "server-[server_id]-controller-[controller_type]-[controller_id]", None, "InputOutput", 0x7f, [], ["read-only"], [u'storageEnclosureDiskSlotEp'], [], [None])
    ...
    prop_meta = {
        ...
        "server_id": MoPropertyMeta("server_id", "serverId", "uint", None, MoPropertyMeta.NAMING, 0x20, None, None, None, [], []), 
