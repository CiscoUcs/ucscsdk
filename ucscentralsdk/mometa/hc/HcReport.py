...
class HcReport(ManagedObject):
    ...
    mo_meta = MoMeta("HcReport", "hcReport", "report-[name]", None, "InputOutput", 0x7fffff, [], ["admin"], [u'hcHolder'], [u'hcScopeDn', u'hcServerComponent'], [None])
    ...
    prop_meta = {
        ...
        "condition": MoPropertyMeta("condition", "condition", "string", None, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["all", "cannot-determine", "not-supported", "ok"], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", None, MoPropertyMeta.READ_ONLY, 0x20, 0, 256, None, [], []), 
        "domain_group_scope_dn_cnt": MoPropertyMeta("domain_group_scope_dn_cnt", "domainGroupScopeDnCnt", "ulong", None, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, [], []), 
        "domain_scope_dn_cnt": MoPropertyMeta("domain_scope_dn_cnt", "domainScopeDnCnt", "ulong", None, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, [], []), 
        "equipment_scope_dn_cnt": MoPropertyMeta("equipment_scope_dn_cnt", "equipmentScopeDnCnt", "ulong", None, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, [], []), 
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, 0x200, None, None, r"""[\-\.:_a-zA-Z0-9]{2,16}""", [], []), 
        "profile_scope_dn_cnt": MoPropertyMeta("profile_scope_dn_cnt", "profileScopeDnCnt", "ulong", None, MoPropertyMeta.READ_WRITE, 0x400, None, None, None, [], []), 
        "report_all": MoPropertyMeta("report_all", "reportAll", "string", None, MoPropertyMeta.READ_WRITE, 0x800, None, None, None, ["false", "no", "true", "yes"], []), 
        "report_completion_time": MoPropertyMeta("report_completion_time", "reportCompletionTime", "string", None, MoPropertyMeta.READ_WRITE, 0x1000, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        "report_error_code": MoPropertyMeta("report_error_code", "reportErrorCode", "string", None, MoPropertyMeta.READ_WRITE, 0x2000, None, None, None, ["adapter-fw-version-not-found", "adapter-not-tagged", "dn-not-specified", "dn-not-supported", "invalid-input", "missing-data-in-catalog", "no-matching-servers-found", "none", "os-not-tagged", "retry", "target-fw-version-invalid", "target-fw-version-not-specified", "ucs-fw-version-not-found"], []), 
        "report_generation_status": MoPropertyMeta("report_generation_status", "reportGenerationStatus", "string", None, MoPropertyMeta.READ_WRITE, 0x4000, None, None, None, ["failed", "in-progress", "not-started", "success"], []), 
        "report_start_time": MoPropertyMeta("report_start_time", "reportStartTime", "string", None, MoPropertyMeta.READ_WRITE, 0x8000, None, None, r"""([0-9]){4}-([0-9]){2}-([0-9]){2}T([0-9]){2}:([0-9]){2}:([0-9]){2}((\.([0-9]){3})){0,1}""", [], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", None, MoPropertyMeta.READ_ONLY, 0x10000, 0, 256, None, [], []), 
        "status": MoPropertyMeta("status", "status", "string", None, MoPropertyMeta.READ_WRITE, 0x20000, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        "target_blade_firmware_version": MoPropertyMeta("target_blade_firmware_version", "targetBladeFirmwareVersion", "string", None, MoPropertyMeta.READ_WRITE, 0x40000, 0, 510, None, [], []), 
        "target_modular_firmware_version": MoPropertyMeta("target_modular_firmware_version", "targetModularFirmwareVersion", "string", None, MoPropertyMeta.READ_WRITE, 0x80000, 0, 510, None, [], []), 
        "target_rack_firmware_version": MoPropertyMeta("target_rack_firmware_version", "targetRackFirmwareVersion", "string", None, MoPropertyMeta.READ_WRITE, 0x100000, 0, 510, None, [], []), 
        "target_ucs_firmware_version": MoPropertyMeta("target_ucs_firmware_version", "targetUCSFirmwareVersion", "string", None, MoPropertyMeta.READ_WRITE, 0x200000, 0, 510, None, [], []), 
        "total_components": MoPropertyMeta("total_components", "totalComponents", "uint", None, MoPropertyMeta.READ_WRITE, 0x400000, None, None, None, [], []), 
    }
