...
class PkiEpConsts():
    ...
    FSM_PREV_UPDATE_EP_SET_CERT_CONF_LOCAL = "updateEpSetCertConfLocal"
    ...
    FSM_STATUS_UPDATE_EP_SET_CERT_CONF_LOCAL = "updateEpSetCertConfLocal"
...
class PkiEp(ManagedObject):
    ...
    mo_meta = MoMeta("PkiEp", "pkiEp", "pki-ext", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["aaa", "admin"], [u'policyDeviceProfile', u'topSystem'], [u'eventInst', u'faultInst', u'pkiEpFsm', u'pkiEpFsmTask', u'pkiKeyRing', u'pkiTP'], ["Get"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version112a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpSetCertConfLocal", "updateEpSuccess"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version112a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateEpBegin", "updateEpFail", "updateEpSetCertConfLocal", "updateEpSuccess"], []), 
