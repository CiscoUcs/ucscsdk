"""This module contains the general information for ConfigBackup ManagedObject."""
...
class ConfigBackupConsts():
    ADMIN_STATE_ACTIVE = "active"
    ADMIN_STATE_DELETE = "delete"
    BACKUP_TYPE_CONFIG_ALL = "config-all"
    BACKUP_TYPE_FULL_STATE = "full-state"
...
class ConfigBackup(ManagedObject):
    ...
    prop_meta = {
        ...
        "backup_type": MoPropertyMeta("backup_type", "backupType", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, 0x4, None, None, None, ["config-all", "full-state"], []), 
        "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "config_qualifier": MoPropertyMeta("config_qualifier", "configQualifier", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|not-applicable|remote-failed),){0,2}(defaultValue|not-applicable|remote-failed){0,1}""", [], []), 
        "creation_ts": MoPropertyMeta("creation_ts", "creationTS", "ulong", VersionMeta.Version101a, MoPropertyMeta.NAMING, 0x8, None, None, None, [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, 0x10, 0, 256, None, [], []), 
        "fault_descr": MoPropertyMeta("fault_descr", "faultDescr", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "file_name": MoPropertyMeta("file_name", "fileName", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        "file_path": MoPropertyMeta("file_path", "filePath", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "gen_number": MoPropertyMeta("gen_number", "genNumber", "uint", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "tftp_url": MoPropertyMeta("tftp_url", "tftpURL", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, backup_type, creation_ts, **kwargs):
        self._dirty_mask = 0
        ...
        ManagedObject.__init__(self, "ConfigBackup", parent_mo_or_dn, **kwargs)
