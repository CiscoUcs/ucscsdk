"""This module contains the general information for ConfigBackupFsm ManagedObject."""
...
class ConfigBackupFsm(ManagedObject):
    """This is ConfigBackupFsm class."""

    consts = ConfigBackupFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ConfigBackupFsm", "configBackupFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'configBackup'], [u'configBackupFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Delete", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigBackupFsm", parent_mo_or_dn, **kwargs)
