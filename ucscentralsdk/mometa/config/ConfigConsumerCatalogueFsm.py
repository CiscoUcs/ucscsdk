"""This module contains the general information for ConfigConsumerCatalogueFsm ManagedObject."""
...
class ConfigConsumerCatalogueFsmConsts():
    COMPLETION_TIME_ = ""
...
class ConfigConsumerCatalogueFsm(ManagedObject):
    """This is ConfigConsumerCatalogueFsm class."""

    consts = ConfigConsumerCatalogueFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("ConfigConsumerCatalogueFsm", "configConsumerCatalogueFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'configConsumerCatalogue'], [u'configConsumerCatalogueFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Create", "Delete", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigConsumerCatalogueFsm", parent_mo_or_dn, **kwargs)
