"""This module contains the general information for ConfigChassisFilter ManagedObject."""
...
class ConfigChassisFilterConsts():
...
class ConfigChassisFilter(ManagedObject):
    """This is ConfigChassisFilter class."""

    consts = ConfigChassisFilterConsts()
    naming_props = set([])

    mo_meta = MoMeta("ConfigChassisFilter", "configChassisFilter", "chassic-filter", VersionMeta.Version131a, "InputOutput", 0x7ff, [], ["read-only"], [], [], [None])
    ...
    prop_meta = {
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", VersionMeta.Version131a, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["accessibility-problem", "auto-upgrade", "bios-post-timeout", "chassis-limit-exceeded", "config", "decomissioning", "degraded", "disabled", "discovery", "discovery-failed", "equipment-problem", "fabric-conn-problem", "fabric-unsupported-conn", "identify", "identity-unestablishable", "inoperable", "malformed-fru", "not-supported", "operable", "peer-comm-problem", "performance-problem", "post-failure", "power-problem", "powered-off", "removed", "thermal-problem", "unknown", "upgrade-problem", "voltage-problem"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ConfigChassisFilter", parent_mo_or_dn, **kwargs)
