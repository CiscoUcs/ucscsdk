...
class TestingServiceProfileFsm(ManagedObject):
    """This is TestingServiceProfileFsm class."""

    consts = TestingServiceProfileFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("TestingServiceProfileFsm", "testingServiceProfileFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'testingServiceProfile'], [u'testingServiceProfileFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ResolveManyPolicyFsm", "ResolvePolicyFsm", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "TestingServiceProfileFsm", parent_mo_or_dn, **kwargs)
