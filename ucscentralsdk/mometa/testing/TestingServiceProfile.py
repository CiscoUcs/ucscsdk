"""This module contains the general information for TestingServiceProfile ManagedObject."""
...
class TestingServiceProfileConsts():
    ...
    FSM_PREV_RESOLVE_POLICY_FSM_RESOLVE = "ResolvePolicyFsmResolve"
    ...
    FSM_STATUS_RESOLVE_POLICY_FSM_RESOLVE = "ResolvePolicyFsmResolve"
    FSM_STATUS_RESOLVE_POLICY_FSM_SUCCESS = "ResolvePolicyFsmSuccess"
    FSM_STATUS_NOP = "nop"
    POLICY_RESOLVE_TYPE_NAME = "name"
    POLICY_RESOLVE_TYPE_RN = "rn"


class TestingServiceProfile(ManagedObject):
    """This is TestingServiceProfile class."""

    consts = TestingServiceProfileConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("TestingServiceProfile", "testingServiceProfile", "service-profile-[name]", VersionMeta.Version101a, "InputOutput", 0x1ff, [], ["admin", "read-only"], [u'orgOrg'], [u'eventInst', u'faultInst', u'testingServiceProfileFsm', u'testingServiceProfileFsmTask'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ResolveManyPolicyFsmBegin", "ResolveManyPolicyFsmFail", "ResolveManyPolicyFsmResolveMany", "ResolveManyPolicyFsmSuccess", "ResolvePolicyFsmBegin", "ResolvePolicyFsmFail", "ResolvePolicyFsmResolve", "ResolvePolicyFsmSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ResolveManyPolicyFsmBegin", "ResolveManyPolicyFsmFail", "ResolveManyPolicyFsmResolveMany", "ResolveManyPolicyFsmSuccess", "ResolvePolicyFsmBegin", "ResolvePolicyFsmFail", "ResolvePolicyFsmResolve", "ResolvePolicyFsmSuccess", "nop"], []), 
        ...
        "org_dn": MoPropertyMeta("org_dn", "orgDn", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x8, 0, 256, None, [], []), 
        "policy_name": MoPropertyMeta("policy_name", "policyName", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x10, 0, 510, None, [], []), 
        "policy_resolve_type": MoPropertyMeta("policy_resolve_type", "policyResolveType", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["name", "rn"], []), 
        "policy_type": MoPropertyMeta("policy_type", "policyType", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x40, 0, 510, None, [], []), 
    ...
    prop_map = {
        ...
        "policyResolveType": "policy_resolve_type", 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        self.policy_resolve_type = None
        self.policy_type = None
        self.status = None

        ManagedObject.__init__(self, "TestingServiceProfile", parent_mo_or_dn, **kwargs)
