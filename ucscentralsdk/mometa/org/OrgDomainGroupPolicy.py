"""This module contains the general information for OrgDomainGroupPolicy ManagedObject."""
...
class OrgDomainGroupPolicyConsts():
...
class OrgDomainGroupPolicy(ManagedObject):
    """This is OrgDomainGroupPolicy class."""

    consts = OrgDomainGroupPolicyConsts()
    naming_props = set([u'name'])

    mo_meta = MoMeta("OrgDomainGroupPolicy", "orgDomainGroupPolicy", "domaingroup-policy-[name]", VersionMeta.Version101a, "InputOutput", 0xff, [], ["read-only"], [u'orgOrg'], [u'faultInst'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "group_dn": MoPropertyMeta("group_dn", "groupDn", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x8, 0, 256, None, [], []), 
        ...
        "qualifier": MoPropertyMeta("qualifier", "qualifier", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
    ...
    def __init__(self, parent_mo_or_dn, name, **kwargs):
        ...
        ManagedObject.__init__(self, "OrgDomainGroupPolicy", parent_mo_or_dn, **kwargs)
