"""This module contains the general information for OrgOrgFsm ManagedObject."""
...
class OrgOrgFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONFIGURE = "configure"
    CURRENT_FSM_CONFIGURE_PEER = "configurePeer"
    CURRENT_FSM_NOP = "nop"
...
class OrgOrgFsm(ManagedObject):
    """This is OrgOrgFsm class."""

    consts = OrgOrgFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("OrgOrgFsm", "orgOrgFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'orgOrg'], [u'orgOrgFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["configure", "configurePeer", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "OrgOrgFsm", parent_mo_or_dn, **kwargs)
