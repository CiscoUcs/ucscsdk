...
class OrgOrgConsts():
    ...
    FSM_PREV_CONFIGURE_PEER_BEGIN = "configurePeerBegin"
    FSM_PREV_CONFIGURE_PEER_CONFIG = "configurePeerConfig"
    FSM_PREV_CONFIGURE_PEER_FAIL = "configurePeerFail"
    FSM_PREV_CONFIGURE_PEER_SUCCESS = "configurePeerSuccess"
    ...
    FSM_STATUS_CONFIGURE_PEER_BEGIN = "configurePeerBegin"
    FSM_STATUS_CONFIGURE_PEER_CONFIG = "configurePeerConfig"
    FSM_STATUS_CONFIGURE_PEER_FAIL = "configurePeerFail"
    FSM_STATUS_CONFIGURE_PEER_SUCCESS = "configurePeerSuccess"
...
class OrgOrg(ManagedObject):
    ...
    mo_meta = MoMeta("OrgOrg", "orgOrg", "org-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["read-only"], [u'orgOrg'], [u'aaaEpAuthProfile', u'adaptorHostEthIfProfile', u'adaptorHostFcIfProfile', u'adaptorHostIscsiIfProfile', u'biosVProfile', u'callhomeEp', u'cimcvmediaMountConfigPolicy', u'commCimxml', u'commCoreFile', u'commDateTime', u'commDns', u'commEvtChannel', u'commHttp', u'commHttps', u'commShellSvcLimits', u'commSmashCLP', u'commSnmp', u'commSsh', u'commSvcPolicy', u'commSyslog', u'commTelnet', u'commWebChannel', u'commWebSvcLimits', u'commWsman', u'computeAutoconfigPolicy', u'computeBladeDiscPolicy', u'computeBladeInheritPolicy', u'computeChassisDiscPolicy', u'computePool', u'computePoolingPolicy', u'computeQual', u'computeRequirement', u'computeScrubPolicy', u'computeServerDiscPolicy', u'computeServerMgmtPolicy', u'computeSystemQual', u'computeTemplate', u'epqosDefinition', u'eventInst', u'fabricLacpPolicy', u'fabricMulticastPolicy', u'fabricOrgVlanPolicy', u'fabricUdldPolicy', u'fabricVConProfile', u'fabricVlanGroupReq', u'fabricVlanPermit', u'fabricVlanReq', u'faultInst', u'faultPolicy', u'fcpoolInitiators', u'firmwareCatalogPack', u'firmwareComputeHostPack', u'firmwareComputeMgmtPack', u'firmwareComputeStoragePack', u'firmwareInfraPack', u'firmwareInfraPolicy', u'firmwareStoragePack', u'identpoolBlockQual', u'ippoolPool', u'iqnpoolPool', u'iscsiAuthProfile', u'lsServer', u'lsTier', u'lsWaitingUserAck', u'lsbootPolicy', u'lsmaintMaintPolicy', u'lstorageArrayRequirement', u'lstorageDiskGroupConfigPolicy', u'lstorageProfile', u'macpoolPool', u'mgmtBackupPolicy', u'mgmtCfgExportPolicy', u'nwctrlDefinition', u'orgDomainGroupPolicy', u'orgExtension', u'orgOrg', u'orgOrgFsm', u'orgOrgFsmTask', u'orgOrgSource', u'orgSourceMask', u'policyDeviceProfile', u'policyIdentifierPolicy', u'policyLogProfile', u'policySystemProfile', u'powerPolicy', u'smartlicenseEp', u'solPolicy', u'statsThresholdPolicy', u'storageConnectionPolicy', u'storageLocalDiskConfigPolicy', u'testingCliPolicy', u'testingServiceProfile', u'testingSnmpPolicy', u'trigTest', u'uuidpoolPool', u'vnicDynamicCon', u'vnicDynamicConPolicy', u'vnicFcGroupTempl', u'vnicLanConnPolicy', u'vnicLanConnTempl', u'vnicSanConnPolicy', u'vnicSanConnTempl', u'vnicUsnicConPolicy', u'vnicVhbaBehPolicy', u'vnicVmqConPolicy', u'vnicVnicBehPolicy'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["configureBegin", "configureConfig", "configureFail", "configurePeerBegin", "configurePeerConfig", "configurePeerFail", "configurePeerSuccess", "configureSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["configureBegin", "configureConfig", "configureFail", "configurePeerBegin", "configurePeerConfig", "configurePeerFail", "configurePeerSuccess", "configureSuccess", "nop"], []), 
