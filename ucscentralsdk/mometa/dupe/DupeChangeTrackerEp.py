"""This module contains the general information for DupeChangeTrackerEp ManagedObject."""
...
class DupeChangeTrackerEpConsts():
    FSM_PREV_CONFIGURE_BEGIN = "ConfigureBegin"
    FSM_PREV_CONFIGURE_FAIL = "ConfigureFail"
    FSM_PREV_CONFIGURE_SEND_CHANGE = "ConfigureSendChange"
    ...
    FSM_STATUS_CONFIGURE_SEND_CHANGE = "ConfigureSendChange"
    FSM_STATUS_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_STATUS_NOP = "nop"


class DupeChangeTrackerEp(ManagedObject):
    """This is DupeChangeTrackerEp class."""

    consts = DupeChangeTrackerEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("DupeChangeTrackerEp", "dupeChangeTrackerEp", "changetracker-ep", VersionMeta.Version131a, "InputOutput", 0xf, [], ["read-only"], [u'dupeEp'], [u'dupeChangeTracker', u'dupeChangeTrackerEpFsm', u'dupeChangeTrackerEpFsmTask', u'eventInst', u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version131a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureSendChange", "ConfigureSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version131a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureSendChange", "ConfigureSuccess", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "DupeChangeTrackerEp", parent_mo_or_dn, **kwargs)
