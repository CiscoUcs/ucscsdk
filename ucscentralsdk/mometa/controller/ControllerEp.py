"""This module contains the general information for ControllerEp ManagedObject."""
...
class ControllerEpConsts():
    FSM_PREV_QUIESCE_BEGIN = "QuiesceBegin"
    FSM_PREV_QUIESCE_FAIL = "QuiesceFail"
    FSM_PREV_QUIESCE_QUIESCE_IDMGR = "QuiesceQuiesceIDMgr"
    FSM_PREV_QUIESCE_QUIESCE_MGMT_CONTROLLER = "QuiesceQuiesceMgmtController"
    FSM_PREV_QUIESCE_QUIESCE_OPS_MGR = "QuiesceQuiesceOpsMgr"
    FSM_PREV_QUIESCE_QUIESCE_POLICY_MGR = "QuiesceQuiescePolicyMgr"
    FSM_PREV_QUIESCE_QUIESCE_RES_MGR = "QuiesceQuiesceResMgr"
    FSM_PREV_QUIESCE_QUIESCE_STATS_MGR = "QuiesceQuiesceStatsMgr"
    FSM_PREV_QUIESCE_SUCCESS = "QuiesceSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_QUIESCE_BEGIN = "QuiesceBegin"
    FSM_STATUS_QUIESCE_FAIL = "QuiesceFail"
    FSM_STATUS_QUIESCE_QUIESCE_IDMGR = "QuiesceQuiesceIDMgr"
    FSM_STATUS_QUIESCE_QUIESCE_MGMT_CONTROLLER = "QuiesceQuiesceMgmtController"
    FSM_STATUS_QUIESCE_QUIESCE_OPS_MGR = "QuiesceQuiesceOpsMgr"
    FSM_STATUS_QUIESCE_QUIESCE_POLICY_MGR = "QuiesceQuiescePolicyMgr"
    FSM_STATUS_QUIESCE_QUIESCE_RES_MGR = "QuiesceQuiesceResMgr"
    FSM_STATUS_QUIESCE_QUIESCE_STATS_MGR = "QuiesceQuiesceStatsMgr"
    FSM_STATUS_QUIESCE_SUCCESS = "QuiesceSuccess"
    FSM_STATUS_NOP = "nop"


class ControllerEp(ManagedObject):
    """This is ControllerEp class."""

    consts = ControllerEpConsts()
    naming_props = set([])

    mo_meta = MoMeta("ControllerEp", "controllerEp", "controller", VersionMeta.Version111a, "InputOutput", 0xf, [], ["read-only"], [u'topRoot'], [u'controllerEpFsm', u'controllerEpFsmTask', u'eventInst', u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["QuiesceBegin", "QuiesceFail", "QuiesceQuiesceIDMgr", "QuiesceQuiesceMgmtController", "QuiesceQuiesceOpsMgr", "QuiesceQuiescePolicyMgr", "QuiesceQuiesceResMgr", "QuiesceQuiesceStatsMgr", "QuiesceSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["QuiesceBegin", "QuiesceFail", "QuiesceQuiesceIDMgr", "QuiesceQuiesceMgmtController", "QuiesceQuiesceOpsMgr", "QuiesceQuiescePolicyMgr", "QuiesceQuiesceResMgr", "QuiesceQuiesceStatsMgr", "QuiesceSuccess", "nop"], []), 
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "ControllerEp", **kwargs)
