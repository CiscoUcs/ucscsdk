"""This module contains the general information for CertRepairEp ManagedObject."""
...
class CertRepairEp(ManagedObject):
    """This is CertRepairEp class."""
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "repairCertBegin", "repairCertFail", "repairCertRequest", "repairCertSuccess", "repairCertVerify"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "repairCertBegin", "repairCertFail", "repairCertRequest", "repairCertSuccess", "repairCertVerify"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "repair_state": MoPropertyMeta("repair_state", "repairState", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["done", "not-done"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CertRepairEp", parent_mo_or_dn, **kwargs)
