"""This module contains the general information for CertRepairEpFsm ManagedObject."""
...
class CertRepairEpFsm(ManagedObject):
    """This is CertRepairEpFsm class."""

    consts = CertRepairEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("CertRepairEpFsm", "certRepairEpFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'certRepairEp'], [u'certRepairEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "repairCert"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CertRepairEpFsm", parent_mo_or_dn, **kwargs)
