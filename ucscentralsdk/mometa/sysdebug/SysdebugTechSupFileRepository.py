...
class SysdebugTechSupFileRepository(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupFileRepository", "sysdebugTechSupFileRepository", "tech-support-files", VersionMeta.Version101a, "InputOutput", 0xf, [], ["admin", "operations"], [u'computeSystem', u'topSystem'], [u'sysdebugTechSupport', u'sysdebugTechSupportOperation'], ["Get"])
