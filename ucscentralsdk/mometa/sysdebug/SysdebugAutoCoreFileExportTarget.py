...
class SysdebugAutoCoreFileExportTarget(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugAutoCoreFileExportTarget", "sysdebugAutoCoreFileExportTarget", "file-export", VersionMeta.Version101a, "InputOutput", 0x7ff, [], ["admin", "operations"], [u'orgDomainGroup', u'policyDeviceProfile', u'sysdebugEp'], [u'eventInst', u'faultInst', u'sysdebugAutoCoreFileExportTargetFsm', u'sysdebugAutoCoreFileExportTargetFsmTask'], ["Add", "Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureLocal", "ConfigureSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureLocal", "ConfigureSuccess", "nop"], []), 
        ...
        "post_action": MoPropertyMeta("post_action", "postAction", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, [], []), 
