...
class SysdebugCore(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugCore", "sysdebugCore", "file-[name]", VersionMeta.Version101a, "InputOutput", 0x3f, [], ["admin", "operations"], [u'sysdebugCoreFileRepository'], [u'faultInst', u'sysdebugManualCoreFileExportTarget', u'sysfileMutation'], ["Get"])
