...
class SysdebugLogControlEpConsts():
    FSM_PREV_NOP = "nop"
    FSM_PREV_PERSISTENCE_BEGIN = "persistenceBegin"
    FSM_PREV_PERSISTENCE_FAIL = "persistenceFail"
    FSM_PREV_PERSISTENCE_PERSIST = "persistencePersist"
    FSM_PREV_PERSISTENCE_SUCCESS = "persistenceSuccess"
    ...
    FSM_STATUS_NOP = "nop"
    FSM_STATUS_PERSISTENCE_BEGIN = "persistenceBegin"
    FSM_STATUS_PERSISTENCE_FAIL = "persistenceFail"
    FSM_STATUS_PERSISTENCE_PERSIST = "persistencePersist"
    FSM_STATUS_PERSISTENCE_SUCCESS = "persistenceSuccess"
    LEVEL_CRIT = "crit"
    LEVEL_DEBUG0 = "debug0"
    LEVEL_DEBUG1 = "debug1"
    LEVEL_DEBUG2 = "debug2"
    ...
    PERSIST_TRUE = "true"
    PERSIST_YES = "yes"
    RESET_LOG_CONTROL_EP_FALSE = "false"
    RESET_LOG_CONTROL_EP_NO = "no"
    RESET_LOG_CONTROL_EP_TRUE = "true"
    RESET_LOG_CONTROL_EP_YES = "yes"
...
class SysdebugLogControlEp(ManagedObject):
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "persistenceBegin", "persistenceFail", "persistencePersist", "persistenceSuccess"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "persistenceBegin", "persistenceFail", "persistencePersist", "persistenceSuccess"], []), 
        ...
        "persist": MoPropertyMeta("persist", "persist", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["false", "no", "true", "yes"], []), 
        "reset_log_control_ep": MoPropertyMeta("reset_log_control_ep", "resetLogControlEp", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["false", "no", "true", "yes"], []), 
    ...
    prop_map = {
        ...
        "persist": "persist", 
        "resetLogControlEp": "reset_log_control_ep", 
        "rn": "rn", 
        "status": "status", 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.persist = None
        self.reset_log_control_ep = None
        self.status = None
