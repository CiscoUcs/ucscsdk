"""This module contains the general information for SmartlicenseTestFsm ManagedObject."""
...
class SmartlicenseTestFsmConsts():
    COMPLETION_TIME_ = ""
...
class SmartlicenseTestFsm(ManagedObject):
    """This is SmartlicenseTestFsm class."""

    consts = SmartlicenseTestFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SmartlicenseTestFsm", "smartlicenseTestFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'smartlicenseTest'], [u'smartlicenseTestFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseTestFsm", parent_mo_or_dn, **kwargs)
