"""This module contains the general information for SmartlicenseAgentFsm ManagedObject."""
...
class SmartlicenseAgentFsmConsts():
    COMPLETION_TIME_ = ""
...
class SmartlicenseAgentFsm(ManagedObject):
    """This is SmartlicenseAgentFsm class."""

    consts = SmartlicenseAgentFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SmartlicenseAgentFsm", "smartlicenseAgentFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'smartlicenseAgent'], [u'smartlicenseAgentFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseAgentFsm", parent_mo_or_dn, **kwargs)
