"""This module contains the general information for SmartlicenseHolderFsm ManagedObject."""
...
class SmartlicenseHolderFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_CONFIGURE = "Configure"
    CURRENT_FSM_UPDATE_STATE = "UpdateState"
    CURRENT_FSM_NOP = "nop"
...
class SmartlicenseHolderFsm(ManagedObject):
    """This is SmartlicenseHolderFsm class."""

    consts = SmartlicenseHolderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SmartlicenseHolderFsm", "smartlicenseHolderFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'smartlicenseHolder'], [u'smartlicenseHolderFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Configure", "UpdateState", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseHolderFsm", parent_mo_or_dn, **kwargs)
