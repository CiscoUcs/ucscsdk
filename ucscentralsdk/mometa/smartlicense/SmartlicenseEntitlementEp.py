"""This module contains the general information for SmartlicenseEntitlementEp ManagedObject."""
...
class SmartlicenseEntitlementEpConsts():
    FSM_PREV_CONFIGURE_BEGIN = "ConfigureBegin"
    FSM_PREV_CONFIGURE_FAIL = "ConfigureFail"
    FSM_PREV_CONFIGURE_REPORT = "ConfigureReport"
    FSM_PREV_CONFIGURE_RETRY_REPORT = "ConfigureRetryReport"
    ...
    FSM_STATUS_CONFIGURE_REPORT = "ConfigureReport"
    FSM_STATUS_CONFIGURE_RETRY_REPORT = "ConfigureRetryReport"
    FSM_STATUS_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_STATUS_NOP = "nop"
    REFRESH_COUNT_FALSE = "false"
    REFRESH_COUNT_NO = "no"
    REFRESH_COUNT_TRUE = "true"
    REFRESH_COUNT_YES = "yes"
...
class SmartlicenseEntitlementEp(ManagedObject):
    """This is SmartlicenseEntitlementEp class."""
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version141a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureReport", "ConfigureRetryReport", "ConfigureSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version141a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureFail", "ConfigureReport", "ConfigureRetryReport", "ConfigureSuccess", "nop"], []), 
        ...
        "refresh_count": MoPropertyMeta("refresh_count", "refreshCount", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["false", "no", "true", "yes"], []), 
        "renew_entitlement": MoPropertyMeta("renew_entitlement", "renewEntitlement", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["false", "no", "true", "yes"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseEntitlementEp", parent_mo_or_dn, **kwargs)
