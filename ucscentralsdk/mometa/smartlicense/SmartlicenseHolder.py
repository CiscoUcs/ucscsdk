"""This module contains the general information for SmartlicenseHolder ManagedObject."""
...
class SmartlicenseHolderConsts():
    CONFIG_REGISTERED_STATE_FALSE = "false"
    CONFIG_REGISTERED_STATE_NO = "no"
    CONFIG_REGISTERED_STATE_TRUE = "true"
    CONFIG_REGISTERED_STATE_YES = "yes"
    CONFIG_STATE_DISABLED = "disabled"
    CONFIG_STATE_ENABLED = "enabled"
    CONFIG_STATE_REGISTERED = "registered"
    CONFIG_STATE_REGISTERFAILED = "registerfailed"
    CONFIG_STATE_REGISTERING = "registering"
    DEREGISTER_FALSE = "false"
    DEREGISTER_NO = "no"
    DEREGISTER_TRUE = "true"
    DEREGISTER_YES = "yes"
    DEREGISTER_FAILED_FALSE = "false"
    DEREGISTER_FAILED_NO = "no"
    DEREGISTER_FAILED_TRUE = "true"
    DEREGISTER_FAILED_YES = "yes"
    ENABLE_STATE_DISABLE = "disable"
    ENABLE_STATE_ENABLE = "enable"
    ENABLE_STATE_FALSE = "false"
    ENABLE_STATE_NO = "no"
    ENABLE_STATE_TRUE = "true"
    ENABLE_STATE_YES = "yes"
    FORCE_REGISTER_FALSE = "false"
    FORCE_REGISTER_NO = "no"
    FORCE_REGISTER_TRUE = "true"
    FORCE_REGISTER_YES = "yes"
    FSM_PREV_CONFIGURE_BEGIN = "ConfigureBegin"
    FSM_PREV_CONFIGURE_DISABLE_SMART_LICENSE = "ConfigureDisableSmartLicense"
    FSM_PREV_CONFIGURE_ENABLE_SMART_LICENSE = "ConfigureEnableSmartLicense"
    FSM_PREV_CONFIGURE_FAIL = "ConfigureFail"
    FSM_PREV_CONFIGURE_REGISTER_DEVICE = "ConfigureRegisterDevice"
    FSM_PREV_CONFIGURE_RETRY_REGISTER_DEVICE = "ConfigureRetryRegisterDevice"
    FSM_PREV_CONFIGURE_RETRY_UNREGISTER_DEVICE = "ConfigureRetryUnregisterDevice"
    FSM_PREV_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_PREV_CONFIGURE_UNREGISTER_DEVICE = "ConfigureUnregisterDevice"
    FSM_PREV_UPDATE_STATE_BEGIN = "UpdateStateBegin"
    FSM_PREV_UPDATE_STATE_FAIL = "UpdateStateFail"
    FSM_PREV_UPDATE_STATE_REFRESH_STATE = "UpdateStateRefreshState"
    FSM_PREV_UPDATE_STATE_SUCCESS = "UpdateStateSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_CONFIGURE_DISABLE_SMART_LICENSE = "ConfigureDisableSmartLicense"
    FSM_STATUS_CONFIGURE_ENABLE_SMART_LICENSE = "ConfigureEnableSmartLicense"
    FSM_STATUS_CONFIGURE_FAIL = "ConfigureFail"
    FSM_STATUS_CONFIGURE_REGISTER_DEVICE = "ConfigureRegisterDevice"
    FSM_STATUS_CONFIGURE_RETRY_REGISTER_DEVICE = "ConfigureRetryRegisterDevice"
    FSM_STATUS_CONFIGURE_RETRY_UNREGISTER_DEVICE = "ConfigureRetryUnregisterDevice"
    FSM_STATUS_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_STATUS_CONFIGURE_UNREGISTER_DEVICE = "ConfigureUnregisterDevice"
    FSM_STATUS_UPDATE_STATE_BEGIN = "UpdateStateBegin"
    FSM_STATUS_UPDATE_STATE_FAIL = "UpdateStateFail"
    FSM_STATUS_UPDATE_STATE_REFRESH_STATE = "UpdateStateRefreshState"
    FSM_STATUS_UPDATE_STATE_SUCCESS = "UpdateStateSuccess"
    FSM_STATUS_NOP = "nop"
    REFRESH_STATE_FALSE = "false"
    REFRESH_STATE_NO = "no"
    REFRESH_STATE_TRUE = "true"
    REFRESH_STATE_YES = "yes"
    RENEW_ENTITLEMENT_FALSE = "false"
    RENEW_ENTITLEMENT_NO = "no"
    RENEW_ENTITLEMENT_TRUE = "true"
    RENEW_ENTITLEMENT_YES = "yes"
...
class SmartlicenseHolder(ManagedObject):
    """This is SmartlicenseHolder class."""

    consts = SmartlicenseHolderConsts()
    naming_props = set([])

    mo_meta = MoMeta("SmartlicenseHolder", "smartlicenseHolder", "smartlicense", VersionMeta.Version141a, "InputOutput", 0x3ff, [], ["admin"], [u'topRoot'], [u'callhomeEp', u'eventInst', u'faultInst', u'smartlicenseAgent', u'smartlicenseEntitlement', u'smartlicenseEntitlementEp', u'smartlicenseEp', u'smartlicenseHolderFsm', u'smartlicenseHolderFsmTask'], ["Get"])
    ...
    def __init__(self, **kwargs):
        ...
        self.report_id_token = None
        self.status = None

        ManagedObject.__init__(self, "SmartlicenseHolder", **kwargs)
