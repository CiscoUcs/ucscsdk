"""This module contains the general information for SmartlicenseTest ManagedObject."""
...
class SmartlicenseTestConsts():
    FSM_PREV_CONFIGURE_BEGIN = "ConfigureBegin"
    FSM_PREV_CONFIGURE_EXECUTE_TEST_CLI = "ConfigureExecuteTestCli"
    ...
    FSM_STATUS_CONFIGURE_EXECUTE_TEST_CLI = "ConfigureExecuteTestCli"
    FSM_STATUS_CONFIGURE_FAIL = "ConfigureFail"
    FSM_STATUS_CONFIGURE_SUCCESS = "ConfigureSuccess"
    FSM_STATUS_NOP = "nop"
    TEST_DEV_CERT_ENABLE_DISABLE = "disable"
    TEST_DEV_CERT_ENABLE_ENABLE = "enable"
    TEST_DEV_CERT_ENABLE_NONE = "none"
    TEST_RESET_EVAL_FALSE = "false"
    TEST_RESET_EVAL_NO = "no"
    TEST_RESET_EVAL_TRUE = "true"
    TEST_RESET_EVAL_YES = "yes"
    TEST_TIMER_NAME_ACK_EXPIRE = "ack-expire"
    TEST_TIMER_NAME_AUTH_EXPIRE = "auth-expire"
    TEST_TIMER_NAME_AUTH_RENEW = "auth-renew"
    TEST_TIMER_NAME_DAILY = "daily"
    TEST_TIMER_NAME_EVAL = "eval"
    TEST_TIMER_NAME_EVAL_WARNING = "eval-warning"
    TEST_TIMER_NAME_GRACE = "grace"
    TEST_TIMER_NAME_IDCERT_EXPIRE = "idcert-expire"
    TEST_TIMER_NAME_IDCERT_RENEW = "idcert-renew"
    TEST_TIMER_NAME_NONE = "none"
    TEST_TIMER_NAME_REGISTRATION = "registration"
    TEST_TRANSPORT_MODE_CALLHOME = "callhome"
    TEST_TRANSPORT_MODE_HTTP = "http"
    TEST_TRANSPORT_MODE_NONE = "none"


class SmartlicenseTest(ManagedObject):
    """This is SmartlicenseTest class."""
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version141a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureExecuteTestCli", "ConfigureFail", "ConfigureSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version141a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureExecuteTestCli", "ConfigureFail", "ConfigureSuccess", "nop"], []), 
        ...
        "test_dev_cert_enable": MoPropertyMeta("test_dev_cert_enable", "testDevCertEnable", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["disable", "enable", "none"], []), 
        "test_reset_eval": MoPropertyMeta("test_reset_eval", "testResetEval", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["false", "no", "true", "yes"], []), 
        "test_timer_name": MoPropertyMeta("test_timer_name", "testTimerName", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["ack-expire", "auth-expire", "auth-renew", "daily", "eval", "eval-warning", "grace", "idcert-expire", "idcert-renew", "none", "registration"], []), 
        "test_timer_value": MoPropertyMeta("test_timer_value", "testTimerValue", "uint", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, [], []), 
        "test_transport_mode": MoPropertyMeta("test_transport_mode", "testTransportMode", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["callhome", "http", "none"], []), 
        "test_transport_url": MoPropertyMeta("test_transport_url", "testTransportUrl", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, [], []), 
    }
    ...
    prop_map = {
        ...
        "rn": "rn", 
        "status": "status", 
        "testDevCertEnable": "test_dev_cert_enable", 
        "testResetEval": "test_reset_eval", 
        "testTimerName": "test_timer_name", 
        "testTimerValue": "test_timer_value", 
        "testTransportMode": "test_transport_mode", 
        "testTransportUrl": "test_transport_url", 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.fsm_try = None
        self.status = None
        self.test_dev_cert_enable = None
        self.test_reset_eval = None
        self.test_timer_name = None
        self.test_timer_value = None
        self.test_transport_mode = None
        self.test_transport_url = None

        ManagedObject.__init__(self, "SmartlicenseTest", parent_mo_or_dn, **kwargs)
