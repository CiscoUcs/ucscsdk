"""This module contains the general information for SmartlicenseEntitlementEpFsm ManagedObject."""
...
class SmartlicenseEntitlementEpFsmConsts():
    COMPLETION_TIME_ = ""
...
class SmartlicenseEntitlementEpFsm(ManagedObject):
    """This is SmartlicenseEntitlementEpFsm class."""

    consts = SmartlicenseEntitlementEpFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("SmartlicenseEntitlementEpFsm", "smartlicenseEntitlementEpFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'smartlicenseEntitlementEp'], [u'smartlicenseEntitlementEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Configure", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "SmartlicenseEntitlementEpFsm", parent_mo_or_dn, **kwargs)
