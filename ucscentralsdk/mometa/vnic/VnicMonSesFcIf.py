...
class VnicMonSesFcIf(ManagedObject):
    ...
    mo_meta = MoMeta("VnicMonSesFcIf", "vnicMonSesFcIf", "monses-fc-if-[name]", None, "InputOutput", 0x1f, [], ["admin", "ls-config", "ls-network", "ls-server"], [u'vnicMonSesFc'], [u'vnicFault'], [None])
    ...
    prop_meta = {
        ...
        "name": MoPropertyMeta("name", "name", "string", None, MoPropertyMeta.NAMING, 0x4, None, None, r"""[\-\.:_a-zA-Z0-9]{1,32}""", [], []), 
        ...
        "oper_state": MoPropertyMeta("oper_state", "operState", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["down", "failed", "indeterminate", "up"], []), 
        "oper_vnet_dn": MoPropertyMeta("oper_vnet_dn", "operVnetDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "oper_vnet_name": MoPropertyMeta("oper_vnet_name", "operVnetName", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "pub_nw_id": MoPropertyMeta("pub_nw_id", "pubNwId", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", None, MoPropertyMeta.READ_ONLY, 0x8, 0, 256, None, [], []), 
        "sharing": MoPropertyMeta("sharing", "sharing", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, None, ["community", "isolated", "none", "primary"], []), 
        ...
        "vnet": MoPropertyMeta("vnet", "vnet", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["1-4093"]), 
    }
