...
class VnicMgmt(ManagedObject):
    ...
    mo_meta = MoMeta("VnicMgmt", "vnicMgmt", "mgmt", VersionMeta.Version112a, "InputOutput", 0x7ffff, [], ["admin", "ls-config", "ls-server", "ls-storage"], [u'lsServer'], [u'faultInst', u'vnicMgmtIf'], ["Add", "Get", "Remove", "Set"])
