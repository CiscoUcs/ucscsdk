...
class VnicFcGroupTempl(ManagedObject):
    ...
    mo_meta = MoMeta("VnicFcGroupTempl", "vnicFcGroupTempl", "fc-group-templ-[name]", VersionMeta.Version111a, "InputOutput", 0x3ff, [], ["admin", "ls-config", "ls-server", "ls-storage", "ls-storage-policy"], [u'orgOrg'], [u'faultInst'], [None])
    ...
    prop_meta = {
        ...
        "redundancy_pair_type": MoPropertyMeta("redundancy_pair_type", "redundancyPairType", "string", None, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["none", "primary", "secondary"], []), 
