...
class VnicIniGrpFc(ManagedObject):
    ...
    mo_meta = MoMeta("VnicIniGrpFc", "vnicIniGrpFc", "inigrp-fc", VersionMeta.Version141a, "InputOutput", 0x1ffff, [], ["admin", "ls-config", "ls-network", "ls-server", "ls-storage"], [u'lsServer', u'vnicFcGroupDef'], [u'faultInst', u'vnicIniGrpFcIf'], ["Get"])
