"""This module contains the general information for MgmtRegistryInfoFsm ManagedObject."""
...
class MgmtRegistryInfoFsmConsts():
    COMPLETION_TIME_ = ""
...
class MgmtRegistryInfoFsm(ManagedObject):
    """This is MgmtRegistryInfoFsm class."""

    consts = MgmtRegistryInfoFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtRegistryInfoFsm", "mgmtRegistryInfoFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtRegistryInfo'], [u'mgmtRegistryInfoFsmStage'], [None])
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtRegistryInfoFsm", parent_mo_or_dn, **kwargs)
