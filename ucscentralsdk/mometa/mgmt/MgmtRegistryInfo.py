"""This module contains the general information for MgmtRegistryInfo ManagedObject."""
...
class MgmtRegistryInfo(ManagedObject):
    """This is MgmtRegistryInfo class."""
    ...
    prop_meta = {
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["configureBegin", "configureConfig", "configureFail", "configureSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["configureBegin", "configureConfig", "configureFail", "configureSuccess", "nop"], []), 
        ...
        "state": MoPropertyMeta("state", "state", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ok", "out-of-sync"], []), 
        ...
        "svc_reg_ip": MoPropertyMeta("svc_reg_ip", "svcRegIP", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x10, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtRegistryInfo", parent_mo_or_dn, **kwargs)
