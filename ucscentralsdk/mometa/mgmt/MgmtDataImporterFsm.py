"""This module contains the general information for MgmtDataImporterFsm ManagedObject."""
...
class MgmtDataImporterFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_IMPORT_DATA = "importData"
    CURRENT_FSM_NOP = "nop"
...
class MgmtDataImporterFsm(ManagedObject):
    """This is MgmtDataImporterFsm class."""

    consts = MgmtDataImporterFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtDataImporterFsm", "mgmtDataImporterFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtDataImporter'], [u'mgmtDataImporterFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["importData", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtDataImporterFsm", parent_mo_or_dn, **kwargs)
