"""This module contains the general information for MgmtDataExporterFsm ManagedObject."""
...
class MgmtDataExporterFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_EXPORT_DATA = "exportData"
    CURRENT_FSM_NOP = "nop"
...
class MgmtDataExporterFsm(ManagedObject):
    """This is MgmtDataExporterFsm class."""

    consts = MgmtDataExporterFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtDataExporterFsm", "mgmtDataExporterFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtDataExporter'], [u'mgmtDataExporterFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["exportData", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtDataExporterFsm", parent_mo_or_dn, **kwargs)
