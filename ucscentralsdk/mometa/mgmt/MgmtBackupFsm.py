...
class MgmtBackupFsm(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtBackupFsm", "mgmtBackupFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtBackup'], [u'mgmtBackupFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["backup", "nop"], []), 
