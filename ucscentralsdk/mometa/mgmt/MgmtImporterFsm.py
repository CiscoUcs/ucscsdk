...
class MgmtImporterFsm(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtImporterFsm", "mgmtImporterFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtImporter'], [u'mgmtImporterFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["import", "nop"], []), 
