...
class MgmtIfFsm(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtIfFsm", "mgmtIfFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtIf'], [u'mgmtIfFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["DisableVip", "EnableVip", "VirtualIfConfig", "nop"], []), 
