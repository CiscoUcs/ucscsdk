...
class MgmtCmcSecureBootOperation(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtCmcSecureBootOperation", "mgmtCmcSecureBootOperation", "remote-oper", None, "InputOutput", 0x3f, [], ["admin", "ls-compute"], [u'mgmtCmcSecureBoot'], [u'faultInst'], [None])
