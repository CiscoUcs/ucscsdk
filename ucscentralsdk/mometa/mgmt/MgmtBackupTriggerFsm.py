"""This module contains the general information for MgmtBackupTriggerFsm ManagedObject."""
...
class MgmtBackupTriggerFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_TRIGGER = "Trigger"
    CURRENT_FSM_NOP = "nop"
...
class MgmtBackupTriggerFsm(ManagedObject):
    """This is MgmtBackupTriggerFsm class."""

    consts = MgmtBackupTriggerFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("MgmtBackupTriggerFsm", "mgmtBackupTriggerFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'mgmtBackupTrigger'], [u'mgmtBackupTriggerFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Trigger", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtBackupTriggerFsm", parent_mo_or_dn, **kwargs)
