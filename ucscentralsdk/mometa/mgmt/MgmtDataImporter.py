"""This module contains the general information for MgmtDataImporter ManagedObject."""
...
class MgmtDataImporterConsts():
    ...
    AT_VMLEVEL_YES = "yes"
    FSM_PREV_IMPORT_DATA_BEGIN = "importDataBegin"
    FSM_PREV_IMPORT_DATA_DME_IMPORT = "importDataDmeImport"
    FSM_PREV_IMPORT_DATA_DOWNLOAD = "importDataDownload"
    FSM_PREV_IMPORT_DATA_FAIL = "importDataFail"
    FSM_PREV_IMPORT_DATA_REPORT_RESULTS = "importDataReportResults"
    FSM_PREV_IMPORT_DATA_SUCCESS = "importDataSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_IMPORT_DATA_BEGIN = "importDataBegin"
    FSM_STATUS_IMPORT_DATA_DME_IMPORT = "importDataDmeImport"
    FSM_STATUS_IMPORT_DATA_DOWNLOAD = "importDataDownload"
    FSM_STATUS_IMPORT_DATA_FAIL = "importDataFail"
    FSM_STATUS_IMPORT_DATA_REPORT_RESULTS = "importDataReportResults"
    FSM_STATUS_IMPORT_DATA_SUCCESS = "importDataSuccess"
    FSM_STATUS_NOP = "nop"
    INT_ID_NONE = "none"
...
class MgmtDataImporter(ManagedObject):
    ...
    prop_meta = {
        ...
        "at_vm_level": MoPropertyMeta("at_vm_level", "atVMLevel", "string", VersionMeta.Version101a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["importDataBegin", "importDataDmeImport", "importDataDownload", "importDataFail", "importDataReportResults", "importDataSuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["importDataBegin", "importDataDmeImport", "importDataDownload", "importDataFail", "importDataReportResults", "importDataSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "hostname": MoPropertyMeta("hostname", "hostname", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, 0x40, None, None, None, [], []), 
    ...
    def __init__(self, parent_mo_or_dn, hostname, **kwargs):
        ...
        ManagedObject.__init__(self, "MgmtDataImporter", parent_mo_or_dn, **kwargs)
