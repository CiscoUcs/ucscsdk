...
class IdentIdentRequestFsm(ManagedObject):
    ...
    mo_meta = MoMeta("IdentIdentRequestFsm", "identIdentRequestFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'identIdentRequest'], [u'identIdentRequestFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateIdent"], []), 
