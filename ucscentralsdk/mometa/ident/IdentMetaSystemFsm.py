...
class IdentMetaSystemFsm(ManagedObject):
    ...
    mo_meta = MoMeta("IdentMetaSystemFsm", "identMetaSystemFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'identMetaSystem'], [u'identMetaSystemFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "sync"], []), 
