...
class IdentIdentRequestConsts():
    ...
    FSM_PREV_UPDATE_IDENT_REPORT_ID_DOMAIN_MAP = "updateIdentReportIdDomainMap"
    ...
    FSM_STATUS_UPDATE_IDENT_REPORT_ID_DOMAIN_MAP = "updateIdentReportIdDomainMap"
    FSM_STATUS_UPDATE_IDENT_SUCCESS = "updateIdentSuccess"
    OPERATION_REPORT = "report"
    OPERATION_UNASSIGN = "unassign"
    OPERATION_UPDATE = "update"
    UPDATE_IDM_FALSE = "false"
    UPDATE_IDM_NO = "no"
    UPDATE_IDM_TRUE = "true"
    UPDATE_IDM_YES = "yes"
...
class IdentIdentRequest(ManagedObject):
    ...
    prop_meta = {
        ...
        "domain_id": MoPropertyMeta("domain_id", "domainId", "uint", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "fsm_flags": MoPropertyMeta("fsm_flags", "fsmFlags", "string", VersionMeta.Version112a, MoPropertyMeta.INTERNAL, None, None, None, None, [], ["0-4294967295"]), 
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateIdentBegin", "updateIdentExecute", "updateIdentFail", "updateIdentReportIdDomainMap", "updateIdentSuccess"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version111a, MoPropertyMeta.INTERNAL, None, None, None, None, ["nop", "updateIdentBegin", "updateIdentExecute", "updateIdentFail", "updateIdentReportIdDomainMap", "updateIdentSuccess"], []), 
        ...
        "ls_guid": MoPropertyMeta("ls_guid", "lsGuid", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "next_ident_request_dn": MoPropertyMeta("next_ident_request_dn", "nextIdentRequestDn", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "operation": MoPropertyMeta("operation", "operation", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["report", "unassign", "update"], []), 
        "prev_ident_request_dn": MoPropertyMeta("prev_ident_request_dn", "prevIdentRequestDn", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "request_size": MoPropertyMeta("request_size", "requestSize", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, 0x8, 0, 256, None, [], []), 
        "seq_num": MoPropertyMeta("seq_num", "seqNum", "uint", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        ...
        "update_idm": MoPropertyMeta("update_idm", "updateIdm", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["false", "no", "true", "yes"], []), 
    }
    ...
    prop_map = {
        ...
        "id": "id", 
        "lsGuid": "ls_guid", 
        "nextIdentRequestDn": "next_ident_request_dn", 
        "operation": "operation", 
        "prevIdentRequestDn": "prev_ident_request_dn", 
        "requestSize": "request_size", 
        "rn": "rn", 
        "seqNum": "seq_num", 
        "status": "status", 
        "updateIdm": "update_idm", 
    }
    ...
    def __init__(self, parent_mo_or_dn, id, **kwargs):
        ...
        self.fsm_try = None
        self.ls_guid = None
        self.next_ident_request_dn = None
        self.operation = None
        self.prev_ident_request_dn = None
        self.request_size = None
        self.seq_num = None
        self.status = None
        self.update_idm = None
