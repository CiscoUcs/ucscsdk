...
class ObserveObservedFsm(ManagedObject):
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ResolveControllerFsm", "ResolvePolicyFsm", "ResolveResourceFsm", "ResolveVMFsm", "nop"], []), 
