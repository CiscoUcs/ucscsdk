"""This module contains the general information for NfsExportDefFsm ManagedObject."""
...
class NfsExportDefFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_ADD_REPO = "AddRepo"
    CURRENT_FSM_IMAGE_SYNC = "ImageSync"
    CURRENT_FSM_NOP = "nop"
...
class NfsExportDefFsm(ManagedObject):
    """This is NfsExportDefFsm class."""

    consts = NfsExportDefFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("NfsExportDefFsm", "nfsExportDefFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'nfsExportDef'], [u'nfsExportDefFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["AddRepo", "ImageSync", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "NfsExportDefFsm", parent_mo_or_dn, **kwargs)
