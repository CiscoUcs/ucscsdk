"""This module contains the general information for NfsClientDef ManagedObject."""
...
class NfsClientDefConsts():
    ADMIN_STATE_ADD = "add"
    ADMIN_STATE_NONE = "none"
    ADMIN_STATE_REMOVE = "remove"
    CONFIG_STATE_CONFIGURED = "configured"
    CONFIG_STATE_FAILED = "failed"
    CONFIG_STATE_REGISTERED = "registered"
    CONFIG_STATE_UNREGISTERED = "unregistered"
    CONSUMER_ELEMENT_ID_A = "A"
    CONSUMER_ELEMENT_ID_B = "B"
    CONSUMER_ELEMENT_ID_NONE = "NONE"
    CONSUMER_ELEMENT_ID_MGMT = "mgmt"
    FSM_PREV_ADD_CONFIG_BEGIN = "AddConfigBegin"
    FSM_PREV_ADD_CONFIG_FAIL = "AddConfigFail"
    FSM_PREV_ADD_CONFIG_INTERNAL_ADD = "AddConfigInternalAdd"
    FSM_PREV_ADD_CONFIG_PEER_ADD = "AddConfigPeerAdd"
    FSM_PREV_ADD_CONFIG_SUCCESS = "AddConfigSuccess"
    FSM_PREV_DELETE_CONFIG_BEGIN = "DeleteConfigBegin"
    FSM_PREV_DELETE_CONFIG_FAIL = "DeleteConfigFail"
    FSM_PREV_DELETE_CONFIG_INTERNAL_DELETE = "DeleteConfigInternalDelete"
    FSM_PREV_DELETE_CONFIG_PEER_DELETE = "DeleteConfigPeerDelete"
    FSM_PREV_DELETE_CONFIG_SUCCESS = "DeleteConfigSuccess"
    FSM_PREV_NOP = "nop"
    ...
    FSM_STATUS_ADD_CONFIG_BEGIN = "AddConfigBegin"
    FSM_STATUS_ADD_CONFIG_FAIL = "AddConfigFail"
    FSM_STATUS_ADD_CONFIG_INTERNAL_ADD = "AddConfigInternalAdd"
    FSM_STATUS_ADD_CONFIG_PEER_ADD = "AddConfigPeerAdd"
    FSM_STATUS_ADD_CONFIG_SUCCESS = "AddConfigSuccess"
    FSM_STATUS_DELETE_CONFIG_BEGIN = "DeleteConfigBegin"
    FSM_STATUS_DELETE_CONFIG_FAIL = "DeleteConfigFail"
    FSM_STATUS_DELETE_CONFIG_INTERNAL_DELETE = "DeleteConfigInternalDelete"
    FSM_STATUS_DELETE_CONFIG_PEER_DELETE = "DeleteConfigPeerDelete"
    FSM_STATUS_DELETE_CONFIG_SUCCESS = "DeleteConfigSuccess"
    FSM_STATUS_NOP = "nop"


class NfsClientDef(ManagedObject):
    ...
    prop_meta = {
        ...
        "admin_state": MoPropertyMeta("admin_state", "adminState", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["add", "none", "remove"], []), 
        "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, r"""((deleteAll|ignore|deleteNonPresent),){0,2}(deleteAll|ignore|deleteNonPresent){0,1}""", [], []), 
        "config_state": MoPropertyMeta("config_state", "configState", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["configured", "failed", "registered", "unregistered"], []), 
        ...
        "consumer_element_id": MoPropertyMeta("consumer_element_id", "consumerElementId", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["A", "B", "NONE", "mgmt"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["AddConfigBegin", "AddConfigFail", "AddConfigInternalAdd", "AddConfigPeerAdd", "AddConfigSuccess", "DeleteConfigBegin", "DeleteConfigFail", "DeleteConfigInternalDelete", "DeleteConfigPeerDelete", "DeleteConfigSuccess", "nop"], []), 
        ...
        "fsm_rmt_inv_err_code": MoPropertyMeta("fsm_rmt_inv_err_code", "fsmRmtInvErrCode", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ERR-DNLD-authentication-failure", "ERR-DNLD-error", "ERR-DNLD-hostkey-mismatch", "ERR-DNLD-invalid-image", "ERR-DNLD-no-file", "ERR-DNLD-no-space", "ERR-DNS-delete-error", "ERR-DNS-get-error", "ERR-DNS-set-error", "ERR-Digest-Validation-error", "ERR-Exec-Gen-Cert-error", "ERR-Exec-Get-CA-Cert-error", "ERR-FILTER-illegal-format", "ERR-FSM-no-such-state", "ERR-Get-CA-Cert-error", "ERR-Get-Cert-error", "ERR-Get-Out-Diget-Message-error", "ERR-HTTP-Request-error", "ERR-HTTP-set-error", "ERR-HTTPS-set-error", "ERR-Ipv6-addr-configured", "ERR-MO-CONFIG-child-object-cant-be-configured", "ERR-MO-META-no-such-object-class", "ERR-MO-PROPERTY-no-such-property", "ERR-MO-PROPERTY-value-out-of-range", "ERR-MO-access-denied", "ERR-MO-deletion-rule-violation", "ERR-MO-duplicate-object", "ERR-MO-illegal-containment", "ERR-MO-illegal-creation", "ERR-MO-illegal-iterator-state", "ERR-MO-illegal-object-lifecycle-transition", "ERR-MO-naming-rule-violation", "ERR-MO-object-not-found", "ERR-MO-resource-allocation", "ERR-NTP-delete-error", "ERR-NTP-get-error", "ERR-NTP-set-error", "ERR-Policy-resolution-in-progress", "ERR-TOKEN-request-denied", "ERR-Update-VM-IP-Mask-Gateway-error", "ERR-aaa-config-modify-error", "ERR-acct-realm-set-error", "ERR-admin-passwd-set", "ERR-auth-realm-set-error", "ERR-authentication", "ERR-authorization-required", "ERR-create-hfp-under-dg", "ERR-create-keyring", "ERR-create-locale", "ERR-create-role", "ERR-create-user", "ERR-delete-locale", "ERR-delete-role", "ERR-delete-session", "ERR-delete-user", "ERR-estimate-impact-on-reconnect", "ERR-get-max-http-user-sessions", "ERR-http-initializing", "ERR-internal-error", "ERR-ldap-delete-error", "ERR-ldap-get-error", "ERR-ldap-group-modify-error", "ERR-ldap-group-set-error", "ERR-ldap-set-error", "ERR-locale-set-error", "ERR-max-userid-sessions-reached", "ERR-modify-locale", "ERR-modify-role", "ERR-modify-user", "ERR-modify-user-locale", "ERR-modify-user-role", "ERR-nfs-down", "ERR-provider-group-modify-error", "ERR-provider-group-set-error", "ERR-radius-global-set-error", "ERR-radius-group-set-error", "ERR-radius-set-error", "ERR-role-set-error", "ERR-service-not-ready", "ERR-session-cache-full", "ERR-session-not-found", "ERR-set-password-strength-check", "ERR-tacacs-enable-error", "ERR-tacacs-global-set-error", "ERR-tacacs-group-set-error", "ERR-tacacs-set-error", "ERR-timezone-set-error", "ERR-user-account-expired", "ERR-user-set-error", "none"], ["0-4294967295"]), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, ["AddConfigBegin", "AddConfigFail", "AddConfigInternalAdd", "AddConfigPeerAdd", "AddConfigSuccess", "DeleteConfigBegin", "DeleteConfigFail", "DeleteConfigInternalDelete", "DeleteConfigPeerDelete", "DeleteConfigSuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "ip": MoPropertyMeta("ip", "ip", "string", VersionMeta.Version101a, MoPropertyMeta.NAMING, 0x4, None, None, r"""^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$|[a-fA-F0-9:\[\]]{1,39}""", [], []), 
        "repository_ip": MoPropertyMeta("repository_ip", "repositoryIp", "string", VersionMeta.Version111a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
    ...
    prop_map = {
        ...
        "consumerElementId": "consumer_element_id", 
        "dn": "dn", 
        "fltAggr": "flt_aggr", 
        "fsmDescr": "fsm_descr", 
        "fsmPrev": "fsm_prev", 
    ...
    def __init__(self, parent_mo_or_dn, ip, **kwargs):
        ...
        self.fsm_try = None
        self.repository_ip = None
        self.status = None

        ManagedObject.__init__(self, "NfsClientDef", parent_mo_or_dn, **kwargs)
