...
class AaaUserEpFsm(ManagedObject):
    ...
    mo_meta = MoMeta("AaaUserEpFsm", "aaaUserEpFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'aaaUserEp'], [u'aaaUserEpFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateUserEp"], []), 
