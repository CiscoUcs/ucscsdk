...
class AaaSession(ManagedObject):
    ...
    mo_meta = MoMeta("AaaSession", "aaaSession", "term-[id]", VersionMeta.Version101a, "InputOutput", 0x1f, [], ["aaa", "admin", "domain-group-management"], [u'aaaRemoteUser', u'aaaUser'], [], ["Get", "Remove"])
