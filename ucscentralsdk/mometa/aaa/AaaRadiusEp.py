...
class AaaRadiusEp(ManagedObject):
    ...
    mo_meta = MoMeta("AaaRadiusEp", "aaaRadiusEp", "radius-ext", VersionMeta.Version101a, "InputOutput", 0xff, [], ["aaa", "admin"], [u'orgDomainGroup', u'policyDeviceProfile', u'topSystem'], [u'aaaEpFsm', u'aaaEpFsmTask', u'aaaProviderGroup', u'aaaRadiusEpFsm', u'aaaRadiusProvider', u'eventInst', u'faultInst'], ["Add", "Get", "Remove", "Set"])
