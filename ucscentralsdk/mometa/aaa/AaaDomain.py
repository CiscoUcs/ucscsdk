...
class AaaDomain(ManagedObject):
    ...
    mo_meta = MoMeta("AaaDomain", "aaaDomain", "domain-[name]", VersionMeta.Version101a, "InputOutput", 0xff, [], ["aaa", "admin", "domain-group-management"], [u'aaaAuthRealm'], [u'aaaDomainAuth'], ["Add", "Get", "Remove", "Set"])
