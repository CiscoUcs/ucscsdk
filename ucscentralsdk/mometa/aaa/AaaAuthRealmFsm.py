...
class AaaAuthRealmFsm(ManagedObject):
    ...
    mo_meta = MoMeta("AaaAuthRealmFsm", "aaaAuthRealmFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'aaaAuthRealm'], [u'aaaAuthRealmFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateRealm"], []), 
