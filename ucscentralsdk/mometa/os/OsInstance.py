...
class OsInstance(ManagedObject):
    ...
    mo_meta = MoMeta("OsInstance", "osInstance", "os", VersionMeta.Version131a, "InputOutput", 0xf, [], ["read-only"], [u'computeBlade'], [u'osEthBondIntf', u'osEthIntf', u'storageEthLif'], ["Get"])
