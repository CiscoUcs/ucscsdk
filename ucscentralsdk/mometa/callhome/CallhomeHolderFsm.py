"""This module contains the general information for CallhomeHolderFsm ManagedObject."""
...
class CallhomeHolderFsm(ManagedObject):
    """This is CallhomeHolderFsm class."""

    consts = CallhomeHolderFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("CallhomeHolderFsm", "callhomeHolderFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'callhomeHolder'], [u'callhomeHolderFsmStage'], ["Get"])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["Configure", "Inventory", "nop"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "CallhomeHolderFsm", parent_mo_or_dn, **kwargs)
