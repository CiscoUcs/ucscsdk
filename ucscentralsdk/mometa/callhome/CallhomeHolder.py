"""This module contains the general information for CallhomeHolder ManagedObject."""
...
class CallhomeHolderConsts():
    CONFIG_STATE_NOT_APPLIED = "not-applied"
    CONFIG_STATE_OK = "ok"
    FSM_PREV_CONFIGURE_BEGIN = "ConfigureBegin"
    FSM_PREV_CONFIGURE_DISABLE_SMART_CALLHOME = "ConfigureDisableSmartCallhome"
    FSM_PREV_CONFIGURE_ENABLE_SMART_CALLHOME = "ConfigureEnableSmartCallhome"
    ...
    FSM_PREV_INVENTORY_SEND_INVENTORY = "InventorySendInventory"
    ...
    FSM_STATUS_CONFIGURE_DISABLE_SMART_CALLHOME = "ConfigureDisableSmartCallhome"
    FSM_STATUS_CONFIGURE_ENABLE_SMART_CALLHOME = "ConfigureEnableSmartCallhome"
    ...
    FSM_STATUS_INVENTORY_SEND_INVENTORY = "InventorySendInventory"
    FSM_STATUS_INVENTORY_SUCCESS = "InventorySuccess"
    FSM_STATUS_NOP = "nop"
    INVENTORY_STATUS_INV_DEFAULT = "INV_DEFAULT"
    INVENTORY_STATUS_INV_ENABLE = "INV_ENABLE"
    INVENTORY_STATUS_INV_IN_PROGRESS = "INV_IN_PROGRESS"
    INVENTORY_STATUS_INV_THROTTLED = "INV_THROTTLED"


class CallhomeHolder(ManagedObject):
    """This is CallhomeHolder class."""
    ...
    prop_meta = {
        ...
        "config_state": MoPropertyMeta("config_state", "configState", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["not-applied", "ok"], []), 
        ...
        "fsm_prev": MoPropertyMeta("fsm_prev", "fsmPrev", "string", VersionMeta.Version141a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureDisableSmartCallhome", "ConfigureEnableSmartCallhome", "ConfigureFail", "ConfigureSuccess", "InventoryBegin", "InventoryFail", "InventorySendInventory", "InventorySuccess", "nop"], []), 
        ...
        "fsm_status": MoPropertyMeta("fsm_status", "fsmStatus", "string", VersionMeta.Version141a, MoPropertyMeta.INTERNAL, None, None, None, None, ["ConfigureBegin", "ConfigureDisableSmartCallhome", "ConfigureEnableSmartCallhome", "ConfigureFail", "ConfigureSuccess", "InventoryBegin", "InventoryFail", "InventorySendInventory", "InventorySuccess", "nop"], []), 
        "fsm_try": MoPropertyMeta("fsm_try", "fsmTry", "byte", VersionMeta.Version141a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "inventory_status": MoPropertyMeta("inventory_status", "inventoryStatus", "string", VersionMeta.Version141a, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["INV_DEFAULT", "INV_ENABLE", "INV_IN_PROGRESS", "INV_THROTTLED"], []), 
    ...
    def __init__(self, **kwargs):
        ...
        ManagedObject.__init__(self, "CallhomeHolder", **kwargs)
