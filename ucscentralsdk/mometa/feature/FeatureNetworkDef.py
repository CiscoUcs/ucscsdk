...
class FeatureNetworkDef(ManagedObject):
    ...
    prop_meta = {
        ...
        "feature_mask": MoPropertyMeta("feature_mask", "featureMask", "string", VersionMeta.Version112a, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|none|pvlan_feature_mask|netflow_feature_mask|vlan_range_feature_mask|vlan_range_extended_feature_mask|usnic_vmq_feature_mask),){0,6}(defaultValue|none|pvlan_feature_mask|netflow_feature_mask|vlan_range_feature_mask|vlan_range_extended_feature_mask|usnic_vmq_feature_mask){0,1}""", [], []), 
