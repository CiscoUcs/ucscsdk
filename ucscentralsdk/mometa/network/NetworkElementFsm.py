"""This module contains the general information for NetworkElementFsm ManagedObject."""
...
class NetworkElementFsmConsts():
    COMPLETION_TIME_ = ""
    CURRENT_FSM_NOP = "nop"
    CURRENT_FSM_UPDATE_ELEMENT = "updateElement"
...
class NetworkElementFsm(ManagedObject):
    """This is NetworkElementFsm class."""

    consts = NetworkElementFsmConsts()
    naming_props = set([])

    mo_meta = MoMeta("NetworkElementFsm", "networkElementFsm", "fsm", VersionMeta.Version141a, "OutputOnly", 0xf, [], [""], [u'networkElement'], [u'networkElementFsmStage'], [None])
    ...
    prop_meta = {
        ...
        "current_fsm": MoPropertyMeta("current_fsm", "currentFsm", "string", VersionMeta.Version141a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["nop", "updateElement"], []), 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "NetworkElementFsm", parent_mo_or_dn, **kwargs)
