...
class NetworkElement(ManagedObject):
    ...
    mo_meta = MoMeta("NetworkElement", "networkElement", "switch-[id]", VersionMeta.Version101a, "InputOutput", 0x3ff, [], ["admin", "ext-lan-config"], [u'computeSystem', u'topSystem'], [u'equipmentFan', u'equipmentFanModule', u'equipmentLocatorLed', u'equipmentPsu', u'equipmentSwitchCard', u'eventInst', u'faultInst', u'firmwareStatus', u'mgmtController', u'mgmtIPv6IfAddr', u'mgmtIPv6IfConfig', u'networkElementFsm', u'networkElementFsmTask', u'networkSystemCACert', u'storageItem', u'swCardEnvStats', u'swEnvStats', u'swSystemStats'], ["Get", "Set"])

    prop_meta = {
        "admin_evac_state": MoPropertyMeta("admin_evac_state", "adminEvacState", "string", None, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["drain", "fill", "unknown"], []), 
        ...
        "diff_memory": MoPropertyMeta("diff_memory", "diffMemory", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "dn": MoPropertyMeta("dn", "dn", "string", VersionMeta.Version101a, MoPropertyMeta.READ_ONLY, 0x4, 0, 256, None, [], []), 
        "expected_memory": MoPropertyMeta("expected_memory", "expectedMemory", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
        "flt_aggr": MoPropertyMeta("flt_aggr", "fltAggr", "ulong", VersionMeta.Version101a, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
        "force_evac": MoPropertyMeta("force_evac", "forceEvac", "string", None, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["false", "no", "true", "yes"], []), 
        ...
        "inband_if_gw": MoPropertyMeta("inband_if_gw", "inbandIfGw", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        "inband_if_ip": MoPropertyMeta("inband_if_ip", "inbandIfIp", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        "inband_if_mask": MoPropertyMeta("inband_if_mask", "inbandIfMask", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []), 
        "inband_if_vnet": MoPropertyMeta("inband_if_vnet", "inbandIfVnet", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], ["0-4090"]), 
        "inventory_status": MoPropertyMeta("inventory_status", "inventoryStatus", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""((defaultValue|up|remote-eth-port-inventory|fc-pc-inventory|fc-port-inventory|switch-fru|vlan-comp-grp-inventory|switch-inventory|vlan-port-count|mgmt-port-inventory|card-inventory|xcvr-inventory|eth-pc-inventory|eth-port-inventory),){0,13}(defaultValue|up|remote-eth-port-inventory|fc-pc-inventory|fc-port-inventory|switch-fru|vlan-comp-grp-inventory|switch-inventory|vlan-port-count|mgmt-port-inventory|card-inventory|xcvr-inventory|eth-pc-inventory|eth-port-inventory){0,1}""", [], []), 
        ...
        "oob_if_mac": MoPropertyMeta("oob_if_mac", "oobIfMac", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [], []), 
        ...
        "total_memory": MoPropertyMeta("total_memory", "totalMemory", "uint", None, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
