"""This module contains the general information for TagInstance ManagedObject."""
...
class TagInstance(ManagedObject):
    ...
    prop_meta = {
        ...
        "tagged_object_dn": MoPropertyMeta("tagged_object_dn", "taggedObjectDn", "string", None, MoPropertyMeta.NAMING, 0x20, 0, 256, None, [], []), 
        "value": MoPropertyMeta("value", "value", "string", None, MoPropertyMeta.NAMING, 0x40, 1, 64, None, [], []), 
    }
    ...
    def __init__(self, parent_mo_or_dn, def_name, value, tagged_object_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "TagInstance", parent_mo_or_dn, **kwargs)
