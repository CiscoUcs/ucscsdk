...
class TagInstanceItem(ManagedObject):
    ...
    mo_meta = MoMeta("TagInstanceItem", "tagInstanceItem", "tag-instance-item", None, "InputOutput", 0xf, [], ["read-only"], [], [], [None])
    ...
    prop_meta = {
        ...
        "def_name": MoPropertyMeta("def_name", "defName", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""[ !#$%&\(\)\*\+,\-\.:;=\?@\[\]_\{\|\}~a-zA-Z0-9]{0,32}""", [], []), 
        ...
        "domain_name": MoPropertyMeta("domain_name", "domainName", "string", None, MoPropertyMeta.READ_ONLY, None, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []), 
        ...
        "tagged_object_dn": MoPropertyMeta("tagged_object_dn", "taggedObjectDn", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 256, None, [], []), 
        "value": MoPropertyMeta("value", "value", "string", None, MoPropertyMeta.READ_ONLY, None, 0, 64, r"""[a-zA-Z0-9=\[\]!#$%()*+\\,-./:;@_\s{|}~?]+""", [], []), 
