...
class TagItem(ManagedObject):
    ...
    mo_meta = MoMeta("TagItem", "tagItem", "tag-[value]", None, "InputOutput", 0x1f, [], ["admin", "tag"], [u'tagDef'], [], [None])
    ...
    prop_meta = {
        ...
        "value": MoPropertyMeta("value", "value", "string", None, MoPropertyMeta.NAMING, 0x10, 1, 64, None, [], []), 
    }
