...
from ucscentralsdk.ucscentralgenutils import Progress
...
def _is_valid_cisco_connection(cisco_username, cisco_password, proxy_str):
    ...
    '''
    image_list = []
    image_list = get_ucscentral_cco_image_list(username=cisco_username,
                                               password=cisco_password,
                                               proxy=proxy_str)

    if image_list == []:
        UcsCentralWarning("Connection to cisco.com failed")
        return False
    return True
